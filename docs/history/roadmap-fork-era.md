...
> **FROZEN HISTORICAL RECORD (2026-09-07).**  This document coordinated the
> fork-era development (2026-07-14 → 2026-08-15): the trunk, the thread-0/
> thread-1 fork, sync gate S, and the W4′/W5′ arcs.  Its checkpoint
> narratives remain accurate and are cited by contracts and working notes;
> nothing here is maintained.  The LIVE roadmap — current stream statuses,
> the audited open-work ledger, and the parked list — is docs/roadmap.md.
> The stream table below in particular is frozen mid-2026-08 and calls
> since-shipped work (the J-track, S1–S3) "proposed"; trust the live file.
