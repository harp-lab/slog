...
(module+ test
  ...
  (displayln "AT: lets are scheduled after their inputs are bound") (flush-output)
  ...
  (displayln "AT: two dynamic joins yield two versions") (flush-output)
  ...
  (displayln "AT: closed-relation joins yield a single version") (flush-output)
  ...
  (displayln "AT: repeated join variables become fresh vars plus == guards") (flush-output)
  ...
  (displayln "AT: nested head constructions stage into a temp-driven chain") (flush-output)
  ...
  (displayln "AT: circular body lets raise") (flush-output)
  ...
  (displayln "AT: circular head lets raise") (flush-output)
  ...
  (displayln "AT: let with already-ground output becomes fresh var plus ==") (flush-output)
  ...
  (displayln "AT: unbound head variable raises") (flush-output)
  ...
  (displayln "AT: two head constructions binding one id raise") (flush-output)
