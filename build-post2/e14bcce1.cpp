...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("e14bcce1");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst6baB89 conste593eb62d5b2b78aac29610d) (let __tconst7zKr90 const99071cf3586be89134ffc1b3)) (probe _enum (1 0) 1 __tconst6baB89 __t7b2E25) (body (join _enum (1 0) 1 __tconst7zKr90 __t02MF24) (join input (0) 0 l)) (head (mkstruct compose (1 2 0) __9hEJ88 __t7b2E25 __t02MF24)) dem_lambda.slog:26 #f)
  class ReadTask2 : public slog::Task
  {
    ...
    slog::Index** _enumindex0;  slog::Index** inputindex1;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("compose");
      std::vector<u16> ord3({1, 0});
      slog::Relation* readrel4 = db->getRelation("_enum");
      ...
      slog::Relation* readrel8 = db->getRelation("input");
      inputindex1 = readrel8->getIndex(ord7, false);
    ...
    virtual bool work()
    {
      ...
      u64 v_c1 = v_const99071cf3586be89134ffc1b3;
      ...
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m9) {
        u64 v_c2 = m9[1];
        if (buckethash(v_c2) != bucket) return;
        slog::join_probe<2,1>(_enumindex0, std::array<u64,2>{v_c1, 0}, [&](const std::array<u64,2>& m10) {
          u64 v_c3 = m10[1];
          slog::join_all<1>(inputindex1, [&](const std::array<u64,1>& m11) {
            u64 v_c4 = m11[0];
            ++_fires;
