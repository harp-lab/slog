...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("8b0ea245");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan mpz_table_overflow __erre4bR280 __errf7OSm81 __errf5KDY82) (body) (head (emit error (0) __erre4bR280)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre9vTt53 __errf3dG454 __errf0TB555) (body) (head (emit error (0) __erre9vTt53)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst6C4s1 const6b86b273ff34fce19d6b804e)) (scan p X __t2FMd2) (body (let chk2MbI83 (_0002b X __tconst6C4s1)) (eq __t2FMd2 chk2MbI83)) (head (emit consec (0 1) X __t2FMd2)) prim2_letfilter.slog:23 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("consec");
      std::vector<u16> ord7({0, 1});
      slog::Relation* readrel8 = db->getRelation("consec");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c7 = _t[0];
        u64 v_c8 = _t[1];
        u64 v_c9 = _prim__0002b(db, v_c7, v_c6);
        if (v_c9 == slog_error) { slog::emit_pending_error(db, "prim2_letfilter.slog:23"); return; }
        if (v_c8 != v_c9) return;
        ++_fires;
      ...
      if (_fires) db->bumpFires("prim2_letfilter.slog:23", "all:p", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre7nfp75 __errf6V0k76 __errf4MlV77 __errf4Lqe78 __errf36pa79) (body) (head (emit error (0) __erre7nfp75)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre5qno56 __errf3Ood57 __errf8KRw58) (body) (head (emit error (0) __erre5qno56)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre3J5I59 __errf93h560 __errf0eEc61 __errf6Vk362) (body) (head (emit error (0) __erre3J5I59)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre1UMY67 __errf4Qil68 __errf2LEB69) (body) (head (emit error (0) __erre1UMY67)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre2CvF63 __errf9vEh64 __errf2k2165 __errf3CHX66) (body) (head (emit error (0) __erre2CvF63)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst856U3 constd4735e3a265e16eee03f5971)) (scan p X __t2pSD4) (body (let chk0uIB85 (_0002a X __tconst856U3)) (eq __t2pSD4 chk0uIB85)) (head (emit dbl (0 1) X __t2pSD4)) prim2_letfilter.slog:24 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel26 = db->getRelation("dbl");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c7 = _t[0];
        u64 v_c30 = _t[1];
        u64 v_c31 = _prim__0002a(db, v_c7, v_c29);
        if (v_c31 == slog_error) { slog::emit_pending_error(db, "prim2_letfilter.slog:24"); return; }
        if (v_c30 != v_c31) return;
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c7, v_c30}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim2_letfilter.slog:24", "all:p", _fires);
  ...
  // (crule (pre (let __tconst94oN5 const6b86b273ff34fce19d6b804e) (let __tconst91RQ7 constd4735e3a265e16eee03f5971)) (scan n X) (body (let __t6JqI6 (_0002b X __tconst94oN5)) (let chk3p1U84 (_0002a X __tconst91RQ7)) (eq __t6JqI6 chk3p1U84)) (head (emit fixp (0 1) X __t6JqI6)) prim2_letfilter.slog:25 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fixp");
      std::vector<u16> ord28({0, 1});
      slog::Relation* readrel29 = db->getRelation("fixp");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c7 = _t[0];
        u64 v_c34 = _prim__0002b(db, v_c7, v_c32);
        if (v_c34 == slog_error) { slog::emit_pending_error(db, "prim2_letfilter.slog:25"); return; }
        u64 v_c35 = _prim__0002a(db, v_c7, v_c33);
        if (v_c35 == slog_error) { slog::emit_pending_error(db, "prim2_letfilter.slog:25"); return; }
        if (v_c34 != v_c35) return;
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c7, v_c34}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim2_letfilter.slog:25", "all:n", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre8Wf070 __errf6rNz71 __errf0luV72 __errf8UVI73 __errf6Suw74) (body) (head (emit error (0) __erre8Wf070)) <internal>:1 #f)
  ...
  s->addDynamicRel("consec");
  s->addDynamicRel("dbl");
  s->addDynamicRel("div_by_zero");
  s->addDynamicRel("error");
  s->addDynamicRel("fixp");
