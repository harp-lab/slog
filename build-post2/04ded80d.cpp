...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("04ded80d");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp6RRc511");
  if (r == 0) db->addTempRelation("temp6RRc511", 2);
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::LatticeInternTask<2>(db, db->getRelation("dist"), std::array<u16,2>{0, 1}, b));
  ...
  // (crule (pre) (scan modulo_by_zero __erre4yam484 __errf01pL485 __errf6mve486) (body) (head (emit error (0) __erre4yam484)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre47xY491 __errf7x2i492 __errf4b4V493 __errf189R494) (body) (head (emit error (0) __erre47xY491)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre041j503 __errf2TKZ504 __errf80sf505 __errf6MMz506 __errf3QfR507) (body) (head (emit error (0) __erre041j503)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp6RRc511 Y __t68961) (body) (head (emit-lat dist Y __t68961)) accel_lat_chain.slog:9 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      outer_rel = db->getRelation("temp6RRc511");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("accel_lat_chain.slog:9", "delta:temp6RRc511", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre9PsL487 __errf9XQy488 __errf1K92489 __errf4g3o490) (body) (head (emit error (0) __erre9PsL487)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre93nV508 __errf1W71509 __errf3kpZ510) (body) (head (emit error (0) __erre93nV508)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre0JOn481 __errf50Ia482 __errf4GAE483) (body) (head (emit error (0) __erre0JOn481)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre5W7w495 __errf2sYG496 __errf5UMa497) (body) (head (emit error (0) __erre5W7w495)) <internal>:1 #f)
  ...
  // (crule (pre) (scan dist X D) (body (join edge (0 1 2) 1 X Y W) (let __t68961 (_0002b D W))) (head (emit-temp temp6RRc511 Y __t68961)) accel_lat_chain.slog:9 #f)
  class ReadTask23 : public slog::Task
  {
    ...
    slog::Index** edgeindex22;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp6RRc511");
      outer_rel = db->getRelation("dist");
      std::vector<u16> ord24({0, 1, 2});
      slog::Relation* readrel25 = db->getRelation("edge");
      edgeindex22 = readrel25->getIndex(ord24, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c27 = _t[0];
        u64 v_c28 = _t[1];
        slog::join_probe<3,1>(edgeindex22, std::array<u64,3>{v_c27, 0, 0}, [&](const std::array<u64,3>& m26) {
          u64 v_c12 = m26[1]; u64 v_c29 = m26[2];
          u64 v_c13 = _prim__0002b(db, v_c28, v_c29);
          if (v_c13 == slog_error) { slog::emit_pending_error(db, "accel_lat_chain.slog:9"); return; }
          ++_fires;
          slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c12, v_c13});
        });
      });
      ...
      if (_fires) db->bumpFires("accel_lat_chain.slog:9", "delta:dist", _fires);
  ...
  // (crule (pre (let __tconst3jm83 const6b86b273ff34fce19d6b804e) (let __tconst7wFG2 const5feceb66ffc86f38d952786c)) (once) (body) (head (emit-lat dist __tconst3jm83 __tconst7wFG2)) accel_lat_chain.slog:8 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("accel_lat_chain.slog:8", "once", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre6cWe498 __errf3BZG499 __errf0I7T500 __errf67di501 __errf9JEk502) (body) (head (emit error (0) __erre6cWe498)) <internal>:1 #f)
