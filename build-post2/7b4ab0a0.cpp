...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("7b4ab0a0");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan type_mismatch __erre7WEG254 __errf5UrE255 __errf3pv5256 __errf6VM8257 __errf90GQ258) (body) (head (emit error (0) __erre7WEG254)) <internal>:1 #f)
  ...
  // (crule (pre (let _00024sqc8dZv180 const6b86b273ff34fce19d6b804e) (let _00024sqc4ETK182 constd4735e3a265e16eee03f5971) (let _00024sqc3orT184 const4e07408562bedb8b60ce05c1) (let _00024sqc9N9a186 const4b227777d4dd1fc61c6f884f) (let _00024sqc554j187 constef2d127de37b942baad06145) (let _00024sqb9Cjh178 (lempty)) (let _00024sqb8M9t179 (lpush _00024sqb9Cjh178 _00024sqc8dZv180)) (let _00024sqb14d9181 (lpush _00024sqb8M9t179 _00024sqc4ETK182)) (let _00024sqb9CP0183 (lpush _00024sqb14d9181 _00024sqc3orT184)) (let _00024sqb47FN185 (lpush _00024sqb9CP0183 _00024sqc9N9a186)) (let _00024seq0 (lpush _00024sqb47FN185 _00024sqc554j187))) (once) (body) (head (mkstruct lst_len (1 0) __46F6205 _00024seq0)) lst_ops.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("lst_len");
    ...
    virtual bool work()
    {
      ...
      u64 v_c9 = v_constef2d127de37b942baad06145;
      u64 v_c10 = _prim_lempty(db);
      if (v_c10 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:15"); return true; }
      u64 v_c11 = _prim_lpush(db, v_c10, v_c5);
      if (v_c11 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:15"); return true; }
      u64 v_c12 = _prim_lpush(db, v_c11, v_c6);
      if (v_c12 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:15"); return true; }
      u64 v_c13 = _prim_lpush(db, v_c12, v_c7);
      if (v_c13 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:15"); return true; }
      u64 v_c14 = _prim_lpush(db, v_c13, v_c8);
      if (v_c14 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:15"); return true; }
      u64 v_c15 = _prim_lpush(db, v_c14, v_c9);
      if (v_c15 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:15"); return true; }
      ...
      if (_fires) db->bumpFires("lst_ops.slog:15", "once", _fires);
  ...
  // (crule (pre) (scan nan_result __erre2huw247 __errf9TqK248 __errf8Gk6249 __errf2Gks250) (body) (head (emit error (0) __erre2huw247)) <internal>:1 #f)
  ...
  // (crule (pre (let _00024sqc0uZQ102 constef2d127de37b942baad06145) (let _00024sqc6rAG104 conste7f6c011776e8db7cd330b54) (let _00024sqc3K8P105 const7902699be42c8a8e46fbbb45) (let __tconst9i7C11 const7902699be42c8a8e46fbbb45) (let _00024sqb0vtH100 (lempty)) (let _00024sqb6VW4101 (lpush _00024sqb0vtH100 _00024sqc0uZQ102)) (let _00024sqb4fJ0103 (lpush _00024sqb6VW4101 _00024sqc6rAG104)) (let _00024seq0 (lpush _00024sqb4fJ0103 _00024sqc3K8P105))) (once) (body) (head (mkstruct lst_member (1 2 0) __3t4N204 _00024seq0 __tconst9i7C11)) lst_ops.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("lst_member");
    ...
    virtual bool work()
    {
      ...
      u64 v_c21 = v_conste7f6c011776e8db7cd330b54;
      u64 v_c22 = v_const7902699be42c8a8e46fbbb45;
      u64 v_c23 = v_const7902699be42c8a8e46fbbb45;
      u64 v_c24 = _prim_lempty(db);
      if (v_c24 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:14"); return true; }
      u64 v_c25 = _prim_lpush(db, v_c24, v_c20);
      if (v_c25 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:14"); return true; }
      u64 v_c26 = _prim_lpush(db, v_c25, v_c21);
      if (v_c26 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:14"); return true; }
      u64 v_c15 = _prim_lpush(db, v_c26, v_c22);
      if (v_c15 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:14"); return true; }
      ...
      ++_fires;
      slog::emit_struct<3>(head_rel[0], newbatch[0], std::array<u64,2>{v_c15, v_c23}, std::array<u16,3>{1, 2, 0});
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lst_ops.slog:14", "once", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre27xX237 __errf2RAW238 __errf16Hb239) (body) (head (emit error (0) __erre27xX237)) <internal>:1 #f)
  ...
  // (crule (pre (let _00024sqc0hVj190 const6b86b273ff34fce19d6b804e) (let _00024sqc9hBw192 constd4735e3a265e16eee03f5971) (let _00024sqc6Pup193 const4e07408562bedb8b60ce05c1) (let _00024sqb2vc4188 (lempty)) (let _00024sqb7m6C189 (lpush _00024sqb2vc4188 _00024sqc0hVj190)) (let _00024sqb9X6q191 (lpush _00024sqb7m6C189 _00024sqc9hBw192)) (let _00024seq0 (lpush _00024sqb9X6q191 _00024sqc6Pup193))) (once) (body) (head (mkstruct lst_rev (1 0) __8X2b202 _00024seq0)) lst_ops.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("lst_rev");
    ...
    virtual bool work()
    {
      ...
      u64 v_c33 = _prim_lempty(db);
      if (v_c33 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:16"); return true; }
      u64 v_c34 = _prim_lpush(db, v_c33, v_c30);
      if (v_c34 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:16"); return true; }
      u64 v_c35 = _prim_lpush(db, v_c34, v_c31);
      if (v_c35 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:16"); return true; }
      u64 v_c15 = _prim_lpush(db, v_c35, v_c32);
      if (v_c15 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:16"); return true; }
      ...
      if (_fires) db->bumpFires("lst_ops.slog:16", "once", _fires);
  ...
  // (crule (pre (let _00024sqc2K0y196 const4e07408562bedb8b60ce05c1) (let _00024sqc8fC0197 const4b227777d4dd1fc61c6f884f) (let _00024sqc2OG3200 const6b86b273ff34fce19d6b804e) (let _00024sqc1zx2201 constd4735e3a265e16eee03f5971) (let _00024sqb5ZzY194 (lempty)) (let _00024sqb3R6G195 (lpush _00024sqb5ZzY194 _00024sqc2K0y196)) (let _00024seq1 (lpush _00024sqb3R6G195 _00024sqc8fC0197)) (let _00024sqb87Ob198 (lempty)) (let _00024sqb8Tvf199 (lpush _00024sqb87Ob198 _00024sqc2OG3200)) (let _00024seq0 (lpush _00024sqb8Tvf199 _00024sqc1zx2201))) (once) (body) (head (mkstruct lst_append (1 2 0) __2F7m203 _00024seq0 _00024seq1)) lst_ops.slog:12 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("lst_append");
  
    }
    ReadTask12(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c36 = v_const4e07408562bedb8b60ce05c1;
      u64 v_c37 = v_const4b227777d4dd1fc61c6f884f;
      u64 v_c38 = v_const6b86b273ff34fce19d6b804e;
      u64 v_c39 = v_constd4735e3a265e16eee03f5971;
      u64 v_c40 = _prim_lempty(db);
      if (v_c40 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:12"); return true; }
      u64 v_c41 = _prim_lpush(db, v_c40, v_c36);
      if (v_c41 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:12"); return true; }
      u64 v_c42 = _prim_lpush(db, v_c41, v_c37);
      if (v_c42 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:12"); return true; }
      u64 v_c43 = _prim_lempty(db);
      if (v_c43 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:12"); return true; }
      u64 v_c44 = _prim_lpush(db, v_c43, v_c38);
      if (v_c44 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:12"); return true; }
      u64 v_c15 = _prim_lpush(db, v_c44, v_c39);
      if (v_c15 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:12"); return true; }
      ...
      ++_fires;
      slog::emit_struct<3>(head_rel[0], newbatch[0], std::array<u64,2>{v_c15, v_c42}, std::array<u16,3>{1, 2, 0});
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lst_ops.slog:12", "once", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre4lbk264 __errf21VJ265 __errf7ni3266) (body) (head (emit error (0) __erre4lbk264)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre71Vx251 __errf0XTY252 __errf5Lk9253) (body) (head (emit error (0) __erre71Vx251)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre2ys1259 __errf0x2k260 __errf9McS261 __errf0Idr262 __errf0BAi263) (body) (head (emit error (0) __erre2ys1259)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre9hRy243 __errf2ZXe244 __errf6eZW245 __errf56G5246) (body) (head (emit error (0) __erre9hRy243)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre35Ml240 __errf2ERb241 __errf8e5L242) (body) (head (emit error (0) __erre35Ml240)) <internal>:1 #f)
  ...
  // (crule (pre (let _00024sqc9mIY67 const4a44dc15364204a80fe80e90) (let _00024sqc2mwM69 constf5ca38f748a1d6eaf726b8a4) (let _00024sqc65Zi71 const624b60c58c9d8bfb6ff1886c) (let _00024sqc4f7x72 constd59eced1ded07f84c145592f) (let __tconst0RrJ1 constd4735e3a265e16eee03f5971) (let _00024sqb9K8v65 (lempty)) (let _00024sqb33hu66 (lpush _00024sqb9K8v65 _00024sqc9mIY67)) (let _00024sqb3ehU68 (lpush _00024sqb33hu66 _00024sqc2mwM69)) (let _00024sqb2UvO70 (lpush _00024sqb3ehU68 _00024sqc65Zi71)) (let _00024seq0 (lpush _00024sqb2UvO70 _00024sqc4f7x72))) (once) (body) (head (mkstruct lst_ref (1 2 0) __56vC206 _00024seq0 __tconst0RrJ1)) lst_ops.slog:13 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("lst_ref");
  
    }
    ReadTask28(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c63 = v_const4a44dc15364204a80fe80e90;
      u64 v_c64 = v_constf5ca38f748a1d6eaf726b8a4;
      u64 v_c65 = v_const624b60c58c9d8bfb6ff1886c;
      u64 v_c66 = v_constd59eced1ded07f84c145592f;
      u64 v_c67 = v_constd4735e3a265e16eee03f5971;
      u64 v_c68 = _prim_lempty(db);
      if (v_c68 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:13"); return true; }
      u64 v_c69 = _prim_lpush(db, v_c68, v_c63);
      if (v_c69 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:13"); return true; }
      u64 v_c70 = _prim_lpush(db, v_c69, v_c64);
      if (v_c70 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:13"); return true; }
      u64 v_c71 = _prim_lpush(db, v_c70, v_c65);
      if (v_c71 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:13"); return true; }
      u64 v_c15 = _prim_lpush(db, v_c71, v_c66);
      if (v_c15 == slog_error) { slog::emit_pending_error(db, "lst_ops.slog:13"); return true; }
      ...
      ++_fires;
      slog::emit_struct<3>(head_rel[0], newbatch[0], std::array<u64,2>{v_c15, v_c67}, std::array<u16,3>{1, 2, 0});
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lst_ops.slog:13", "once", _fires);
  ...
  s->addDynamicRel("lst_append");
  s->addDynamicRel("lst_len");
  s->addDynamicRel("lst_member");
  s->addDynamicRel("lst_ref");
  s->addDynamicRel("lst_rev");
