...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("3ca39d1d");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan start n) (body (join inc (1 0) 1 n __t3Q6g1) (join inc_ans (0 1) 1 __t3Q6g1 m)) (head (emit result (0 1) n m)) dem_chain.slog:12 #f)
  class ReadTask2 : public slog::Task
  {
    ...
    slog::Index** incindex0;  slog::Index** inc_ansindex1;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel4 = db->getRelation("result");
      head_index[0] = readrel4->getIndex(ord3, false);
      outer_rel = db->getRelation("start");
      std::vector<u16> ord5({1, 0});
      slog::Relation* readrel6 = db->getRelation("inc");
      incindex0 = readrel6->getIndex(ord5, false);
      std::vector<u16> ord7({0, 1});
      slog::Relation* readrel8 = db->getRelation("inc_ans");
      inc_ansindex1 = readrel8->getIndex(ord7, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        slog::join_probe<2,1>(incindex0, std::array<u64,2>{v_c0, 0}, [&](const std::array<u64,2>& m9) {
          u64 v_c1 = m9[1];
          slog::join_probe<2,1>(inc_ansindex1, std::array<u64,2>{v_c1, 0}, [&](const std::array<u64,2>& m10) {
            u64 v_c2 = m10[1];
            ++_fires;
