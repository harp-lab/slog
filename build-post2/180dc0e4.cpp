...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("180dc0e4");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<2>(db, db->getRelation("q"), std::array<u16,2>{0, 1}, b));
  r = db->getRelation("p");
  ...
  // (crule (pre (let __tconst27361 constd4735e3a265e16eee03f5971) (let __tconst0NJ63 const4b227777d4dd1fc61c6f884f) (let __tconst4s215 const4e07408562bedb8b60ce05c1) (let __tconst6Odc6 const6b86b273ff34fce19d6b804e) (let __tconst7MyX7 const19581e27de7ced00ff1ce50b) (let __tconst0ztc8 constef2d127de37b942baad06145)) (once) (body) (head (emit p (0 1) __tconst6Odc6 __tconst27361) (emit p (0 1) __tconst4s215 __tconst0NJ63) (emit p (0 1) __tconst6Odc6 __tconst4s215) (emit p (0 1) __tconst0ztc8 __tconst7MyX7)) prim2_headlet.slog:8 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("prim2_headlet.slog:8", "once", _fires);
