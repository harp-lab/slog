...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("cf083732");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan start n) (body) (head (mkstruct inc (1 0) __7vY87 n)) dem_chain.slog:12 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("inc");
      outer_rel = db->getRelation("start");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_chain.slog:12", "all:start", _fires);
