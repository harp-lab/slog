...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("024fcd46");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("bad");
  if (r == 0) db->addRelation("bad", 1);
  else if (r->getArity() != 1)
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("bad");
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<1>(db, db->getRelation("bad"), std::array<u16,1>{0}, b));
  ...
  // (crule (pre) (scan modulo_by_zero __erre5KZj38 __errf9H3F39 __errf1ka640) (body) (head (emit error (0) __erre5KZj38)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst1gSF1 constad57366865126e55649ecb23)) (scan d X) (body (let __t5FpE2 (_0002f __tconst1gSF1 X))) (head (emit bad (0) __t5FpE2)) err_div0.slog:8 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("bad");
      std::vector<u16> ord4({0});
      slog::Relation* readrel5 = db->getRelation("bad");
    ...
    virtual bool work()
    {
      u64 v_c3 = v_constad57366865126e55649ecb23;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c4 = _t[0];
        u64 v_c5 = _prim__0002f(db, v_c3, v_c4);
        if (v_c5 == slog_error) { slog::emit_pending_error(db, "err_div0.slog:8"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("err_div0.slog:8", "all:d", _fires);
  ...
  // (crule (pre) (scan nan_result __erre1Q3m45 __errf6d9B46 __errf6rmS47 __errf8QFD48) (body) (head (emit error (0) __erre1Q3m45)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre7Olq62 __errf3kKQ63 __errf2Qg464) (body) (head (emit error (0) __erre7Olq62)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre8PgW35 __errf1qBw36 __errf1JXF37) (body) (head (emit error (0) __erre8PgW35)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre9UuK57 __errf1OFb58 __errf8fac59 __errf5zMs60 __errf3GkQ61) (body) (head (emit error (0) __erre9UuK57)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre3Sla52 __errf6n3H53 __errf4o0V54 __errf66R755 __errf3JL256) (body) (head (emit error (0) __erre3Sla52)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre2GYe41 __errf0OeS42 __errf48rt43 __errf4JZR44) (body) (head (emit error (0) __erre2GYe41)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre4Wzz49 __errf8jb950 __errf2JVP51) (body) (head (emit error (0) __erre4Wzz49)) <internal>:1 #f)
