...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("ff8436c0");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst82Re14 const076de6e730df0b4c3860877a) (let __tconst9X2M15 const18d10c7d2b4b04aaf04254d1) (let __tconst6bGC8 constc100f95c1913f9c72fc1f4ef) (let __tconst3AJB6 constac8d8342bbb2362d13f0a559)) (probe _enum (1 0) 1 __tconst82Re14 __tconst8Htp7) (body (join _enum (1 0) 1 __tconst9X2M15 __tconst2Qvw5)) (head (emit flag (0 1) __tconst6bGC8 __tconst8Htp7) (emit flag (0 1) __tconst3AJB6 __tconst2Qvw5)) bools.slog:8 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("flag");
      std::vector<u16> ord2({0, 1});
      slog::Relation* readrel3 = db->getRelation("flag");
      head_index[0] = readrel3->getIndex(ord2, false);
      head_rel[1] = db->getRelation("flag");
    ...
    virtual bool work()
    {
      ...
      u64 v_c1 = v_const18d10c7d2b4b04aaf04254d1;
      ...
      if (_fires) db->bumpFires("bools.slog:8", "all:_enum", _fires);
