...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("e88bcfd2");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan smt_vcode C V) (body (join smt_core (0 1) 0 __t9sMq95 F)) (head (mkstruct smt_qcore (1 0) __9Cg5175 F)) smt.slog:106 #f)
  ...
  // (crule (pre) (scan smt_vcode C V) (body (join smt_model (0 1) 0 __t9SC4111 F)) (head (mkstruct smt_qmodel (1 0) __5NIo146 F)) smt.slog:93 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel8 = db->getRelation("smt_model");
      smt_modelindex5 = readrel8->getIndex(ord7, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c1 = _t[1];
        slog::join_all<2>(smt_modelindex5, [&](const std::array<u64,2>& m9) {
  ...
  // (crule (pre) (scan smt_vcode C V) (body (join smt_check (0 1) 0 __t6CXf92 F)) (head (mkstruct smt_qsat (1 0) __4ovY151 F)) smt.slog:69 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel13 = db->getRelation("smt_check");
      smt_checkindex10 = readrel13->getIndex(ord12, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c1 = _t[1];
        slog::join_all<2>(smt_checkindex10, [&](const std::array<u64,2>& m14) {
  ...
  // (crule (pre) (scan smt_bad_formula __erre1tfh201 __errf3POv202 __errf262y203) (body) (head (emit error (0) __erre1tfh201)) <internal>:1 #f)
