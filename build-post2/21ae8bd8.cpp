...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("21ae8bd8");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan b X) (body) (head (emit d (0) X)) strat_or.slog:16 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("strat_or.slog:16", "all:b", _fires);
  ...
  // (crule (pre) (scan c X) (body) (head (emit d (0) X)) strat_or.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel5 = db->getRelation("d");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("strat_or.slog:16", "all:c", _fires);
