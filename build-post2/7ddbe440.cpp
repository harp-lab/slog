...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("7ddbe440");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan mpz_overflow __erre9h7W200 __errf0NYs201 __errf7IjQ202 __errf4C0y203 __errf2DvJ204) (body) (head (emit error (0) __erre9h7W200)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre5Ky4192 __errf6hKl193 __errf7OBE194) (body) (head (emit error (0) __erre5Ky4192)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre5lXq205 __errf22YV206 __errf1PKa207) (body) (head (emit error (0) __erre5lXq205)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre2aw5195 __errf66uN196 __errf1LFu197 __errf1qh6198 __errf2MjB199) (body) (head (emit error (0) __erre2aw5195)) <internal>:1 #f)
  ...
  // (crule (pre) (scan bigneg N) (body (let __t6hTk3 (abs N))) (head (emit bigabs (0) __t6hTk3)) int_bignum.slog:29 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("bigabs");
      std::vector<u16> ord13({0});
      slog::Relation* readrel14 = db->getRelation("bigabs");
      head_index[0] = readrel14->getIndex(ord13, false);
      outer_rel = db->getRelation("bigneg");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c16 = _t[0];
        u64 v_c17 = _prim_abs(db, v_c16);
        if (v_c17 == slog_error) { slog::emit_pending_error(db, "int_bignum.slog:29"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("int_bignum.slog:29", "all:bigneg", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre7X8t184 __errf45oA185 __errf2bXs186 __errf26LN187) (body) (head (emit error (0) __erre7X8t184)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre4IWg188 __errf3YR1189 __errf2Xx9190 __errf8J60191) (body) (head (emit error (0) __erre4IWg188)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre0E7o178 __errf85h0179 __errf9Q3C180) (body) (head (emit error (0) __erre0E7o178)) <internal>:1 #f)
  ...
  // (crule (pre) (scan fact25 S) (body (letp __t93fX27 (s2i S))) (head (emit parsed (0) __t93fX27)) int_bignum.slog:22 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("parsed");
      std::vector<u16> ord25({0});
      slog::Relation* readrel26 = db->getRelation("parsed");
      head_index[0] = readrel26->getIndex(ord25, false);
      outer_rel = db->getRelation("fact25");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c29 = _t[0];
        bool ok27 = true;
        u64 v_c30 = _prim_s2i(db, v_c29, &ok27);
        if (!ok27) return;
        ++_fires;
      ...
      if (_fires) db->bumpFires("int_bignum.slog:22", "all:fact25", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre9Kv4181 __errf0qUb182 __errf6lGP183) (body) (head (emit error (0) __erre9Kv4181)) <internal>:1 #f)
