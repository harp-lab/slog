...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("3b74627d");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst3St06 const4e07408562bedb8b60ce05c1) (let __tconst5UhF5 const4b227777d4dd1fc61c6f884f) (let __tconst4sxf4 const6b86b273ff34fce19d6b804e) (let __tconst5GaI3 constd4735e3a265e16eee03f5971)) (once) (body) (head (emit in (0 1) __tconst3St06 __tconst5UhF5) (emit in (0 1) __tconst4sxf4 __tconst5GaI3)) nested.slog:6 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("nested.slog:6", "once", _fires);
