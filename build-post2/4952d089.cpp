...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("4952d089");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<2>(db, db->getRelation("ret"), std::array<u16,2>{0, 1}, b));
  ...
  // (crule (pre (let __tconst5CfN44 conste433800a79f2d3be41014577)) (once) (body) (head (mkstruct _enum (1 0) __9KDd45 __tconst5CfN44)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c0 = v_conste433800a79f2d3be41014577;
