...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("517e76c7");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("samecycle");
  if (r == 0) db->addRelation("samecycle", 2);
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<2>(db, db->getRelation("samecycle"), std::array<u16,2>{0, 1}, b));
  ...
  r = db->getRelation("from1");
  if (r == 0) db->addRelation("from1", 1);
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<1>(db, db->getRelation("from1"), std::array<u16,1>{0}, b));
  ...
  // (crule (pre (let __tconst20tb5 constd4735e3a265e16eee03f5971) (let __tconst4cf76 const6b86b273ff34fce19d6b804e) (let __tconst7oM48 const4b227777d4dd1fc61c6f884f) (let __tconst8FNt9 const4e07408562bedb8b60ce05c1)) (once) (body) (head (emit edge (0 1) __tconst4cf76 __tconst20tb5) (emit edge (0 1) __tconst20tb5 __tconst8FNt9) (emit edge (0 1) __tconst8FNt9 __tconst4cf76) (emit edge (0 1) __tconst8FNt9 __tconst7oM48)) strat_selfdown.slog:10 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("strat_selfdown.slog:10", "once", _fires);
