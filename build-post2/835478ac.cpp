...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("835478ac");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp8qAu768");
  if (r == 0) db->addTempRelation("temp8qAu768", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp8bwG771");
  if (r == 0) db->addTempRelation("temp8bwG771", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp66xl773");
  if (r == 0) db->addTempRelation("temp66xl773", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp5U6d769");
  if (r == 0) db->addTempRelation("temp5U6d769", 3);
  else if (r->getArity() != 3) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp1azi770");
  if (r == 0) db->addTempRelation("temp1azi770", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp1BUp772");
  if (r == 0) db->addTempRelation("temp1BUp772", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  ...
  r = db->getRelation("mpz_overflow");
    ...
    r->addIndex<5>(ord115, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<5>(db, r, std::array<u16,5>{1, 2, 3, 4, 0}, false, b), true);
      std::vector<u16> ord116({0, 1, 2, 3, 4});
    
    r->addIndex<5>(ord116, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<5>(db, r, std::array<u16,5>{0, 1, 2, 3, 4}, false, b), false);
  ...
  if (r == 0) db->addRelation("argument_list", 1);
    ...
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("argument_list");
      std::vector<u16> ord192({0});
    
    r->addIndex<1>(ord192, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<1>(db, r, std::array<u16,1>{0}, false, b), true);
  ...
  // (crule (pre) (scan lst_ref __t2I1O15 l n) (body (letp __t3u9714 (lref l n))) (head (emit-temp temp66xl773 __t2I1O15 __t3u9714)) list.slog:16 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("temp66xl773");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c2 = _t[2];
        bool ok1 = true;
        u64 v_c3 = _prim_lref(db, v_c1, v_c2, &ok1);
        if (!ok1) return;
        ++_fires;
  ...
  // (crule (pre) (scan temp1BUp772 __t4owM117 __t6A4W118) (body) (head (emit lst_len_ans (0 1) __t6A4W118 __t4owM117)) list.slog:24 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel4 = db->getRelation("lst_len_ans");
      head_index[0] = readrel4->getIndex(ord3, false);
      outer_rel = db->getRelation("temp1BUp772");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("list.slog:24", "delta:temp1BUp772", _fires);
  ...
  // (crule (pre (let __tconst1n87679 constb9e118781cea1f9fa01462e0) (let __tconst54YQ680 const0122baa3ac55f1b433944eb1)) (probe _enum (1 0) 1 __tconst1n87679 __t8dvl210) (body (join _enum (1 0) 1 __tconst54YQ680 __t8qBA209)) (head (emit any_bool (0) __t8dvl210) (emit any_bool (0) __t8qBA209)) interp.slog:107 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel10 = db->getRelation("any_bool");
      head_index[1] = readrel10->getIndex(ord9, false);
      ...
      _enumindex5 = readrel14->getIndex(ord13, false);
    ...
    virtual bool work()
    {
      ...
      u64 v_c7 = v_const0122baa3ac55f1b433944eb1;
      ...
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c6, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m15) {
        u64 v_c8 = m15[1];
        if (buckethash(v_c8) != bucket) return;
        slog::join_probe<2,1>(_enumindex5, std::array<u64,2>{v_c7, 0}, [&](const std::array<u64,2>& m16) {
          u64 v_c9 = m16[1];
          ++_fires;
  ...
  // (crule (pre) (scan temp8qAu768 __t3Un3385 __t5HUt384) (body) (head (emit lst_rev_ans (0 1) __t3Un3385 __t5HUt384)) list.slog:37 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel19 = db->getRelation("lst_rev_ans");
      head_index[0] = readrel19->getIndex(ord18, false);
      outer_rel = db->getRelation("temp8qAu768");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("list.slog:37", "delta:temp8qAu768", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre0w5r765 __errf0wJl766 __errf49MN767) (body) (head (emit error (0) __erre0w5r765)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre2XJx741 __errf5O4V742 __errf8AuQ743) (body) (head (emit error (0) __erre2XJx741)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre4WSC760 __errf66xk761 __errf0RIR762 __errf0Sjd763 __errf9251764) (body) (head (emit error (0) __erre4WSC760)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre5oOh748 __errf0TTi749 __errf8zuN750 __errf6qq0751) (body) (head (emit error (0) __erre5oOh748)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp1azi770 __t10Vk124 __t7nBX125) (body) (head (emit lst_rev_acc_ans (0 1) __t7nBX125 __t10Vk124)) list.slog:42 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel34 = db->getRelation("lst_rev_acc_ans");
      head_index[0] = readrel34->getIndex(ord33, false);
      outer_rel = db->getRelation("temp1azi770");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c28 = _t[1];
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c28, v_c27}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("list.slog:42", "delta:temp1azi770", _fires);
  ...
  // (crule (pre) (scan lst_len __t6A4W118 l) (body (let __t4owM117 (llen l))) (head (emit-temp temp1BUp772 __t4owM117 __t6A4W118)) list.slog:24 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp1BUp772");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c5 = _t[0];
        u64 v_c1 = _t[1];
        u64 v_c4 = _prim_llen(db, v_c1);
        if (v_c4 == slog_error) { slog::emit_pending_error(db, "list.slog:24"); return; }
        ++_fires;
  ...
  // (crule (pre) (scan int_overflow __erre6vJr744 __errf73yA745 __errf83k4746 __errf9qfh747) (body) (head (emit error (0) __erre6vJr744)) <internal>:1 #f)
  ...
  // (crule (pre) (scan lst_append __t1yx07 a b) (body (let __t12Tv6 (lcat a b))) (head (emit-temp temp8bwG771 __t12Tv6 __t1yx07)) list.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp8bwG771");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c34 = _t[1];
        u64 v_c35 = _t[2];
        u64 v_c36 = _prim_lcat(db, v_c34, v_c35);
        if (v_c36 == slog_error) { slog::emit_pending_error(db, "list.slog:11"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c36, v_c33});
      });
  ...
  // (crule (pre) (scan temp8bwG771 __t12Tv6 __t1yx07) (body) (head (emit lst_append_ans (0 1) __t1yx07 __t12Tv6)) list.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel42 = db->getRelation("lst_append_ans");
      head_index[0] = readrel42->getIndex(ord41, false);
      outer_rel = db->getRelation("temp8bwG771");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("list.slog:11", "delta:temp8bwG771", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre9y5w738 __errf2UpW739 __errf7Y5K740) (body) (head (emit error (0) __erre9y5w738)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst9cVd192 const5feceb66ffc86f38d952786c) (let __tconst6j9a189 const6b86b273ff34fce19d6b804e)) (scan lst_member __t2IpY190 l y) (body (let __t3Vqk191 (lmem l y)) (cmp lt __tconst9cVd192 __t3Vqk191)) (head (emit lst_member_ans (0 1) __t2IpY190 __tconst6j9a189)) list.slog:20 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel48 = db->getRelation("lst_member_ans");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c1 = _t[1];
        u64 v_c43 = _t[2];
        u64 v_c44 = _prim_lmem(db, v_c1, v_c43);
        if (v_c44 == slog_error) { slog::emit_pending_error(db, "list.slog:20"); return; }
        u64 v_c45 = _prim_lt(db, v_c40, v_c44);
        if (v_c45 == slog_error) { slog::emit_pending_error(db, "list.slog:20"); return; }
        if (!v_c45) return;
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c42, v_c41}, std::array<u16,2>{0, 1});
      });
  ...
  // (crule (pre (let __tconst6Lsd61 const60e3114d9b4b6577eea8cbc0) (let __tconst8IDj60 const06abaa100ecef791ce028c56)) (once) (body) (head (emit primitive (0) __tconst6Lsd61) (emit primitive (0) __tconst8IDj60)) interp.slog:106 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel52 = db->getRelation("primitive");
      head_index[0] = readrel52->getIndex(ord51, false);
      head_rel[1] = db->getRelation("primitive");
      std::vector<u16> ord53({0});
      slog::Relation* readrel54 = db->getRelation("primitive");
      head_index[1] = readrel54->getIndex(ord53, false);
  
    }
    ReadTask50(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c46 = v_const60e3114d9b4b6577eea8cbc0;
  ...
  // (crule (pre) (scan lst_rev __t3Un3385 l) (body (let __t5HUt384 (lrev l))) (head (emit-temp temp8qAu768 __t3Un3385 __t5HUt384)) list.slog:37 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp8qAu768");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c10 = _t[0];
        u64 v_c1 = _t[1];
        u64 v_c11 = _prim_lrev(db, v_c1);
        if (v_c11 == slog_error) { slog::emit_pending_error(db, "list.slog:37"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c10, v_c11});
      });
  ...
  // (crule (pre) (scan type_mismatch __erre71QM755 __errf9H3t756 __errf2qDW757 __errf5PwY758 __errf6DjF759) (body) (head (emit error (0) __erre71QM755)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp66xl773 __t2I1O15 __t3u9714) (body) (head (emit lst_ref_ans (0 1) __t2I1O15 __t3u9714)) list.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel61 = db->getRelation("lst_ref_ans");
      head_index[0] = readrel61->getIndex(ord60, false);
      outer_rel = db->getRelation("temp66xl773");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("list.slog:16", "delta:temp66xl773", _fires);
  ...
  // (crule (pre) (scan toint_range __erre7ItZ752 __errf4CCP753 __errf0PDI754) (body) (head (emit error (0) __erre7ItZ752)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp5U6d769 __t7nBX125 __t7zs6123 acc) (body (let __t10Vk124 (lcat __t7zs6123 acc))) (head (emit-temp temp1azi770 __t10Vk124 __t7nBX125)) list.slog:42 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp1azi770");
      outer_rel = db->getRelation("temp5U6d769");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c56 = _t[1];
        u64 v_c57 = _t[2];
        u64 v_c27 = _prim_lcat(db, v_c56, v_c57);
        if (v_c27 == slog_error) { slog::emit_pending_error(db, "list.slog:42"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("list.slog:42", "delta:temp5U6d769", _fires);
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel68 = db->getRelation("primitive");
  ...
  // (crule (pre) (scan lst_rev_acc __t7nBX125 l acc) (body (let __t7zs6123 (lrev l))) (head (emit-temp temp5U6d769 __t7nBX125 __t7zs6123 acc)) list.slog:42 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp5U6d769");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c1 = _t[1];
        u64 v_c57 = _t[2];
        u64 v_c56 = _prim_lrev(db, v_c1);
        if (v_c56 == slog_error) { slog::emit_pending_error(db, "list.slog:42"); return; }
        ++_fires;
        slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c28, v_c56, v_c57});
      });
  ...
  s->addReadRel("temp1BUp772");
  s->addReadRel("temp1azi770");
  s->addReadRel("temp5U6d769");
  s->addReadRel("temp66xl773");
  s->addReadRel("temp8bwG771");
  s->addReadRel("temp8qAu768");
  ...
  s->addDynamicRel("temp1BUp772");
  s->addDynamicRel("temp1azi770");
  s->addDynamicRel("temp5U6d769");
  s->addDynamicRel("temp66xl773");
  s->addDynamicRel("temp8bwG771");
  s->addDynamicRel("temp8qAu768");
