...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("e35c2365");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<1>(db, db->getRelation("grow"), std::array<u16,1>{0}, b));
  ...
  // (crule (pre) (scan mpz_table_overflow __erre07Y0125 __errf8lOq126 __errf2cbx127) (body) (head (emit error (0) __erre07Y0125)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre1f1T104 __errf65U6105 __errf3esT106 __errf3Plz107) (body) (head (emit error (0) __erre1f1T104)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre5hU7120 __errf2KoZ121 __errf3FJ0122 __errf01EQ123 __errf3dLs124) (body) (head (emit error (0) __erre5hU7120)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre52ug115 __errf6QA9116 __errf9hdF117 __errf9Mh5118 __errf4yIx119) (body) (head (emit error (0) __erre52ug115)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre8bYe112 __errf0Xy2113 __errf6OQr114) (body) (head (emit error (0) __erre8bYe112)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst6CzH5 constef2d127de37b942baad06145)) (scan grow X) (body (let __t8vI86 (_0002b X __tconst6CzH5))) (head (emit big (0) __t8vI86)) strat_run_main.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel17 = db->getRelation("big");
    ...
    virtual bool work()
    {
      u64 v_c20 = v_constef2d127de37b942baad06145;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c21 = _t[0];
        u64 v_c22 = _prim__0002b(db, v_c21, v_c20);
        if (v_c22 == slog_error) { slog::emit_pending_error(db, "strat_run_main.slog:14"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_run_main.slog:14", "all:grow", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre9vpL101 __errf31Es102 __errf92O8103) (body) (head (emit error (0) __erre9vpL101)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre48zn108 __errf607Z109 __errf0ahw110 __errf2eok111) (body) (head (emit error (0) __erre48zn108)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre4eGT98 __errf9aTC99 __errf7jCl100) (body) (head (emit error (0) __erre4eGT98)) <internal>:1 #f)
