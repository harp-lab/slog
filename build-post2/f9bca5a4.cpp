...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("f9bca5a4");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan toint_range __erre3hRD407 __errf3CND408 __errf26VV409) (body) (head (emit error (0) __erre3hRD407)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre1y2Y403 __errf5HD6404 __errf0lyJ405 __errf5RH9406) (body) (head (emit error (0) __erre1y2Y403)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre6je4393 __errf7gfp394 __errf0LyV395) (body) (head (emit error (0) __erre6je4393)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre0NOS396 __errf7o4b397 __errf9Yqc398) (body) (head (emit error (0) __erre0NOS396)) <internal>:1 #f)
  ...
  // (crule (pre) (scan loopsof n s) (body (let __t22gd6 (csize s))) (head (emit depth (0 1) n __t22gd6)) domtree.slog:100 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("depth");
      std::vector<u16> ord13({0, 1});
      slog::Relation* readrel14 = db->getRelation("depth");
      head_index[0] = readrel14->getIndex(ord13, false);
      outer_rel = db->getRelation("loopsof");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        if (v_c15 == slog_error) { slog::emit_pending_error(db, "domtree.slog:100"); return; }
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c13, v_c15}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("domtree.slog:100", "all:loopsof", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre12Zn415 __errf6Ipu416 __errf31q4417 __errf07ts418 __errf83XD419) (body) (head (emit error (0) __erre12Zn415)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre4WOt399 __errf2mpR400 __errf0Ngb401 __errf0D5E402) (body) (head (emit error (0) __erre4WOt399)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre7Cpx410 __errf6Pwf411 __errf6ykI412 __errf9Wxg413 __errf4EiP414) (body) (head (emit error (0) __erre7Cpx410)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre2Sad420 __errf6LSz421 __errf3RdM422) (body) (head (emit error (0) __erre2Sad420)) <internal>:1 #f)
