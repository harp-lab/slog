...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("acc562b2");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst9YGr4 constef2d127de37b942baad06145) (let __tconst8b5u3 const5feceb66ffc86f38d952786c)) (once) (body) (head (emit d (0) __tconst9YGr4) (emit d (0) __tconst8b5u3)) err_react.slog:6 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("err_react.slog:6", "once", _fires);
