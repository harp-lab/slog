...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("94bbf3df");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan modulo_by_zero __erre0TgG195 __errf4z2d196 __errf8t2M197) (body) (head (emit error (0) __erre0TgG195)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre2AcA202 __errf75Ud203 __errf4Lcb204 __errf3sNv205) (body) (head (emit error (0) __erre2AcA202)) <internal>:1 #f)
  ...
  // (crule (pre) (scan n x) (body) (head (mkstruct sq (1 0) __0cX834 x)) dem_value.slog:27 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre4zls192 __errf9OMK193 __errf2Bjp194) (body) (head (emit error (0) __erre4zls192)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst5gnQ16 const4a44dc15364204a80fe80e90)) (scan n x) (body (join fib (1 0) 1 x __t9xSy17) (join fib_ans (0 1) 1 __t9xSy17 __v0) (cmp lt __v0 __tconst5gnQ16)) (head (emit smallfib (0) x)) dem_value.slog:22 #f)
  class ReadTask12 : public slog::Task
  {
    ...
    slog::Index** fibindex10;  slog::Index** fib_ansindex11;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("smallfib");
      std::vector<u16> ord13({0});
      slog::Relation* readrel14 = db->getRelation("smallfib");
      head_index[0] = readrel14->getIndex(ord13, false);
      outer_rel = db->getRelation("n");
      std::vector<u16> ord15({1, 0});
      slog::Relation* readrel16 = db->getRelation("fib");
      fibindex10 = readrel16->getIndex(ord15, false);
      std::vector<u16> ord17({0, 1});
      slog::Relation* readrel18 = db->getRelation("fib_ans");
      fib_ansindex11 = readrel18->getIndex(ord17, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c7 = _t[0];
        slog::join_probe<2,1>(fibindex10, std::array<u64,2>{v_c7, 0}, [&](const std::array<u64,2>& m19) {
          u64 v_c12 = m19[1];
          slog::join_probe<2,1>(fib_ansindex11, std::array<u64,2>{v_c12, 0}, [&](const std::array<u64,2>& m20) {
            u64 v_c13 = m20[1];
            u64 v_c14 = _prim_lt(db, v_c13, v_c11);
            if (v_c14 == slog_error) { slog::emit_pending_error(db, "dem_value.slog:22"); return; }
            if (!v_c14) return;
            ++_fires;
  ...
  // (crule (pre) (scan int_overflow __erre3vqa198 __errf875B199 __errf8Gp7200 __errf8I0Y201) (body) (head (emit error (0) __erre3vqa198)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre6U5f219 __errf918y220 __errf6cBO221) (body) (head (emit error (0) __erre6U5f219)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre8Sbp206 __errf6ZAr207 __errf4pwm208) (body) (head (emit error (0) __erre8Sbp206)) <internal>:1 #f)
  ...
  // (crule (pre) (scan n x) (body (join fib (1 0) 1 x __t6isY22) (join fib_ans (0 1) 1 __t6isY22 __v0)) (head (mkstruct sq (1 0) __8EM331 __v0)) dem_value.slog:18 #f)
  class ReadTask33 : public slog::Task
  {
    ...
    slog::Index** fibindex31;  slog::Index** fib_ansindex32;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel35 = db->getRelation("fib");
      fibindex31 = readrel35->getIndex(ord34, false);
      std::vector<u16> ord36({0, 1});
      slog::Relation* readrel37 = db->getRelation("fib_ans");
      fib_ansindex32 = readrel37->getIndex(ord36, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c7 = _t[0];
        slog::join_probe<2,1>(fibindex31, std::array<u64,2>{v_c7, 0}, [&](const std::array<u64,2>& m38) {
          u64 v_c25 = m38[1];
          slog::join_probe<2,1>(fib_ansindex32, std::array<u64,2>{v_c25, 0}, [&](const std::array<u64,2>& m39) {
            u64 v_c13 = m39[1];
            ++_fires;
  ...
  // (crule (pre) (scan mpz_overflow __erre8NuL214 __errf59wX215 __errf2rKB216 __errf5ouT217 __errf3IQK218) (body) (head (emit error (0) __erre8NuL214)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre51av209 __errf7Hhj210 __errf7cfJ211 __errf3lie212 __errf0ZoN213) (body) (head (emit error (0) __erre51av209)) <internal>:1 #f)
