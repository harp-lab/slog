...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("715003d3");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst7BgD4 const6b86b273ff34fce19d6b804e) (let __tconst415Z5 const4b227777d4dd1fc61c6f884f) (let __tconst6cCy6 const4e07408562bedb8b60ce05c1) (let __tconst3fWI7 constd4735e3a265e16eee03f5971)) (once) (body) (head (emit edge (0 1 2) __tconst7BgD4 __tconst3fWI7 __tconst6cCy6) (emit edge (0 1 2) __tconst3fWI7 __tconst6cCy6 __tconst415Z5)) lat_run_base.slog:8 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      ++_fires;
      slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c0, v_c3, v_c2}, std::array<u16,3>{0, 1, 2});
      slog::emit<3>(head_rel[1], head_index[1], newbatch[1], std::array<u64,3>{v_c3, v_c2, v_c1}, std::array<u16,3>{0, 1, 2});
  
        head_rel[0]->sendBatch(newbatch[0]);
        head_rel[1]->sendBatch(newbatch[1]);
  
      if (_fires) db->bumpFires("lat_run_base.slog:8", "once", _fires);
