...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("bb4f9d53");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst7U8H49 consta221beeaebe583607e193be7) (let __tconst3M3l50 constab76c7d069d6f33dc950fb33) (let __tconst8fVN51 consteb8bf0d80db323992f6b634a) (let __tconst0NPx10 constd4735e3a265e16eee03f5971) (let __tconst7cIc8 const6b86b273ff34fce19d6b804e) (let __tconst2jY56 const5feceb66ffc86f38d952786c)) (probe _enum (1 0) 1 __tconst7U8H49 __t0j8p9) (body (exists _enum (1 0) 1 __tconst8fVN51) (join _enum (1 0) 1 __tconst3M3l50 __t59k47) (join _enum (1 0) 1 __tconst8fVN51 __t2XKM5)) (head (emit smt_vcode (0 1) __tconst0NPx10 __t0j8p9) (emit smt_vcode (0 1) __tconst7cIc8 __t59k47) (emit smt_vcode (0 1) __tconst2jY56 __t2XKM5)) smt.slog:68 #f)
