...
u64 v_const4e99def398d795aface67ec8;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("e1b10d0e");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  v_const4e99def398d795aface67ec8 = db->encodeString("lat_cjoin.slog:26");
  ...
  // (crule (pre) (scan modulo_by_zero __erre0pif219 __errf5dla220 __errf7Djf221) (body) (head (emit error (0) __erre0pif219)) <internal>:1 #f)
  ...
  // (crule (pre) (scan malformed_deduction __erre5DpO211 __errf85jr212 __errf9st5213 __errf8NEk214 __errf32Ut215) (body) (head (emit error (0) __erre5DpO211)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst7qx012 const5feceb66ffc86f38d952786c) (let __tconst4JXr13 constd4735e3a265e16eee03f5971) (let __trid17H040 const4e99def398d795aface67ec8) (let __trel1E4041 const4f8703bdbf8b58437187d106) (let __tcol2ztd42 constd4735e3a265e16eee03f5971)) (scan mc k z) (body (let __t9Rgt11 (chas z __tconst4JXr13)) (cmp gt __t9Rgt11 __tconst7qx012) (letp __t3UAr14 (cget z __tconst4JXr13))) (head (tycheck __t3UAr14 (accept int) __trid17H040 __trel1E4041 __tcol2ztd42 (1 2 3 4 0)) (emit got (0 1 2) k __tconst4JXr13 __t3UAr14)) lat_cjoin.slog:26 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel8 = db->getRelation("got");
    ...
    virtual bool work()
    {
      ...
      u64 v_c10 = v_const4e99def398d795aface67ec8;
      u64 v_c11 = v_const4f8703bdbf8b58437187d106;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c13 = _t[0];
        u64 v_c14 = _t[1];
        u64 v_c15 = _prim_chas(db, v_c14, v_c9);
        if (v_c15 == slog_error) { slog::emit_pending_error(db, "lat_cjoin.slog:26"); return; }
        u64 v_c16 = _prim_gt(db, v_c15, v_c8);
        if (v_c16 == slog_error) { slog::emit_pending_error(db, "lat_cjoin.slog:26"); return; }
        if (!v_c16) return;
        bool ok10 = true;
        u64 v_c17 = _prim_cget(db, v_c14, v_c9, &ok10);
        if (!ok10) return;
        ++_fires;
        if (!(is_int(v_c17)))
        {
          slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c10, v_c11, v_c12, v_c17}, std::array<u16,5>{1, 2, 3, 4, 0});
          return;
        }
        slog::emit<3>(head_rel[1], head_index[1], newbatch[1], std::array<u64,3>{v_c13, v_c9, v_c17}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
        head_rel[1]->sendBatch(newbatch[1]);
  
      if (_fires) db->bumpFires("lat_cjoin.slog:26", "all:mc", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre2Pov243 __errf6xhg244 __errf5Ali245) (body) (head (emit error (0) __erre2Pov243)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre7qZ8233 __errf9EFq234 __errf3xL9235 __errf2jiB236 __errf7tML237) (body) (head (emit error (0) __erre7qZ8233)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre3WtI230 __errf8y1x231 __errf0D0O232) (body) (head (emit error (0) __erre3WtI230)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre7xeL238 __errf0jOz239 __errf57j6240 __errf6ZWd241 __errf8o8Y242) (body) (head (emit error (0) __erre7xeL238)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre4Q1h216 __errf0tfG217 __errf5rwY218) (body) (head (emit error (0) __erre4Q1h216)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre7Wai226 __errf9Pnj227 __errf59ID228 __errf1LNy229) (body) (head (emit error (0) __erre7Wai226)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre9Miw222 __errf9aYU223 __errf5h6U224 __errf5kD3225) (body) (head (emit error (0) __erre9Miw222)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mc k z) (body (join-lat mb (0 1) 1 k y) (cjoin __t01E931 (map int (min int)) z y) (let __t35A732 (csize __t01E931))) (head (emit usz (0 1) k __t35A732)) lat_cjoin.slog:25 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c13 = _t[0];
        u64 v_c14 = _t[1];
        slog::join_probe_lat<1,1>(mbindex32, std::array<u64,1>{v_c13}, [&](const std::array<u64,1>& m38, u64 val39) {
          u64 v_c45 = val39;
          ...
          u64 v_c46 = db->collections()->merge_spec(v_c14, v_c45, spec40);
          u64 v_c47 = _prim_csize(db, v_c46);
          if (v_c47 == slog_error) { slog::emit_pending_error(db, "lat_cjoin.slog:25"); return; }
          ++_fires;
          slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c13, v_c47}, std::array<u16,2>{0, 1});
        });
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lat_cjoin.slog:25", "all:mc", _fires);
