...
u64 v_constf54e5c8f810648e7638d25eb;
...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("c4a844fc");
  if (s == nullptr) return;
  slog::Relation* r;
  v_const5feceb66ffc86f38d952786c = s32_encode(0);
  v_const6b86b273ff34fce19d6b804e = s32_encode(1);
  v_constf54e5c8f810648e7638d25eb = db->encodeIntLiteral("123456789012345678901234567890");
  if (v_constf54e5c8f810648e7638d25eb == slog_error) slog::fatal("bignum literal exceeds the mpz caps (SLOG_MPZ_MAX_BITS / SLOG_MPZ_TABLE_BYTES)");
  ...
  // (crule (pre (let __tconst04e87 constb7a56873cd771f2c446d369b) (let __tconst4Vam8 const6b86b273ff34fce19d6b804e)) (scan fact N F) (body (cmp lt N __tconst04e87) (let __t5Ulr9 (_0002b N __tconst4Vam8)) (let __t2ej410 (_0002a __t5Ulr9 F))) (head (emit fact (0 1) __t5Ulr9 __t2ej410)) int_bignum.slog:20 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("fact");
      std::vector<u16> ord1({0, 1});
      slog::Relation* readrel2 = db->getRelation("fact");
      head_index[0] = readrel2->getIndex(ord1, false);
      outer_rel = db->getRelation("fact");
  
    }
    ReadTask0(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c0 = v_constb7a56873cd771f2c446d369b;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        if (v_c4 == slog_error) { slog::emit_pending_error(db, "int_bignum.slog:20"); return; }
        if (!v_c4) return;
        u64 v_c5 = _prim__0002b(db, v_c2, v_c1);
        if (v_c5 == slog_error) { slog::emit_pending_error(db, "int_bignum.slog:20"); return; }
        u64 v_c6 = _prim__0002a(db, v_c5, v_c3);
        if (v_c6 == slog_error) { slog::emit_pending_error(db, "int_bignum.slog:20"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("int_bignum.slog:20", "delta:fact", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre9Pw880 __errf7ExA81 __errf15zx82 __errf0gvH83 __errf09LT84) (body) (head (emit error (0) __erre9Pw880)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre9FeP72 __errf2KFt73 __errf78kc74) (body) (head (emit error (0) __erre9FeP72)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre21SF61 __errf7DH362 __errf42mT63) (body) (head (emit error (0) __erre21SF61)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre94YU68 __errf4Skw69 __errf5DsP70 __errf4v9F71) (body) (head (emit error (0) __erre94YU68)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre3n3j85 __errf8sTG86 __errf5ySz87) (body) (head (emit error (0) __erre3n3j85)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst7AKL6 constf54e5c8f810648e7638d25eb) (let __tconst3M3y5 const5feceb66ffc86f38d952786c) (let __tconst2nfv4 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit biglit (0) __tconst7AKL6) (emit fact (0 1) __tconst3M3y5 __tconst2nfv4)) int_bignum.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("biglit");
      std::vector<u16> ord20({0});
      slog::Relation* readrel21 = db->getRelation("biglit");
      head_index[0] = readrel21->getIndex(ord20, false);
      head_rel[1] = db->getRelation("fact");
      std::vector<u16> ord22({0, 1});
      slog::Relation* readrel23 = db->getRelation("fact");
    ...
    virtual bool work()
    {
      u64 v_c25 = v_constf54e5c8f810648e7638d25eb;
      ...
      slog::emit<2>(head_rel[1], head_index[1], newbatch[1], std::array<u64,2>{v_c26, v_c27}, std::array<u16,2>{0, 1});
  
        head_rel[0]->sendBatch(newbatch[0]);
        head_rel[1]->sendBatch(newbatch[1]);
  
      if (_fires) db->bumpFires("int_bignum.slog:16", "once", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre1xVX58 __errf1mtC59 __errf8qUX60) (body) (head (emit error (0) __erre1xVX58)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre9sZi75 __errf5tBz76 __errf5tgl77 __errf6i5378 __errf0kmV79) (body) (head (emit error (0) __erre9sZi75)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre1LGg64 __errf8HAS65 __errf5X8G66 __errf9hdp67) (body) (head (emit error (0) __erre1LGg64)) <internal>:1 #f)
  ...
  s->addDynamicRel("biglit");
  s->addDynamicRel("div_by_zero");
  s->addDynamicRel("error");
  s->addDynamicRel("fact");
