...
u64 v_constb642bb32c0b8fd35118770e8;
u64 v_const6e5ee07e63cdbc3ea07dd8a9;
u64 v_const90d5df9a2327146dec6b6cee;
u64 v_const521b2193c302e05f0bbf60da;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("8317f945");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  v_constb642bb32c0b8fd35118770e8 = db->encodeString("mp_get");
  v_const6e5ee07e63cdbc3ea07dd8a9 = db->encodeString("map.slog:122");
  v_const90d5df9a2327146dec6b6cee = db->encodeString("map.slog:53");
  v_const521b2193c302e05f0bbf60da = db->encodeString("map.slog:52");
  ...
  r = db->getRelation("type_mismatch");
    ...
    for (u16 b = 0; b < 32; ++b)
      ...
      std::vector<u16> ord152({0, 1, 2, 3, 4});
  ...
  if (r == 0) db->addStruct("nan_result", 4);
    ...
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("nan_result");
      std::vector<u16> ord157({1, 2, 3, 0});
    
    r->addIndex<4>(ord157, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<4>(db, r, std::array<u16,4>{1, 2, 3, 0}, false, b), true);
      std::vector<u16> ord158({0, 1, 2, 3});
    
    r->addIndex<4>(ord158, false);
    for (u16 b = 0; b < 32; ++b)
  ...
  r = db->getRelation("mp_put");
    ...
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<4>(db, r, std::array<u16,4>{0, 1, 2, 3}, false, b), false);
      std::vector<u16> ord175({2, 3, 0, 1});
    
    r->addIndex<4>(ord175, true);
    for (u16 b = 0; b < 32; ++b)
  ...
  r = db->getRelation("mp_bld");
    ...
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<5>(db, r, std::array<u16,5>{1, 2, 3, 4, 0}, false, b), true);
      std::vector<u16> ord201({0, 1, 2, 3, 4});
  ...
  r = db->getRelation("malformed_deduction");
    ...
    r->addIndex<5>(ord208, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<5>(db, r, std::array<u16,5>{1, 2, 3, 4, 0}, false, b), true);
      std::vector<u16> ord209({0, 1, 2, 3, 4});
    
    r->addIndex<5>(ord209, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<5>(db, r, std::array<u16,5>{0, 1, 2, 3, 4}, false, b), false);
  ...
  // (crule (pre (let __trid1534667 const90d5df9a2327146dec6b6cee) (let __trel6jI4668 constb642bb32c0b8fd35118770e8) (let __tcol5P5v669 const5feceb66ffc86f38d952786c) (let __trel4PLK670 constb642bb32c0b8fd35118770e8) (let __tcol6p6Q671 const6b86b273ff34fce19d6b804e)) (scan $sup5638x52x0x0x0 __d0 k l m p r) (body) (head (tycheck r (accept (struct mbranch) (struct _enum) (struct mleaf)) __trid1534667 __trel6jI4668 __tcol5P5v669 (1 2 3 4 0)) (tycheck k (accept int) __trid1534667 __trel4PLK670 __tcol6p6Q671 (1 2 3 4 0)) (mkstruct mp_get (1 2 0) __3QZZ666 r k)) map.slog:53 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c0 = v_const90d5df9a2327146dec6b6cee;
      u64 v_c1 = v_constb642bb32c0b8fd35118770e8;
      u64 v_c2 = v_const5feceb66ffc86f38d952786c;
      u64 v_c3 = v_constb642bb32c0b8fd35118770e8;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        {
          slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c0, v_c1, v_c2, v_c10}, std::array<u16,5>{1, 2, 3, 4, 0});
          return;
        }
        if (!(is_int(v_c6)))
        {
        ...
        slog::emit_struct<3>(head_rel[2], newbatch[2], std::array<u64,2>{v_c10, v_c6}, std::array<u16,3>{1, 2, 0});
      });
  ...
  // (crule (pre) (scan mpz_table_overflow __erre94iL1158 __errf6poW1159 __errf1xzY1160) (body) (head (emit error (0) __erre94iL1158)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre4gzF1148 __errf6z7H1149 __errf5uF81150 __errf83Qs1151 __errf0LJZ1152) (body) (head (emit error (0) __erre4gzF1148)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre8fJe1145 __errf6TI41146 __errf78t91147) (body) (head (emit error (0) __erre8fJe1145)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst8We5347 const6b86b273ff34fce19d6b804e)) (scan mp_get __t2xca346 __t2c5t345 k) (body (join mbranch (0 1 2 3 4) 1 __t2c5t345 p m l r) (let __t0Yjv348 (band k m)) (cmp lt __t0Yjv348 __tconst8We5347)) (head (emit $sup5638x51x0x0x0 (0 1 2 3 4 5) __t2xca346 k l m p r)) map.slog:52 #f)
  class ReadTask14 : public slog::Task
  {
    ...
    slog::Index** mbranchindex13;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("$sup5638x51x0x0x0");
      std::vector<u16> ord15({0, 1, 2, 3, 4, 5});
      slog::Relation* readrel16 = db->getRelation("$sup5638x51x0x0x0");
      head_index[0] = readrel16->getIndex(ord15, false);
      outer_rel = db->getRelation("mp_get");
      std::vector<u16> ord17({0, 1, 2, 3, 4});
      slog::Relation* readrel18 = db->getRelation("mbranch");
      mbranchindex13 = readrel18->getIndex(ord17, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c24 = _t[1];
        u64 v_c6 = _t[2];
        slog::join_probe<5,1>(mbranchindex13, std::array<u64,5>{v_c24, 0, 0, 0, 0}, [&](const std::array<u64,5>& m19) {
          u64 v_c9 = m19[1]; u64 v_c8 = m19[2]; u64 v_c7 = m19[3]; u64 v_c10 = m19[4];
          u64 v_c25 = _prim_band(db, v_c6, v_c8);
          if (v_c25 == slog_error) { slog::emit_pending_error(db, "map.slog:52"); return; }
          u64 v_c26 = _prim_lt(db, v_c25, v_c22);
          if (v_c26 == slog_error) { slog::emit_pending_error(db, "map.slog:52"); return; }
          if (!v_c26) return;
          ++_fires;
          slog::emit<6>(head_rel[0], head_index[0], newbatch[0], std::array<u64,6>{v_c23, v_c6, v_c7, v_c8, v_c9, v_c10}, std::array<u16,6>{0, 1, 2, 3, 4, 5});
        });
      });
  ...
  // (crule (pre) (scan malformed_deduction __erre0yoW1126 __errf9f431127 __errf9OC91128 __errf3ABj1129 __errf2Phi1130) (body) (head (emit error (0) __erre0yoW1126)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre5aV91134 __errf7fL21135 __errf4Z3G1136) (body) (head (emit error (0) __erre5aV91134)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre1t2G1131 __errf7aFO1132 __errf8fkh1133) (body) (head (emit error (0) __erre1t2G1131)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst1nk924 const5feceb66ffc86f38d952786c)) (scan mp_get __t9hhc23 __t2nkl22 k) (body (join mbranch (0 1 2 3 4) 1 __t2nkl22 p m l r) (let __t9aS425 (band k m)) (cmp gt __t9aS425 __tconst1nk924)) (head (emit $sup5638x52x0x0x0 (0 1 2 3 4 5) __t9hhc23 k l m p r)) map.slog:53 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel33 = db->getRelation("$sup5638x52x0x0x0");
      head_index[0] = readrel33->getIndex(ord32, false);
      outer_rel = db->getRelation("mp_get");
      std::vector<u16> ord34({0, 1, 2, 3, 4});
      slog::Relation* readrel35 = db->getRelation("mbranch");
      mbranchindex30 = readrel35->getIndex(ord34, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c40 = _t[1];
        u64 v_c6 = _t[2];
        slog::join_probe<5,1>(mbranchindex30, std::array<u64,5>{v_c40, 0, 0, 0, 0}, [&](const std::array<u64,5>& m36) {
          u64 v_c9 = m36[1]; u64 v_c8 = m36[2]; u64 v_c7 = m36[3]; u64 v_c10 = m36[4];
          u64 v_c41 = _prim_band(db, v_c6, v_c8);
          if (v_c41 == slog_error) { slog::emit_pending_error(db, "map.slog:53"); return; }
          u64 v_c42 = _prim_gt(db, v_c41, v_c38);
          if (v_c42 == slog_error) { slog::emit_pending_error(db, "map.slog:53"); return; }
          if (!v_c42) return;
          ++_fires;
          slog::emit<6>(head_rel[0], head_index[0], newbatch[0], std::array<u64,6>{v_c39, v_c6, v_c7, v_c8, v_c9, v_c10}, std::array<u16,6>{0, 1, 2, 3, 4, 5});
        });
      });
  ...
  // (crule (pre (let __trid7Opr772 const6e5ee07e63cdbc3ea07dd8a9) (let __trel9CEV773 constf7d5dda68c5473f68197d2e7) (let __tcol9f4x774 const5feceb66ffc86f38d952786c)) (scan $sup5638x121x0x0x0 __d0 l m p r) (body) (head (tycheck r (accept (struct mbranch) (struct _enum) (struct mleaf)) __trid7Opr772 __trel9CEV773 __tcol9f4x774 (1 2 3 4 0)) (mkstruct mp_size (1 0) __042J771 r)) map.slog:122 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      sid38 = db->getRelation("mbranch")->getStructId();
      sid40 = db->getRelation("mleaf")->getStructId();
  
    }
    ReadTask41(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c43 = v_const6e5ee07e63cdbc3ea07dd8a9;
      u64 v_c44 = v_constf7d5dda68c5473f68197d2e7;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c10 = _t[4];
        ++_fires;
        if (!((is_struct(v_c10) && (decode_struct_id(v_c10) == sid38 || decode_struct_id(v_c10) == sid39 || decode_struct_id(v_c10) == sid40))))
        {
          slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c43, v_c44, v_c45, v_c10}, std::array<u16,5>{1, 2, 3, 4, 0});
          return;
        }
        slog::emit_struct<2>(head_rel[1], newbatch[1], std::array<u64,1>{v_c10}, std::array<u16,2>{1, 0});
      });
  ...
  // (crule (pre (let __tconst422y860 constd01925b37634a1a9d24159d8) (let __tconst1IbP252 const8c1f1046219ddd216a023f79) (let __tconst1GOU253 const6b86b273ff34fce19d6b804e)) (probe mp_put (2 3 0 1) 2 __tconst1GOU253 __tconst1IbP252 __t1vXG255 __t4q1D254) (body (join _enum (0 1) 2 __t4q1D254 __tconst422y860) (join mp_put_ans (0 1) 1 __t1vXG255 s) (join mp_union (1 2 0) 1 s m __t70u3256) (join canon (0) 1 m) (join mp_union_ans (0 1) 1 __t70u3256 r)) (head (emit uni (0) r)) mp_basic.slog:23 #f)
  class ReadTask47 : public slog::Task
  {
    ...
    slog::Index** _enumindex42;  slog::Index** mp_put_ansindex43;  slog::Index** mp_unionindex44;  slog::Index** canonindex45;  slog::Index** mp_union_ansindex46;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("uni");
      std::vector<u16> ord48({0});
      slog::Relation* readrel49 = db->getRelation("uni");
      head_index[0] = readrel49->getIndex(ord48, false);
      std::vector<u16> ord50({2, 3, 0, 1});
      slog::Relation* readrel51 = db->getRelation("mp_put");
      driver_index = readrel51->getIndex(ord50, true);
      std::vector<u16> ord52({0, 1});
      slog::Relation* readrel53 = db->getRelation("_enum");
      _enumindex42 = readrel53->getIndex(ord52, false);
      std::vector<u16> ord54({0, 1});
      slog::Relation* readrel55 = db->getRelation("mp_put_ans");
      mp_put_ansindex43 = readrel55->getIndex(ord54, false);
      std::vector<u16> ord56({1, 2, 0});
      slog::Relation* readrel57 = db->getRelation("mp_union");
      mp_unionindex44 = readrel57->getIndex(ord56, false);
      std::vector<u16> ord58({0});
      slog::Relation* readrel59 = db->getRelation("canon");
      canonindex45 = readrel59->getIndex(ord58, false);
      std::vector<u16> ord60({0, 1});
      slog::Relation* readrel61 = db->getRelation("mp_union_ans");
      mp_union_ansindex46 = readrel61->getIndex(ord60, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::join_probe_sliced<4,2>(driver_index, std::array<u64,4>{v_c48, v_c47, 0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,4>& m62) {
        u64 v_c49 = m62[2];
        u64 v_c50 = m62[3];
        if (buckethash(v_c49) != bucket) return;
        slog::join_probe<2,2>(_enumindex42, std::array<u64,2>{v_c50, v_c46}, [&](const std::array<u64,2>& m63) {
          slog::join_probe<2,1>(mp_put_ansindex43, std::array<u64,2>{v_c49, 0}, [&](const std::array<u64,2>& m64) {
            u64 v_c51 = m64[1];
            slog::join_probe<3,1>(mp_unionindex44, std::array<u64,3>{v_c51, 0, 0}, [&](const std::array<u64,3>& m65) {
              u64 v_c8 = m65[1]; u64 v_c52 = m65[2];
              slog::join_probe<1,1>(canonindex45, std::array<u64,1>{v_c8}, [&](const std::array<u64,1>& m66) {
                slog::join_probe<2,1>(mp_union_ansindex46, std::array<u64,2>{v_c52, 0}, [&](const std::array<u64,2>& m67) {
                  u64 v_c10 = m67[1];
                  ++_fires;
      ...
      if (_fires) db->bumpFires("mp_basic.slog:23", "all:mp_put", _fires);
  ...
  // (crule (pre) (scan mp_size __t6D8V189 __t8n2c188) (body (join mbranch (0 1 2 3 4) 1 __t8n2c188 p m l r)) (head (emit $sup5638x121x0x0x0 (0 1 2 3 4) __t6D8V189 l m p r)) map.slog:122 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      mbranchindex68 = readrel73->getIndex(ord72, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c53 = _t[0];
        u64 v_c54 = _t[1];
        slog::join_probe<5,1>(mbranchindex68, std::array<u64,5>{v_c54, 0, 0, 0, 0}, [&](const std::array<u64,5>& m74) {
          u64 v_c9 = m74[1]; u64 v_c8 = m74[2]; u64 v_c7 = m74[3]; u64 v_c10 = m74[4];
          ++_fires;
          slog::emit<5>(head_rel[0], head_index[0], newbatch[0], std::array<u64,5>{v_c53, v_c7, v_c8, v_c9, v_c10}, std::array<u16,5>{0, 1, 2, 3, 4});
        });
      });
  ...
  // (crule (pre (let __tconst9Jh1294 const8c1f1046219ddd216a023f79) (let __tconst5DaW295 const6b86b273ff34fce19d6b804e)) (probe mp_put (2 3 0 1) 2 __tconst5DaW295 __tconst9Jh1294 __t4Jgx296 m) (body (join canon (0) 1 m) (join mp_put_ans (0 1) 1 __t4Jgx296 r)) (head (emit upd (0) r)) mp_basic.slog:22 #f)
  class ReadTask77 : public slog::Task
  {
    ...
    std::array<u64,4> resume_key{};
    bool has_resume = false;
    slog::Index** canonindex75;  slog::Index** mp_put_ansindex76;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel79 = db->getRelation("upd");
      head_index[0] = readrel79->getIndex(ord78, false);
      std::vector<u16> ord80({2, 3, 0, 1});
      slog::Relation* readrel81 = db->getRelation("mp_put");
      driver_index = readrel81->getIndex(ord80, true);
      std::vector<u16> ord82({0});
      slog::Relation* readrel83 = db->getRelation("canon");
      canonindex75 = readrel83->getIndex(ord82, false);
      std::vector<u16> ord84({0, 1});
      slog::Relation* readrel85 = db->getRelation("mp_put_ans");
      mp_put_ansindex76 = readrel85->getIndex(ord84, false);
  
    }
    ReadTask77(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c55 = v_const8c1f1046219ddd216a023f79;
      ...
      slog::SliceCtx _sc{_slice_deadline, &db->runStopFlag()};
      std::array<u64,4> _rkey = resume_key; bool _hr = has_resume;
      bool _done = slog::join_probe_sliced<4,2>(driver_index, std::array<u64,4>{v_c56, v_c55, 0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,4>& m86) {
        u64 v_c57 = m86[2];
        u64 v_c8 = m86[3];
        if (buckethash(v_c57) != bucket) return;
        slog::join_probe<1,1>(canonindex75, std::array<u64,1>{v_c8}, [&](const std::array<u64,1>& m87) {
          slog::join_probe<2,1>(mp_put_ansindex76, std::array<u64,2>{v_c57, 0}, [&](const std::array<u64,2>& m88) {
            u64 v_c10 = m88[1];
            ++_fires;
            slog::emit<1>(head_rel[0], head_index[0], newbatch[0], std::array<u64,1>{v_c10}, std::array<u16,1>{0});
          });
      ...
      if (_fires) db->bumpFires("mp_basic.slog:22", "all:mp_put", _fires);
  ...
  // (crule (pre (let __tconst4cz5186 const7902699be42c8a8e46fbbb45)) (probe mp_has0 (2 0 1) 1 __tconst4cz5186 __t9G7a187 m) (body (join canon (0) 1 m) (join mp_has0_ans (0 1) 1 __t9G7a187 a)) (head (emit has (0 1) __tconst4cz5186 a)) mp_basic.slog:20 #f)
  class ReadTask91 : public slog::Task
  {
    ...
    bool has_resume = false;
    slog::Index** canonindex89;  slog::Index** mp_has0_ansindex90;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel93 = db->getRelation("has");
      head_index[0] = readrel93->getIndex(ord92, false);
      std::vector<u16> ord94({2, 0, 1});
      slog::Relation* readrel95 = db->getRelation("mp_has0");
      driver_index = readrel95->getIndex(ord94, true);
      std::vector<u16> ord96({0});
      slog::Relation* readrel97 = db->getRelation("canon");
      canonindex89 = readrel97->getIndex(ord96, false);
      std::vector<u16> ord98({0, 1});
      slog::Relation* readrel99 = db->getRelation("mp_has0_ans");
      mp_has0_ansindex90 = readrel99->getIndex(ord98, false);
  
    }
    ReadTask91(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c58 = v_const7902699be42c8a8e46fbbb45;
      ...
      bool _done = slog::join_probe_sliced<3,1>(driver_index, std::array<u64,3>{v_c58, 0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,3>& m100) {
        u64 v_c59 = m100[1];
        u64 v_c8 = m100[2];
        if (buckethash(v_c59) != bucket) return;
        slog::join_probe<1,1>(canonindex89, std::array<u64,1>{v_c8}, [&](const std::array<u64,1>& m101) {
          slog::join_probe<2,1>(mp_has0_ansindex90, std::array<u64,2>{v_c59, 0}, [&](const std::array<u64,2>& m102) {
            u64 v_c60 = m102[1];
            ++_fires;
            slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c58, v_c60}, std::array<u16,2>{0, 1});
          });
        });
      });
      ...
      if (_fires) db->bumpFires("mp_basic.slog:20", "all:mp_has0", _fires);
  ...
  // (crule (pre) (scan nan_result __erre28Am1141 __errf47j31142 __errf3Mzu1143 __errf6KCr1144) (body) (head (emit error (0) __erre28Am1141)) <internal>:1 #f)
  ...
  // (crule (pre (let __trid0v9g637 const6e5ee07e63cdbc3ea07dd8a9) (let __trel2VpD638 constf7d5dda68c5473f68197d2e7) (let __tcol3I4b639 const5feceb66ffc86f38d952786c)) (scan $sup5638x121x0x0x0 __d0 l m p r) (body) (head (tycheck l (accept (struct mbranch) (struct _enum) (struct mleaf)) __trid0v9g637 __trel2VpD638 __tcol3I4b639 (1 2 3 4 0)) (mkstruct mp_size (1 0) __2fMP636 l)) map.slog:122 #f)
  class ReadTask109 : public slog::Task
  {
    ...
    u32 sid107;  u32 sid106;  u32 sid108;
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("malformed_deduction");
      head_rel[1] = db->getRelation("mp_size");
      outer_rel = db->getRelation("$sup5638x121x0x0x0");
      sid107 = db->getRelation("_enum")->getStructId();
      sid106 = db->getRelation("mbranch")->getStructId();
      sid108 = db->getRelation("mleaf")->getStructId();
  
    }
    ReadTask109(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c65 = v_const6e5ee07e63cdbc3ea07dd8a9;
      u64 v_c66 = v_constf7d5dda68c5473f68197d2e7;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c10 = _t[4];
        ++_fires;
        if (!((is_struct(v_c7) && (decode_struct_id(v_c7) == sid106 || decode_struct_id(v_c7) == sid107 || decode_struct_id(v_c7) == sid108))))
        {
          slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c65, v_c66, v_c67, v_c7}, std::array<u16,5>{1, 2, 3, 4, 0});
          return;
        }
  ...
  // (crule (pre (let __tconst0M5O382 const4e07408562bedb8b60ce05c1)) (probe mp_del (2 0 1) 1 __tconst0M5O382 __t6Ppw383 m) (body (join canon (0) 1 m) (join mp_del_ans (0 1) 1 __t6Ppw383 r)) (head (emit afterdel (0) r)) mp_basic.slog:21 #f)
  class ReadTask112 : public slog::Task
  {
    ...
    std::array<u64,3> resume_key{};
    bool has_resume = false;
    slog::Index** canonindex110;  slog::Index** mp_del_ansindex111;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel114 = db->getRelation("afterdel");
      head_index[0] = readrel114->getIndex(ord113, false);
      std::vector<u16> ord115({2, 0, 1});
      slog::Relation* readrel116 = db->getRelation("mp_del");
      driver_index = readrel116->getIndex(ord115, true);
      std::vector<u16> ord117({0});
      slog::Relation* readrel118 = db->getRelation("canon");
      canonindex110 = readrel118->getIndex(ord117, false);
      std::vector<u16> ord119({0, 1});
      slog::Relation* readrel120 = db->getRelation("mp_del_ans");
      mp_del_ansindex111 = readrel120->getIndex(ord119, false);
  
    }
    ReadTask112(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c68 = v_const4e07408562bedb8b60ce05c1;
      ...
      slog::SliceCtx _sc{_slice_deadline, &db->runStopFlag()};
      std::array<u64,3> _rkey = resume_key; bool _hr = has_resume;
      bool _done = slog::join_probe_sliced<3,1>(driver_index, std::array<u64,3>{v_c68, 0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,3>& m121) {
        u64 v_c69 = m121[1];
        u64 v_c8 = m121[2];
        if (buckethash(v_c69) != bucket) return;
        slog::join_probe<1,1>(canonindex110, std::array<u64,1>{v_c8}, [&](const std::array<u64,1>& m122) {
          slog::join_probe<2,1>(mp_del_ansindex111, std::array<u64,2>{v_c69, 0}, [&](const std::array<u64,2>& m123) {
            u64 v_c10 = m123[1];
            ++_fires;
            slog::emit<1>(head_rel[0], head_index[0], newbatch[0], std::array<u64,1>{v_c10}, std::array<u16,1>{0});
          });
      ...
      if (_fires) db->bumpFires("mp_basic.slog:21", "all:mp_del", _fires);
  ...
  // (crule (pre (let __tconst1wb9312 constef2d127de37b942baad06145)) (probe mp_has0 (2 0 1) 1 __tconst1wb9312 __t9fbh313 m) (body (join canon (0) 1 m) (join mp_has0_ans (0 1) 1 __t9fbh313 a)) (head (emit has (0 1) __tconst1wb9312 a)) mp_basic.slog:19 #f)
  class ReadTask126 : public slog::Task
  {
    ...
    std::array<u64,3> resume_key{};
    bool has_resume = false;
    slog::Index** canonindex124;  slog::Index** mp_has0_ansindex125;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel128 = db->getRelation("has");
      head_index[0] = readrel128->getIndex(ord127, false);
      std::vector<u16> ord129({2, 0, 1});
      slog::Relation* readrel130 = db->getRelation("mp_has0");
      driver_index = readrel130->getIndex(ord129, true);
      std::vector<u16> ord131({0});
      slog::Relation* readrel132 = db->getRelation("canon");
      canonindex124 = readrel132->getIndex(ord131, false);
      std::vector<u16> ord133({0, 1});
      slog::Relation* readrel134 = db->getRelation("mp_has0_ans");
      mp_has0_ansindex125 = readrel134->getIndex(ord133, false);
  
    }
    ReadTask126(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c70 = v_constef2d127de37b942baad06145;
      ...
      slog::SliceCtx _sc{_slice_deadline, &db->runStopFlag()};
      std::array<u64,3> _rkey = resume_key; bool _hr = has_resume;
      bool _done = slog::join_probe_sliced<3,1>(driver_index, std::array<u64,3>{v_c70, 0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,3>& m135) {
        u64 v_c71 = m135[1];
        u64 v_c8 = m135[2];
        if (buckethash(v_c71) != bucket) return;
        slog::join_probe<1,1>(canonindex124, std::array<u64,1>{v_c8}, [&](const std::array<u64,1>& m136) {
          slog::join_probe<2,1>(mp_has0_ansindex125, std::array<u64,2>{v_c71, 0}, [&](const std::array<u64,2>& m137) {
            u64 v_c60 = m137[1];
            ++_fires;
            slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c70, v_c60}, std::array<u16,2>{0, 1});
          });
        });
      });
      ...
      if (_fires) db->bumpFires("mp_basic.slog:19", "all:mp_has0", _fires);
    ...
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_read, new ReadTask126(db,b), true);
  // (crule (pre (let __trid8hPY726 const521b2193c302e05f0bbf60da) (let __trel22F2727 constb642bb32c0b8fd35118770e8) (let __tcol8Yvl728 const5feceb66ffc86f38d952786c) (let __trel2cB9729 constb642bb32c0b8fd35118770e8) (let __tcol3i9m730 const6b86b273ff34fce19d6b804e)) (scan $sup5638x51x0x0x0 __d0 k l m p r) (body) (head (tycheck l (accept (struct mbranch) (struct _enum) (struct mleaf)) __trid8hPY726 __trel22F2727 __tcol8Yvl728 (1 2 3 4 0)) (tycheck k (accept int) __trid8hPY726 __trel2cB9729 __tcol3i9m730 (1 2 3 4 0)) (mkstruct mp_get (1 2 0) __0ETX725 l k)) map.slog:52 #f)
  class ReadTask141 : public slog::Task
  {
    ...
    u32 sid139;  u32 sid138;  u32 sid140;
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("malformed_deduction");
      ...
      sid139 = db->getRelation("_enum")->getStructId();
      sid138 = db->getRelation("mbranch")->getStructId();
      sid140 = db->getRelation("mleaf")->getStructId();
  
    }
    ReadTask141(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c72 = v_const521b2193c302e05f0bbf60da;
      u64 v_c73 = v_constb642bb32c0b8fd35118770e8;
      u64 v_c74 = v_const5feceb66ffc86f38d952786c;
      u64 v_c75 = v_constb642bb32c0b8fd35118770e8;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c10 = _t[5];
        ++_fires;
        if (!((is_struct(v_c7) && (decode_struct_id(v_c7) == sid138 || decode_struct_id(v_c7) == sid139 || decode_struct_id(v_c7) == sid140))))
        {
          slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c72, v_c73, v_c74, v_c7}, std::array<u16,5>{1, 2, 3, 4, 0});
          return;
        }
        if (!(is_int(v_c6)))
        {
  ...
  // (crule (pre (let __tconst3Rsa306 const4e07408562bedb8b60ce05c1)) (scan canon m) (body) (head (mkstruct mp_get (1 2 0) __7oEh787 m __tconst3Rsa306)) mp_basic.slog:18 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c8 = _t[0];
        ++_fires;
        slog::emit_struct<3>(head_rel[0], newbatch[0], std::array<u64,2>{v_c8, v_c77}, std::array<u16,3>{1, 2, 0});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("mp_basic.slog:18", "all:canon", _fires);
    ...
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_read, new ReadTask142(db,b), true);
  // (crule (pre) (scan int_overflow __erre808x1137 __errf0O921138 __errf8ycu1139 __errf3MKq1140) (body) (head (emit error (0) __erre808x1137)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre8hNw1153 __errf8KmY1154 __errf2gct1155 __errf8PPg1156 __errf1E2y1157) (body) (head (emit error (0) __erre8hNw1153)) <internal>:1 #f)
  ...
  s->addDynamicRel("$sup5638x51x0x0x0");
  s->addDynamicRel("$sup5638x52x0x0x0");
