...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("dd0c2160");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan div_by_zero __t1P8N5 L A) (body (join error (0) 1 __t1P8N5)) (head (emit caught (0) L)) err_react.slog:10 #f)
  class ReadTask1 : public slog::Task
  {
    ...
    slog::Index** errorindex0;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("caught");
      std::vector<u16> ord2({0});
      slog::Relation* readrel3 = db->getRelation("caught");
      head_index[0] = readrel3->getIndex(ord2, false);
      outer_rel = db->getRelation("div_by_zero");
      std::vector<u16> ord4({0});
      slog::Relation* readrel5 = db->getRelation("error");
      errorindex0 = readrel5->getIndex(ord4, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c1 = _t[1];
        u64 v_c2 = _t[2];
        slog::join_probe<1,1>(errorindex0, std::array<u64,1>{v_c0}, [&](const std::array<u64,1>& m6) {
          ++_fires;
      ...
      if (_fires) db->bumpFires("err_react.slog:10", "delta:div_by_zero", _fires);
  ...
  // (crule (pre) (scan error __t1P8N5) (body (join-old div_by_zero (0 1 2) 1 (0 1 2) __t1P8N5 L A)) (head (emit caught (0) L)) err_react.slog:10 #f)
  class ReadTask9 : public slog::Task
  {
    ...
    slog::Index** div_by_zeroindex7;  slog::Index** div_by_zerodelta8;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel11 = db->getRelation("caught");
      head_index[0] = readrel11->getIndex(ord10, false);
      outer_rel = db->getRelation("error");
      std::vector<u16> ord12({0, 1, 2});
      slog::Relation* readrel13 = db->getRelation("div_by_zero");
      div_by_zeroindex7 = readrel13->getIndex(ord12, false);
      std::vector<u16> ord14({0, 1, 2});
      slog::Relation* readrel15 = db->getRelation("div_by_zero");
      div_by_zerodelta8 = readrel15->getIndex(ord14, true);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        slog::join_probe_old<3,1>(div_by_zeroindex7, div_by_zerodelta8, std::array<u64,3>{v_c0, 0, 0}, [&](const std::array<u64,3>& m16) {
          u64 v_c1 = m16[1]; u64 v_c2 = m16[2];
          ++_fires;
          slog::emit<1>(head_rel[0], head_index[0], newbatch[0], std::array<u64,1>{v_c1}, std::array<u16,1>{0});
        });
      });
      ...
      if (_fires) db->bumpFires("err_react.slog:10", "delta:error", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre1vLX39 __errf9kkp40 __errf7K3O41) (body) (head (emit error (0) __erre1vLX39)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre4eTc53 __errf3x7K54 __errf8xfR55 __errf75PT56 __errf9UoM57) (body) (head (emit error (0) __erre4eTc53)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre7X3Q46 __errf0Awh47 __errf2ZIv48 __errf4fuE49) (body) (head (emit error (0) __erre7X3Q46)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre55Y942 __errf7z5343 __errf2CRV44 __errf0UeY45) (body) (head (emit error (0) __erre55Y942)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst2SKg1 const4a44dc15364204a80fe80e90)) (scan d X) (body (let __t3KvH2 (_0002f __tconst2SKg1 X))) (head (emit q (0) __t3KvH2)) err_react.slog:9 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel31 = db->getRelation("q");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c20 = _t[0];
        u64 v_c21 = _prim__0002f(db, v_c19, v_c20);
        if (v_c21 == slog_error) { slog::emit_pending_error(db, "err_react.slog:9"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("err_react.slog:9", "all:d", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre9gSn63 __errf7dq964 __errf4yUx65) (body) (head (emit error (0) __erre9gSn63)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre5kn636 __errf9aMj37 __errf16KS38) (body) (head (emit error (0) __erre5kn636)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre8glc50 __errf1Zvy51 __errf0Bye52) (body) (head (emit error (0) __erre8glc50)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre56YZ58 __errf4OFh59 __errf6yzs60 __errf6cv561 __errf4m3B62) (body) (head (emit error (0) __erre56YZ58)) <internal>:1 #f)
