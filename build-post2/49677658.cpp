...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("49677658");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst1j3O12 const5feceb66ffc86f38d952786c)) (scan d A B) (body (let __t6MzI13 (_0002d __tconst1j3O12 A)) (let __t9SOe14 (_00025 __t6MzI13 B))) (head (emit nrem (0 1 2) __t6MzI13 B __t9SOe14)) prim2_divmod.slog:22 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("nrem");
      std::vector<u16> ord1({0, 1, 2});
      slog::Relation* readrel2 = db->getRelation("nrem");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        u64 v_c2 = _t[1];
        u64 v_c3 = _prim__0002d(db, v_c0, v_c1);
        if (v_c3 == slog_error) { slog::emit_pending_error(db, "prim2_divmod.slog:22"); return; }
        u64 v_c4 = _prim__00025(db, v_c3, v_c2);
        if (v_c4 == slog_error) { slog::emit_pending_error(db, "prim2_divmod.slog:22"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c3, v_c2, v_c4}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim2_divmod.slog:22", "all:d", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre3DJ856 __errf4KZ957 __errf9YJe58) (body) (head (emit error (0) __erre3DJ856)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre1iZ970 __errf9i2T71 __errf3xcE72 __errf1oN873 __errf84Ch74) (body) (head (emit error (0) __erre1iZ970)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre5HKA67 __errf99TG68 __errf9KwH69) (body) (head (emit error (0) __erre5HKA67)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst9ULm9 const5feceb66ffc86f38d952786c)) (scan d A B) (body (let __t32Qd10 (_0002d __tconst9ULm9 B)) (let __t19Zh11 (_0002f A __t32Qd10))) (head (emit dquot (0 1 2) A __t32Qd10 __t19Zh11)) prim2_divmod.slog:23 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("dquot");
      std::vector<u16> ord13({0, 1, 2});
      slog::Relation* readrel14 = db->getRelation("dquot");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        u64 v_c2 = _t[1];
        u64 v_c17 = _prim__0002d(db, v_c16, v_c2);
        if (v_c17 == slog_error) { slog::emit_pending_error(db, "prim2_divmod.slog:23"); return; }
        u64 v_c18 = _prim__0002f(db, v_c1, v_c17);
        if (v_c18 == slog_error) { slog::emit_pending_error(db, "prim2_divmod.slog:23"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c1, v_c17, v_c18}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim2_divmod.slog:23", "all:d", _fires);
  ...
  // (crule (pre (let __tconst5Ra16 const5feceb66ffc86f38d952786c)) (scan d A B) (body (let __t7Kh47 (_0002d __tconst5Ra16 B)) (let __t2ptZ8 (_00025 A __t7Kh47))) (head (emit drem (0 1 2) A __t7Kh47 __t2ptZ8)) prim2_divmod.slog:24 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("drem");
      std::vector<u16> ord16({0, 1, 2});
      slog::Relation* readrel17 = db->getRelation("drem");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        u64 v_c2 = _t[1];
        u64 v_c20 = _prim__0002d(db, v_c19, v_c2);
        if (v_c20 == slog_error) { slog::emit_pending_error(db, "prim2_divmod.slog:24"); return; }
        u64 v_c21 = _prim__00025(db, v_c1, v_c20);
        if (v_c21 == slog_error) { slog::emit_pending_error(db, "prim2_divmod.slog:24"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c1, v_c20, v_c21}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim2_divmod.slog:24", "all:d", _fires);
  ...
  // (crule (pre (let __tconst5jtR2 const5feceb66ffc86f38d952786c)) (scan d A B) (body (let __t7slG3 (_0002d __tconst5jtR2 A)) (let __t6TQw4 (_0002f __t7slG3 B))) (head (emit nquot (0 1 2) __t7slG3 B __t6TQw4)) prim2_divmod.slog:21 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("nquot");
      std::vector<u16> ord19({0, 1, 2});
      slog::Relation* readrel20 = db->getRelation("nquot");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        u64 v_c2 = _t[1];
        u64 v_c23 = _prim__0002d(db, v_c22, v_c1);
        if (v_c23 == slog_error) { slog::emit_pending_error(db, "prim2_divmod.slog:21"); return; }
        u64 v_c24 = _prim__0002f(db, v_c23, v_c2);
        if (v_c24 == slog_error) { slog::emit_pending_error(db, "prim2_divmod.slog:21"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c23, v_c2, v_c24}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim2_divmod.slog:21", "all:d", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre3hOD80 __errf5vcF81 __errf7JsG82) (body) (head (emit error (0) __erre3hOD80)) <internal>:1 #f)
  ...
  // (crule (pre) (scan d A B) (body (let __t0ugY1 (_00025 A B))) (head (emit remm (0 1 2) A B __t0ugY1)) prim2_divmod.slog:20 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("remm");
      std::vector<u16> ord25({0, 1, 2});
      slog::Relation* readrel26 = db->getRelation("remm");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        u64 v_c2 = _t[1];
        u64 v_c28 = _prim__00025(db, v_c1, v_c2);
        if (v_c28 == slog_error) { slog::emit_pending_error(db, "prim2_divmod.slog:20"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c1, v_c2, v_c28}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim2_divmod.slog:20", "all:d", _fires);
  ...
  // (crule (pre) (scan nan_result __erre6JpQ63 __errf5Tvu64 __errf9XJx65 __errf0cfw66) (body) (head (emit error (0) __erre6JpQ63)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre3Jer75 __errf1joG76 __errf972i77 __errf5pId78 __errf8Nfe79) (body) (head (emit error (0) __erre3Jer75)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre0HsP59 __errf11wH60 __errf1R3S61 __errf2XOc62) (body) (head (emit error (0) __erre0HsP59)) <internal>:1 #f)
  ...
  // (crule (pre) (scan d A B) (body (let __t5N7K5 (_0002f A B))) (head (emit quot (0 1 2) A B __t5N7K5)) prim2_divmod.slog:19 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("quot");
      std::vector<u16> ord37({0, 1, 2});
      slog::Relation* readrel38 = db->getRelation("quot");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        u64 v_c2 = _t[1];
        u64 v_c42 = _prim__0002f(db, v_c1, v_c2);
        if (v_c42 == slog_error) { slog::emit_pending_error(db, "prim2_divmod.slog:19"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c1, v_c2, v_c42}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim2_divmod.slog:19", "all:d", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre1Olw53 __errf5ZMH54 __errf7AXv55) (body) (head (emit error (0) __erre1Olw53)) <internal>:1 #f)
  ...
  s->addDynamicRel("dquot");
  s->addDynamicRel("drem");
  ...
  s->addDynamicRel("nquot");
  s->addDynamicRel("nrem");
  s->addDynamicRel("quot");
  s->addDynamicRel("remm");
