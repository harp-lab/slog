...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("30faf7ec");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst59Pj17 const18d10c7d2b4b04aaf04254d1)) (once) (body) (head (mkstruct _enum (1 0) __3vT718 __tconst59Pj17)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst27Hf19 const076de6e730df0b4c3860877a)) (once) (body) (head (mkstruct _enum (1 0) __5RJE20 __tconst27Hf19)) <internal>:1 #f)
