...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("a5e2a689");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst3I8Q184 constee295786ce9f03797df76c26)) (once) (body) (head (mkstruct _enum (1 0) __3WlL185 __tconst3I8Q184)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c0 = v_constee295786ce9f03797df76c26;
  ...
  // (crule (pre (let __tconst9dUc178 constab76c7d069d6f33dc950fb33)) (once) (body) (head (mkstruct _enum (1 0) __3GaA179 __tconst9dUc178)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst3YFO176 consta221beeaebe583607e193be7)) (once) (body) (head (mkstruct _enum (1 0) __292a177 __tconst3YFO176)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c2 = v_consta221beeaebe583607e193be7;
  ...
  // (crule (pre (let __tconst8cJm180 consteb8bf0d80db323992f6b634a)) (once) (body) (head (mkstruct _enum (1 0) __6DDo181 __tconst8cJm180)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst4q23182 const683276d23a1fc1d255583994)) (once) (body) (head (mkstruct _enum (1 0) __3Olk183 __tconst4q23182)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c4 = v_const683276d23a1fc1d255583994;
