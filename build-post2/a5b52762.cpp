...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("a5b52762");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp1S2S15");
  if (r == 0) db->addTempRelation("temp1S2S15", 2);
  ...
  // (crule (pre) (scan temp1S2S15 n s) (body (join box (1 0) 1 s __t278s3)) (head (emit out (0 1) n __t278s3)) enum_struct_field2.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      outer_rel = db->getRelation("temp1S2S15");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c1 = _t[1];
        slog::join_probe<2,1>(boxindex0, std::array<u64,2>{v_c1, 0}, [&](const std::array<u64,2>& m6) {
          u64 v_c2 = m6[1];
          ++_fires;
      ...
      if (_fires) db->bumpFires("enum_struct_field2.slog:15", "delta:temp1S2S15", _fires);
  ...
  // (crule (pre) (scan in n s) (body) (head (emit-temp temp1S2S15 n s) (mkstruct box (1 0) __t278s3 s)) enum_struct_field2.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp1S2S15");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("enum_struct_field2.slog:15", "all:in", _fires);
  ...
  s->addReadRel("box");
  s->addReadRel("in");
  s->addReadRel("temp1S2S15");
  s->addDynamicRel("box");
  s->addDynamicRel("out");
  s->addDynamicRel("temp1S2S15");
  d->push(s);
  d->continueRun();
}
