...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  v_const08b53b7d666cf717c2136d70 = db->encodeString(",");
  v_const4e07408562bedb8b60ce05c1 = s32_encode(3);
  v_const59100e1b869f778eb1d0975e = s32_encode(-13);
  ...
  r = db->getRelation("temp9QDi98");
  if (r == 0) db->addTempRelation("temp9QDi98", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp8tuU96");
  if (r == 0) db->addTempRelation("temp8tuU96", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp8B3c95");
  if (r == 0) db->addTempRelation("temp8B3c95", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp7jij97");
  if (r == 0) db->addTempRelation("temp7jij97", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp4ao394");
  if (r == 0) db->addTempRelation("temp4ao394", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  ...
  // (crule (pre (let __tconst7TQ224 constd4735e3a265e16eee03f5971) (let __tconst7VTE22 constb8736b999909049671d0ea07) (let __t8TVl23 (f2s __tconst7VTE22))) (scan csv ____0wzg25) (body) (head (emit-temp temp8B3c95 __t8TVl23)) str_split.slog:33 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("temp8B3c95");
      outer_rel = db->getRelation("csv");
    ...
    virtual bool work()
    {
      ...
      u64 v_c1 = v_constb8736b999909049671d0ea07;
      u64 v_c2 = _prim_f2s(db, v_c1);
      if (v_c2 == slog_error) { slog::emit_pending_error(db, "str_split.slog:33"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c3 = _t[0];
        ++_fires;
        slog::emit_temp<1>(head_rel[0], newbatch[0], std::array<u64,1>{v_c2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("str_split.slog:33", "all:csv", _fires);
  ...
  // (crule (pre) (scan temp9QDi98 __t3Qkc3) (body) (head (emit chars (0) __t3Qkc3)) str_split.slog:22 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("chars");
      std::vector<u16> ord2({0});
      slog::Relation* readrel3 = db->getRelation("chars");
      head_index[0] = readrel3->getIndex(ord2, false);
      outer_rel = db->getRelation("temp9QDi98");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("str_split.slog:22", "delta:temp9QDi98", _fires);
  ...
  // (crule (pre (let __tconst183l32 const4e07408562bedb8b60ce05c1) (let __tconst3M8N30 constfbd04e1aae9ce0b11a8946e2) (let __t0gm631 (f2s __tconst3M8N30))) (scan csv ____46Db33) (body) (head (emit-temp temp7jij97 __t0gm631)) str_split.slog:34 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp7jij97");
      outer_rel = db->getRelation("csv");
    ...
    virtual bool work()
    {
      ...
      u64 v_c6 = v_constfbd04e1aae9ce0b11a8946e2;
      u64 v_c7 = _prim_f2s(db, v_c6);
      if (v_c7 == slog_error) { slog::emit_pending_error(db, "str_split.slog:34"); return true; }
      ...
      if (_fires) db->bumpFires("str_split.slog:34", "all:csv", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre09aS81 __errf93HW82 __errf7T0983 __errf7Ksn84 __errf3by785) (body) (head (emit error (0) __erre09aS81)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst7TQ224 constd4735e3a265e16eee03f5971)) (scan temp8B3c95 __t8TVl23) (body) (head (emit render (0 1) __tconst7TQ224 __t8TVl23)) str_split.slog:33 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("render");
      std::vector<u16> ord9({0, 1});
      slog::Relation* readrel10 = db->getRelation("render");
      head_index[0] = readrel10->getIndex(ord9, false);
      outer_rel = db->getRelation("temp8B3c95");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("str_split.slog:33", "delta:temp8B3c95", _fires);
  ...
  // (crule (pre (let __tconst3GRA9 const6b86b273ff34fce19d6b804e)) (scan temp8tuU96 __t7CKA8) (body) (head (emit render (0 1) __tconst3GRA9 __t7CKA8)) str_split.slog:32 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel13 = db->getRelation("render");
      head_index[0] = readrel13->getIndex(ord12, false);
      outer_rel = db->getRelation("temp8tuU96");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c15 = _t[0];
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c14, v_c15}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("str_split.slog:32", "delta:temp8tuU96", _fires);
  ...
  // (crule (pre (let __tconst3GRA9 const6b86b273ff34fce19d6b804e) (let __tconst7CQW7 const59100e1b869f778eb1d0975e) (let __t7CKA8 (i2s __tconst7CQW7))) (scan csv ____6Fqg10) (body) (head (emit-temp temp8tuU96 __t7CKA8)) str_split.slog:32 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp8tuU96");
      outer_rel = db->getRelation("csv");
    ...
    {
      u64 v_c14 = v_const6b86b273ff34fce19d6b804e;
      u64 v_c16 = v_const59100e1b869f778eb1d0975e;
      u64 v_c15 = _prim_i2s(db, v_c16);
      if (v_c15 == slog_error) { slog::emit_pending_error(db, "str_split.slog:32"); return true; }
      ...
      if (_fires) db->bumpFires("str_split.slog:32", "all:csv", _fires);
  ...
  // (crule (pre) (scan nan_result __erre07r174 __errf0NIW75 __errf1KEV76 __errf0HuX77) (body) (head (emit error (0) __erre07r174)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre9NeU78 __errf42HT79 __errf4ZEy80) (body) (head (emit error (0) __erre9NeU78)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst1R8K2 const7bbcb27d0c708f84fe100912) (let __tconst4BdG1 const12ae32cb1ec02d01eda3581b) (let __t3Qkc3 (ssplit __tconst1R8K2 __tconst4BdG1))) (scan csv ____6SLu4) (body) (head (emit-temp temp9QDi98 __t3Qkc3)) str_split.slog:22 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp9QDi98");
      outer_rel = db->getRelation("csv");
    ...
    virtual bool work()
    {
      u64 v_c25 = v_const7bbcb27d0c708f84fe100912;
      u64 v_c26 = v_const12ae32cb1ec02d01eda3581b;
      u64 v_c4 = _prim_ssplit(db, v_c25, v_c26);
      if (v_c4 == slog_error) { slog::emit_pending_error(db, "str_split.slog:22"); return true; }
      ...
      if (_fires) db->bumpFires("str_split.slog:22", "all:csv", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre8S3267 __errf9ocg68 __errf1lSe69) (body) (head (emit error (0) __erre8S3267)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst183l32 const4e07408562bedb8b60ce05c1)) (scan temp7jij97 __t0gm631) (body) (head (emit render (0 1) __tconst183l32 __t0gm631)) str_split.slog:34 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel27 = db->getRelation("render");
      head_index[0] = readrel27->getIndex(ord26, false);
      outer_rel = db->getRelation("temp7jij97");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c7 = _t[0];
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c5, v_c7}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("str_split.slog:34", "delta:temp7jij97", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre73DE91 __errf38hc92 __errf9pRt93) (body) (head (emit error (0) __erre73DE91)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre8jxW70 __errf5A5f71 __errf39Hx72 __errf4WvP73) (body) (head (emit error (0) __erre8jxW70)) <internal>:1 #f)
  ...
  // (crule (pre) (scan cand s) (body (letp __t1Syw29 (s2i s))) (head (emit nums (0 1) s __t1Syw29)) str_split.slog:27 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("nums");
      std::vector<u16> ord35({0, 1});
      slog::Relation* readrel36 = db->getRelation("nums");
      head_index[0] = readrel36->getIndex(ord35, false);
      outer_rel = db->getRelation("cand");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c38 = _t[0];
        bool ok37 = true;
        u64 v_c39 = _prim_s2i(db, v_c38, &ok37);
        if (!ok37) return;
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c38, v_c39}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("str_split.slog:27", "all:cand", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre8u1n86 __errf4Fqv87 __errf8vqV88 __errf81OY89 __errf0WyC90) (body) (head (emit error (0) __erre8u1n86)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp4ao394 __t41dY6) (body) (head (emit fields (0) __t41dY6)) str_split.slog:17 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fields");
      std::vector<u16> ord42({0});
      slog::Relation* readrel43 = db->getRelation("fields");
      head_index[0] = readrel43->getIndex(ord42, false);
      outer_rel = db->getRelation("temp4ao394");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("str_split.slog:17", "delta:temp4ao394", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre6i1G64 __errf9b0k65 __errf1BHG66) (body) (head (emit error (0) __erre6i1G64)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst8lR85 const08b53b7d666cf717c2136d70)) (scan csv s) (body (let __t41dY6 (ssplit s __tconst8lR85))) (head (emit-temp temp4ao394 __t41dY6)) str_split.slog:17 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp4ao394");
      outer_rel = db->getRelation("csv");
    ...
    virtual bool work()
    {
      u64 v_c49 = v_const08b53b7d666cf717c2136d70;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c38 = _t[0];
        u64 v_c45 = _prim_ssplit(db, v_c38, v_c49);
        if (v_c45 == slog_error) { slog::emit_pending_error(db, "str_split.slog:17"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("str_split.slog:17", "all:csv", _fires);
  ...
  // (crule (pre) (scan fcand s) (body (letp __t1z5J26 (s2f s))) (head (emit fls (0 1) s __t1z5J26)) str_split.slog:30 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fls");
      std::vector<u16> ord49({0, 1});
      slog::Relation* readrel50 = db->getRelation("fls");
      head_index[0] = readrel50->getIndex(ord49, false);
      outer_rel = db->getRelation("fcand");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c38 = _t[0];
        bool ok51 = true;
        u64 v_c50 = _prim_s2f(db, v_c38, &ok51);
        if (!ok51) return;
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c38, v_c50}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("str_split.slog:30", "all:fcand", _fires);
  ...
  s->addReadRel("temp4ao394");
  s->addReadRel("temp7jij97");
  s->addReadRel("temp8B3c95");
  s->addReadRel("temp8tuU96");
  s->addReadRel("temp9QDi98");
  s->addReadRel("toint_range");
  s->addReadRel("type_mismatch");
  s->addDynamicRel("chars");
  s->addDynamicRel("div_by_zero");
  s->addDynamicRel("error");
  s->addDynamicRel("fields");
  s->addDynamicRel("fls");
  ...
  s->addDynamicRel("nums");
  s->addDynamicRel("render");
  s->addDynamicRel("temp4ao394");
  s->addDynamicRel("temp7jij97");
  s->addDynamicRel("temp8B3c95");
  s->addDynamicRel("temp8tuU96");
  s->addDynamicRel("temp9QDi98");
