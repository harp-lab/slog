...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("6ef11593");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst2Q8222 const6b51d431df5d7f141cbececc) (let __tconst2Oxk25 constd4735e3a265e16eee03f5971) (let __tconst6glU26 const7902699be42c8a8e46fbbb45) (let __tconst3cK627 constef2d127de37b942baad06145) (let __tconst8PF228 const5feceb66ffc86f38d952786c)) (once) (body) (head (emit in2 (0 1) __tconst2Q8222 __tconst3cK627) (emit in2 (0 1) __tconst6glU26 __tconst2Oxk25) (emit in2 (0 1) __tconst3cK627 __tconst2Q8222) (emit in2 (0 1) __tconst2Oxk25 __tconst6glU26) (emit in1 (0) __tconst6glU26) (emit in1 (0) __tconst3cK627) (emit in1 (0) __tconst8PF228)) prim_int.slog:28 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("in2");
      std::vector<u16> ord1({0, 1});
      slog::Relation* readrel2 = db->getRelation("in2");
      head_index[0] = readrel2->getIndex(ord1, false);
      head_rel[1] = db->getRelation("in2");
      std::vector<u16> ord3({0, 1});
      slog::Relation* readrel4 = db->getRelation("in2");
      head_index[1] = readrel4->getIndex(ord3, false);
      head_rel[2] = db->getRelation("in2");
      std::vector<u16> ord5({0, 1});
      slog::Relation* readrel6 = db->getRelation("in2");
      head_index[2] = readrel6->getIndex(ord5, false);
      head_rel[3] = db->getRelation("in2");
      std::vector<u16> ord7({0, 1});
      slog::Relation* readrel8 = db->getRelation("in2");
      head_index[3] = readrel8->getIndex(ord7, false);
      head_rel[4] = db->getRelation("in1");
      std::vector<u16> ord9({0});
      slog::Relation* readrel10 = db->getRelation("in1");
      head_index[4] = readrel10->getIndex(ord9, false);
      head_rel[5] = db->getRelation("in1");
      std::vector<u16> ord11({0});
      slog::Relation* readrel12 = db->getRelation("in1");
      head_index[5] = readrel12->getIndex(ord11, false);
      head_rel[6] = db->getRelation("in1");
      std::vector<u16> ord13({0});
      slog::Relation* readrel14 = db->getRelation("in1");
    ...
    virtual bool work()
    {
      u64 v_c0 = v_const6b51d431df5d7f141cbececc;
      ...
      slog::emit<2>(head_rel[2], head_index[2], newbatch[2], std::array<u64,2>{v_c3, v_c0}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[3], head_index[3], newbatch[3], std::array<u64,2>{v_c1, v_c2}, std::array<u16,2>{0, 1});
      ...
      if (_fires) db->bumpFires("prim_int.slog:28", "once", _fires);
