...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("96c70494");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan tri ____35wy14 ____6hFf15 Z) (body) (head (emit lst (0) Z)) shape_wild.slog:28 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("lst");
      std::vector<u16> ord1({0});
      slog::Relation* readrel2 = db->getRelation("lst");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_wild.slog:28", "all:tri", _fires);
  ...
  // (crule (pre) (scan tri X ____9MRF10 dup8LSt19) (body (eq X dup8LSt19)) (head (emit skew (0) X)) shape_wild.slog:30 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("skew");
      std::vector<u16> ord4({0});
      slog::Relation* readrel5 = db->getRelation("skew");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_wild.slog:30", "all:tri", _fires);
  ...
  // (crule (pre) (scan tri X ____9iaw13 Z) (body) (head (emit outr (0 1) X Z)) shape_wild.slog:29 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("outr");
      std::vector<u16> ord7({0, 1});
      slog::Relation* readrel8 = db->getRelation("outr");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_wild.slog:29", "all:tri", _fires);
  ...
  // (crule (pre) (scan tri X ____4UC317 ____7xyb18) (body) (head (emit fst (0) X)) shape_wild.slog:26 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fst");
      std::vector<u16> ord10({0});
      slog::Relation* readrel11 = db->getRelation("fst");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_wild.slog:26", "all:tri", _fires);
  ...
  // (crule (pre) (scan tri ____9lt811 Y ____5M9c12) (body) (head (emit mid (0) Y)) shape_wild.slog:27 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel14 = db->getRelation("mid");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_wild.slog:27", "all:tri", _fires);
  ...
  s->addDynamicRel("lst");
  s->addDynamicRel("mid");
  s->addDynamicRel("outr");
  s->addDynamicRel("skew");
  d->push(s);
  d->continueRun();
}
