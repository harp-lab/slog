...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("54a16e16");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst7vss90 const76c777b0ce3c35ba97c6cbde)) (once) (body) (head (mkstruct _enum (1 0) __0FhL91 __tconst7vss90)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst41s092 constcea17e0b05e3e6ace77ec2d1)) (once) (body) (head (mkstruct _enum (1 0) __457N93 __tconst41s092)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c1 = v_constcea17e0b05e3e6ace77ec2d1;
