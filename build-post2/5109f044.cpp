...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("5109f044");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan want n) (body) (head (mkstruct sq (1 0) __3s7x6 n)) dem_escape.slog:15 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("sq");
      outer_rel = db->getRelation("want");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_escape.slog:15", "all:want", _fires);
