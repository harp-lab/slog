...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("517f0fa8");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan modulo_by_zero __erre7qse118 __errf7M1w119 __errf2DSq120) (body) (head (emit error (0) __erre7qse118)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre2PFG129 __errf1Vux130 __errf5ANk131) (body) (head (emit error (0) __erre2PFG129)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre49hU125 __errf8y5D126 __errf5IY6127 __errf6bgc128) (body) (head (emit error (0) __erre49hU125)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre0WqZ137 __errf2HgG138 __errf9J3O139 __errf6f4x140 __errf6rIe141) (body) (head (emit error (0) __erre0WqZ137)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre6yOV121 __errf5aFW122 __errf73Al123 __errf3lD6124) (body) (head (emit error (0) __erre6yOV121)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre4BxI132 __errf73Ul133 __errf2TQX134 __errf63Yg135 __errf8Ylr136) (body) (head (emit error (0) __erre4BxI132)) <internal>:1 #f)
  ...
  // (crule (pre) (scan best a m) (body (let __t4bcT21 (csize m))) (head (emit bsz (0 1) a __t4bcT21)) lat_nested.slog:38 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("bsz");
      std::vector<u16> ord19({0, 1});
      slog::Relation* readrel20 = db->getRelation("bsz");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c24 = _t[0];
        u64 v_c25 = _t[1];
        u64 v_c26 = _prim_csize(db, v_c25);
        if (v_c26 == slog_error) { slog::emit_pending_error(db, "lat_nested.slog:38"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("lat_nested.slog:38", "all:best", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre6o9Z142 __errf1ybu143 __errf4gVu144) (body) (head (emit error (0) __erre6o9Z142)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre269D115 __errf0ynI116 __errf0bzt117) (body) (head (emit error (0) __erre269D115)) <internal>:1 #f)
