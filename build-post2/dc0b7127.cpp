...
u64 v_constaca89214f1220d4eb23801b3;
u64 v_const902cf2b465fb076229183b40;
u64 v_const4cc23abdbdc20da8971c8095;
...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("dc0b7127");
  if (s == nullptr) return;
  slog::Relation* r;
  v_const6b86b273ff34fce19d6b804e = s32_encode(1);
  v_constd4735e3a265e16eee03f5971 = s32_encode(2);
  v_constaca89214f1220d4eb23801b3 = db->encodeString("beta");
  v_const902cf2b465fb076229183b40 = db->encodeString("alpha");
  v_const4cc23abdbdc20da8971c8095 = float_encode(2.25);
  ...
  if (r == 0) db->addStruct("rec", 7);
    ...
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("rec");
      std::vector<u16> ord15({1, 2, 3, 4, 5, 6, 0});
    
    r->addIndex<7>(ord15, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<7>(db, r, std::array<u16,7>{1, 2, 3, 4, 5, 6, 0}, false, b), true);
      std::vector<u16> ord16({0, 1, 2, 3, 4, 5, 6});
    
    r->addIndex<7>(ord16, false);
    for (u16 b = 0; b < 32; ++b)
  ...
  // (crule (pre (let __tconst1yQv14 constd4735e3a265e16eee03f5971) (let __tconst27ms13 constaca89214f1220d4eb23801b3) (let __tconst5C3r12 const4cc23abdbdc20da8971c8095) (let __tconst4qFc11 const6b86b273ff34fce19d6b804e) (let __tconst1Hoc10 const902cf2b465fb076229183b40) (let __tconst48Pk9 const9f29a130438b81170b92a426)) (once) (body) (head (emit in (0 1 2) __tconst1yQv14 __tconst27ms13 __tconst5C3r12) (emit in (0 1 2) __tconst4qFc11 __tconst1Hoc10 __tconst48Pk9)) sdeep_mixed.slog:14 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      u64 v_c1 = v_constaca89214f1220d4eb23801b3;
      u64 v_c2 = v_const4cc23abdbdc20da8971c8095;
      u64 v_c3 = v_const6b86b273ff34fce19d6b804e;
      u64 v_c4 = v_const902cf2b465fb076229183b40;
      u64 v_c5 = v_const9f29a130438b81170b92a426;
      ...
      ++_fires;
      slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c0, v_c1, v_c2}, std::array<u16,3>{0, 1, 2});
      slog::emit<3>(head_rel[1], head_index[1], newbatch[1], std::array<u64,3>{v_c3, v_c4, v_c5}, std::array<u16,3>{0, 1, 2});
  
        head_rel[0]->sendBatch(newbatch[0]);
        head_rel[1]->sendBatch(newbatch[1]);
  
      if (_fires) db->bumpFires("sdeep_mixed.slog:14", "once", _fires);
