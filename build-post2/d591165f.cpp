...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("d591165f");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan int_overflow __erre1YH141 __errf2cSC42 __errf98Un43 __errf2VZs44) (body) (head (emit error (0) __erre1YH141)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre7CuF45 __errf8VQH46 __errf5piu47 __errf52YR48) (body) (head (emit error (0) __erre7CuF45)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre6CNx38 __errf5C7539 __errf7hmR40) (body) (head (emit error (0) __erre6CNx38)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre7psF52 __errf8yeu53 __errf09co54 __errf7T4E55 __errf7XPb56) (body) (head (emit error (0) __erre7psF52)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst4w023 const6b86b273ff34fce19d6b804e)) (scan thing X) (body (let __t5ir24 (_0002b X __tconst4w023))) (head (emit incremented (0) __t5ir24)) err_typemix.slog:9 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("incremented");
      std::vector<u16> ord13({0});
      slog::Relation* readrel14 = db->getRelation("incremented");
      head_index[0] = readrel14->getIndex(ord13, false);
      outer_rel = db->getRelation("thing");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c17 = _t[0];
        u64 v_c18 = _prim__0002b(db, v_c17, v_c16);
        if (v_c18 == slog_error) { slog::emit_pending_error(db, "err_typemix.slog:9"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("err_typemix.slog:9", "all:thing", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre66KG62 __errf18t163 __errf5Dwl64) (body) (head (emit error (0) __erre66KG62)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre4Dwu35 __errf6b6J36 __errf3byU37) (body) (head (emit error (0) __erre4Dwu35)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre2lzi49 __errf5Zrp50 __errf3ojJ51) (body) (head (emit error (0) __erre2lzi49)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre5Rxx57 __errf2Viy58 __errf3HL559 __errf6lGJ60 __errf0hPe61) (body) (head (emit error (0) __erre5Rxx57)) <internal>:1 #f)
