...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("4b7790c2");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan probe n) (body (join classify (1 0) 1 n __t7Kqw10) (join classify_ans (0 1) 1 __t7Kqw10 s)) (head (emit out (0 1) n s)) dem_or.slog:16 #f)
  class ReadTask2 : public slog::Task
  {
    ...
    slog::Index** classifyindex0;  slog::Index** classify_ansindex1;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel6 = db->getRelation("classify");
      classifyindex0 = readrel6->getIndex(ord5, false);
      std::vector<u16> ord7({0, 1});
      slog::Relation* readrel8 = db->getRelation("classify_ans");
      classify_ansindex1 = readrel8->getIndex(ord7, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        slog::join_probe<2,1>(classifyindex0, std::array<u64,2>{v_c0, 0}, [&](const std::array<u64,2>& m9) {
          u64 v_c1 = m9[1];
          slog::join_probe<2,1>(classify_ansindex1, std::array<u64,2>{v_c1, 0}, [&](const std::array<u64,2>& m10) {
            u64 v_c2 = m10[1];
            ++_fires;
      ...
      if (_fires) db->bumpFires("dem_or.slog:16", "all:probe", _fires);
