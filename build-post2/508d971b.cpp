...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("508d971b");
  if (s == nullptr) return;
  slog::Relation* r;
  r = db->getRelation("w");
  ...
  // (crule (pre) (scan w A) (body (let __t8S041 (size A))) (head (emit len (0 1) A __t8S041)) prim2_sizeany.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel2 = db->getRelation("len");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c1 = _prim_size(db, v_c0);
        if (v_c1 == slog_error) { slog::emit_pending_error(db, "prim2_sizeany.slog:15"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("prim2_sizeany.slog:15", "all:w", _fires);
  ...
  // (crule (pre) (scan toint_range __erre5RNf51 __errf8nc752 __errf4AKN53) (body) (head (emit error (0) __erre5RNf51)) <internal>:1 #f)
  ...
  // (crule (pre) (scan w A) (body (let __t8m5n2 (_0002b A A)) (let __t9eOf3 (size __t8m5n2))) (head (emit catlen (0 1) __t8m5n2 __t9eOf3)) prim2_sizeany.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel8 = db->getRelation("catlen");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c5 = _prim__0002b(db, v_c0, v_c0);
        if (v_c5 == slog_error) { slog::emit_pending_error(db, "prim2_sizeany.slog:16"); return; }
        u64 v_c6 = _prim_size(db, v_c5);
        if (v_c6 == slog_error) { slog::emit_pending_error(db, "prim2_sizeany.slog:16"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("prim2_sizeany.slog:16", "all:w", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre3Opm43 __errf1NRb44 __errf4pHM45 __errf7pwX46) (body) (head (emit error (0) __erre3Opm43)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre4Pl340 __errf93Ne41 __errf5x9W42) (body) (head (emit error (0) __erre4Pl340)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre4T1p64 __errf478k65 __errf2mgD66) (body) (head (emit error (0) __erre4T1p64)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre1urW37 __errf6azo38 __errf6PIb39) (body) (head (emit error (0) __erre1urW37)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre8B6854 __errf81pt55 __errf8D4356 __errf99yd57 __errf760e58) (body) (head (emit error (0) __erre8B6854)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre6ppz47 __errf2Cd348 __errf2zs549 __errf6mBL50) (body) (head (emit error (0) __erre6ppz47)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre3PhG59 __errf88Ix60 __errf3bEi61 __errf9qFh62 __errf6x8y63) (body) (head (emit error (0) __erre3PhG59)) <internal>:1 #f)
