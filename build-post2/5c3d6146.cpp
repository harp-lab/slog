...
u64 v_const84182bebf45b37d0de496994;
u64 v_const970778cdc941f2c931da5d11;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("5c3d6146");
  if (s == nullptr) return;
  slog::Relation* r;
  v_const5feceb66ffc86f38d952786c = s32_encode(0);
  v_const6b86b273ff34fce19d6b804e = s32_encode(1);
  v_const84182bebf45b37d0de496994 = db->encodeString("cn_basic.slog:46");
  v_const970778cdc941f2c931da5d11 = db->encodeString("nestget");
  ...
  // (crule (pre (let __tconst26TL16 const6b86b273ff34fce19d6b804e) (let __trid0BJk108 const84182bebf45b37d0de496994) (let __trel6OuF109 const970778cdc941f2c931da5d11) (let __tcol8f7n110 const5feceb66ffc86f38d952786c)) (scan nest n) (body (join pairkey (0) 0 k) (letp __t83zZ15 (cget n k)) (letp __t7OUZ17 (cget __t83zZ15 __tconst26TL16))) (head (tycheck __t7OUZ17 (accept int) __trid0BJk108 __trel6OuF109 __tcol8f7n110 (1 2 3 4 0)) (emit nestget (0) __t7OUZ17)) cn_basic.slog:46 #f)
  class ReadTask1 : public slog::Task
  {
    ...
    slog::Index** pairkeyindex0;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("malformed_deduction");
      head_rel[1] = db->getRelation("nestget");
      std::vector<u16> ord2({0});
      slog::Relation* readrel3 = db->getRelation("nestget");
      head_index[1] = readrel3->getIndex(ord2, false);
      outer_rel = db->getRelation("nest");
      std::vector<u16> ord4({0});
      slog::Relation* readrel5 = db->getRelation("pairkey");
      pairkeyindex0 = readrel5->getIndex(ord4, false);
    ...
    virtual bool work()
    {
      ...
      u64 v_c1 = v_const84182bebf45b37d0de496994;
      u64 v_c2 = v_const970778cdc941f2c931da5d11;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c4 = _t[0];
        slog::join_all<1>(pairkeyindex0, [&](const std::array<u64,1>& m6) {
          u64 v_c5 = m6[0];
          bool ok7 = true;
          u64 v_c6 = _prim_cget(db, v_c4, v_c5, &ok7);
          if (!ok7) return;
          bool ok8 = true;
          u64 v_c7 = _prim_cget(db, v_c6, v_c0, &ok8);
          if (!ok8) return;
          ++_fires;
          if (!(is_int(v_c7)))
          {
            slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c1, v_c2, v_c3, v_c7}, std::array<u16,5>{1, 2, 3, 4, 0});
            return;
          }
      ...
      if (_fires) db->bumpFires("cn_basic.slog:46", "all:nest", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre8sLA287 __errf5id6288 __errf9msR289) (body) (head (emit error (0) __erre8sLA287)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre0yoY294 __errf7rUC295 __errf4ib7296 __errf0jUw297) (body) (head (emit error (0) __erre0yoY294)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre2jMQ306 __errf1Wdk307 __errf7OZq308 __errf9hyy309 __errf1tAF310) (body) (head (emit error (0) __erre2jMQ306)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre4lGu311 __errf52NR312 __errf9YgP313) (body) (head (emit error (0) __erre4lGu311)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre1GNQ290 __errf6juZ291 __errf9jel292 __errf9vwb293) (body) (head (emit error (0) __erre1GNQ290)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre1j7E284 __errf1VGQ285 __errf4Q3o286) (body) (head (emit error (0) __erre1j7E284)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre4MeX298 __errf4yI0299 __errf2BX6300) (body) (head (emit error (0) __erre4MeX298)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre9NoF301 __errf2qB9302 __errf1apt303 __errf68wV304 __errf5mx8305) (body) (head (emit error (0) __erre9NoF301)) <internal>:1 #f)
  ...
  // (crule (pre) (scan malformed_deduction __erre3Xgk279 __errf0AK5280 __errf18ZE281 __errf0Tkh282 __errf1MtR283) (body) (head (emit error (0) __erre3Xgk279)) <internal>:1 #f)
