...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("d042e2c1");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst15BK10 constef2d127de37b942baad06145) (let __tconst1u5m15 constd4735e3a265e16eee03f5971) (let __tconst3wjO16 const6b86b273ff34fce19d6b804e) (let __tconst5zZK17 const4b227777d4dd1fc61c6f884f) (let __tconst3Nwr18 const4e07408562bedb8b60ce05c1)) (once) (body) (head (emit edge (0 1 2) __tconst3wjO16 __tconst1u5m15 __tconst3Nwr18) (emit edge (0 1 2) __tconst3wjO16 __tconst1u5m15 __tconst15BK10) (emit edge (0 1 2) __tconst1u5m15 __tconst3Nwr18 __tconst5zZK17) (emit edge (0 1 2) __tconst3Nwr18 __tconst5zZK17 __tconst3wjO16)) lat_nested.slog:19 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("lat_nested.slog:19", "once", _fires);
  ...
  // (crule (pre (let __tconst8GVs4 const4b227777d4dd1fc61c6f884f) (let __tconst0b0t3 const4e07408562bedb8b60ce05c1) (let __tconst3fSe2 constd4735e3a265e16eee03f5971) (let __tconst02fr1 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit node (0) __tconst8GVs4) (emit node (0) __tconst0b0t3) (emit node (0) __tconst3fSe2) (emit node (0) __tconst02fr1)) lat_nested.slog:20 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel11 = db->getRelation("node");
      head_index[0] = readrel11->getIndex(ord10, false);
      head_rel[1] = db->getRelation("node");
      std::vector<u16> ord12({0});
      slog::Relation* readrel13 = db->getRelation("node");
      head_index[1] = readrel13->getIndex(ord12, false);
      head_rel[2] = db->getRelation("node");
      std::vector<u16> ord14({0});
      slog::Relation* readrel15 = db->getRelation("node");
      head_index[2] = readrel15->getIndex(ord14, false);
      head_rel[3] = db->getRelation("node");
      std::vector<u16> ord16({0});
      slog::Relation* readrel17 = db->getRelation("node");
      head_index[3] = readrel17->getIndex(ord16, false);
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("lat_nested.slog:20", "once", _fires);
