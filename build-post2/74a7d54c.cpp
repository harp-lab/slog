...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("74a7d54c");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp0W8e87");
  if (r == 0) db->addTempRelation("temp0W8e87", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp0R9086");
  if (r == 0) db->addTempRelation("temp0R9086", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  ...
  // (crule (pre) (scan toint_range __erre4YnE70 __errf873H71 __errf3mHp72) (body) (head (emit error (0) __erre4YnE70)) <internal>:1 #f)
  ...
  // (crule (pre) (scan query n) (body) (head (mkstruct fib (1 0) __6Tgf23 n)) dem_fib.slog:14 #f)
  ...
  // (crule (pre) (scan temp0W8e87 __t48IQ2) (body) (head (mkstruct fib (1 0) __4bjN24 __t48IQ2)) dem_fib.slog:8 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("fib");
      outer_rel = db->getRelation("temp0W8e87");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_fib.slog:8", "delta:temp0W8e87", _fires);
  ...
  // (crule (pre) (scan nan_result __erre91qT66 __errf8iM867 __errf4Kvp68 __errf4Cmq69) (body) (head (emit error (0) __erre91qT66)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst2ZT54 const6b86b273ff34fce19d6b804e) (let __tconst0svJ1 constd4735e3a265e16eee03f5971)) (scan fib __t8R7a3 n) (body (cmp lt __tconst2ZT54 n) (let __t48IQ2 (_0002d n __tconst0svJ1))) (head (emit-temp temp0W8e87 __t48IQ2)) dem_fib.slog:8 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp0W8e87");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        if (!v_c12) return;
        u64 v_c4 = _prim__0002d(db, v_c3, v_c10);
      ...
      if (_fires) db->bumpFires("dem_fib.slog:8", "delta:fib", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre04Ll83 __errf4Hvl84 __errf9jfb85) (body) (head (emit error (0) __erre04Ll83)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre0omD56 __errf57vo57 __errf7mt758) (body) (head (emit error (0) __erre0omD56)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre7azT62 __errf4tq863 __errf4BHp64 __errf3yQ365) (body) (head (emit error (0) __erre7azT62)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre9V5S59 __errf2FYJ60 __errf3KGS61) (body) (head (emit error (0) __erre9V5S59)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp0R9086 __t9DYo8) (body) (head (mkstruct fib (1 0) __4WEf25 __t9DYo8)) dem_fib.slog:8 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("fib");
      outer_rel = db->getRelation("temp0R9086");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_fib.slog:8", "delta:temp0R9086", _fires);
  ...
  // (crule (pre (let __tconst1g5C10 const6b86b273ff34fce19d6b804e)) (scan fib __t2pez9 n) (body (cmp lt __tconst1g5C10 n) (let __t9DYo8 (_0002d n __tconst1g5C10))) (head (emit-temp temp0R9086 __t9DYo8)) dem_fib.slog:8 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp0R9086");
      outer_rel = db->getRelation("fib");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c28 = _t[0];
        u64 v_c3 = _t[1];
        u64 v_c29 = _prim_lt(db, v_c27, v_c3);
        if (v_c29 == slog_error) { slog::emit_pending_error(db, "dem_fib.slog:8"); return; }
        if (!v_c29) return;
        u64 v_c26 = _prim__0002d(db, v_c3, v_c27);
        if (v_c26 == slog_error) { slog::emit_pending_error(db, "dem_fib.slog:8"); return; }
        ++_fires;
  ...
  // (crule (pre) (scan mpz_overflow __erre0pVL78 __errf2ClA79 __errf0QaS80 __errf5VvE81 __errf9Z7E82) (body) (head (emit error (0) __erre0pVL78)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre54ui73 __errf6PVo74 __errf1AKD75 __errf4hBd76 __errf5Vsg77) (body) (head (emit error (0) __erre54ui73)) <internal>:1 #f)
  ...
  s->addReadRel("query");
  s->addReadRel("temp0R9086");
  s->addReadRel("temp0W8e87");
  ...
  s->addDynamicRel("temp0R9086");
  s->addDynamicRel("temp0W8e87");
