...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("f1d97c38");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan edge A C) (body (join3 B (full edge (1 0) 1 () C B) (full edge (0 1) 1 () A B))) (head (emit tri (0 1 2) A B C)) wcoj3.slog:15 #f)
  class ReadTask2 : public slog::Task
  {
    ...
    slog::Index** edgeindex0;  slog::Index** edgeindex1;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      edgeindex0 = readrel6->getIndex(ord5, false);
      std::vector<u16> ord7({0, 1});
      slog::Relation* readrel8 = db->getRelation("edge");
      edgeindex1 = readrel8->getIndex(ord7, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c1 = _t[1];
        slog::join3<2,1,slog::Join3View::full,2,1,slog::Join3View::full>(edgeindex0, edgeindex0, std::array<u64,2>{v_c1, 0}, edgeindex1, edgeindex1, std::array<u64,2>{v_c0, 0}, [&](u64 cycle9) {
        u64 v_c2 = cycle9;
          ++_fires;
      ...
      if (_fires) db->bumpFires("wcoj3.slog:15", "all:edge", _fires);
