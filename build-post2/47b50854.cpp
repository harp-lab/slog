...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("47b50854");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan nan_result __erre3isp109 __errf4Lxg110 __errf57YV111 __errf0Pqm112) (body) (head (emit error (0) __erre3isp109)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst2Qfi1 const4e07408562bedb8b60ce05c1)) (scan unbox X) (body (cmp ge X __tconst2Qfi1)) (head (emit final (0) X)) sdeep_strata.slog:25 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel5 = db->getRelation("final");
      head_index[0] = readrel5->getIndex(ord4, false);
      outer_rel = db->getRelation("unbox");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c5 = _t[0];
        u64 v_c6 = _prim_ge(db, v_c5, v_c4);
        if (v_c6 == slog_error) { slog::emit_pending_error(db, "sdeep_strata.slog:25"); return; }
        if (!v_c6) return;
        ++_fires;
      ...
      if (_fires) db->bumpFires("sdeep_strata.slog:25", "all:unbox", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre0Wda116 __errf64Kq117 __errf6rop118 __errf9ml2119 __errf9IRv120) (body) (head (emit error (0) __erre0Wda116)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre3BHw99 __errf6h4q100 __errf8BtP101) (body) (head (emit error (0) __erre3BHw99)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre9bsw113 __errf5rXP114 __errf2zIV115) (body) (head (emit error (0) __erre9bsw113)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre8K41105 __errf9rx6106 __errf1NPE107 __errf0uXe108) (body) (head (emit error (0) __erre8K41105)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre2Lx3126 __errf4bd8127 __errf6qPC128) (body) (head (emit error (0) __erre2Lx3126)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre2oqc102 __errf3QpO103 __errf4b6d104) (body) (head (emit error (0) __erre2oqc102)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre5T1T121 __errf5UAu122 __errf80H1123 __errf8Arx124 __errf8oMJ125) (body) (head (emit error (0) __erre5T1T121)) <internal>:1 #f)
