...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("bbf42b03");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp3bbL159");
  if (r == 0) db->addTempRelation("temp3bbL159", 1);
  ...
  // (crule (pre) (scan mpz_overflow __erre5mPr151 __errf46sz152 __errf5B3I153 __errf56EM154 __errf4KE9155) (body) (head (emit error (0) __erre5mPr151)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre5sPD132 __errf02q8133 __errf3p51134) (body) (head (emit error (0) __erre5sPD132)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre1RTe146 __errf6BUg147 __errf0Y5A148 __errf6ofj149 __errf5DyN150) (body) (head (emit error (0) __erre1RTe146)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre6vAg156 __errf7DHO157 __errf1S4M158) (body) (head (emit error (0) __erre6vAg156)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp3bbL159 __t6IPY21) (body) (head (emit rejoined (0) __t6IPY21)) str_split.slog:18 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("rejoined");
      std::vector<u16> ord13({0});
      slog::Relation* readrel14 = db->getRelation("rejoined");
      head_index[0] = readrel14->getIndex(ord13, false);
      outer_rel = db->getRelation("temp3bbL159");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("str_split.slog:18", "delta:temp3bbL159", _fires);
  ...
  // (crule (pre) (scan nan_result __erre7eGU139 __errf0Mwl140 __errf6Iq7141 __errf90rA142) (body) (head (emit error (0) __erre7eGU139)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst1Oqh20 const08b53b7d666cf717c2136d70)) (scan fields f) (body (join csv (0) 0 s) (let __t6IPY21 (sjoin f __tconst1Oqh20))) (head (emit-temp temp3bbL159 __t6IPY21)) str_split.slog:18 #f)
  class ReadTask19 : public slog::Task
  {
    ...
    slog::Index** csvindex18;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp3bbL159");
      outer_rel = db->getRelation("fields");
      std::vector<u16> ord20({0});
      slog::Relation* readrel21 = db->getRelation("csv");
      csvindex18 = readrel21->getIndex(ord20, false);
  
    }
    ReadTask19(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c21 = v_const08b53b7d666cf717c2136d70;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c22 = _t[0];
        slog::join_all<1>(csvindex18, [&](const std::array<u64,1>& m22) {
          u64 v_c23 = m22[0];
          u64 v_c16 = _prim_sjoin(db, v_c22, v_c21);
          if (v_c16 == slog_error) { slog::emit_pending_error(db, "str_split.slog:18"); return; }
          ++_fires;
      ...
      if (_fires) db->bumpFires("str_split.slog:18", "all:fields", _fires);
  ...
  // (crule (pre) (scan toint_range __erre2WnK143 __errf6fIb144 __errf0ect145) (body) (head (emit error (0) __erre2WnK143)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre8vX8135 __errf7gcr136 __errf7G5s137 __errf2hRC138) (body) (head (emit error (0) __erre8vX8135)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre6xEd129 __errf3ALs130 __errf7mwI131) (body) (head (emit error (0) __erre6xEd129)) <internal>:1 #f)
  ...
  s->addDynamicRel("rejoined");
  s->addDynamicRel("temp3bbL159");
