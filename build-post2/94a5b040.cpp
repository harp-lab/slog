...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("94a5b040");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst80iO8 const6b86b273ff34fce19d6b804e) (let __tconst5rE09 const4e07408562bedb8b60ce05c1) (let __tconst06hA11 const4b227777d4dd1fc61c6f884f) (let __tconst9jle12 constd4735e3a265e16eee03f5971)) (once) (body) (head (emit edge (0 1) __tconst80iO8 __tconst9jle12) (emit edge (0 1) __tconst9jle12 __tconst5rE09) (emit edge (0 1) __tconst80iO8 __tconst5rE09) (emit edge (0 1) __tconst80iO8 __tconst06hA11) (emit edge (0 1) __tconst06hA11 __tconst5rE09) (emit edge (0 1) __tconst9jle12 __tconst06hA11)) wcoj3.slog:7 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      slog::emit<2>(head_rel[2], head_index[2], newbatch[2], std::array<u64,2>{v_c0, v_c1}, std::array<u16,2>{0, 1});
      ...
      if (_fires) db->bumpFires("wcoj3.slog:7", "once", _fires);
