...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("072d397f");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("type_mismatch");
      std::vector<u16> ord5({1, 2, 3, 4, 0});
    
    r->addIndex<5>(ord5, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<5>(db, r, std::array<u16,5>{1, 2, 3, 4, 0}, false, b), true);
      std::vector<u16> ord6({0, 1, 2, 3, 4});
  ...
  r = db->getRelation("nan_result");
    ...
    r->addIndex<4>(ord11, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<4>(db, r, std::array<u16,4>{1, 2, 3, 0}, false, b), true);
      std::vector<u16> ord12({0, 1, 2, 3});
  ...
  // (crule (pre (let __tconst7pUQ7 constd4735e3a265e16eee03f5971) (let __tconst2L5y6 constef2d127de37b942baad06145) (let __tconst3hEO5 const6b86b273ff34fce19d6b804e) (let __tconst1dV74 const4e07408562bedb8b60ce05c1)) (once) (body) (head (emit base (0 1) __tconst7pUQ7 __tconst2L5y6) (emit base (0 1) __tconst3hEO5 __tconst1dV74)) strat_inc_main.slog:9 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("base");
      std::vector<u16> ord1({0, 1});
      slog::Relation* readrel2 = db->getRelation("base");
      head_index[0] = readrel2->getIndex(ord1, false);
      head_rel[1] = db->getRelation("base");
      std::vector<u16> ord3({0, 1});
      slog::Relation* readrel4 = db->getRelation("base");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("strat_inc_main.slog:9", "once", _fires);
