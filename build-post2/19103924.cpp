...
u64 v_constcc3ec73cd71163b2b0ee5fae;
u64 v_const5feceb66ffc86f38d952786c;
u64 v_const9ff968046ee58067c38b586b;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("19103924");
  if (s == nullptr) return;
  slog::Relation* r;
  v_const6b86b273ff34fce19d6b804e = s32_encode(1);
  v_const4e07408562bedb8b60ce05c1 = s32_encode(3);
  v_constcc3ec73cd71163b2b0ee5fae = db->encodeString("count");
  v_const5feceb66ffc86f38d952786c = s32_encode(0);
  v_const9ff968046ee58067c38b586b = db->encodeString("stat_dem.slog:12");
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<3>(db, db->getRelation("$sup4873x11x0x0x0"), std::array<u16,3>{0, 1, 2}, b));
  // (crule (pre) (scan div_by_zero __erre8Pl063 __errf01qM64 __errf2l3T65) (body) (head (emit error (0) __erre8Pl063)) <internal>:1 #f)
  ...
  // (crule (pre) (scan malformed_deduction __erre0W8h58 __errf6yfk59 __errf0Ovm60 __errf2JhV61 __errf9lnA62) (body) (head (emit error (0) __erre0W8h58)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst22xT12 const4e07408562bedb8b60ce05c1)) (once) (body) (head (mkstruct count (1 0) __383L22 __tconst22xT12)) stat_dem.slog:15 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("stat_dem.slog:15", "once", _fires);
  ...
  // (crule (pre) (scan toint_range __erre5dLn77 __errf45m978 __errf0Vly79) (body) (head (emit error (0) __erre5dLn77)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre2Cf080 __errf1U0n81 __errf4Aif82 __errf54UM83 __errf3q5Z84) (body) (head (emit error (0) __erre2Cf080)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst43Lc9 const5feceb66ffc86f38d952786c) (let __tconst4P0U10 const6b86b273ff34fce19d6b804e)) (scan count __t1kYP8 n) (body (cmp gt n __tconst43Lc9) (let __t7Crh11 (_0002d n __tconst4P0U10))) (head (emit $sup4873x11x0x0x0 (0 1 2) __t1kYP8 __t7Crh11 n)) stat_dem.slog:12 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("$sup4873x11x0x0x0");
      std::vector<u16> ord14({0, 1, 2});
      slog::Relation* readrel15 = db->getRelation("$sup4873x11x0x0x0");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c19 = _t[0];
        u64 v_c20 = _t[1];
        u64 v_c21 = _prim_gt(db, v_c20, v_c17);
        if (v_c21 == slog_error) { slog::emit_pending_error(db, "stat_dem.slog:12"); return; }
        if (!v_c21) return;
        u64 v_c22 = _prim__0002d(db, v_c20, v_c18);
        if (v_c22 == slog_error) { slog::emit_pending_error(db, "stat_dem.slog:12"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c19, v_c22, v_c20}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("stat_dem.slog:12", "delta:count", _fires);
  ...
  // (crule (pre (let __trid2UQ319 const9ff968046ee58067c38b586b) (let __trel2Pjw20 constcc3ec73cd71163b2b0ee5fae) (let __tcol3Jgl21 const5feceb66ffc86f38d952786c)) (scan $sup4873x11x0x0x0 __d0 m n) (body) (head (tycheck m (accept int) __trid2UQ319 __trel2Pjw20 __tcol3Jgl21 (1 2 3 4 0)) (mkstruct count (1 0) __1jrT18 m)) stat_dem.slog:12 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      head_rel[1] = db->getRelation("count");
      outer_rel = db->getRelation("$sup4873x11x0x0x0");
  
    }
    ReadTask17(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c23 = v_const9ff968046ee58067c38b586b;
      u64 v_c24 = v_constcc3ec73cd71163b2b0ee5fae;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        if (!(is_int(v_c27)))
        {
          slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c23, v_c24, v_c25, v_c27}, std::array<u16,5>{1, 2, 3, 4, 0});
          return;
        }
      ...
      if (_fires) db->bumpFires("stat_dem.slog:12", "delta:$sup4873x11x0x0x0", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre87qA66 __errf0ojr67 __errf7Lba68) (body) (head (emit error (0) __erre87qA66)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre2ENq73 __errf8ziG74 __errf1uIl75 __errf05G976) (body) (head (emit error (0) __erre2ENq73)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre3Jmz90 __errf52qo91 __errf5fKS92) (body) (head (emit error (0) __erre3Jmz90)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre9twF69 __errf9K1M70 __errf0jkt71 __errf2vAF72) (body) (head (emit error (0) __erre9twF69)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre34jZ85 __errf3I7R86 __errf4e3Y87 __errf2qxJ88 __errf7RTb89) (body) (head (emit error (0) __erre34jZ85)) <internal>:1 #f)
  ...
  s->addDynamicRel("$sup4873x11x0x0x0");
