...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("adfca67c");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst0J6I13 constc48b5b1a9776c84602de2306)) (once) (body) (head (mkstruct _enum (1 0) __9Lk114 __tconst0J6I13)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst8mAy11 constcbfeda2b1f044ccca4ea9dac)) (once) (body) (head (mkstruct _enum (1 0) __9vHN12 __tconst8mAy11)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c1 = v_constcbfeda2b1f044ccca4ea9dac;
