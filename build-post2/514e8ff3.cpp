...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("514e8ff3");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<3>(db, db->getRelation("sedge"), std::array<u16,3>{0, 1, 2}, b));
  ...
  // (crule (pre (let __tconst4I3o69 consta221beeaebe583607e193be7) (let __tconst9DhF70 constab76c7d069d6f33dc950fb33) (let __tconst2wCN71 consteb8bf0d80db323992f6b634a) (let __tconst7Ys535 constd4735e3a265e16eee03f5971) (let __tconst2BKZ33 const6b86b273ff34fce19d6b804e) (let __tconst5YIo31 const5feceb66ffc86f38d952786c)) (probe _enum (1 0) 1 __tconst4I3o69 __t2lDP34) (body (exists _enum (1 0) 1 __tconst2wCN71) (join _enum (1 0) 1 __tconst9DhF70 __t3MJv32) (join _enum (1 0) 1 __tconst2wCN71 __t1IM030)) (head (emit smt_vcode (0 1) __tconst7Ys535 __t2lDP34) (emit smt_vcode (0 1) __tconst2BKZ33 __t3MJv32) (emit smt_vcode (0 1) __tconst5YIo31 __t1IM030)) smt.slog:68 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      u64 v_c1 = v_constab76c7d069d6f33dc950fb33;
      u64 v_c2 = v_consteb8bf0d80db323992f6b634a;
      ...
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m18) {
        u64 v_c6 = m18[1];
        if (buckethash(v_c6) != bucket) return;
        if (!slog::exists_probe<2,1>(_enumindex0, std::array<u64,2>{v_c2, 0})) return;
        slog::join_probe<2,1>(_enumindex1, std::array<u64,2>{v_c1, 0}, [&](const std::array<u64,2>& m19) {
          u64 v_c7 = m19[1];
          slog::join_probe<2,1>(_enumindex2, std::array<u64,2>{v_c2, 0}, [&](const std::array<u64,2>& m20) {
            u64 v_c8 = m20[1];
            ++_fires;
            slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c3, v_c6}, std::array<u16,2>{0, 1});
