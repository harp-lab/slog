...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("0071acc5");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  if (r == 0) db->addRelation("arithmetic_op", 1);
    ...
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("arithmetic_op");
      std::vector<u16> ord138({0});
    
    r->addIndex<1>(ord138, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<1>(db, r, std::array<u16,1>{0}, false, b), true);
  ...
  // (crule (pre (let __tconst5OqC70 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit mlimit (0) __tconst5OqC70)) analysis-demo.slog:7 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel2 = db->getRelation("mlimit");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("analysis-demo.slog:7", "once", _fires);
  ...
  // (crule (pre (let __tconst6kUV706 constb9e118781cea1f9fa01462e0)) (once) (body) (head (mkstruct _enum (1 0) __7kL7707 __tconst6kUV706)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c1 = v_constb9e118781cea1f9fa01462e0;
  ...
  // (crule (pre (let __tconst5Kl6122 const90fb9068eda6f2d68bb61c33) (let __tconst4Nnb121 const57ba71c4b2fba1fd2fbcd814) (let __tconst8rOI120 const53a56174f3826669a422fc54)) (once) (body) (head (emit comparison_op (0) __tconst5Kl6122) (emit comparison_op (0) __tconst4Nnb121) (emit comparison_op (0) __tconst8rOI120)) interp.slog:105 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel8 = db->getRelation("comparison_op");
      head_index[1] = readrel8->getIndex(ord7, false);
      head_rel[2] = db->getRelation("comparison_op");
      std::vector<u16> ord9({0});
      slog::Relation* readrel10 = db->getRelation("comparison_op");
    ...
    virtual bool work()
    {
      u64 v_c2 = v_const90fb9068eda6f2d68bb61c33;
      u64 v_c3 = v_const57ba71c4b2fba1fd2fbcd814;
      u64 v_c4 = v_const53a56174f3826669a422fc54;
  ...
  // (crule (pre (let __tconst6hCf702 constcd2a69ce5ca278db1d6da969)) (once) (body) (head (mkstruct _enum (1 0) __3V6u703 __tconst6hCf702)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c5 = v_constcd2a69ce5ca278db1d6da969;
  ...
  // (crule (pre (let __tconst4sAz704 const0122baa3ac55f1b433944eb1)) (once) (body) (head (mkstruct _enum (1 0) __0oPG705 __tconst4sAz704)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c6 = v_const0122baa3ac55f1b433944eb1;
  ...
  // (crule (pre (let __tconst14bq350 consted725292f5f32d61535958c1) (let __tconst8nQi349 const0933fb667296882d8c45abca) (let __tconst0gYd348 const7297d2085ea0adffc396d546)) (once) (body) (head (emit arithmetic_op (0) __tconst14bq350) (emit arithmetic_op (0) __tconst8nQi349) (emit arithmetic_op (0) __tconst0gYd348)) interp.slog:104 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      head_index[1] = readrel17->getIndex(ord16, false);
      head_rel[2] = db->getRelation("arithmetic_op");
      std::vector<u16> ord18({0});
      slog::Relation* readrel19 = db->getRelation("arithmetic_op");
      head_index[2] = readrel19->getIndex(ord18, false);
    ...
    virtual bool work()
    {
      ...
      u64 v_c8 = v_const0933fb667296882d8c45abca;
      u64 v_c9 = v_const7297d2085ea0adffc396d546;
      ...
      slog::emit<1>(head_rel[2], head_index[2], newbatch[2], std::array<u64,1>{v_c9}, std::array<u16,1>{0});
