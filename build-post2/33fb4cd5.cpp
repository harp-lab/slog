...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("33fb4cd5");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst80rz27 const6b86b273ff34fce19d6b804e)) (scan rejoined s) (body (join csv (0) 1 s)) (head (emit roundtrip (0) __tconst80rz27)) str_split.slog:19 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel3 = db->getRelation("roundtrip");
      head_index[0] = readrel3->getIndex(ord2, false);
      outer_rel = db->getRelation("rejoined");
      std::vector<u16> ord4({0});
      slog::Relation* readrel5 = db->getRelation("csv");
      csvindex0 = readrel5->getIndex(ord4, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        slog::join_probe<1,1>(csvindex0, std::array<u64,1>{v_c1}, [&](const std::array<u64,1>& m6) {
          ++_fires;
      ...
      if (_fires) db->bumpFires("str_split.slog:19", "all:rejoined", _fires);
