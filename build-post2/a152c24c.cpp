...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("a152c24c");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("grandparent");
  if (r == 0) db->addRelation("grandparent", 2);
  else if (r->getArity() != 2)
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("grandparent");
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<2>(db, db->getRelation("grandparent"), std::array<u16,2>{0, 1}, b));
  ...
  // (crule (pre (let __tconst1xcV2 const6b86b273ff34fce19d6b804e) (let __tconst6T4U4 constd4735e3a265e16eee03f5971) (let __tconst2T6T6 const4e07408562bedb8b60ce05c1) (let __tconst9CLz7 constef2d127de37b942baad06145) (let __tconst99re8 const4b227777d4dd1fc61c6f884f)) (once) (body) (head (emit parent (0 1) __tconst1xcV2 __tconst6T4U4) (emit parent (0 1) __tconst6T4U4 __tconst2T6T6) (emit parent (0 1) __tconst2T6T6 __tconst99re8) (emit parent (0 1) __tconst99re8 __tconst9CLz7)) grandparent.slog:4 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      slog::emit<2>(head_rel[2], head_index[2], newbatch[2], std::array<u64,2>{v_c2, v_c4}, std::array<u16,2>{0, 1});
      ...
      if (_fires) db->bumpFires("grandparent.slog:4", "once", _fires);
