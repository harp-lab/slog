...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("f525cfb4");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst36n29 constcbfeda2b1f044ccca4ea9dac) (let __tconst6s9K10 constc48b5b1a9776c84602de2306) (let __tconst2STt4 constc100f95c1913f9c72fc1f4ef) (let __tconst2WkH2 constac8d8342bbb2362d13f0a559)) (probe _enum (1 0) 1 __tconst36n29 __t0shh3) (body (join _enum (1 0) 1 __tconst6s9K10 __t3I1n1)) (head (emit in (0 1) __tconst2STt4 __t0shh3) (emit in (0 1) __tconst2WkH2 __t3I1n1)) enum_struct_field.slog:11 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("enum_struct_field.slog:11", "all:_enum", _fires);
