...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("8f80c714");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst2jVo6 const6b86b273ff34fce19d6b804e) (let __tconst18KB5 constd4735e3a265e16eee03f5971)) (once) (body) (head (emit edge (0 1) __tconst2jVo6 __tconst18KB5)) rule_noarrow.slog:6 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("rule_noarrow.slog:6", "once", _fires);
  ...
  // (crule (pre (let __tconst0ZQ39 constd4735e3a265e16eee03f5971) (let __tconst7n3d10 const4b227777d4dd1fc61c6f884f) (let __tconst9Y6H11 const4e07408562bedb8b60ce05c1)) (once) (body) (head (emit edge (0 1) __tconst0ZQ39 __tconst9Y6H11) (emit edge (0 1) __tconst9Y6H11 __tconst7n3d10)) rule_noarrow.slog:7 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("rule_noarrow.slog:7", "once", _fires);
