...
u64 v_constb7ce3f814d0e14e74eb1dc74;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("4263e7a5");
  if (s == nullptr) return;
  slog::Relation* r;
  v_constb7ce3f814d0e14e74eb1dc74 = db->encodeString("zero");
  ...
  // (crule (pre (let __tconst0GmY12 constb7ce3f814d0e14e74eb1dc74)) (once) (body) (head (mkstruct _enum (1 0) __728k13 __tconst0GmY12)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c0 = v_constb7ce3f814d0e14e74eb1dc74;
