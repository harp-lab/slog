...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("13f6769d");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan b X) (body) (head (emit o (0) X)) shape_nestor.slog:14 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("o");
      std::vector<u16> ord1({0});
      slog::Relation* readrel2 = db->getRelation("o");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_nestor.slog:14", "all:b", _fires);
  ...
  // (crule (pre) (scan c X) (body) (head (emit o (0) X)) shape_nestor.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel5 = db->getRelation("o");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_nestor.slog:14", "all:c", _fires);
  ...
  // (crule (pre) (scan a X) (body) (head (emit o (0) X)) shape_nestor.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel8 = db->getRelation("o");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_nestor.slog:14", "all:a", _fires);
