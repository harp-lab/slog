...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("b5cc3310");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan path X Y) (body (join edge (0 1) 1 Y Z)) (head (emit path (0 1) X Z)) hub.slog:111 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel3 = db->getRelation("path");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c1 = _t[1];
        slog::join_probe<2,1>(edgeindex0, std::array<u64,2>{v_c1, 0}, [&](const std::array<u64,2>& m6) {
          u64 v_c2 = m6[1];
          ++_fires;
      ...
      if (_fires) db->bumpFires("hub.slog:111", "delta:path", _fires);
  ...
  // (crule (pre) (scan edge X Y) (body) (head (emit path (0 1) X Y)) hub.slog:106 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel9 = db->getRelation("path");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("hub.slog:106", "all:edge", _fires);
