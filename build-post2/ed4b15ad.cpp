...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("ed4b15ad");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan nan_result __erre3OZQ108 __errf7wtg109 __errf7Xuz110 __errf63Mk111) (body) (head (emit error (0) __erre3OZQ108)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre0V5N120 __errf1Ko9121 __errf1v9N122 __errf2D8t123 __errf6eF9124) (body) (head (emit error (0) __erre0V5N120)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst7wf54 const6b86b273ff34fce19d6b804e)) (scan b X) (body (let __t7Sll5 (_0002b X __tconst7wf54))) (head (emit c (0) __t7Sll5)) strat_revorder.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("c");
      std::vector<u16> ord7({0});
      slog::Relation* readrel8 = db->getRelation("c");
      head_index[0] = readrel8->getIndex(ord7, false);
      outer_rel = db->getRelation("b");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c10 = _t[0];
        u64 v_c11 = _prim__0002b(db, v_c10, v_c9);
        if (v_c11 == slog_error) { slog::emit_pending_error(db, "strat_revorder.slog:14"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_revorder.slog:14", "all:b", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre8cJK115 __errf9jJR116 __errf3MeC117 __errf55Mh118 __errf7KQO119) (body) (head (emit error (0) __erre8cJK115)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre90il98 __errf4eUI99 __errf1iaH100) (body) (head (emit error (0) __erre90il98)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre8Obd125 __errf8Uxg126 __errf3CT7127) (body) (head (emit error (0) __erre8Obd125)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre5ND4104 __errf5uRS105 __errf6E15106 __errf0LK8107) (body) (head (emit error (0) __erre5ND4104)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre6P0j112 __errf2hRQ113 __errf9MYk114) (body) (head (emit error (0) __erre6P0j112)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre2iVw101 __errf8oTR102 __errf7M2v103) (body) (head (emit error (0) __erre2iVw101)) <internal>:1 #f)
