...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("df6f2004");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan best_at a k v) (body) (head (emit final (0 1 2) a k v)) lat_rat.slog:34 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel2 = db->getRelation("final");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("lat_rat.slog:34", "delta:best_at", _fires);
