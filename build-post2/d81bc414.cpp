...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("d81bc414");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<1>(db, db->getRelation("r"), std::array<u16,1>{0}, b));
  r = db->getRelation("q");
  ...
  // (crule (pre) (scan mpz_table_overflow __erre0hrJ124 __errf246U125 __errf22bv126) (body) (head (emit error (0) __erre0hrJ124)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre4ECy114 __errf9JM3115 __errf02Xl116 __errf9xWp117 __errf3frx118) (body) (head (emit error (0) __erre4ECy114)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst8npR5 constd4735e3a265e16eee03f5971)) (scan q X) (body (let __t4Uvm6 (_0002a X __tconst8npR5))) (head (emit r (0) __t4Uvm6)) strat_run2_main.slog:13 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("r");
      std::vector<u16> ord7({0});
      slog::Relation* readrel8 = db->getRelation("r");
      head_index[0] = readrel8->getIndex(ord7, false);
      outer_rel = db->getRelation("q");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c9 = _t[0];
        u64 v_c10 = _prim__0002a(db, v_c9, v_c8);
        if (v_c10 == slog_error) { slog::emit_pending_error(db, "strat_run2_main.slog:13"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_run2_main.slog:13", "all:q", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre3Gww119 __errf5YzB120 __errf3hCQ121 __errf0vZT122 __errf7xid123) (body) (head (emit error (0) __erre3Gww119)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre3q3y107 __errf8Mnf108 __errf8ine109 __errf13Mf110) (body) (head (emit error (0) __erre3q3y107)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre37SX111 __errf2gdl112 __errf5nUa113) (body) (head (emit error (0) __erre37SX111)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre0Qby103 __errf9r0i104 __errf7hb6105 __errf61oB106) (body) (head (emit error (0) __erre0Qby103)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre4lxj97 __errf0C3C98 __errf2djp99) (body) (head (emit error (0) __erre4lxj97)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre9gO5100 __errf9twH101 __errf5JLx102) (body) (head (emit error (0) __erre9gO5100)) <internal>:1 #f)
