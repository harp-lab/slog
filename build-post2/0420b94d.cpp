...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("0420b94d");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst9mPM80 consta221beeaebe583607e193be7) (let __tconst095681 constab76c7d069d6f33dc950fb33) (let __tconst9Vib82 consteb8bf0d80db323992f6b634a) (let __tconst04Yg43 constd4735e3a265e16eee03f5971) (let __tconst57OR41 const6b86b273ff34fce19d6b804e) (let __tconst4Xfb39 const5feceb66ffc86f38d952786c)) (probe _enum (1 0) 1 __tconst9mPM80 __t2yFK42) (body (exists _enum (1 0) 1 __tconst9Vib82) (join _enum (1 0) 1 __tconst095681 __t1zKD40) (join _enum (1 0) 1 __tconst9Vib82 __t89JD38)) (head (emit smt_vcode (0 1) __tconst04Yg43 __t2yFK42) (emit smt_vcode (0 1) __tconst57OR41 __t1zKD40) (emit smt_vcode (0 1) __tconst4Xfb39 __t89JD38)) smt.slog:68 #f)
