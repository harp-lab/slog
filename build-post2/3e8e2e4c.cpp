...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("3e8e2e4c");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst6sfq19 const4ec9599fc203d176a301536c)) (scan person P A) (body (cmp ge A __tconst6sfq19)) (head (emit adult (0) P)) shape_facts.slog:35 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("adult");
      std::vector<u16> ord1({0});
      slog::Relation* readrel2 = db->getRelation("adult");
      head_index[0] = readrel2->getIndex(ord1, false);
      outer_rel = db->getRelation("person");
  
    }
    ReadTask0(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c0 = v_const4ec9599fc203d176a301536c;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        u64 v_c2 = _t[1];
        u64 v_c3 = _prim_ge(db, v_c2, v_c0);
        if (v_c3 == slog_error) { slog::emit_pending_error(db, "shape_facts.slog:35"); return; }
        if (!v_c3) return;
        ++_fires;
      ...
      if (_fires) db->bumpFires("shape_facts.slog:35", "all:person", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre2nrl57 __errf3Aie58 __errf6Ze259 __errf6CTp60) (body) (head (emit error (0) __erre2nrl57)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre2VJc54 __errf2KE455 __errf7Kgl56) (body) (head (emit error (0) __erre2VJc54)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre4boH78 __errf4Mdh79 __errf7xf080) (body) (head (emit error (0) __erre4boH78)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre1hWG68 __errf7nuK69 __errf8Di770 __errf9Srs71 __errf0pou72) (body) (head (emit error (0) __erre1hWG68)) <internal>:1 #f)
  ...
  // (crule (pre) (scan likes Y X) (body (join likes (0 1) 2 X Y)) (head (emit mutual (0 1) X Y)) shape_facts.slog:37 #f)
  class ReadTask17 : public slog::Task
  {
    ...
    slog::Index** likesindex16;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("mutual");
      std::vector<u16> ord18({0, 1});
      slog::Relation* readrel19 = db->getRelation("mutual");
      head_index[0] = readrel19->getIndex(ord18, false);
      outer_rel = db->getRelation("likes");
      std::vector<u16> ord20({0, 1});
      slog::Relation* readrel21 = db->getRelation("likes");
      likesindex16 = readrel21->getIndex(ord20, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c19 = _t[0];
        u64 v_c20 = _t[1];
        slog::join_probe<2,2>(likesindex16, std::array<u64,2>{v_c20, v_c19}, [&](const std::array<u64,2>& m22) {
          ++_fires;
      ...
      if (_fires) db->bumpFires("shape_facts.slog:37", "all:likes", _fires);
  ...
  // (crule (pre (let __tconst8uDQ20 constd4735e3a265e16eee03f5971)) (scan num N) (body (cmp gt N __tconst8uDQ20)) (head (emit bignum (0) N)) shape_facts.slog:39 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("bignum");
      std::vector<u16> ord24({0});
      slog::Relation* readrel25 = db->getRelation("bignum");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c22 = _t[0];
        u64 v_c23 = _prim_gt(db, v_c22, v_c21);
        if (v_c23 == slog_error) { slog::emit_pending_error(db, "shape_facts.slog:39"); return; }
        if (!v_c23) return;
        ++_fires;
      ...
      if (_fires) db->bumpFires("shape_facts.slog:39", "all:num", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre9Arc73 __errf2mSr74 __errf7vi975 __errf4fuu76 __errf4CBm77) (body) (head (emit error (0) __erre9Arc73)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre59e165 __errf46oI66 __errf42at67) (body) (head (emit error (0) __erre59e165)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre167N61 __errf2YiE62 __errf3bU463 __errf6BCK64) (body) (head (emit error (0) __erre167N61)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre7FLF51 __errf0UkN52 __errf4yas53) (body) (head (emit error (0) __erre7FLF51)) <internal>:1 #f)
  ...
  s->addDynamicRel("adult");
  s->addDynamicRel("bignum");
