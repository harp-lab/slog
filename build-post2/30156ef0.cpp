...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("30156ef0");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst8AnX6 const7902699be42c8a8e46fbbb45) (let __tconst5UIx5 const4a44dc15364204a80fe80e90)) (once) (body) (head (emit query (0) __tconst8AnX6) (emit query (0) __tconst5UIx5)) dem_fib.slog:12 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel2 = db->getRelation("query");
      head_index[0] = readrel2->getIndex(ord1, false);
      head_rel[1] = db->getRelation("query");
      std::vector<u16> ord3({0});
      slog::Relation* readrel4 = db->getRelation("query");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_fib.slog:12", "once", _fires);
