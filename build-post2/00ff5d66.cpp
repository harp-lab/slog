...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("00ff5d66");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst00xe37 const4b227777d4dd1fc61c6f884f) (let __tconst9kHt36 const19581e27de7ced00ff1ce50b)) (once) (body) (head (emit edge (0 1) __tconst00xe37 __tconst9kHt36)) smt_rhas.slog:22 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("smt_rhas.slog:22", "once", _fires);
  ...
  // (crule (pre (let __tconst6KV958 const6b86b273ff34fce19d6b804e) (let __tconst8F9r57 constd4735e3a265e16eee03f5971)) (once) (body) (head (emit edge (0 1) __tconst6KV958 __tconst8F9r57)) smt_rhas.slog:19 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("smt_rhas.slog:19", "once", _fires);
  ...
  // (crule (pre (let __tconst4FPM81 consteb8bf0d80db323992f6b634a)) (once) (body) (head (mkstruct _enum (1 0) __62oI82 __tconst4FPM81)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst0vhO5 constd4735e3a265e16eee03f5971) (let __tconst1m254 const4e07408562bedb8b60ce05c1) (let __tconst5fEM3 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit sedge (0 1 2) __tconst0vhO5 __tconst1m254 __tconst5fEM3)) smt_rhas.slog:20 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("sedge");
      std::vector<u16> ord8({0, 1, 2});
      slog::Relation* readrel9 = db->getRelation("sedge");
    ...
    virtual bool work()
    {
      ...
      ++_fires;
      slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c5, v_c6, v_c7}, std::array<u16,3>{0, 1, 2});
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("smt_rhas.slog:20", "once", _fires);
  ...
  // (crule (pre (let __tconst0ylo79 constab76c7d069d6f33dc950fb33)) (once) (body) (head (mkstruct _enum (1 0) __1wqH80 __tconst0ylo79)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c8 = v_constab76c7d069d6f33dc950fb33;
  ...
  // (crule (pre (let __tconst4oMD77 consta221beeaebe583607e193be7)) (once) (body) (head (mkstruct _enum (1 0) __9cZv78 __tconst4oMD77)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst5isw6 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit src (0) __tconst5isw6)) smt_rhas.slog:18 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel14 = db->getRelation("src");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("smt_rhas.slog:18", "once", _fires);
  ...
  // (crule (pre (let __tconst14QM48 const4e07408562bedb8b60ce05c1) (let __tconst3s8p47 const4b227777d4dd1fc61c6f884f) (let __tconst4btv46 constef2d127de37b942baad06145)) (once) (body) (head (emit sedge (0 1 2) __tconst14QM48 __tconst3s8p47 __tconst4btv46)) smt_rhas.slog:21 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel17 = db->getRelation("sedge");
    ...
    virtual bool work()
    {
      ...
      ++_fires;
      slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c11, v_c12, v_c13}, std::array<u16,3>{0, 1, 2});
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("smt_rhas.slog:21", "once", _fires);
