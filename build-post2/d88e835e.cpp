...
u64 v_constdae8d75c920d72b9a6865496;
u64 v_const6d5a2a93f0ffba5895bf30a7;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("d88e835e");
  if (s == nullptr) return;
  slog::Relation* r;
  v_const6b86b273ff34fce19d6b804e = s32_encode(1);
  v_constdae8d75c920d72b9a6865496 = db->encodeString("domtree.slog:52");
  v_const6d5a2a93f0ffba5895bf30a7 = db->encodeString("ndset");
  ...
  // (crule (pre) (scan modulo_by_zero __erre1ah685 __errf8DUk86 __errf24aC87) (body) (head (emit error (0) __erre1ah685)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre1oIa104 __errf2qXw105 __errf9na7106 __errf0kf4107 __errf7t9k108) (body) (head (emit error (0) __erre1oIa104)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre3zaN88 __errf6RiF89 __errf3KhH90 __errf32ct91) (body) (head (emit error (0) __erre3zaN88)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre217K82 __errf6EHj83 __errf24Qg84) (body) (head (emit error (0) __erre217K82)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre2TLg92 __errf4ybz93 __errf19Gr94 __errf5hCo95) (body) (head (emit error (0) __erre2TLg92)) <internal>:1 #f)
  ...
  // (crule (pre (let __t0WgT2 (cmap))) (scan nd d n) (body (let __t5QdR3 (cins __t0WgT2 d))) (head (emit-lat ndset n __t5QdR3)) domtree.slog:53 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("ndset");
    ...
    virtual bool work()
    {
      ...
      if (v_c19 == slog_error) { slog::emit_pending_error(db, "domtree.slog:53"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        if (v_c22 == slog_error) { slog::emit_pending_error(db, "domtree.slog:53"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("domtree.slog:53", "all:nd", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre2BUm109 __errf7jHV110 __errf1THW111) (body) (head (emit error (0) __erre2BUm109)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre4FTa96 __errf08k597 __errf7Cky98) (body) (head (emit error (0) __erre4FTa96)) <internal>:1 #f)
  ...
  // (crule (pre (let __trid69R736 constdae8d75c920d72b9a6865496) (let __trel95XQ37 const6d5a2a93f0ffba5895bf30a7) (let __tcol9YVE38 const6b86b273ff34fce19d6b804e) (let __t4YnQ21 (cmap))) (scan reached n) (body) (head (tycheck __t4YnQ21 (accept cnode) __trid69R736 __trel95XQ37 __tcol9YVE38 (1 2 3 4 0)) (emit-lat ndset n __t4YnQ21)) domtree.slog:52 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      head_rel[1] = db->getRelation("ndset");
    ...
    virtual bool work()
    {
      u64 v_c29 = v_constdae8d75c920d72b9a6865496;
      u64 v_c30 = v_const6d5a2a93f0ffba5895bf30a7;
      u64 v_c31 = v_const6b86b273ff34fce19d6b804e;
      u64 v_c32 = _prim_cmap(db);
      if (v_c32 == slog_error) { slog::emit_pending_error(db, "domtree.slog:52"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        if (!(is_cnode(v_c32)))
        {
          slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c29, v_c30, v_c31, v_c32}, std::array<u16,5>{1, 2, 3, 4, 0});
          return;
        }
        slog::emit_temp<2>(head_rel[1], newbatch[1], std::array<u64,2>{v_c21, v_c32});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
        head_rel[1]->sendBatch(newbatch[1]);
  
      if (_fires) db->bumpFires("domtree.slog:52", "all:reached", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre1xf599 __errf0ZO1100 __errf0YQ8101 __errf1VNE102 __errf5Ppn103) (body) (head (emit error (0) __erre1xf599)) <internal>:1 #f)
  ...
  // (crule (pre) (scan malformed_deduction __erre5eSb77 __errf1l1578 __errf0MnV79 __errf4TgQ80 __errf0vMe81) (body) (head (emit error (0) __erre5eSb77)) <internal>:1 #f)
