...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("9c1d4f4a");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<1>(db, db->getRelation("o"), std::array<u16,1>{0}, b));
  ...
  // (crule (pre (let __tconst2U743 const4e07408562bedb8b60ce05c1) (let __tconst0t3b2 constd4735e3a265e16eee03f5971) (let __tconst9CKY1 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit c (0) __tconst2U743) (emit b (0) __tconst0t3b2) (emit a (0) __tconst9CKY1)) shape_nestor.slog:9 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel2 = db->getRelation("c");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_nestor.slog:9", "once", _fires);
