...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("74862d9e");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst6uIw12 const7902699be42c8a8e46fbbb45) (let __tconst9qGj11 const4e07408562bedb8b60ce05c1) (let __tconst3Z3K10 constd4735e3a265e16eee03f5971) (let __tconst96uJ9 const6b86b273ff34fce19d6b804e) (let __tconst9crz8 const5feceb66ffc86f38d952786c)) (once) (body) (head (emit n (0) __tconst6uIw12) (emit n (0) __tconst9qGj11) (emit n (0) __tconst3Z3K10) (emit n (0) __tconst96uJ9) (emit n (0) __tconst9crz8)) prim2_lets.slog:9 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      head_rel[2] = db->getRelation("n");
      std::vector<u16> ord5({0});
      slog::Relation* readrel6 = db->getRelation("n");
      head_index[2] = readrel6->getIndex(ord5, false);
      head_rel[3] = db->getRelation("n");
      std::vector<u16> ord7({0});
      slog::Relation* readrel8 = db->getRelation("n");
      head_index[3] = readrel8->getIndex(ord7, false);
      head_rel[4] = db->getRelation("n");
      std::vector<u16> ord9({0});
      slog::Relation* readrel10 = db->getRelation("n");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("prim2_lets.slog:9", "once", _fires);
