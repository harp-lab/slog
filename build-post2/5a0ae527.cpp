...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("5a0ae527");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst0JwX15 const47dbebec5d6543d84309f992)) (once) (body) (head (mkstruct _enum (1 0) __8hm116 __tconst0JwX15)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c0 = v_const47dbebec5d6543d84309f992;
