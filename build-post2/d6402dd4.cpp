...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("d6402dd4");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp814H137");
  if (r == 0) db->addTempRelation("temp814H137", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp7gr6135");
  if (r == 0) db->addTempRelation("temp7gr6135", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp4Okv134");
  if (r == 0) db->addTempRelation("temp4Okv134", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp486I136");
  if (r == 0) db->addTempRelation("temp486I136", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  ...
  // (crule (pre) (scan modulo_by_zero __erre5Rhf107 __errf8T75108 __errf2Uht109) (body) (head (emit error (0) __erre5Rhf107)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst2a1a9 const6b86b273ff34fce19d6b804e) (let __tconst3Qpg8 constd4735e3a265e16eee03f5971) (let __tconst5QP27 const4e07408562bedb8b60ce05c1)) (scan temp4Okv134 __t7GEj10) (body (let __t6hPX11 (lpush __t7GEj10 __tconst2a1a9))) (head (emit-temp temp7gr6135 __t6hPX11)) dem_brackets.slog:18 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp7gr6135");
      outer_rel = db->getRelation("temp4Okv134");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        if (v_c7 == slog_error) { slog::emit_pending_error(db, "dem_brackets.slog:18"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("dem_brackets.slog:18", "delta:temp4Okv134", _fires);
  ...
  // (crule (pre) (scan temp814H137 __t3S6Z13) (body) (head (emit input (0) __t3S6Z13)) dem_brackets.slog:18 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel6 = db->getRelation("input");
      head_index[0] = readrel6->getIndex(ord5, false);
      outer_rel = db->getRelation("temp814H137");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_brackets.slog:18", "delta:temp814H137", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre6uJh104 __errf5zb0105 __errf4khB106) (body) (head (emit error (0) __erre6uJh104)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst3Qpg8 constd4735e3a265e16eee03f5971) (let __tconst5QP27 const4e07408562bedb8b60ce05c1)) (scan temp7gr6135 __t6hPX11) (body (let __t6ux612 (lpush __t6hPX11 __tconst3Qpg8))) (head (emit-temp temp486I136 __t6ux612)) dem_brackets.slog:18 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp486I136");
      outer_rel = db->getRelation("temp7gr6135");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c7 = _t[0];
        u64 v_c12 = _prim_lpush(db, v_c7, v_c4);
        if (v_c12 == slog_error) { slog::emit_pending_error(db, "dem_brackets.slog:18"); return; }
        ++_fires;
        slog::emit_temp<1>(head_rel[0], newbatch[0], std::array<u64,1>{v_c12});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("dem_brackets.slog:18", "delta:temp7gr6135", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre1kjG110 __errf6xui111 __errf1f3Y112 __errf2COU113) (body) (head (emit error (0) __erre1kjG110)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst90jT72 const933b575c961e931c43e84b05)) (once) (body) (head (mkstruct _enum (1 0) __4fcC73 __tconst90jT72)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c17 = v_const933b575c961e931c43e84b05;
  ...
  // (crule (pre (let __tconst5QP27 const4e07408562bedb8b60ce05c1)) (scan temp486I136 __t6ux612) (body (let __t3S6Z13 (lpush __t6ux612 __tconst5QP27))) (head (emit-temp temp814H137 __t3S6Z13)) dem_brackets.slog:18 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp814H137");
      outer_rel = db->getRelation("temp486I136");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c12 = _t[0];
        u64 v_c8 = _prim_lpush(db, v_c12, v_c5);
        if (v_c8 == slog_error) { slog::emit_pending_error(db, "dem_brackets.slog:18"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("dem_brackets.slog:18", "delta:temp486I136", _fires);
  ...
  // (crule (pre (let __tconst2a1a9 const6b86b273ff34fce19d6b804e) (let __tconst3Qpg8 constd4735e3a265e16eee03f5971) (let __tconst5QP27 const4e07408562bedb8b60ce05c1) (let __t7GEj10 (lempty))) (once) (body) (head (emit-temp temp4Okv134 __t7GEj10)) dem_brackets.slog:18 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp4Okv134");
    ...
    virtual bool work()
    {
      ...
      if (v_c6 == slog_error) { slog::emit_pending_error(db, "dem_brackets.slog:18"); return true; }
      ...
      if (_fires) db->bumpFires("dem_brackets.slog:18", "once", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre149z121 __errf15lF122 __errf32am123 __errf3SCK124 __errf5C3V125) (body) (head (emit error (0) __erre149z121)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre131u114 __errf2QWr115 __errf5BmO116 __errf6Zg4117) (body) (head (emit error (0) __erre131u114)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre3dH9131 __errf14Dm132 __errf58C7133) (body) (head (emit error (0) __erre3dH9131)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre9hXS126 __errf44yU127 __errf9JSv128 __errf8Ysu129 __errf3dKH130) (body) (head (emit error (0) __erre9hXS126)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre7cRJ118 __errf52Ug119 __errf2dln120) (body) (head (emit error (0) __erre7cRJ118)) <internal>:1 #f)
  ...
  s->addReadRel("temp486I136");
  s->addReadRel("temp4Okv134");
  s->addReadRel("temp7gr6135");
  s->addReadRel("temp814H137");
  ...
  s->addDynamicRel("temp486I136");
  s->addDynamicRel("temp4Okv134");
  s->addDynamicRel("temp7gr6135");
  s->addDynamicRel("temp814H137");
