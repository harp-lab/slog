...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("10a01940");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  if (r == 0) db->addStruct("int_overflow", 4);
    ...
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("int_overflow");
      std::vector<u16> ord88({1, 2, 3, 0});
    
    r->addIndex<4>(ord88, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<4>(db, r, std::array<u16,4>{1, 2, 3, 0}, false, b), true);
      std::vector<u16> ord89({0, 1, 2, 3});
  ...
  // (crule (pre (let __tconst6Q0f16 const6b86b273ff34fce19d6b804e) (let __tconst6sOS19 constd4735e3a265e16eee03f5971)) (scan fib_ans __t3goq18 a) (body (join fib (0 1) 1 __t3goq18 __t6LWt17) (join fib (0 1) 0 __t5Cdn14 n) (cmp lt __tconst6Q0f16 n) (join-old fib_ans (0 1) 0 (0 1) __t6yxm21 b) (let __t7HjL20 (_0002d n __tconst6sOS19)) (join fib (0 1) 2 __t6yxm21 __t7HjL20) (let chk7E2C148 (_0002d n __tconst6Q0f16)) (eq __t6LWt17 chk7E2C148) (let __t6fS322 (_0002b a b))) (head (emit fib_ans (0 1) __t5Cdn14 __t6fS322)) dem_fib.slog:8 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel7 = db->getRelation("fib_ans");
      ...
      fibindex0 = readrel9->getIndex(ord8, false);
      std::vector<u16> ord10({0, 1});
      slog::Relation* readrel11 = db->getRelation("fib");
      fibindex1 = readrel11->getIndex(ord10, false);
      std::vector<u16> ord12({0, 1});
      slog::Relation* readrel13 = db->getRelation("fib_ans");
      fib_ansindex2 = readrel13->getIndex(ord12, false);
      std::vector<u16> ord14({0, 1});
      slog::Relation* readrel15 = db->getRelation("fib_ans");
      fib_ansdelta4 = readrel15->getIndex(ord14, true);
      std::vector<u16> ord16({0, 1});
      slog::Relation* readrel17 = db->getRelation("fib");
      fibindex3 = readrel17->getIndex(ord16, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c2 = _t[0];
        u64 v_c3 = _t[1];
        slog::join_probe<2,1>(fibindex0, std::array<u64,2>{v_c2, 0}, [&](const std::array<u64,2>& m18) {
          u64 v_c4 = m18[1];
          slog::join_all<2>(fibindex1, [&](const std::array<u64,2>& m19) {
            u64 v_c5 = m19[0]; u64 v_c6 = m19[1];
            u64 v_c7 = _prim_lt(db, v_c0, v_c6);
            if (v_c7 == slog_error) { slog::emit_pending_error(db, "dem_fib.slog:8"); return; }
            if (!v_c7) return;
            slog::join_all_old<2>(fib_ansindex2, fib_ansdelta4, [&](const std::array<u64,2>& m21) {
              u64 v_c8 = m21[0]; u64 v_c9 = m21[1];
              u64 v_c10 = _prim__0002d(db, v_c6, v_c1);
              if (v_c10 == slog_error) { slog::emit_pending_error(db, "dem_fib.slog:8"); return; }
              slog::join_probe<2,2>(fibindex3, std::array<u64,2>{v_c8, v_c10}, [&](const std::array<u64,2>& m22) {
                u64 v_c11 = _prim__0002d(db, v_c6, v_c0);
                if (v_c11 == slog_error) { slog::emit_pending_error(db, "dem_fib.slog:8"); return; }
                if (v_c4 != v_c11) return;
                u64 v_c12 = _prim__0002b(db, v_c3, v_c9);
                if (v_c12 == slog_error) { slog::emit_pending_error(db, "dem_fib.slog:8"); return; }
                ++_fires;
      ...
      if (_fires) db->bumpFires("dem_fib.slog:8", "delta:fib_ans", _fires);
  ...
  // (crule (pre (let __tconst6Q0f16 const6b86b273ff34fce19d6b804e) (let __tconst6sOS19 constd4735e3a265e16eee03f5971)) (scan fib_ans __t6yxm21 b) (body (join fib (0 1) 1 __t6yxm21 __t7HjL20) (join fib (0 1) 0 __t5Cdn14 n) (cmp lt __tconst6Q0f16 n) (join fib_ans (0 1) 0 __t3goq18 a) (let __t6LWt17 (_0002d n __tconst6Q0f16)) (join fib (0 1) 2 __t3goq18 __t6LWt17) (let chk5ail149 (_0002d n __tconst6sOS19)) (eq __t7HjL20 chk5ail149) (let __t6fS322 (_0002b a b))) (head (emit fib_ans (0 1) __t5Cdn14 __t6fS322)) dem_fib.slog:8 #f)
  class ReadTask27 : public slog::Task
  {
    ...
    slog::Index** fibindex23;  slog::Index** fibindex24;  slog::Index** fib_ansindex25;  slog::Index** fibindex26;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel29 = db->getRelation("fib_ans");
      head_index[0] = readrel29->getIndex(ord28, false);
      outer_rel = db->getRelation("fib_ans");
      std::vector<u16> ord30({0, 1});
      slog::Relation* readrel31 = db->getRelation("fib");
      fibindex23 = readrel31->getIndex(ord30, false);
      std::vector<u16> ord32({0, 1});
      slog::Relation* readrel33 = db->getRelation("fib");
      fibindex24 = readrel33->getIndex(ord32, false);
      std::vector<u16> ord34({0, 1});
      slog::Relation* readrel35 = db->getRelation("fib_ans");
      fib_ansindex25 = readrel35->getIndex(ord34, false);
      std::vector<u16> ord36({0, 1});
      slog::Relation* readrel37 = db->getRelation("fib");
      fibindex26 = readrel37->getIndex(ord36, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c8 = _t[0];
        u64 v_c9 = _t[1];
        slog::join_probe<2,1>(fibindex23, std::array<u64,2>{v_c8, 0}, [&](const std::array<u64,2>& m38) {
          u64 v_c10 = m38[1];
          slog::join_all<2>(fibindex24, [&](const std::array<u64,2>& m39) {
            u64 v_c5 = m39[0]; u64 v_c6 = m39[1];
            u64 v_c13 = _prim_lt(db, v_c0, v_c6);
            if (v_c13 == slog_error) { slog::emit_pending_error(db, "dem_fib.slog:8"); return; }
            if (!v_c13) return;
            slog::join_all<2>(fib_ansindex25, [&](const std::array<u64,2>& m41) {
              u64 v_c2 = m41[0]; u64 v_c3 = m41[1];
              u64 v_c4 = _prim__0002d(db, v_c6, v_c0);
              if (v_c4 == slog_error) { slog::emit_pending_error(db, "dem_fib.slog:8"); return; }
              slog::join_probe<2,2>(fibindex26, std::array<u64,2>{v_c2, v_c4}, [&](const std::array<u64,2>& m42) {
                u64 v_c14 = _prim__0002d(db, v_c6, v_c1);
                if (v_c14 == slog_error) { slog::emit_pending_error(db, "dem_fib.slog:8"); return; }
  ...
  // (crule (pre) (scan toint_range __erre7yHL132 __errf4uiO133 __errf7ZMr134) (body) (head (emit error (0) __erre7yHL132)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre4hwm124 __errf53Dp125 __errf2dSp126 __errf641a127) (body) (head (emit error (0) __erre4hwm124)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre8Sph128 __errf81Mt129 __errf9B8i130 __errf2PGF131) (body) (head (emit error (0) __erre8Sph128)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre4Tij135 __errf9tg2136 __errf6t6u137 __errf2VH1138 __errf3p1u139) (body) (head (emit error (0) __erre4Tij135)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre0KEg118 __errf73Em119 __errf5oy6120) (body) (head (emit error (0) __erre0KEg118)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre3ueb140 __errf2Dsr141 __errf8XjE142 __errf24qy143 __errf93D7144) (body) (head (emit error (0) __erre3ueb140)) <internal>:1 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel60 = db->getRelation("error");
  ...
  // (crule (pre) (scan modulo_by_zero __erre8RpY121 __errf9ebs122 __errf5XEx123) (body) (head (emit error (0) __erre8RpY121)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst1NpX13 constd4735e3a265e16eee03f5971)) (scan fib __t2Px812 n) (body (cmp lt n __tconst1NpX13)) (head (emit fib_ans (0 1) __t2Px812 n)) dem_fib.slog:7 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel66 = db->getRelation("fib_ans");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c43 = _t[0];
        u64 v_c6 = _t[1];
        u64 v_c44 = _prim_lt(db, v_c6, v_c42);
        if (v_c44 == slog_error) { slog::emit_pending_error(db, "dem_fib.slog:7"); return; }
        if (!v_c44) return;
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c43, v_c6}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("dem_fib.slog:7", "all:fib", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre1HYF145 __errf46H1146 __errf4nYF147) (body) (head (emit error (0) __erre1HYF145)) <internal>:1 #f)
