...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("f4c8761a");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<3>(db, db->getRelation("path"), std::array<u16,3>{0, 1, 2}, b));
  ...
  // (crule (pre (let __tconst8AKK6 constd4735e3a265e16eee03f5971) (let __tconst0chl7 const5feceb66ffc86f38d952786c) (let __tconst1S5h8 const4b227777d4dd1fc61c6f884f) (let __tconst8W3q9 const4e07408562bedb8b60ce05c1) (let __tconst4Xdp12 conste7f6c011776e8db7cd330b54) (let __tconst9K8f13 const6b86b273ff34fce19d6b804e) (let __tconst7Ihx14 const2c624232cdd221771294dfbb) (let __tconst7WUC15 const7902699be42c8a8e46fbbb45)) (once) (body) (head (emit edge (0 1 2) __tconst9K8f13 __tconst8AKK6 __tconst0chl7) (emit edge (0 1 2) __tconst8AKK6 __tconst8W3q9 __tconst0chl7) (emit edge (0 1 2) __tconst8W3q9 __tconst1S5h8 __tconst0chl7) (emit edge (0 1 2) __tconst4Xdp12 __tconst7WUC15 __tconst9K8f13) (emit edge (0 1 2) __tconst7WUC15 __tconst7Ihx14 __tconst9K8f13)) labels.slog:4 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      ++_fires;
      slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c5, v_c0, v_c1}, std::array<u16,3>{0, 1, 2});
      ...
      slog::emit<3>(head_rel[3], head_index[3], newbatch[3], std::array<u64,3>{v_c4, v_c7, v_c5}, std::array<u16,3>{0, 1, 2});
      slog::emit<3>(head_rel[4], head_index[4], newbatch[4], std::array<u64,3>{v_c7, v_c6, v_c5}, std::array<u16,3>{0, 1, 2});
      ...
      if (_fires) db->bumpFires("labels.slog:4", "once", _fires);
