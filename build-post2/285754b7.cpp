...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("285754b7");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan f1 X) (body (let __t5KnD27 (ceil X))) (head (emit fceil (0 1) X __t5KnD27)) prim_float.slog:52 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("fceil");
      std::vector<u16> ord1({0, 1});
      slog::Relation* readrel2 = db->getRelation("fceil");
      head_index[0] = readrel2->getIndex(ord1, false);
      outer_rel = db->getRelation("f1");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c1 = _prim_ceil(db, v_c0);
        if (v_c1 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:52"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("prim_float.slog:52", "all:f1", _fires);
  ...
  // (crule (pre (let __tconst1zmS11 constd2cbad71ff333de67d07ec67)) (scan n X) (body (let __t38KZ10 (tofloat X)) (let __t0gHW12 (_0002b __t38KZ10 __tconst1zmS11))) (head (emit nplus (0) __t0gHW12)) prim_float.slog:58 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("nplus");
      std::vector<u16> ord4({0});
      slog::Relation* readrel5 = db->getRelation("nplus");
    ...
    virtual bool work()
    {
      u64 v_c2 = v_constd2cbad71ff333de67d07ec67;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c3 = _prim_tofloat(db, v_c0);
        if (v_c3 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:58"); return; }
        u64 v_c4 = _prim__0002b(db, v_c3, v_c2);
        if (v_c4 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:58"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("prim_float.slog:58", "all:n", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre8T1887 __errf9fh388 __errf2g7h89) (body) (head (emit error (0) __erre8T1887)) <internal>:1 #f)
  ...
  // (crule (pre) (scan n X) (body (let __t1YJx26 (tofloat X))) (head (emit tf (0 1) X __t1YJx26)) prim_float.slog:57 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("tf");
      std::vector<u16> ord10({0, 1});
      slog::Relation* readrel11 = db->getRelation("tf");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c8 = _prim_tofloat(db, v_c0);
        if (v_c8 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:57"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("prim_float.slog:57", "all:n", _fires);
  ...
  // (crule (pre) (scan f1 X) (body (let __t7msk3 (floor X))) (head (emit ffloor (0 1) X __t7msk3)) prim_float.slog:51 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("ffloor");
      std::vector<u16> ord13({0, 1});
      slog::Relation* readrel14 = db->getRelation("ffloor");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c9 = _prim_floor(db, v_c0);
        if (v_c9 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:51"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("prim_float.slog:51", "all:f1", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre0ejL63 __errf8syM64 __errf38ab65) (body) (head (emit error (0) __erre0ejL63)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre6pe674 __errf3LcT75 __errf6WqO76) (body) (head (emit error (0) __erre6pe674)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre87AM82 __errf4cHT83 __errf6twj84 __errf6b6q85 __errf8pSL86) (body) (head (emit error (0) __erre87AM82)) <internal>:1 #f)
  ...
  // (crule (pre) (scan f2 A B) (body (let __t9tfc25 (pow A B))) (head (emit fpow (0 1 2) A B __t9tfc25)) prim_float.slog:47 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fpow");
      std::vector<u16> ord25({0, 1, 2});
      slog::Relation* readrel26 = db->getRelation("fpow");
      head_index[0] = readrel26->getIndex(ord25, false);
      outer_rel = db->getRelation("f2");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c21 = _t[0];
        u64 v_c22 = _t[1];
        u64 v_c23 = _prim_pow(db, v_c21, v_c22);
        if (v_c23 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:47"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c21, v_c22, v_c23}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:47", "all:f2", _fires);
  ...
  // (crule (pre) (scan f1 X) (body (let __t5oKG13 (sqrt X))) (head (emit fsqrt (0 1) X __t5oKG13)) prim_float.slog:50 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fsqrt");
      std::vector<u16> ord28({0, 1});
      slog::Relation* readrel29 = db->getRelation("fsqrt");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c24 = _prim_sqrt(db, v_c0);
        if (v_c24 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:50"); return; }
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c0, v_c24}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:50", "all:f1", _fires);
  ...
  // (crule (pre) (scan f1 X) (body (let __t3rvQ4 (round X))) (head (emit fround (0 1) X __t3rvQ4)) prim_float.slog:53 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fround");
      std::vector<u16> ord31({0, 1});
      slog::Relation* readrel32 = db->getRelation("fround");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c25 = _prim_round(db, v_c0);
        if (v_c25 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:53"); return; }
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c0, v_c25}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:53", "all:f1", _fires);
  ...
  // (crule (pre) (scan f2 A B) (body (let __t6bak14 (_0002d A B))) (head (emit fsub (0 1 2) A B __t6bak14)) prim_float.slog:41 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fsub");
      std::vector<u16> ord34({0, 1, 2});
      slog::Relation* readrel35 = db->getRelation("fsub");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c21 = _t[0];
        u64 v_c22 = _t[1];
        u64 v_c26 = _prim__0002d(db, v_c21, v_c22);
        if (v_c26 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:41"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c21, v_c22, v_c26}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:41", "all:f2", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre1sBZ77 __errf9UZj78 __errf22MG79 __errf5WhL80 __errf8ak581) (body) (head (emit error (0) __erre1sBZ77)) <internal>:1 #f)
  ...
  // (crule (pre) (scan f2 A B) (body (let __t9oJz1 (max A B))) (head (emit fmax (0 1 2) A B __t9oJz1)) prim_float.slog:46 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fmax");
      std::vector<u16> ord40({0, 1, 2});
      slog::Relation* readrel41 = db->getRelation("fmax");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c21 = _t[0];
        u64 v_c22 = _t[1];
        u64 v_c32 = _prim_max(db, v_c21, v_c22);
        if (v_c32 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:46"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c21, v_c22, v_c32}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:46", "all:f2", _fires);
  ...
  // (crule (pre) (scan f2 A B) (body (let __t2mn85 (_0002b A B))) (head (emit fadd (0 1 2) A B __t2mn85)) prim_float.slog:40 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fadd");
      std::vector<u16> ord43({0, 1, 2});
      slog::Relation* readrel44 = db->getRelation("fadd");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c21 = _t[0];
        u64 v_c22 = _t[1];
        u64 v_c33 = _prim__0002b(db, v_c21, v_c22);
        if (v_c33 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:40"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c21, v_c22, v_c33}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:40", "all:f2", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre6yTM60 __errf7zzi61 __errf2ZHh62) (body) (head (emit error (0) __erre6yTM60)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre4u7A70 __errf17Eg71 __errf4HAD72 __errf03Pf73) (body) (head (emit error (0) __erre4u7A70)) <internal>:1 #f)
  ...
  // (crule (pre) (scan f2 A B) (body (let __t47W17 (_0002d B A)) (let __t2ppM8 (abs __t47W17))) (head (emit fabsd (0 1 2) A B __t2ppM8)) prim_float.slog:48 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fabsd");
      std::vector<u16> ord52({0, 1, 2});
      slog::Relation* readrel53 = db->getRelation("fabsd");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c21 = _t[0];
        u64 v_c22 = _t[1];
        u64 v_c41 = _prim__0002d(db, v_c22, v_c21);
        if (v_c41 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:48"); return; }
        u64 v_c42 = _prim_abs(db, v_c41);
        if (v_c42 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:48"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c21, v_c22, v_c42}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:48", "all:f2", _fires);
  ...
  // (crule (pre) (scan f1 X) (body (let __t3xWP6 (neg X))) (head (emit fneg (0 1) X __t3xWP6)) prim_float.slog:54 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fneg");
      std::vector<u16> ord55({0, 1});
      slog::Relation* readrel56 = db->getRelation("fneg");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c43 = _prim_neg(db, v_c0);
        if (v_c43 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:54"); return; }
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c0, v_c43}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:54", "all:f1", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre6H6V66 __errf5PgJ67 __errf1b1D68 __errf0CI969) (body) (head (emit error (0) __erre6H6V66)) <internal>:1 #f)
  ...
  // (crule (pre) (scan f2 A B) (body (let __t3AjP2 (_00025 A B))) (head (emit fmod2 (0 1 2) A B __t3AjP2)) prim_float.slog:44 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fmod2");
      std::vector<u16> ord61({0, 1, 2});
      slog::Relation* readrel62 = db->getRelation("fmod2");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c21 = _t[0];
        u64 v_c22 = _t[1];
        u64 v_c48 = _prim__00025(db, v_c21, v_c22);
        if (v_c48 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:44"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c21, v_c22, v_c48}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:44", "all:f2", _fires);
  ...
  // (crule (pre) (scan f2 A B) (body (let __t1Ctr24 (_0002a A B))) (head (emit fmul (0 1 2) A B __t1Ctr24)) prim_float.slog:42 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fmul");
      std::vector<u16> ord64({0, 1, 2});
      slog::Relation* readrel65 = db->getRelation("fmul");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c21 = _t[0];
        u64 v_c22 = _t[1];
        u64 v_c49 = _prim__0002a(db, v_c21, v_c22);
        if (v_c49 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:42"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c21, v_c22, v_c49}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:42", "all:f2", _fires);
  ...
  // (crule (pre) (scan f2 A B) (body (let __t89uZ29 (min A B))) (head (emit fmin (0 1 2) A B __t89uZ29)) prim_float.slog:45 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fmin");
      std::vector<u16> ord67({0, 1, 2});
      slog::Relation* readrel68 = db->getRelation("fmin");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c21 = _t[0];
        u64 v_c22 = _t[1];
        u64 v_c50 = _prim_min(db, v_c21, v_c22);
        if (v_c50 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:45"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c21, v_c22, v_c50}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:45", "all:f2", _fires);
  ...
  // (crule (pre) (scan f2 A B) (body (let __t2VuX9 (_0002f A B))) (head (emit fdiv (0 1 2) A B __t2VuX9)) prim_float.slog:43 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fdiv");
      std::vector<u16> ord70({0, 1, 2});
      slog::Relation* readrel71 = db->getRelation("fdiv");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c21 = _t[0];
        u64 v_c22 = _t[1];
        u64 v_c51 = _prim__0002f(db, v_c21, v_c22);
        if (v_c51 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:43"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c21, v_c22, v_c51}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:43", "all:f2", _fires);
  ...
  // (crule (pre) (scan f1 X) (body (let __t1mM528 (toint X))) (head (emit ti (0 1) X __t1mM528)) prim_float.slog:56 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("ti");
      std::vector<u16> ord73({0, 1});
      slog::Relation* readrel74 = db->getRelation("ti");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c52 = _prim_toint(db, v_c0);
        if (v_c52 == slog_error) { slog::emit_pending_error(db, "prim_float.slog:56"); return; }
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c0, v_c52}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim_float.slog:56", "all:f1", _fires);
    ...
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_read, new ReadTask72(db,b), true);
  ...
  s->addDynamicRel("fabsd");
  s->addDynamicRel("fadd");
  s->addDynamicRel("fceil");
  s->addDynamicRel("fdiv");
  s->addDynamicRel("ffloor");
  s->addDynamicRel("fmax");
  s->addDynamicRel("fmin");
  s->addDynamicRel("fmod2");
  s->addDynamicRel("fmul");
  s->addDynamicRel("fneg");
  s->addDynamicRel("fpow");
  s->addDynamicRel("fround");
  s->addDynamicRel("fsqrt");
  s->addDynamicRel("fsub");
  s->addDynamicRel("int_overflow");
  s->addDynamicRel("modulo_by_zero");
  s->addDynamicRel("mpz_overflow");
  s->addDynamicRel("mpz_table_overflow");
  s->addDynamicRel("nan_result");
  s->addDynamicRel("nplus");
  s->addDynamicRel("tf");
  s->addDynamicRel("ti");
