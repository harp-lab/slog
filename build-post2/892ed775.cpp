...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("892ed775");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst1CKp2 const6b86b273ff34fce19d6b804e) (let __tconst4O654 constd4735e3a265e16eee03f5971) (let __tconst4GcJ6 const4e07408562bedb8b60ce05c1) (let __tconst7xCi7 constef2d127de37b942baad06145) (let __tconst7QeO8 const4b227777d4dd1fc61c6f884f)) (once) (body) (head (emit edge (0 1) __tconst1CKp2 __tconst4O654) (emit edge (0 1) __tconst4O654 __tconst4GcJ6) (emit edge (0 1) __tconst4GcJ6 __tconst7QeO8) (emit edge (0 1) __tconst7QeO8 __tconst7xCi7)) stat_chain.slog:11 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("stat_chain.slog:11", "once", _fires);
