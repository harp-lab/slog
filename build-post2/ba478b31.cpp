...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("ba478b31");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst3ewW2 const6b86b273ff34fce19d6b804e) (let __tconst5E5k4 constd4735e3a265e16eee03f5971) (let __tconst2Puf5 const4b227777d4dd1fc61c6f884f) (let __tconst2Q6l6 const4e07408562bedb8b60ce05c1)) (once) (body) (head (emit edge (0 1) __tconst3ewW2 __tconst5E5k4) (emit edge (0 1) __tconst5E5k4 __tconst2Q6l6) (emit edge (0 1) __tconst2Q6l6 __tconst2Puf5)) reach.slog:4 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("reach.slog:4", "once", _fires);
