...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("263dcbca");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst8qdd4 const4b227777d4dd1fc61c6f884f)) (probe split (1 0) 1 __tconst8qdd4 __t6Cqk5) (body (join split_ans (0 1 2) 1 __t6Cqk5 a b)) (head (emit pairs (0 1 2) __tconst8qdd4 a b)) dem_multi.slog:13 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel3 = db->getRelation("pairs");
      head_index[0] = readrel3->getIndex(ord2, false);
      std::vector<u16> ord4({1, 0});
      slog::Relation* readrel5 = db->getRelation("split");
      driver_index = readrel5->getIndex(ord4, true);
      std::vector<u16> ord6({0, 1, 2});
      slog::Relation* readrel7 = db->getRelation("split_ans");
      split_ansindex0 = readrel7->getIndex(ord6, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m8) {
        ...
        slog::join_probe<3,1>(split_ansindex0, std::array<u64,3>{v_c1, 0, 0}, [&](const std::array<u64,3>& m9) {
      ...
      if (_fires) db->bumpFires("dem_multi.slog:13", "all:split", _fires);
