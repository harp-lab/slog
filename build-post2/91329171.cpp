...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("91329171");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst4Jc315 const19581e27de7ced00ff1ce50b) (let __tconst3jtw14 const4b227777d4dd1fc61c6f884f)) (once) (body) (head (emit n (0) __tconst4Jc315) (emit n (0) __tconst3jtw14)) dem_value.slog:14 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_value.slog:14", "once", _fires);
