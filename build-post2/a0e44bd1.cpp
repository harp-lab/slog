...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("a0e44bd1");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp8gLd705");
  if (r == 0) db->addTempRelation("temp8gLd705", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp2ROZ706");
  if (r == 0) db->addTempRelation("temp2ROZ706", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp2GjS707");
  if (r == 0) db->addTempRelation("temp2GjS707", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  ...
  // (crule (pre) (scan temp2GjS707 __t2LjF22 __t5lM423) (body) (head (emit lst_append_ans (0 1) __t5lM423 __t2LjF22)) list.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel2 = db->getRelation("lst_append_ans");
      head_index[0] = readrel2->getIndex(ord1, false);
      outer_rel = db->getRelation("temp2GjS707");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("list.slog:11", "delta:temp2GjS707", _fires);
  ...
  // (crule (pre) (scan lst_append __t5lM423 a b) (body (let __t2LjF22 (lcat a b))) (head (emit-temp temp2GjS707 __t2LjF22 __t5lM423)) list.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp2GjS707");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c2 = _t[1];
        u64 v_c3 = _t[2];
        u64 v_c0 = _prim_lcat(db, v_c2, v_c3);
        if (v_c0 == slog_error) { slog::emit_pending_error(db, "list.slog:11"); return; }
        ++_fires;
  ...
  // (crule (pre) (scan type_mismatch __erre1QZx692 __errf0XK5693 __errf8QgZ694 __errf18Z6695 __errf7jpG696) (body) (head (emit error (0) __erre1QZx692)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp2ROZ706 __t7Rrw28 __t8Vp327) (body) (head (emit lst_ref_ans (0 1) __t7Rrw28 __t8Vp327)) list.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel9 = db->getRelation("lst_ref_ans");
      head_index[0] = readrel9->getIndex(ord8, false);
      outer_rel = db->getRelation("temp2ROZ706");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("list.slog:16", "delta:temp2ROZ706", _fires);
  ...
  // (crule (pre) (scan lst_ref __t7Rrw28 l n) (body (letp __t8Vp327 (lref l n))) (head (emit-temp temp2ROZ706 __t7Rrw28 __t8Vp327)) list.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp2ROZ706");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c12 = _t[2];
        bool ok11 = true;
        u64 v_c10 = _prim_lref(db, v_c11, v_c12, &ok11);
        if (!ok11) return;
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c9, v_c10});
      });
  ...
  // (crule (pre) (scan div_by_zero __erre6vN5675 __errf0jmW676 __errf5erm677) (body) (head (emit error (0) __erre6vN5675)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp8gLd705 __t1zTl42 __t42ru41) (body) (head (emit lst_take_ans (0 1) __t1zTl42 __t42ru41)) list.slog:29 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel17 = db->getRelation("lst_take_ans");
      head_index[0] = readrel17->getIndex(ord16, false);
      outer_rel = db->getRelation("temp8gLd705");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("list.slog:29", "delta:temp8gLd705", _fires);
  ...
  // (crule (pre (let __tconst11ql116 const5feceb66ffc86f38d952786c) (let __tconst6WHq113 const6b86b273ff34fce19d6b804e)) (scan lst_member __t6Qn2114 l y) (body (let __t8B3T115 (lmem l y)) (cmp lt __tconst11ql116 __t8B3T115)) (head (emit lst_member_ans (0 1) __t6Qn2114 __tconst6WHq113)) list.slog:20 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel20 = db->getRelation("lst_member_ans");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c11 = _t[1];
        u64 v_c21 = _t[2];
        u64 v_c22 = _prim_lmem(db, v_c11, v_c21);
        if (v_c22 == slog_error) { slog::emit_pending_error(db, "list.slog:20"); return; }
        u64 v_c23 = _prim_lt(db, v_c18, v_c22);
        if (v_c23 == slog_error) { slog::emit_pending_error(db, "list.slog:20"); return; }
        if (!v_c23) return;
        ++_fires;
  ...
  // (crule (pre) (scan int_overflow __erre7ojn681 __errf9BGq682 __errf4NB1683 __errf9nEx684) (body) (head (emit error (0) __erre7ojn681)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre1PkO702 __errf690b703 __errf7ZNA704) (body) (head (emit error (0) __erre1PkO702)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre18k7685 __errf9yLg686 __errf7qVI687 __errf14sP688) (body) (head (emit error (0) __erre18k7685)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst5TBO40 const5feceb66ffc86f38d952786c)) (scan lst_take __t1zTl42 l n) (body (let __t42ru41 (lslice l __tconst5TBO40 n))) (head (emit-temp temp8gLd705 __t1zTl42 __t42ru41)) list.slog:29 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp8gLd705");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c11 = _t[1];
        u64 v_c12 = _t[2];
        u64 v_c17 = _prim_lslice(db, v_c11, v_c35, v_c12);
        if (v_c17 == slog_error) { slog::emit_pending_error(db, "list.slog:29"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c16, v_c17});
      });
  ...
  // (crule (pre) (scan toint_range __erre2cAS689 __errf3urP690 __errf036p691) (body) (head (emit error (0) __erre2cAS689)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst1SmI112 const6b86b273ff34fce19d6b804e)) (scan lst_absent __t2ycU110 l y) (body (let __t8Q0u111 (lmem l y)) (cmp lt __t8Q0u111 __tconst1SmI112)) (head (emit lst_absent_ans (0 1) __t2ycU110 __tconst1SmI112)) list.slog:33 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c11 = _t[1];
        u64 v_c21 = _t[2];
        u64 v_c41 = _prim_lmem(db, v_c11, v_c21);
  ...
  // (crule (pre) (scan mpz_overflow __erre7w19697 __errf5Mdn698 __errf1891699 __errf8YXs700 __errf2VC1701) (body) (head (emit error (0) __erre7w19697)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre8EiN678 __errf4ndi679 __errf02ML680) (body) (head (emit error (0) __erre8EiN678)) <internal>:1 #f)
  ...
  s->addReadRel("temp2GjS707");
  s->addReadRel("temp2ROZ706");
  s->addReadRel("temp8gLd705");
  ...
  s->addDynamicRel("temp2GjS707");
  s->addDynamicRel("temp2ROZ706");
  s->addDynamicRel("temp8gLd705");
