...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("0066dc28");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp6A10126");
  if (r == 0) db->addTempRelation("temp6A10126", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp4Qth124");
  if (r == 0) db->addTempRelation("temp4Qth124", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp4N1H121");
  if (r == 0) db->addTempRelation("temp4N1H121", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp4G71123");
  if (r == 0) db->addTempRelation("temp4G71123", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp3P6W125");
  if (r == 0) db->addTempRelation("temp3P6W125", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp2daV122");
  if (r == 0) db->addTempRelation("temp2daV122", 2);
  ...
  // (crule (pre) (scan modulo_by_zero __erre8crQ94 __errf2BcK95 __errf28im96) (body) (head (emit error (0) __erre8crQ94)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst9ZTK10 constef2d127de37b942baad06145) (let __tconst13Bf11 const4b227777d4dd1fc61c6f884f)) (scan temp4Qth124 __t6wEP8) (body (let __t1f8L19 (lpush __t6wEP8 __tconst13Bf11))) (head (emit-temp temp3P6W125 __t1f8L19)) seq_split.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp3P6W125");
      outer_rel = db->getRelation("temp4Qth124");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c5 = _t[0];
        u64 v_c6 = _prim_lpush(db, v_c5, v_c4);
        if (v_c6 == slog_error) { slog::emit_pending_error(db, "seq_split.slog:11"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("seq_split.slog:11", "delta:temp4Qth124", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre6aub113 __errf8tR5114 __errf2ffQ115 __errf5gW9116 __errf2tUo117) (body) (head (emit error (0) __erre6aub113)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre3Kel118 __errf4eN8119 __errf93SW120) (body) (head (emit error (0) __erre3Kel118)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre68sb91 __errf8pfR92 __errf3UaH93) (body) (head (emit error (0) __erre68sb91)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst9ZTK10 constef2d127de37b942baad06145)) (scan temp3P6W125 __t1f8L19) (body (let __t1H4920 (lpush __t1f8L19 __tconst9ZTK10))) (head (emit-temp temp6A10126 __t1H4920) (emit doc (0) __t1f8L19)) seq_split.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp6A10126");
      head_rel[1] = db->getRelation("doc");
      std::vector<u16> ord14({0});
      slog::Relation* readrel15 = db->getRelation("doc");
      head_index[1] = readrel15->getIndex(ord14, false);
      outer_rel = db->getRelation("temp3P6W125");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c6 = _t[0];
        u64 v_c18 = _prim_lpush(db, v_c6, v_c3);
        if (v_c18 == slog_error) { slog::emit_pending_error(db, "seq_split.slog:11"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("seq_split.slog:11", "delta:temp3P6W125", _fires);
  ...
  // (crule (pre (let __tconst9ZTK10 constef2d127de37b942baad06145) (let __tconst13Bf11 const4b227777d4dd1fc61c6f884f) (let __tconst4f6z12 const4e07408562bedb8b60ce05c1) (let __tconst3T0513 constd4735e3a265e16eee03f5971)) (scan temp2daV122 __t1dJd23 __t2tma6) (body (let __t0TQ817 (lpush __t2tma6 __tconst3T0513))) (head (emit-temp temp4G71123 __t0TQ817) (emit doc (0) __t1dJd23)) seq_split.slog:11 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      u64 v_c20 = v_constd4735e3a265e16eee03f5971;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c21 = _t[0];
        u64 v_c22 = _t[1];
        u64 v_c23 = _prim_lpush(db, v_c22, v_c20);
        if (v_c23 == slog_error) { slog::emit_pending_error(db, "seq_split.slog:11"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("seq_split.slog:11", "delta:temp2daV122", _fires);
  ...
  // (crule (pre (let __tconst9ZTK10 constef2d127de37b942baad06145) (let __tconst13Bf11 const4b227777d4dd1fc61c6f884f) (let __tconst4f6z12 const4e07408562bedb8b60ce05c1) (let __tconst3T0513 constd4735e3a265e16eee03f5971) (let __tconst5Djq14 const6b86b273ff34fce19d6b804e) (let __tconst2RCB21 const5feceb66ffc86f38d952786c)) (scan temp4N1H121 __t704g24) (body (let __t2tma6 (lpush __t704g24 __tconst5Djq14)) (let __t1dJd23 (lpush __t704g24 __tconst2RCB21))) (head (emit-temp temp2daV122 __t1dJd23 __t2tma6) (emit doc (0) __t704g24)) seq_split.slog:11 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c26 = _t[0];
        u64 v_c22 = _prim_lpush(db, v_c26, v_c24);
        if (v_c22 == slog_error) { slog::emit_pending_error(db, "seq_split.slog:11"); return; }
        u64 v_c21 = _prim_lpush(db, v_c26, v_c25);
        if (v_c21 == slog_error) { slog::emit_pending_error(db, "seq_split.slog:11"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("seq_split.slog:11", "delta:temp4N1H121", _fires);
  ...
  // (crule (pre) (scan nan_result __erre3MLT101 __errf0RMW102 __errf8pOz103 __errf828d104) (body) (head (emit error (0) __erre3MLT101)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst9ZTK10 constef2d127de37b942baad06145) (let __tconst13Bf11 const4b227777d4dd1fc61c6f884f) (let __tconst4f6z12 const4e07408562bedb8b60ce05c1) (let __tconst3T0513 constd4735e3a265e16eee03f5971) (let __tconst5Djq14 const6b86b273ff34fce19d6b804e) (let __tconst2RCB21 const5feceb66ffc86f38d952786c) (let __t704g24 (lempty))) (once) (body) (head (emit-temp temp4N1H121 __t704g24)) seq_split.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp4N1H121");
    ...
    virtual bool work()
    {
      ...
      if (v_c26 == slog_error) { slog::emit_pending_error(db, "seq_split.slog:11"); return true; }
      ...
      if (_fires) db->bumpFires("seq_split.slog:11", "once", _fires);
  ...
  // (crule (pre) (scan temp6A10126 __t1H4920) (body) (head (emit doc (0) __t1H4920)) seq_split.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel28 = db->getRelation("doc");
      head_index[0] = readrel28->getIndex(ord27, false);
      outer_rel = db->getRelation("temp6A10126");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("seq_split.slog:11", "delta:temp6A10126", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre2ync108 __errf4ngW109 __errf9OE1110 __errf8Yfv111 __errf9MiY112) (body) (head (emit error (0) __erre2ync108)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst9ZTK10 constef2d127de37b942baad06145) (let __tconst13Bf11 const4b227777d4dd1fc61c6f884f) (let __tconst4f6z12 const4e07408562bedb8b60ce05c1)) (scan temp4G71123 __t0TQ817) (body (let __t6wEP8 (lpush __t0TQ817 __tconst4f6z12))) (head (emit-temp temp4Qth124 __t6wEP8)) seq_split.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp4Qth124");
      outer_rel = db->getRelation("temp4G71123");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c23 = _t[0];
        u64 v_c5 = _prim_lpush(db, v_c23, v_c19);
        if (v_c5 == slog_error) { slog::emit_pending_error(db, "seq_split.slog:11"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("seq_split.slog:11", "delta:temp4G71123", _fires);
  ...
  // (crule (pre) (scan toint_range __erre04dg105 __errf9G9N106 __errf7OWE107) (body) (head (emit error (0) __erre04dg105)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre5pn597 __errf6Dlt98 __errf6fdJ99 __errf8OpV100) (body) (head (emit error (0) __erre5pn597)) <internal>:1 #f)
  ...
  s->addReadRel("temp2daV122");
  s->addReadRel("temp3P6W125");
  s->addReadRel("temp4G71123");
  s->addReadRel("temp4N1H121");
  s->addReadRel("temp4Qth124");
  s->addReadRel("temp6A10126");
  ...
  s->addDynamicRel("temp2daV122");
  s->addDynamicRel("temp3P6W125");
  s->addDynamicRel("temp4G71123");
  s->addDynamicRel("temp4N1H121");
  s->addDynamicRel("temp4Qth124");
  s->addDynamicRel("temp6A10126");
