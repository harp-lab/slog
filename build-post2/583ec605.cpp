...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("583ec605");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan wrap t) (body) (head (emit seen (0) t)) stage_derived.slog:17 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("seen");
      std::vector<u16> ord1({0});
      slog::Relation* readrel2 = db->getRelation("seen");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("stage_derived.slog:17", "all:wrap", _fires);
