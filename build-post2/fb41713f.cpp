...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("fb41713f");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst6plU15 const990c23868b965814b117cf9a)) (once) (body) (head (mkstruct _enum (1 0) __7aWS16 __tconst6plU15)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst9ZMT13 const9f3becba6e4b1583b3e19441)) (once) (body) (head (mkstruct _enum (1 0) __5Wk514 __tconst9ZMT13)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c1 = v_const9f3becba6e4b1583b3e19441;
