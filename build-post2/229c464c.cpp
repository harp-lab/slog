...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("229c464c");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp51wk69");
  if (r == 0) db->addTempRelation("temp51wk69", 3);
  ...
  // (crule (pre) (scan modulo_by_zero __erre6Rk042 __errf7Xiv43 __errf2ob544) (body) (head (emit error (0) __erre6Rk042)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre9BVe66 __errf9RFO67 __errf0p6F68) (body) (head (emit error (0) __erre9BVe66)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp51wk69 X Z __t1L9f1) (body) (head (emit-lat dist X Z __t1L9f1)) lat_run_base.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      outer_rel = db->getRelation("temp51wk69");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c8 = _t[2];
        ++_fires;
        slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c6, v_c7, v_c8});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lat_run_base.slog:11", "delta:temp51wk69", _fires);
  ...
  // (crule (pre) (scan edge X Y W) (body) (head (emit-lat dist X Y W)) lat_run_base.slog:10 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c10 = _t[2];
        ++_fires;
        slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c6, v_c9, v_c10});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lat_run_base.slog:10", "all:edge", _fires);
  ...
  // (crule (pre) (scan toint_range __erre2GkH53 __errf871w54 __errf0Wl055) (body) (head (emit error (0) __erre2GkH53)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre6UqP61 __errf8lm462 __errf7reo63 __errf8iM264 __errf7lIM65) (body) (head (emit error (0) __erre6UqP61)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre9QNC45 __errf0QAh46 __errf030M47 __errf9WtB48) (body) (head (emit error (0) __erre9QNC45)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre2gz039 __errf1bMz40 __errf1DZz41) (body) (head (emit error (0) __erre2gz039)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre7Xp856 __errf3FA557 __errf7Hbg58 __errf0zRg59 __errf3fus60) (body) (head (emit error (0) __erre7Xp856)) <internal>:1 #f)
  ...
  // (crule (pre) (scan dist X Y D) (body (join edge (0 1 2) 1 Y Z W) (let __t1L9f1 (_0002b D W))) (head (emit-temp temp51wk69 X Z __t1L9f1)) lat_run_base.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp51wk69");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c9 = _t[1];
        u64 v_c31 = _t[2];
        slog::join_probe<3,1>(edgeindex23, std::array<u64,3>{v_c9, 0, 0}, [&](const std::array<u64,3>& m27) {
          u64 v_c7 = m27[1]; u64 v_c10 = m27[2];
          u64 v_c8 = _prim__0002b(db, v_c31, v_c10);
          if (v_c8 == slog_error) { slog::emit_pending_error(db, "lat_run_base.slog:11"); return; }
          ++_fires;
          slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c6, v_c7, v_c8});
        });
      });
      ...
      if (_fires) db->bumpFires("lat_run_base.slog:11", "delta:dist", _fires);
  ...
  // (crule (pre) (scan nan_result __erre7wxL49 __errf05xT50 __errf3YCG51 __errf8D4W52) (body) (head (emit error (0) __erre7wxL49)) <internal>:1 #f)
