...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("a89fae58");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp0fF994");
  if (r == 0) db->addTempRelation("temp0fF994", 2);
  ...
  // (crule (pre) (scan div_by_zero __erre5dvS64 __errf0qz365 __errf6Et066) (body) (head (emit error (0) __erre5dvS64)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre9Kq878 __errf7u3h79 __errf5dDV80) (body) (head (emit error (0) __erre9Kq878)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre9Ow674 __errf6blx75 __errf638176 __errf9V1277) (body) (head (emit error (0) __erre9Ow674)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst0FbT33 const7902699be42c8a8e46fbbb45) (let __tconst3G9n31 const6b86b273ff34fce19d6b804e)) (scan grow n s) (body (cmp lt n __tconst0FbT33) (let __t0vby32 (_0002b n __tconst3G9n31)) (let __t25HB30 (_0002b s s))) (head (emit-temp temp0fF994 __t0vby32 __t25HB30)) str_rope.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp0fF994");
    ...
    virtual bool work()
    {
      u64 v_c10 = v_const7902699be42c8a8e46fbbb45;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c12 = _t[0];
        u64 v_c13 = _t[1];
        u64 v_c14 = _prim_lt(db, v_c12, v_c10);
        if (v_c14 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:14"); return; }
        if (!v_c14) return;
        u64 v_c15 = _prim__0002b(db, v_c12, v_c11);
        if (v_c15 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:14"); return; }
        u64 v_c16 = _prim__0002b(db, v_c13, v_c13);
        if (v_c16 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:14"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c15, v_c16});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("str_rope.slog:14", "delta:grow", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre3jWk91 __errf84ZQ92 __errf1aUb93) (body) (head (emit error (0) __erre3jWk91)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst0ru18 const5feceb66ffc86f38d952786c) (let __tconst3PAK7 const351d6dab4ca246706f225aa3)) (once) (body) (head (emit grow (0 1) __tconst0ru18 __tconst3PAK7)) str_rope.slog:13 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      u64 v_c21 = v_const351d6dab4ca246706f225aa3;
      ...
      ++_fires;
      slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c20, v_c21}, std::array<u16,2>{0, 1});
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("str_rope.slog:13", "once", _fires);
  ...
  // (crule (pre) (scan temp0fF994 __t0vby32 __t25HB30) (body) (head (emit grow (0 1) __t0vby32 __t25HB30)) str_rope.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel19 = db->getRelation("grow");
      head_index[0] = readrel19->getIndex(ord18, false);
      outer_rel = db->getRelation("temp0fF994");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("str_rope.slog:14", "delta:temp0fF994", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre5UKt70 __errf6pE071 __errf4OfE72 __errf5XUI73) (body) (head (emit error (0) __erre5UKt70)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre8dCV67 __errf6Lrf68 __errf25Na69) (body) (head (emit error (0) __erre8dCV67)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre7qf881 __errf34HX82 __errf2g7383 __errf2rw984 __errf5Vax85) (body) (head (emit error (0) __erre7qf881)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre98mN86 __errf26mR87 __errf9Zld88 __errf2pQE89 __errf3Is090) (body) (head (emit error (0) __erre98mN86)) <internal>:1 #f)
