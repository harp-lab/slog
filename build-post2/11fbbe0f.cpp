...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("11fbbe0f");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst6sCd1 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit a (0) __tconst6sCd1)) strat_revorder.slog:10 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("strat_revorder.slog:10", "once", _fires);
