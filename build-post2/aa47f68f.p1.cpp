...
{
  // (crule (pre) (scan a11 X) (body) (head (emit a10 (0) X)) split_vprefix.slog:71 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("a10");
      std::vector<u16> ord1({0});
      slog::Relation* readrel2 = db->getRelation("a10");
      head_index[0] = readrel2->getIndex(ord1, false);
      outer_rel = db->getRelation("a11");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:71", "delta:a11", _fires);
  ...
  // (crule (pre) (scan a41 X) (body) (head (emit a40 (0) X)) split_vprefix.slog:101 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a40");
      std::vector<u16> ord4({0});
      slog::Relation* readrel5 = db->getRelation("a40");
      head_index[0] = readrel5->getIndex(ord4, false);
      outer_rel = db->getRelation("a41");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:101", "delta:a41", _fires);
  ...
  // (crule (pre) (scan a14 X) (body) (head (emit a13 (0) X)) split_vprefix.slog:74 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a13");
      std::vector<u16> ord7({0});
      slog::Relation* readrel8 = db->getRelation("a13");
      head_index[0] = readrel8->getIndex(ord7, false);
      outer_rel = db->getRelation("a14");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:74", "delta:a14", _fires);
  ...
  // (crule (pre) (scan a3 X) (body) (head (emit a2 (0) X)) split_vprefix.slog:63 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a2");
      std::vector<u16> ord10({0});
      slog::Relation* readrel11 = db->getRelation("a2");
      head_index[0] = readrel11->getIndex(ord10, false);
      outer_rel = db->getRelation("a3");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:63", "delta:a3", _fires);
  ...
  // (crule (pre) (scan a43 X) (body) (head (emit a42 (0) X)) split_vprefix.slog:103 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a42");
      std::vector<u16> ord13({0});
      slog::Relation* readrel14 = db->getRelation("a42");
      head_index[0] = readrel14->getIndex(ord13, false);
      outer_rel = db->getRelation("a43");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:103", "delta:a43", _fires);
  ...
  // (crule (pre) (scan a29 X) (body) (head (emit a28 (0) X)) split_vprefix.slog:89 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a28");
      std::vector<u16> ord16({0});
      slog::Relation* readrel17 = db->getRelation("a28");
      head_index[0] = readrel17->getIndex(ord16, false);
      outer_rel = db->getRelation("a29");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:89", "delta:a29", _fires);
  ...
  // (crule (pre) (scan a15 X) (body) (head (emit a14 (0) X)) split_vprefix.slog:75 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a14");
      std::vector<u16> ord19({0});
      slog::Relation* readrel20 = db->getRelation("a14");
      head_index[0] = readrel20->getIndex(ord19, false);
      outer_rel = db->getRelation("a15");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:75", "delta:a15", _fires);
  ...
  // (crule (pre) (scan a21 X) (body) (head (emit a20 (0) X)) split_vprefix.slog:81 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a20");
      std::vector<u16> ord22({0});
      slog::Relation* readrel23 = db->getRelation("a20");
      head_index[0] = readrel23->getIndex(ord22, false);
      outer_rel = db->getRelation("a21");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:81", "delta:a21", _fires);
  ...
  // (crule (pre) (scan a26 X) (body) (head (emit a25 (0) X)) split_vprefix.slog:86 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a25");
      std::vector<u16> ord25({0});
      slog::Relation* readrel26 = db->getRelation("a25");
      head_index[0] = readrel26->getIndex(ord25, false);
      outer_rel = db->getRelation("a26");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:86", "delta:a26", _fires);
  ...
  // (crule (pre) (scan a20 X) (body) (head (emit a19 (0) X)) split_vprefix.slog:80 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a19");
      std::vector<u16> ord28({0});
      slog::Relation* readrel29 = db->getRelation("a19");
      head_index[0] = readrel29->getIndex(ord28, false);
      outer_rel = db->getRelation("a20");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:80", "delta:a20", _fires);
  ...
  // (crule (pre) (scan a31 X) (body) (head (emit a30 (0) X)) split_vprefix.slog:91 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a30");
      std::vector<u16> ord31({0});
      slog::Relation* readrel32 = db->getRelation("a30");
      head_index[0] = readrel32->getIndex(ord31, false);
      outer_rel = db->getRelation("a31");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:91", "delta:a31", _fires);
  ...
  // (crule (pre) (scan a33 X) (body) (head (emit a32 (0) X)) split_vprefix.slog:93 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a32");
      std::vector<u16> ord34({0});
      slog::Relation* readrel35 = db->getRelation("a32");
      head_index[0] = readrel35->getIndex(ord34, false);
      outer_rel = db->getRelation("a33");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:93", "delta:a33", _fires);
  ...
  // (crule (pre) (scan a44 X) (body) (head (emit a43 (0) X)) split_vprefix.slog:104 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a43");
      std::vector<u16> ord37({0});
      slog::Relation* readrel38 = db->getRelation("a43");
      head_index[0] = readrel38->getIndex(ord37, false);
      outer_rel = db->getRelation("a44");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:104", "delta:a44", _fires);
  ...
  // (crule (pre) (scan a16 X) (body) (head (emit a15 (0) X)) split_vprefix.slog:76 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a15");
      std::vector<u16> ord40({0});
      slog::Relation* readrel41 = db->getRelation("a15");
      head_index[0] = readrel41->getIndex(ord40, false);
      outer_rel = db->getRelation("a16");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:76", "delta:a16", _fires);
  ...
  // (crule (pre) (scan a13 X) (body) (head (emit a12 (0) X)) split_vprefix.slog:73 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a12");
      std::vector<u16> ord43({0});
      slog::Relation* readrel44 = db->getRelation("a12");
      head_index[0] = readrel44->getIndex(ord43, false);
      outer_rel = db->getRelation("a13");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:73", "delta:a13", _fires);
  ...
  // (crule (pre) (scan a28 X) (body) (head (emit a27 (0) X)) split_vprefix.slog:88 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a27");
      std::vector<u16> ord46({0});
      slog::Relation* readrel47 = db->getRelation("a27");
      head_index[0] = readrel47->getIndex(ord46, false);
      outer_rel = db->getRelation("a28");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:88", "delta:a28", _fires);
  ...
  // (crule (pre) (scan a32 X) (body) (head (emit a31 (0) X)) split_vprefix.slog:92 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a31");
      std::vector<u16> ord49({0});
      slog::Relation* readrel50 = db->getRelation("a31");
      head_index[0] = readrel50->getIndex(ord49, false);
      outer_rel = db->getRelation("a32");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:92", "delta:a32", _fires);
  ...
  // (crule (pre) (scan a46 X) (body) (head (emit a45 (0) X)) split_vprefix.slog:106 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a45");
      std::vector<u16> ord52({0});
      slog::Relation* readrel53 = db->getRelation("a45");
      head_index[0] = readrel53->getIndex(ord52, false);
      outer_rel = db->getRelation("a46");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:106", "delta:a46", _fires);
  ...
  // (crule (pre) (scan a2 X) (body) (head (emit a1 (0) X)) split_vprefix.slog:62 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a1");
      std::vector<u16> ord55({0});
      slog::Relation* readrel56 = db->getRelation("a1");
      head_index[0] = readrel56->getIndex(ord55, false);
      outer_rel = db->getRelation("a2");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:62", "delta:a2", _fires);
  ...
  // (crule (pre) (scan a34 X) (body) (head (emit a33 (0) X)) split_vprefix.slog:94 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a33");
      std::vector<u16> ord58({0});
      slog::Relation* readrel59 = db->getRelation("a33");
      head_index[0] = readrel59->getIndex(ord58, false);
      outer_rel = db->getRelation("a34");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:94", "delta:a34", _fires);
  ...
  // (crule (pre) (scan a38 X) (body) (head (emit a37 (0) X)) split_vprefix.slog:98 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a37");
      std::vector<u16> ord61({0});
      slog::Relation* readrel62 = db->getRelation("a37");
      head_index[0] = readrel62->getIndex(ord61, false);
      outer_rel = db->getRelation("a38");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:98", "delta:a38", _fires);
  ...
  // (crule (pre) (scan a25 X) (body) (head (emit a24 (0) X)) split_vprefix.slog:85 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a24");
      std::vector<u16> ord64({0});
      slog::Relation* readrel65 = db->getRelation("a24");
      head_index[0] = readrel65->getIndex(ord64, false);
      outer_rel = db->getRelation("a25");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:85", "delta:a25", _fires);
  ...
  // (crule (pre) (scan a19 X) (body) (head (emit a18 (0) X)) split_vprefix.slog:79 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a18");
      std::vector<u16> ord67({0});
      slog::Relation* readrel68 = db->getRelation("a18");
      head_index[0] = readrel68->getIndex(ord67, false);
      outer_rel = db->getRelation("a19");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:79", "delta:a19", _fires);
  ...
  // (crule (pre) (scan a30 X) (body) (head (emit a29 (0) X)) split_vprefix.slog:90 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a29");
      std::vector<u16> ord70({0});
      slog::Relation* readrel71 = db->getRelation("a29");
      head_index[0] = readrel71->getIndex(ord70, false);
      outer_rel = db->getRelation("a30");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:90", "delta:a30", _fires);
  ...
  // (crule (pre) (scan a48 X) (body) (head (emit a47 (0) X)) split_vprefix.slog:108 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a47");
      std::vector<u16> ord73({0});
      slog::Relation* readrel74 = db->getRelation("a47");
      head_index[0] = readrel74->getIndex(ord73, false);
      outer_rel = db->getRelation("a48");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:108", "delta:a48", _fires);
