...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("612a0f2e");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp6W8n72");
  if (r == 0) db->addTempRelation("temp6W8n72", 2);
  ...
  if (r == 0) db->addRelation("peak", 2);
    ...
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("peak");
  r->setLattice(LAT_MAX, false, 0, true, float_encode(10.0), "max-float-ceiling-10.0", db->collections());
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<1>(db, db->getRelation("dbl"), std::array<u16,1>{0}, b));
  ...
  // (crule (pre) (scan modulo_by_zero __erre8Sm645 __errf5hxl46 __errf8cby47) (body) (head (emit error (0) __erre8Sm645)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre2wCH48 __errf5WM849 __errf3noU50 __errf79BZ51) (body) (head (emit error (0) __erre2wCH48)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre2CMN42 __errf7t8I43 __errf3ta244) (body) (head (emit error (0) __erre2CMN42)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp6W8n72 K __t4WSs2) (body) (head (emit-lat peak K __t4WSs2)) lat_maxfloat.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      outer_rel = db->getRelation("temp6W8n72");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("lat_maxfloat.slog:15", "delta:temp6W8n72", _fires);
  ...
  // (crule (pre) (scan score K V) (body) (head (emit-lat peak K V)) lat_maxfloat.slog:14 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c12 = _t[1];
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c10, v_c12});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lat_maxfloat.slog:14", "all:score", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre5ZAe69 __errf5yUW70 __errf1DcA71) (body) (head (emit error (0) __erre5ZAe69)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre6Lcw59 __errf4M6S60 __errf2qMe61 __errf4gKw62 __errf8Hme63) (body) (head (emit error (0) __erre6Lcw59)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre0xHt64 __errf74x065 __errf3G5c66 __errf4DzQ67 __errf78ON68) (body) (head (emit error (0) __erre0xHt64)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre7r6x52 __errf46Gm53 __errf2OiP54 __errf36Ia55) (body) (head (emit error (0) __erre7r6x52)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre4Zzc56 __errf2hEy57 __errf4MZh58) (body) (head (emit error (0) __erre4Zzc56)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst0hJc1 constd84bdb34d4eeef4034d77e54)) (scan peak K V) (body (join dbl (0) 1 K) (let __t4WSs2 (_0002a V __tconst0hJc1))) (head (emit-temp temp6W8n72 K __t4WSs2)) lat_maxfloat.slog:15 #f)
  class ReadTask27 : public slog::Task
  {
    ...
    slog::Index** dblindex26;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp6W8n72");
      outer_rel = db->getRelation("peak");
      std::vector<u16> ord28({0});
      slog::Relation* readrel29 = db->getRelation("dbl");
      dblindex26 = readrel29->getIndex(ord28, false);
  
    }
    ReadTask27(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c33 = v_constd84bdb34d4eeef4034d77e54;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c10 = _t[0];
        u64 v_c12 = _t[1];
        slog::join_probe<1,1>(dblindex26, std::array<u64,1>{v_c10}, [&](const std::array<u64,1>& m30) {
          u64 v_c11 = _prim__0002a(db, v_c12, v_c33);
          if (v_c11 == slog_error) { slog::emit_pending_error(db, "lat_maxfloat.slog:15"); return; }
          ++_fires;
          slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c10, v_c11});
        });
      });
      ...
      if (_fires) db->bumpFires("lat_maxfloat.slog:15", "delta:peak", _fires);
