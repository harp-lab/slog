...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("3a42606c");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst5L4N11 const4bc9274d8758b867e8c071a6)) (once) (body) (head (mkstruct _enum (1 0) __7ljv12 __tconst5L4N11)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst5IlK9 const7f3e916bf628c503cac5f6ba)) (once) (body) (head (mkstruct _enum (1 0) __9PzX10 __tconst5IlK9)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c1 = v_const7f3e916bf628c503cac5f6ba;
