...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("6f71d194");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst7rlT3 const4b227777d4dd1fc61c6f884f) (let __tconst6ra14 const4e07408562bedb8b60ce05c1) (let __tconst9kdq5 constd4735e3a265e16eee03f5971) (let __tconst8A3P6 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit in (0 1) __tconst8A3P6 __tconst9kdq5) (emit in (0 1) __tconst6ra14 __tconst7rlT3) (emit in (0 1) __tconst8A3P6 __tconst9kdq5)) structs.slog:5 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      head_rel[2] = db->getRelation("in");
      std::vector<u16> ord5({0, 1});
      slog::Relation* readrel6 = db->getRelation("in");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("structs.slog:5", "once", _fires);
