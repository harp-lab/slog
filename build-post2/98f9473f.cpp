...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("98f9473f");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst1qCi121 consta9a6d512c3f845483b03fd37)) (once) (body) (head (emit entry (0) __tconst1qCi121)) demo.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel2 = db->getRelation("entry");
    ...
    virtual bool work()
    {
      u64 v_c0 = v_consta9a6d512c3f845483b03fd37;
      ...
      if (_fires) db->bumpFires("demo.slog:15", "once", _fires);
  ...
  // (crule (pre (let __tconst0o6H84 consted0583037dc2e002b6af2ca9)) (once) (body) (head (emit entry (0) __tconst0o6H84)) demo.slog:28 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c1 = v_consted0583037dc2e002b6af2ca9;
      ...
      if (_fires) db->bumpFires("demo.slog:28", "once", _fires);
  ...
  // (crule (pre (let __tconst4fQX161 constab76c7d069d6f33dc950fb33)) (once) (body) (head (mkstruct _enum (1 0) __1n6R162 __tconst4fQX161)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst4fO6163 consteb8bf0d80db323992f6b634a)) (once) (body) (head (mkstruct _enum (1 0) __8tik164 __tconst4fO6163)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst3ru078 const1c39633808c54038b6212e46)) (once) (body) (head (emit entry (0) __tconst3ru078)) demo.slog:23 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel10 = db->getRelation("entry");
    ...
    virtual bool work()
    {
      u64 v_c4 = v_const1c39633808c54038b6212e46;
      ...
      if (_fires) db->bumpFires("demo.slog:23", "once", _fires);
  ...
  // (crule (pre (let __tconst5vxp157 consta221beeaebe583607e193be7)) (once) (body) (head (mkstruct _enum (1 0) __61XL158 __tconst5vxp157)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c5 = v_consta221beeaebe583607e193be7;
  ...
  // (crule (pre (let __tconst5GSa159 conste433800a79f2d3be41014577)) (once) (body) (head (mkstruct _enum (1 0) __0bSZ160 __tconst5GSa159)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c6 = v_conste433800a79f2d3be41014577;
