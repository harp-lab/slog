...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("3a3e2bed");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp8PIA74");
  if (r == 0) db->addTempRelation("temp8PIA74", 2);
  ...
  // (crule (pre) (scan type_mismatch __erre5tsI61 __errf9o3h62 __errf3HZk63 __errf3X9N64 __errf68E165) (body) (head (emit error (0) __erre5tsI61)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp8PIA74 N __t47yX7) (body (join succ (1 0) 1 N __t1Ooo4)) (head (emit tonum (0 1) __t1Ooo4 __t47yX7)) sdeep_recnest.slog:15 #f)
  class ReadTask4 : public slog::Task
  {
    ...
    slog::Index** succindex3;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("tonum");
      std::vector<u16> ord5({0, 1});
      slog::Relation* readrel6 = db->getRelation("tonum");
      head_index[0] = readrel6->getIndex(ord5, false);
      outer_rel = db->getRelation("temp8PIA74");
      std::vector<u16> ord7({1, 0});
      slog::Relation* readrel8 = db->getRelation("succ");
      succindex3 = readrel8->getIndex(ord7, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c5 = _t[0];
        u64 v_c6 = _t[1];
        slog::join_probe<2,1>(succindex3, std::array<u64,2>{v_c5, 0}, [&](const std::array<u64,2>& m9) {
          u64 v_c7 = m9[1];
          ++_fires;
      ...
      if (_fires) db->bumpFires("sdeep_recnest.slog:15", "delta:temp8PIA74", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre4D7166 __errf049O67 __errf81Wk68 __errf88np69 __errf4GqA70) (body) (head (emit error (0) __erre4D7166)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre4VdC58 __errf6thD59 __errf4LVo60) (body) (head (emit error (0) __erre4VdC58)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre9HBJ50 __errf825P51 __errf5WbO52 __errf1ez053) (body) (head (emit error (0) __erre9HBJ50)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst8IaY5 const4e07408562bedb8b60ce05c1) (let __tconst4BJ56 const6b86b273ff34fce19d6b804e)) (scan tonum N V) (body (cmp lt V __tconst8IaY5) (let __t47yX7 (_0002b V __tconst4BJ56))) (head (emit-temp temp8PIA74 N __t47yX7) (mkstruct succ (1 0) __t1Ooo4 N)) sdeep_recnest.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp8PIA74");
      head_rel[1] = db->getRelation("succ");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c5 = _t[0];
        u64 v_c22 = _t[1];
        u64 v_c23 = _prim_lt(db, v_c22, v_c20);
        if (v_c23 == slog_error) { slog::emit_pending_error(db, "sdeep_recnest.slog:15"); return; }
        if (!v_c23) return;
        u64 v_c6 = _prim__0002b(db, v_c22, v_c21);
        if (v_c6 == slog_error) { slog::emit_pending_error(db, "sdeep_recnest.slog:15"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("sdeep_recnest.slog:15", "delta:tonum", _fires);
  ...
  // (crule (pre (let __tconst2r9s11 constb7ce3f814d0e14e74eb1dc74) (let __tconst5FOe8 const5feceb66ffc86f38d952786c)) (probe _enum (1 0) 1 __tconst2r9s11 __t3ZUI9) (body) (head (emit tonum (0 1) __t3ZUI9 __tconst5FOe8)) sdeep_recnest.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel23 = db->getRelation("tonum");
    ...
    virtual bool work()
    {
      u64 v_c24 = v_constb7ce3f814d0e14e74eb1dc74;
      ...
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c24, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m26) {
        u64 v_c26 = m26[1];
      ...
      if (_fires) db->bumpFires("sdeep_recnest.slog:11", "all:_enum", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre45S171 __errf1caT72 __errf7AxC73) (body) (head (emit error (0) __erre45S171)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre2glK44 __errf2zgo45 __errf00mN46) (body) (head (emit error (0) __erre2glK44)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre4Seg54 __errf4YGb55 __errf6WE556 __errf6v0U57) (body) (head (emit error (0) __erre4Seg54)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre5kmI47 __errf72zC48 __errf9QbZ49) (body) (head (emit error (0) __erre5kmI47)) <internal>:1 #f)
  ...
  s->addDynamicRel("succ");
  s->addDynamicRel("temp8PIA74");
  s->addDynamicRel("toint_range");
  s->addDynamicRel("tonum");
