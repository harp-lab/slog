...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("a6f783ea");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<1>(db, db->getRelation("sum"), std::array<u16,1>{0}, b));
  ...
  // (crule (pre (let __tconst1Ax115 constd4735e3a265e16eee03f5971) (let __tconst9dvR16 const2bc983a5942276eb00a75e21) (let __tconst3ZJx17 const6b86b273ff34fce19d6b804e) (let __tconst6VBt18 constba2df4903a2c14e86dc3bcca) (let __t8rez19 (cmap)) (let __t3FH020 (cput __t8rez19 __tconst6VBt18 __tconst3ZJx17)) (let __t3HBh21 (cput __t3FH020 __tconst9dvR16 __tconst1Ax115))) (once) (body) (head (emit env (0) __t3HBh21)) cn_getp.slog:12 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel2 = db->getRelation("env");
    ...
    virtual bool work()
    {
      ...
      u64 v_c1 = v_const2bc983a5942276eb00a75e21;
      u64 v_c2 = v_const6b86b273ff34fce19d6b804e;
      u64 v_c3 = v_constba2df4903a2c14e86dc3bcca;
      u64 v_c4 = _prim_cmap(db);
      if (v_c4 == slog_error) { slog::emit_pending_error(db, "cn_getp.slog:12"); return true; }
      u64 v_c5 = _prim_cput(db, v_c4, v_c3, v_c2);
      if (v_c5 == slog_error) { slog::emit_pending_error(db, "cn_getp.slog:12"); return true; }
      u64 v_c6 = _prim_cput(db, v_c5, v_c1, v_c0);
      if (v_c6 == slog_error) { slog::emit_pending_error(db, "cn_getp.slog:12"); return true; }
      ...
      if (_fires) db->bumpFires("cn_getp.slog:12", "once", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre7IZk85 __errf1g5d86 __errf7vC887) (body) (head (emit error (0) __erre7IZk85)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre6Jvd68 __errf7HF569 __errf3Sxy70 __errf8hMm71) (body) (head (emit error (0) __erre6Jvd68)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre7lHE80 __errf63fp81 __errf6wJ982 __errf5w6g83 __errf7Vxf84) (body) (head (emit error (0) __erre7lHE80)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre5T9v72 __errf673h73 __errf49sz74) (body) (head (emit error (0) __erre5T9v72)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre9U9V58 __errf7fTV59 __errf2yGL60) (body) (head (emit error (0) __erre9U9V58)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre8vV561 __errf9re862 __errf7WgQ63) (body) (head (emit error (0) __erre8vV561)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre5Jfi64 __errf0qg765 __errf1kd666 __errf0Hai67) (body) (head (emit error (0) __erre5Jfi64)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre1CMZ75 __errf08Vt76 __errf9hLn77 __errf3VNR78 __errf5f4B79) (body) (head (emit error (0) __erre1CMZ75)) <internal>:1 #f)
