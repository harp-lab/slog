...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("b07dd148");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<2>(db, db->getRelation("okq_ans"), std::array<u16,2>{0, 1}, b));
  ...
  // (crule (pre (let __tconst19sF3 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit okt (0) __tconst19sF3)) dem_head_guarded.slog:20 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("okt");
      std::vector<u16> ord1({0});
      slog::Relation* readrel2 = db->getRelation("okt");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_head_guarded.slog:20", "once", _fires);
