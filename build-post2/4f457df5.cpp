...
u64 v_constb24daeeb6fab51e617ee863f;
u64 v_const5aa762ae383fbb727af3c7a3;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("4f457df5");
  if (s == nullptr) return;
  slog::Relation* r;
  v_constb24daeeb6fab51e617ee863f = db->encodeString("abcdef");
  v_const5aa762ae383fbb727af3c7a3 = db->encodeString("hello");
  ...
  r = db->getRelation("mid24");
  if (r == 0) db->addRelation("mid24", 2);
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<2>(db, db->getRelation("mid24"), std::array<u16,2>{0, 1}, b));
  r = db->getRelation("mid13");
  if (r == 0) db->addRelation("mid13", 2);
  else if (r->getArity() != 2)
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("mid13");
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<2>(db, db->getRelation("mid13"), std::array<u16,2>{0, 1}, b));
  ...
  // (crule (pre (let __tconst4dXV5 const5aa762ae383fbb727af3c7a3) (let __tconst3TNc4 constb24daeeb6fab51e617ee863f)) (once) (body) (head (emit t (0) __tconst4dXV5) (emit t (0) __tconst3TNc4)) prim2_substr.slog:9 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c0 = v_const5aa762ae383fbb727af3c7a3;
      u64 v_c1 = v_constb24daeeb6fab51e617ee863f;
      ...
      if (_fires) db->bumpFires("prim2_substr.slog:9", "once", _fires);
