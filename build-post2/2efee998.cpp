...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("2efee998");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst5Srh51 const933b575c961e931c43e84b05)) (once) (body) (head (mkstruct _enum (1 0) __51gL52 __tconst5Srh51)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c0 = v_const933b575c961e931c43e84b05;
  ...
  // (crule (pre (let __tconst9AYg53 const9ac63e4426dab2edcc97bcf7)) (once) (body) (head (mkstruct _enum (1 0) __6YtS54 __tconst9AYg53)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c1 = v_const9ac63e4426dab2edcc97bcf7;
