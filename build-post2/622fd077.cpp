...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("622fd077");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst5zFx11 constcbfeda2b1f044ccca4ea9dac)) (once) (body) (head (mkstruct _enum (1 0) __1F5n12 __tconst5zFx11)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst7ggN13 constc48b5b1a9776c84602de2306)) (once) (body) (head (mkstruct _enum (1 0) __5zP814 __tconst7ggN13)) <internal>:1 #f)
