...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("a6c5cef0");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp4UXb282");
  if (r == 0) db->addTempRelation("temp4UXb282", 2);
  ...
  // (crule (pre) (scan int_overflow __erre7v0G258 __errf7oAo259 __errf2Dny260 __errf53pF261) (body) (head (emit error (0) __erre7v0G258)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp4UXb282 __t7PV930 __t7YPN29) (body) (head (emit sq_ans (0 1) __t7PV930 __t7YPN29)) dem_value.slog:7 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("sq_ans");
      std::vector<u16> ord4({0, 1});
      slog::Relation* readrel5 = db->getRelation("sq_ans");
      head_index[0] = readrel5->getIndex(ord4, false);
      outer_rel = db->getRelation("temp4UXb282");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_value.slog:7", "delta:temp4UXb282", _fires);
  ...
  // (crule (pre) (scan nan_result __erre3ylm262 __errf8epU263 __errf0Zdi264 __errf4Uuh265) (body) (head (emit error (0) __erre3ylm262)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre1plk252 __errf5rQn253 __errf5PUA254) (body) (head (emit error (0) __erre1plk252)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre5zDo269 __errf6lEs270 __errf3nLz271 __errf6XNu272 __errf4Gdx273) (body) (head (emit error (0) __erre5zDo269)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre3zu4266 __errf24sV267 __errf4UL1268) (body) (head (emit error (0) __erre3zu4266)) <internal>:1 #f)
  ...
  // (crule (pre) (scan sq __t7PV930 n) (body (let __t7YPN29 (_0002a n n))) (head (emit-temp temp4UXb282 __t7PV930 __t7YPN29)) dem_value.slog:7 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp4UXb282");
      outer_rel = db->getRelation("sq");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c4 = _t[0];
        u64 v_c21 = _t[1];
        u64 v_c5 = _prim__0002a(db, v_c21, v_c21);
        if (v_c5 == slog_error) { slog::emit_pending_error(db, "dem_value.slog:7"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("dem_value.slog:7", "all:sq", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre1Z76279 __errf5fNS280 __errf8Nfw281) (body) (head (emit error (0) __erre1Z76279)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre2L87274 __errf5s9O275 __errf8JJm276 __errf81bx277 __errf4DPI278) (body) (head (emit error (0) __erre2L87274)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre6wuo255 __errf0xuB256 __errf8KFx257) (body) (head (emit error (0) __erre6wuo255)) <internal>:1 #f)
  ...
  s->addDynamicRel("sq_ans");
  s->addDynamicRel("temp4UXb282");
