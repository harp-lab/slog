...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("60397776");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst2Wi5268 consta221beeaebe583607e193be7) (let __tconst2lX0269 constab76c7d069d6f33dc950fb33) (let __tconst7OA9270 consteb8bf0d80db323992f6b634a) (let __tconst4zfX21 constd4735e3a265e16eee03f5971) (let __tconst8iWH19 const6b86b273ff34fce19d6b804e) (let __tconst3kCD17 const5feceb66ffc86f38d952786c)) (probe _enum (1 0) 1 __tconst2Wi5268 __t2wcI20) (body (exists _enum (1 0) 1 __tconst7OA9270) (join _enum (1 0) 1 __tconst2lX0269 __t3mH818) (join _enum (1 0) 1 __tconst7OA9270 __t4KoY16)) (head (emit smt_vcode (0 1) __tconst4zfX21 __t2wcI20) (emit smt_vcode (0 1) __tconst8iWH19 __t3mH818) (emit smt_vcode (0 1) __tconst3kCD17 __t4KoY16)) smt.slog:68 #f)
