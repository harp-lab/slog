...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("2f60c728");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst5F1v4 const4b227777d4dd1fc61c6f884f) (let __tconst7pEq3 const5feceb66ffc86f38d952786c)) (once) (body) (head (emit d (0) __tconst5F1v4) (emit d (0) __tconst7pEq3)) err_div0.slog:5 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("err_div0.slog:5", "once", _fires);
