...
u64 v_constadfa91e0d6df3c44db4040f0;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("0f7e0ce9");
  if (s == nullptr) return;
  slog::Relation* r;
  v_constadfa91e0d6df3c44db4040f0 = db->encodeString("héllo wörld €42 🎉");
  ...
  // (crule (pre (let __tconst7mFM39 constadfa91e0d6df3c44db4040f0)) (once) (body) (head (emit seed (0) __tconst7mFM39)) str_utf8.slog:14 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c0 = v_constadfa91e0d6df3c44db4040f0;
      ...
      if (_fires) db->bumpFires("str_utf8.slog:14", "once", _fires);
