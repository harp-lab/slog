...
u64 v_const86bc00bf176c8b99e9cbdd89;
u64 v_const05220501ba67007b288db75d;
u64 v_constbda584056eb9957d6c681e00;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("e373c493");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  v_const86bc00bf176c8b99e9cbdd89 = s32_encode(647);
  v_const05220501ba67007b288db75d = db->encodeString("HEAD:");
  v_constbda584056eb9957d6c681e00 = s32_encode(637);
  ...
  r = db->getRelation("temp8dHb156");
  if (r == 0) db->addTempRelation("temp8dHb156", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp5jl9155");
  if (r == 0) db->addTempRelation("temp5jl9155", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp17Hj161");
  if (r == 0) db->addTempRelation("temp17Hj161", 2);
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<1>(db, db->getRelation("agree"), std::array<u16,1>{0}, b));
  ...
  // (crule (pre) (scan mpz_table_overflow __erre0Iq4152 __errf4Opo153 __errf9dJU154) (body) (head (emit error (0) __erre0Iq4152)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre9tup147 __errf0R1j148 __errf3SpW149 __errf8YtN150 __errf57VE151) (body) (head (emit error (0) __erre9tup147)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst5BRu3 const7902699be42c8a8e46fbbb45) (let __tconst1G1j5 const5feceb66ffc86f38d952786c) (let __tconst2uQS2 constd4735e3a265e16eee03f5971)) (probe grow (0 1) 1 __tconst5BRu3 __t4kTF6) (body (let __t6fwY4 (size __t4kTF6)) (let chk1xhy157 (substr __t4kTF6 __tconst1G1j5 __t6fwY4)) (eq __t4kTF6 chk1xhy157)) (head (emit agree (0) __tconst2uQS2)) str_rope.slog:23 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("agree");
      std::vector<u16> ord7({0});
      slog::Relation* readrel8 = db->getRelation("agree");
      head_index[0] = readrel8->getIndex(ord7, false);
      std::vector<u16> ord9({0, 1});
      slog::Relation* readrel10 = db->getRelation("grow");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c8, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m11) {
        u64 v_c11 = m11[1];
        if (buckethash(v_c11) != bucket) return;
        u64 v_c12 = _prim_size(db, v_c11);
        if (v_c12 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:23"); return; }
        u64 v_c13 = _prim_substr(db, v_c11, v_c9, v_c12);
        if (v_c13 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:23"); return; }
      ...
      if (_fires) db->bumpFires("str_rope.slog:23", "all:grow", _fires);
  ...
  // (crule (pre (let __tconst7blN10 const7902699be42c8a8e46fbbb45) (let __tconst2jIM13 const12ae32cb1ec02d01eda3581b) (let __tconst9evH9 const4e07408562bedb8b60ce05c1)) (probe grow (0 1) 1 __tconst7blN10 __t8TGK12) (body (let chk0dNe158 (_0002b __tconst2jIM13 __t8TGK12)) (eq __t8TGK12 chk0dNe158) (let chk8aTX159 (_0002b __t8TGK12 __tconst2jIM13)) (eq __t8TGK12 chk8aTX159)) (head (emit agree (0) __tconst9evH9)) str_rope.slog:29 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel14 = db->getRelation("agree");
    ...
    virtual bool work()
    {
      u64 v_c14 = v_const7902699be42c8a8e46fbbb45;
      u64 v_c15 = v_const12ae32cb1ec02d01eda3581b;
      u64 v_c16 = v_const4e07408562bedb8b60ce05c1;
      ...
      slog::SliceCtx _sc{_slice_deadline, &db->runStopFlag()};
      std::array<u64,2> _rkey = resume_key; bool _hr = has_resume;
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c14, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m17) {
        u64 v_c17 = m17[1];
        if (buckethash(v_c17) != bucket) return;
        u64 v_c18 = _prim__0002b(db, v_c15, v_c17);
        if (v_c18 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:29"); return; }
        if (v_c17 != v_c18) return;
        u64 v_c19 = _prim__0002b(db, v_c17, v_c15);
        if (v_c19 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:29"); return; }
        if (v_c17 != v_c19) return;
        ++_fires;
      ...
      if (_fires) db->bumpFires("str_rope.slog:29", "all:grow", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre63Rw142 __errf001a143 __errf7Bdb144 __errf6IJy145 __errf2vcZ146) (body) (head (emit error (0) __erre63Rw142)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp8dHb156 __t8HYS28) (body) (head (emit probe (0) __t8HYS28)) str_rope.slog:24 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel23 = db->getRelation("probe");
      head_index[0] = readrel23->getIndex(ord22, false);
      outer_rel = db->getRelation("temp8dHb156");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("str_rope.slog:24", "delta:temp8dHb156", _fires);
  ...
  // (crule (pre (let __tconst7N5b17 const7902699be42c8a8e46fbbb45) (let __tconst5SSa18 const05220501ba67007b288db75d) (let __tconst5oJA16 constad57366865126e55649ecb23)) (probe grow (0 1) 1 __tconst7N5b17 s) (body (let __t7j5J19 (_0002b __tconst5SSa18 s)) (let __t6hXR15 (size __t7j5J19))) (head (emit-temp temp5jl9155 __t6hXR15)) str_rope.slog:28 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp5jl9155");
      std::vector<u16> ord25({0, 1});
      slog::Relation* readrel26 = db->getRelation("grow");
    ...
    virtual bool work()
    {
      u64 v_c26 = v_const7902699be42c8a8e46fbbb45;
      u64 v_c27 = v_const05220501ba67007b288db75d;
      u64 v_c28 = v_constad57366865126e55649ecb23;
      ...
      slog::SliceCtx _sc{_slice_deadline, &db->runStopFlag()};
      std::array<u64,2> _rkey = resume_key; bool _hr = has_resume;
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c26, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m27) {
        u64 v_c29 = m27[1];
        if (buckethash(v_c29) != bucket) return;
        u64 v_c30 = _prim__0002b(db, v_c27, v_c29);
        if (v_c30 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:28"); return; }
        u64 v_c31 = _prim_size(db, v_c30);
        if (v_c31 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:28"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("str_rope.slog:28", "all:grow", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre7wqH128 __errf0PVh129 __errf88i7130) (body) (head (emit error (0) __erre7wqH128)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst4StL21 conste7f6c011776e8db7cd330b54) (let __tconst6y2w20 const6b86b273ff34fce19d6b804e)) (probe grow (0 1) 1 __tconst4StL21 s) (body (let __t3avI24 (_0002b s s)) (let __t3PFE23 (_0002b __t3avI24 s)) (let chk9yh9160 (_0002b s __t3avI24)) (eq __t3PFE23 chk9yh9160)) (head (emit agree (0) __tconst6y2w20)) str_rope.slog:19 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel33 = db->getRelation("agree");
      head_index[0] = readrel33->getIndex(ord32, false);
      std::vector<u16> ord34({0, 1});
      slog::Relation* readrel35 = db->getRelation("grow");
    ...
    virtual bool work()
    {
      u64 v_c35 = v_conste7f6c011776e8db7cd330b54;
      ...
      slog::SliceCtx _sc{_slice_deadline, &db->runStopFlag()};
      std::array<u64,2> _rkey = resume_key; bool _hr = has_resume;
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c35, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m36) {
        u64 v_c29 = m36[1];
        if (buckethash(v_c29) != bucket) return;
        u64 v_c37 = _prim__0002b(db, v_c29, v_c29);
        if (v_c37 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:19"); return; }
        u64 v_c38 = _prim__0002b(db, v_c37, v_c29);
        if (v_c38 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:19"); return; }
        u64 v_c39 = _prim__0002b(db, v_c29, v_c37);
        if (v_c39 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:19"); return; }
        if (v_c38 != v_c39) return;
        ++_fires;
      ...
      if (_fires) db->bumpFires("str_rope.slog:19", "all:grow", _fires);
  ...
  // (crule (pre) (scan temp17Hj161 __t8R4l1 n) (body) (head (emit sz (0 1) n __t8R4l1)) str_rope.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel39 = db->getRelation("sz");
      head_index[0] = readrel39->getIndex(ord38, false);
      outer_rel = db->getRelation("temp17Hj161");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("str_rope.slog:15", "delta:temp17Hj161", _fires);
  ...
  // (crule (pre (let __tconst9C3k29 const7902699be42c8a8e46fbbb45) (let __tconst3fBC27 constbda584056eb9957d6c681e00) (let __tconst7Iht26 const86bc00bf176c8b99e9cbdd89)) (probe grow (0 1) 1 __tconst9C3k29 s) (body (let __t8HYS28 (substr s __tconst3fBC27 __tconst7Iht26))) (head (emit-temp temp8dHb156 __t8HYS28)) str_rope.slog:24 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp8dHb156");
    ...
    virtual bool work()
    {
      u64 v_c42 = v_const7902699be42c8a8e46fbbb45;
      u64 v_c43 = v_constbda584056eb9957d6c681e00;
      u64 v_c44 = v_const86bc00bf176c8b99e9cbdd89;
      ...
      slog::SliceCtx _sc{_slice_deadline, &db->runStopFlag()};
      std::array<u64,2> _rkey = resume_key; bool _hr = has_resume;
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c42, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m43) {
        u64 v_c29 = m43[1];
        if (buckethash(v_c29) != bucket) return;
        u64 v_c25 = _prim_substr(db, v_c29, v_c43, v_c44);
        if (v_c25 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:24"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("str_rope.slog:24", "all:grow", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre5NYm125 __errf6qxp126 __errf0bbp127) (body) (head (emit error (0) __erre5NYm125)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre1iMB135 __errf8iAf136 __errf8V3l137 __errf0Cce138) (body) (head (emit error (0) __erre1iMB135)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre7KZs131 __errf237g132 __errf15nv133 __errf2BcA134) (body) (head (emit error (0) __erre7KZs131)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst5oJA16 constad57366865126e55649ecb23)) (scan temp5jl9155 __t6hXR15) (body) (head (emit sz (0 1) __tconst5oJA16 __t6hXR15)) str_rope.slog:28 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel55 = db->getRelation("sz");
      head_index[0] = readrel55->getIndex(ord54, false);
      outer_rel = db->getRelation("temp5jl9155");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c31 = _t[0];
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c28, v_c31}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("str_rope.slog:28", "delta:temp5jl9155", _fires);
  ...
  // (crule (pre) (scan toint_range __erre8qv3139 __errf1dyM140 __errf48J6141) (body) (head (emit error (0) __erre8qv3139)) <internal>:1 #f)
  ...
  // (crule (pre) (scan grow n s) (body (let __t8R4l1 (size s))) (head (emit-temp temp17Hj161 __t8R4l1 n)) str_rope.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp17Hj161");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c41 = _t[0];
        u64 v_c29 = _t[1];
        u64 v_c40 = _prim_size(db, v_c29);
        if (v_c40 == slog_error) { slog::emit_pending_error(db, "str_rope.slog:15"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c40, v_c41});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("str_rope.slog:15", "all:grow", _fires);
  ...
  s->addReadRel("temp17Hj161");
  s->addReadRel("temp5jl9155");
  s->addReadRel("temp8dHb156");
  s->addReadRel("toint_range");
  s->addReadRel("type_mismatch");
  s->addDynamicRel("agree");
  ...
  s->addDynamicRel("sz");
  s->addDynamicRel("temp17Hj161");
  s->addDynamicRel("temp5jl9155");
  s->addDynamicRel("temp8dHb156");
