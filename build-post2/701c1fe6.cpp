...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("701c1fe6");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan type_mismatch __erre2ZXT71 __errf0YBK72 __errf2b3p73 __errf2wOf74 __errf9fOc75) (body) (head (emit error (0) __erre2ZXT71)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre3AP557 __errf5H2C58 __errf9JDN59) (body) (head (emit error (0) __erre3AP557)) <internal>:1 #f)
  ...
  // (crule (pre) (scan vnum __t5P1K2 N) (body (join-lat regval (0 1 2) 0 L R latchk_0) (eq __t5P1K2 latchk_0)) (head (emit constat (0 1 2) L R __t5P1K2)) lat_constprop.slog:27 #f)
  class ReadTask7 : public slog::Task
  {
    ...
    slog::Index** regvalindex6;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("constat");
      std::vector<u16> ord8({0, 1, 2});
      slog::Relation* readrel9 = db->getRelation("constat");
      head_index[0] = readrel9->getIndex(ord8, false);
      outer_rel = db->getRelation("vnum");
      std::vector<u16> ord10({0, 1, 2});
      slog::Relation* readrel11 = db->getRelation("regval");
      regvalindex6 = readrel11->getIndex(ord10, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c8 = _t[0];
        u64 v_c9 = _t[1];
        slog::join_all_lat<2>(regvalindex6, [&](const std::array<u64,2>& m12, u64 val13) {
          u64 v_c10 = m12[0]; u64 v_c11 = m12[1]; u64 v_c12 = val13;
          if (v_c8 != v_c12) return;
          ++_fires;
          slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c10, v_c11, v_c8}, std::array<u16,3>{0, 1, 2});
        });
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lat_constprop.slog:27", "all:vnum", _fires);
  ...
  // (crule (pre (let __t7T2c3 (top))) (probe regval (2 0 1) 1 __t7T2c3 L R) (body) (head (emit nonconst (0 1) L R)) lat_constprop.slog:26 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("nonconst");
      std::vector<u16> ord15({0, 1});
      slog::Relation* readrel16 = db->getRelation("nonconst");
      head_index[0] = readrel16->getIndex(ord15, false);
      std::vector<u16> ord17({2, 0, 1});
      slog::Relation* readrel18 = db->getRelation("regval");
    ...
    virtual bool work()
    {
      u64 v_c13 = _prim_top(db);
      if (v_c13 == slog_error) { slog::emit_pending_error(db, "lat_constprop.slog:26"); return true; }
      ...
      bool _done = slog::join_probe_sliced<3,1>(driver_index, std::array<u64,3>{v_c13, 0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,3>& m19) {
        u64 v_c10 = m19[1];
        u64 v_c11 = m19[2];
      ...
      if (_fires) db->bumpFires("lat_constprop.slog:26", "all:regval", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre2t2781 __errf2jLk82 __errf316z83) (body) (head (emit error (0) __erre2t2781)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre7veb76 __errf356l77 __errf2Hax78 __errf8giR79 __errf7ZmM80) (body) (head (emit error (0) __erre7veb76)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre5K7e60 __errf4Kmh61 __errf5tHM62 __errf6E1n63) (body) (head (emit error (0) __erre5K7e60)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre1zK064 __errf9Xy365 __errf4ojM66 __errf0Kqc67) (body) (head (emit error (0) __erre1zK064)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre0cLo54 __errf7K0d55 __errf7kej56) (body) (head (emit error (0) __erre0cLo54)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre0mUI68 __errf0nmT69 __errf1EDM70) (body) (head (emit error (0) __erre0mUI68)) <internal>:1 #f)
