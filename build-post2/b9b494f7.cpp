...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("b9b494f7");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst2sFk12 const7902699be42c8a8e46fbbb45) (let __tconst0CBf17 constd4735e3a265e16eee03f5971) (let __tconst4pQD18 const6b86b273ff34fce19d6b804e) (let __tconst97Nd19 const4b227777d4dd1fc61c6f884f) (let __tconst6uoK20 const4e07408562bedb8b60ce05c1)) (once) (body) (head (emit edge (0 1 2) __tconst4pQD18 __tconst0CBf17 __tconst6uoK20) (emit edge (0 1 2) __tconst4pQD18 __tconst0CBf17 __tconst2sFk12) (emit edge (0 1 2) __tconst0CBf17 __tconst6uoK20 __tconst97Nd19) (emit edge (0 1 2) __tconst6uoK20 __tconst97Nd19 __tconst4pQD18)) lat_rat.slog:16 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      ++_fires;
      slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c2, v_c1, v_c4}, std::array<u16,3>{0, 1, 2});
      slog::emit<3>(head_rel[1], head_index[1], newbatch[1], std::array<u64,3>{v_c2, v_c1, v_c0}, std::array<u16,3>{0, 1, 2});
      slog::emit<3>(head_rel[2], head_index[2], newbatch[2], std::array<u64,3>{v_c1, v_c4, v_c3}, std::array<u16,3>{0, 1, 2});
      slog::emit<3>(head_rel[3], head_index[3], newbatch[3], std::array<u64,3>{v_c4, v_c3, v_c2}, std::array<u16,3>{0, 1, 2});
      ...
      if (_fires) db->bumpFires("lat_rat.slog:16", "once", _fires);
