...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("9c320425");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan smt_bad_formula __erre3FJq380 __errf9GE3381 __errf6VWw382) (body) (head (emit error (0) __erre3FJq380)) <internal>:1 #f)
  ...
  // (crule (pre) (scan smt_vcode C V) (body (join smt_check (0 1) 0 __t6JbH106 F)) (head (mkstruct smt_qsat (1 0) __1z3y142 F)) smt.slog:69 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel6 = db->getRelation("smt_check");
      smt_checkindex3 = readrel6->getIndex(ord5, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c3 = _t[0];
        u64 v_c4 = _t[1];
        slog::join_all<2>(smt_checkindex3, [&](const std::array<u64,2>& m7) {
