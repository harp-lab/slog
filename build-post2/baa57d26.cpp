...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("baa57d26");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp9EJB90");
  if (r == 0) db->addTempRelation("temp9EJB90", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp4Yz591");
  if (r == 0) db->addTempRelation("temp4Yz591", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp4AhD92");
  if (r == 0) db->addTempRelation("temp4AhD92", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  ...
  // (crule (pre (let __tconst4OxZ19 const6b86b273ff34fce19d6b804e) (let __tconst9gCw23 constd4735e3a265e16eee03f5971) (let __tconst7TuV25 const4e07408562bedb8b60ce05c1)) (scan temp4Yz591 __t1BUL5 __t803X16) (body (let __t3IPu12 (lpush __t1BUL5 __tconst9gCw23))) (head (emit-temp temp4AhD92 __t3IPu12) (emit assign (0 1) __tconst7TuV25 __t803X16)) lst_flat.slog:15 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("temp4AhD92");
      head_rel[1] = db->getRelation("assign");
      std::vector<u16> ord1({0, 1});
      slog::Relation* readrel2 = db->getRelation("assign");
      head_index[1] = readrel2->getIndex(ord1, false);
      outer_rel = db->getRelation("temp4Yz591");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c3 = _t[0];
        u64 v_c4 = _t[1];
        u64 v_c5 = _prim_lpush(db, v_c3, v_c1);
        if (v_c5 == slog_error) { slog::emit_pending_error(db, "lst_flat.slog:15"); return; }
        ++_fires;
        slog::emit_temp<1>(head_rel[0], newbatch[0], std::array<u64,1>{v_c5});
        slog::emit<2>(head_rel[1], head_index[1], newbatch[1], std::array<u64,2>{v_c2, v_c4}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
        head_rel[1]->sendBatch(newbatch[1]);
  
      if (_fires) db->bumpFires("lst_flat.slog:15", "delta:temp4Yz591", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre6MUq63 __errf8pAs64 __errf5uxJ65) (body) (head (emit error (0) __erre6MUq63)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre1iMF60 __errf9vcW61 __errf456L62) (body) (head (emit error (0) __erre1iMF60)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre4rly66 __errf3gYD67 __errf3GrK68 __errf4hYU69) (body) (head (emit error (0) __erre4rly66)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst4OxZ19 const6b86b273ff34fce19d6b804e) (let __tconst9gCw23 constd4735e3a265e16eee03f5971)) (scan temp4AhD92 __t3IPu12) (body) (head (emit assign (0 1) __tconst4OxZ19 __t3IPu12) (emit assign (0 1) __tconst9gCw23 __t3IPu12)) lst_flat.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("assign");
      std::vector<u16> ord13({0, 1});
      slog::Relation* readrel14 = db->getRelation("assign");
      head_index[0] = readrel14->getIndex(ord13, false);
      head_rel[1] = db->getRelation("assign");
      std::vector<u16> ord15({0, 1});
      slog::Relation* readrel16 = db->getRelation("assign");
      head_index[1] = readrel16->getIndex(ord15, false);
      outer_rel = db->getRelation("temp4AhD92");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        slog::emit<2>(head_rel[1], head_index[1], newbatch[1], std::array<u64,2>{v_c1, v_c5}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
        head_rel[1]->sendBatch(newbatch[1]);
  
      if (_fires) db->bumpFires("lst_flat.slog:15", "delta:temp4AhD92", _fires);
  ...
  // (crule (pre (let __tconst8vOD14 const19581e27de7ced00ff1ce50b) (let __tconst4OxZ19 const6b86b273ff34fce19d6b804e) (let __tconst9gCw23 constd4735e3a265e16eee03f5971) (let __tconst7TuV25 const4e07408562bedb8b60ce05c1)) (scan temp9EJB90 __t5P4D15) (body (let __t1BUL5 (lpush __t5P4D15 __tconst4OxZ19)) (let __t803X16 (lpush __t5P4D15 __tconst8vOD14))) (head (emit-temp temp4Yz591 __t1BUL5 __t803X16)) lst_flat.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp4Yz591");
      outer_rel = db->getRelation("temp9EJB90");
  
    }
    ReadTask17(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c16 = v_const19581e27de7ced00ff1ce50b;
      u64 v_c0 = v_const6b86b273ff34fce19d6b804e;
      u64 v_c1 = v_constd4735e3a265e16eee03f5971;
      u64 v_c2 = v_const4e07408562bedb8b60ce05c1;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c17 = _t[0];
        u64 v_c3 = _prim_lpush(db, v_c17, v_c0);
        if (v_c3 == slog_error) { slog::emit_pending_error(db, "lst_flat.slog:15"); return; }
        u64 v_c4 = _prim_lpush(db, v_c17, v_c16);
        if (v_c4 == slog_error) { slog::emit_pending_error(db, "lst_flat.slog:15"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("lst_flat.slog:15", "delta:temp9EJB90", _fires);
  ...
  // (crule (pre) (scan nan_result __erre5jiF70 __errf3dHQ71 __errf04Gx72 __errf7czb73) (body) (head (emit error (0) __erre5jiF70)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre3cto74 __errf4WR175 __errf22OU76) (body) (head (emit error (0) __erre3cto74)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst8vOD14 const19581e27de7ced00ff1ce50b) (let __tconst4OxZ19 const6b86b273ff34fce19d6b804e) (let __tconst1WCX20 const4b227777d4dd1fc61c6f884f) (let __tconst9gCw23 constd4735e3a265e16eee03f5971) (let __tconst5YoN24 constef2d127de37b942baad06145) (let __tconst7TuV25 const4e07408562bedb8b60ce05c1) (let __t5P4D15 (lempty))) (once) (body) (head (emit-temp temp9EJB90 __t5P4D15) (emit flow (0 1) __tconst4OxZ19 __tconst1WCX20) (emit flow (0 1) __tconst9gCw23 __tconst1WCX20) (emit flow (0 1) __tconst9gCw23 __tconst5YoN24) (emit flow (0 1) __tconst7TuV25 __tconst5YoN24)) lst_flat.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      head_index[3] = readrel30->getIndex(ord29, false);
      head_rel[4] = db->getRelation("flow");
      std::vector<u16> ord31({0, 1});
      slog::Relation* readrel32 = db->getRelation("flow");
      head_index[4] = readrel32->getIndex(ord31, false);
    ...
    virtual bool work()
    {
      ...
      u64 v_c1 = v_constd4735e3a265e16eee03f5971;
      u64 v_c26 = v_constef2d127de37b942baad06145;
      u64 v_c2 = v_const4e07408562bedb8b60ce05c1;
      u64 v_c17 = _prim_lempty(db);
      if (v_c17 == slog_error) { slog::emit_pending_error(db, "lst_flat.slog:15"); return true; }
      ...
      slog::emit<2>(head_rel[1], head_index[1], newbatch[1], std::array<u64,2>{v_c0, v_c25}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[2], head_index[2], newbatch[2], std::array<u64,2>{v_c1, v_c25}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[3], head_index[3], newbatch[3], std::array<u64,2>{v_c1, v_c26}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[4], head_index[4], newbatch[4], std::array<u64,2>{v_c2, v_c26}, std::array<u16,2>{0, 1});
      ...
      if (_fires) db->bumpFires("lst_flat.slog:15", "once", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre871387 __errf7zQ288 __errf41B489) (body) (head (emit error (0) __erre871387)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre4Vl182 __errf5IuV83 __errf4jNb84 __errf7dC385 __errf3yjQ86) (body) (head (emit error (0) __erre4Vl182)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre1gbz77 __errf4QOu78 __errf2G7E79 __errf4VzR80 __errf43Mz81) (body) (head (emit error (0) __erre1gbz77)) <internal>:1 #f)
  ...
  s->addReadRel("temp4AhD92");
  s->addReadRel("temp4Yz591");
  s->addReadRel("temp9EJB90");
  s->addReadRel("toint_range");
  s->addReadRel("type_mismatch");
  s->addDynamicRel("assign");
  ...
  s->addDynamicRel("temp4AhD92");
  s->addDynamicRel("temp4Yz591");
  s->addDynamicRel("temp9EJB90");
