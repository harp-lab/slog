...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("ed169f59");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("also");
  if (r == 0) db->addRelation("also", 1);
  else if (r->getArity() != 1)
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("also");
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<1>(db, db->getRelation("also"), std::array<u16,1>{0}, b));
  ...
  // (crule (pre) (scan modulo_by_zero __erre2SkG44 __errf3tiq45 __errf1o6M46) (body) (head (emit error (0) __erre2SkG44)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre9mGv51 __errf9lXX52 __errf8oq053 __errf7es754) (body) (head (emit error (0) __erre9mGv51)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre5Xzi68 __errf5bYs69 __errf3yBS70) (body) (head (emit error (0) __erre5Xzi68)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre7NdG41 __errf3s4E42 __errf4sHE43) (body) (head (emit error (0) __erre7NdG41)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre2QnO47 __errf9KRF48 __errf8LEi49 __errf2Jir50) (body) (head (emit error (0) __erre2QnO47)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre1Fil63 __errf22gU64 __errf24Rx65 __errf9rEo66 __errf3tOZ67) (body) (head (emit error (0) __erre1Fil63)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst7LG29 constef2d127de37b942baad06145) (let __tconst7sNo10 constd4735e3a265e16eee03f5971) (let __tconst8YF08 const6b86b273ff34fce19d6b804e) (cmp lt __tconst7LG29 __tconst7sNo10)) (once) (body) (head (emit bad (0) __tconst8YF08)) shape_constguard.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel20 = db->getRelation("bad");
    ...
    virtual bool work()
    {
      ...
      u64 v_c25 = _prim_lt(db, v_c22, v_c23);
      if (v_c25 == slog_error) { slog::emit_pending_error(db, "shape_constguard.slog:16"); return true; }
      if (!v_c25) return true;
      ...
      if (_fires) db->bumpFires("shape_constguard.slog:16", "once", _fires);
  ...
  // (crule (pre) (scan toint_range __erre3anJ55 __errf5u6x56 __errf6NTO57) (body) (head (emit error (0) __erre3anJ55)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre2OOD58 __errf075359 __errf7Gwl60 __errf5jSJ61 __errf6TTg62) (body) (head (emit error (0) __erre2OOD58)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst76rV2 const6b86b273ff34fce19d6b804e) (let __tconst73H53 constd4735e3a265e16eee03f5971) (cmp lt __tconst76rV2 __tconst73H53)) (once) (body) (head (emit ok (0) __tconst76rV2)) shape_constguard.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("ok");
      std::vector<u16> ord29({0});
      slog::Relation* readrel30 = db->getRelation("ok");
    ...
    virtual bool work()
    {
      ...
      u64 v_c36 = _prim_lt(db, v_c34, v_c35);
      if (v_c36 == slog_error) { slog::emit_pending_error(db, "shape_constguard.slog:14"); return true; }
      if (!v_c36) return true;
      ...
      if (_fires) db->bumpFires("shape_constguard.slog:14", "once", _fires);
  ...
  // (crule (pre (let __tconst09414 const4a44dc15364204a80fe80e90) (let __tconst3Ly95 constef2d127de37b942baad06145) (let __tconst4OFk7 conste629fa6598d732768f7c726b) (let __t8Sc76 (_0002b __tconst09414 __tconst3Ly95)) (cmp ge __t8Sc76 __tconst4OFk7)) (once) (body) (head (emit also (0) __t8Sc76)) shape_constguard.slog:18 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("also");
      std::vector<u16> ord33({0});
      slog::Relation* readrel34 = db->getRelation("also");
    ...
    virtual bool work()
    {
      u64 v_c37 = v_const4a44dc15364204a80fe80e90;
      u64 v_c38 = v_constef2d127de37b942baad06145;
      u64 v_c39 = v_conste629fa6598d732768f7c726b;
      u64 v_c40 = _prim__0002b(db, v_c37, v_c38);
      if (v_c40 == slog_error) { slog::emit_pending_error(db, "shape_constguard.slog:18"); return true; }
      u64 v_c41 = _prim_ge(db, v_c40, v_c39);
      if (v_c41 == slog_error) { slog::emit_pending_error(db, "shape_constguard.slog:18"); return true; }
      if (!v_c41) return true;
      ...
      if (_fires) db->bumpFires("shape_constguard.slog:18", "once", _fires);
