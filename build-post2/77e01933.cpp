...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("77e01933");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan nan_result __erre2T6V111 __errf72lP112 __errf8W2T113 __errf66S2114) (body) (head (emit error (0) __erre2T6V111)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre0gEE107 __errf6M87108 __errf9d6w109 __errf8mgr110) (body) (head (emit error (0) __erre0gEE107)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre6nvQ128 __errf2VEz129 __errf7D3e130) (body) (head (emit error (0) __erre6nvQ128)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre4uWd123 __errf0YSA124 __errf1KU2125 __errf18iC126 __errf7vqL127) (body) (head (emit error (0) __erre4uWd123)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre0k5M118 __errf8V5d119 __errf3xYL120 __errf3RQz121 __errf4qRS122) (body) (head (emit error (0) __erre0k5M118)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst5d385 constad57366865126e55649ecb23)) (scan b X) (body (let __t8wwb6 (_0002b X __tconst5d385))) (head (emit c (0) __t8wwb6)) strat_chain.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel17 = db->getRelation("c");
    ...
    virtual bool work()
    {
      u64 v_c21 = v_constad57366865126e55649ecb23;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c22 = _t[0];
        u64 v_c23 = _prim__0002b(db, v_c22, v_c21);
        if (v_c23 == slog_error) { slog::emit_pending_error(db, "strat_chain.slog:16"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_chain.slog:16", "all:b", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre0ql3101 __errf2UgG102 __errf1tVT103) (body) (head (emit error (0) __erre0ql3101)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre7Crj115 __errf2pWu116 __errf3RdU117) (body) (head (emit error (0) __erre7Crj115)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre6G4v104 __errf4A7y105 __errf7kmF106) (body) (head (emit error (0) __erre6G4v104)) <internal>:1 #f)
