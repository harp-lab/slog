...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("1467079e");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst9Whb2 const6b51d431df5d7f141cbececc) (let __tconst6SvA1 const2c624232cdd221771294dfbb)) (once) (body) (head (mkstruct half (1 0) __4JTR6 __tconst9Whb2) (mkstruct half (1 0) __7h5f7 __tconst6SvA1)) dem_multihead.slog:10 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("half");
      head_rel[1] = db->getRelation("half");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_multihead.slog:10", "once", _fires);
