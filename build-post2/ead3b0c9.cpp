...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("ead3b0c9");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst3QRl7 constd4735e3a265e16eee03f5971) (let __tconst9QMH6 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit src (0) __tconst3QRl7) (emit src (0) __tconst9QMH6)) strat_or.slog:10 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel4 = db->getRelation("src");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("strat_or.slog:10", "once", _fires);
