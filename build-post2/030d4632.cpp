...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("030d4632");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("type_mismatch");
      std::vector<u16> ord25({1, 2, 3, 4, 0});
    
    r->addIndex<5>(ord25, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<5>(db, r, std::array<u16,5>{1, 2, 3, 4, 0}, false, b), true);
      std::vector<u16> ord26({0, 1, 2, 3, 4});
  ...
  // (crule (pre (let __tconst4Ndi16 const19581e27de7ced00ff1ce50b) (let __tconst95Or18 const7902699be42c8a8e46fbbb45) (let __tconst1XgN20 constef2d127de37b942baad06145) (let __tconst6Xl621 const6b86b273ff34fce19d6b804e) (let __tconst4Ek023 constd4735e3a265e16eee03f5971) (let __tconst6MCN24 const2c624232cdd221771294dfbb) (let __tconst9AO325 const4e07408562bedb8b60ce05c1) (let __tconst11Pf26 constf5ca38f748a1d6eaf726b8a4) (let __tconst9GDc27 const4b227777d4dd1fc61c6f884f)) (once) (body) (head (emit e (0 1) __tconst6Xl621 __tconst4Ek023) (emit e (0 1) __tconst4Ek023 __tconst9AO325) (emit e (0 1) __tconst9AO325 __tconst9GDc27) (emit e (0 1) __tconst9GDc27 __tconst6Xl621) (emit f (0 1) __tconst4Ek023 __tconst1XgN20) (emit f (0 1) __tconst9AO325 __tconst6Xl621) (emit f (0 1) __tconst9GDc27 __tconst4Ndi16) (emit f (0 1) __tconst6Xl621 __tconst95Or18) (emit pq (0 1) __tconst6Xl621 __tconst1XgN20) (emit pq (0 1) __tconst4Ek023 __tconst9AO325) (emit pq (0 1) __tconst9AO325 __tconst6MCN24) (emit pq (0 1) __tconst9GDc27 __tconst11Pf26)) prim2_guards.slog:13 #f)
  class ReadTask0 : public slog::Task
  {
    slog::Database* db;
    u16 bucket;
    slog::Relation* head_rel[12];
    slog::Index** head_index[12];
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("e");
      std::vector<u16> ord1({0, 1});
      slog::Relation* readrel2 = db->getRelation("e");
      head_index[0] = readrel2->getIndex(ord1, false);
      head_rel[1] = db->getRelation("e");
      std::vector<u16> ord3({0, 1});
      slog::Relation* readrel4 = db->getRelation("e");
      head_index[1] = readrel4->getIndex(ord3, false);
      head_rel[2] = db->getRelation("e");
      std::vector<u16> ord5({0, 1});
      slog::Relation* readrel6 = db->getRelation("e");
      head_index[2] = readrel6->getIndex(ord5, false);
      head_rel[3] = db->getRelation("e");
      std::vector<u16> ord7({0, 1});
      slog::Relation* readrel8 = db->getRelation("e");
      head_index[3] = readrel8->getIndex(ord7, false);
      head_rel[4] = db->getRelation("f");
      std::vector<u16> ord9({0, 1});
      slog::Relation* readrel10 = db->getRelation("f");
      head_index[4] = readrel10->getIndex(ord9, false);
      head_rel[5] = db->getRelation("f");
      std::vector<u16> ord11({0, 1});
      slog::Relation* readrel12 = db->getRelation("f");
      head_index[5] = readrel12->getIndex(ord11, false);
      head_rel[6] = db->getRelation("f");
      std::vector<u16> ord13({0, 1});
      slog::Relation* readrel14 = db->getRelation("f");
      head_index[6] = readrel14->getIndex(ord13, false);
      head_rel[7] = db->getRelation("f");
      std::vector<u16> ord15({0, 1});
      slog::Relation* readrel16 = db->getRelation("f");
      head_index[7] = readrel16->getIndex(ord15, false);
      head_rel[8] = db->getRelation("pq");
      std::vector<u16> ord17({0, 1});
      slog::Relation* readrel18 = db->getRelation("pq");
      head_index[8] = readrel18->getIndex(ord17, false);
      head_rel[9] = db->getRelation("pq");
      std::vector<u16> ord19({0, 1});
      slog::Relation* readrel20 = db->getRelation("pq");
      head_index[9] = readrel20->getIndex(ord19, false);
      head_rel[10] = db->getRelation("pq");
      std::vector<u16> ord21({0, 1});
      slog::Relation* readrel22 = db->getRelation("pq");
      head_index[10] = readrel22->getIndex(ord21, false);
      head_rel[11] = db->getRelation("pq");
      std::vector<u16> ord23({0, 1});
      slog::Relation* readrel24 = db->getRelation("pq");
    ...
    virtual bool work()
    {
      u64 v_c0 = v_const19581e27de7ced00ff1ce50b;
      u64 v_c1 = v_const7902699be42c8a8e46fbbb45;
      ...
      u64 v_c7 = v_constf5ca38f748a1d6eaf726b8a4;
      u64 v_c8 = v_const4b227777d4dd1fc61c6f884f;
  
      u64 _fires = 0;
      slog::InsertBatch* newbatch[12];
      ...
      slog::emit<2>(head_rel[2], head_index[2], newbatch[2], std::array<u64,2>{v_c6, v_c8}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[3], head_index[3], newbatch[3], std::array<u64,2>{v_c8, v_c3}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[4], head_index[4], newbatch[4], std::array<u64,2>{v_c4, v_c2}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[5], head_index[5], newbatch[5], std::array<u64,2>{v_c6, v_c3}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[6], head_index[6], newbatch[6], std::array<u64,2>{v_c8, v_c0}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[7], head_index[7], newbatch[7], std::array<u64,2>{v_c3, v_c1}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[8], head_index[8], newbatch[8], std::array<u64,2>{v_c3, v_c2}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[9], head_index[9], newbatch[9], std::array<u64,2>{v_c4, v_c6}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[10], head_index[10], newbatch[10], std::array<u64,2>{v_c6, v_c5}, std::array<u16,2>{0, 1});
      slog::emit<2>(head_rel[11], head_index[11], newbatch[11], std::array<u64,2>{v_c8, v_c7}, std::array<u16,2>{0, 1});
      ...
      if (_fires) db->bumpFires("prim2_guards.slog:13", "once", _fires);
