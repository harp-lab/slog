...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("0390d054");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan fst X) (body (join tri (0 1 2) 1 X ____3T9K16 C)) (head (emit joined (0) C)) shape_wild.slog:31 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel3 = db->getRelation("joined");
      head_index[0] = readrel3->getIndex(ord2, false);
      outer_rel = db->getRelation("fst");
      std::vector<u16> ord4({0, 1, 2});
      slog::Relation* readrel5 = db->getRelation("tri");
      triindex0 = readrel5->getIndex(ord4, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        slog::join_probe<3,1>(triindex0, std::array<u64,3>{v_c0, 0, 0}, [&](const std::array<u64,3>& m6) {
      ...
      if (_fires) db->bumpFires("shape_wild.slog:31", "all:fst", _fires);
