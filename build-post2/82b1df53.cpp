...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("82b1df53");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst9mcN1 const4a44dc15364204a80fe80e90)) (scan src X) (body (let __t3CG22 (_0002b X __tconst9mcN1))) (head (emit b (0) __t3CG22)) strat_or.slog:14 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        if (v_c2 == slog_error) { slog::emit_pending_error(db, "strat_or.slog:14"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_or.slog:14", "all:src", _fires);
  ...
  // (crule (pre (let __tconst8hTi3 constd4735e3a265e16eee03f5971) (let __tconst6mLf4 constf5ca38f748a1d6eaf726b8a4)) (scan src X) (body (cmp lt X __tconst8hTi3) (let __t8hTi5 (_0002b X __tconst6mLf4))) (head (emit c (0) __t8hTi5)) strat_or.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel5 = db->getRelation("c");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        u64 v_c5 = _prim_lt(db, v_c1, v_c3);
        if (v_c5 == slog_error) { slog::emit_pending_error(db, "strat_or.slog:15"); return; }
        if (!v_c5) return;
        u64 v_c6 = _prim__0002b(db, v_c1, v_c4);
        if (v_c6 == slog_error) { slog::emit_pending_error(db, "strat_or.slog:15"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_or.slog:15", "all:src", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre6TX638 __errf8xrT39 __errf2UmX40) (body) (head (emit error (0) __erre6TX638)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre5HOV52 __errf6MHt53 __errf3mA254) (body) (head (emit error (0) __erre5HOV52)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre9Viw65 __errf3wtk66 __errf6wDS67) (body) (head (emit error (0) __erre9Viw65)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre47xr60 __errf87SM61 __errf68OK62 __errf5Uas63 __errf1RQd64) (body) (head (emit error (0) __erre47xr60)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre6SrG55 __errf7KoZ56 __errf4ADF57 __errf1Ke658 __errf4W1h59) (body) (head (emit error (0) __erre6SrG55)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre72fB48 __errf3ea249 __errf6hYw50 __errf8RVQ51) (body) (head (emit error (0) __erre72fB48)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre9y0T41 __errf1IHK42 __errf5YH943) (body) (head (emit error (0) __erre9y0T41)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre3tVB44 __errf10wJ45 __errf66XB46 __errf60Uo47) (body) (head (emit error (0) __erre3tVB44)) <internal>:1 #f)
