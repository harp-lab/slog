...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("f2339f1a");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  if (r == 0) db->addStruct("mpz_overflow", 5);
    ...
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("mpz_overflow");
      std::vector<u16> ord104({1, 2, 3, 4, 0});
    
    r->addIndex<5>(ord104, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<5>(db, r, std::array<u16,5>{1, 2, 3, 4, 0}, false, b), true);
      std::vector<u16> ord105({0, 1, 2, 3, 4});
  ...
  // (crule (pre) (scan b X) (body) (head (emit o1 (0) X)) shape_or.slog:46 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("o1");
      std::vector<u16> ord1({0});
      slog::Relation* readrel2 = db->getRelation("o1");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_or.slog:46", "all:b", _fires);
  ...
  // (crule (pre (let __tconst9sy11 constd4735e3a265e16eee03f5971)) (scan p X) (body (cmp lt X __tconst9sy11)) (head (emit q (0) X)) shape_or.slog:58 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel5 = db->getRelation("q");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c2 = _prim_lt(db, v_c0, v_c1);
        if (v_c2 == slog_error) { slog::emit_pending_error(db, "shape_or.slog:58"); return; }
        if (!v_c2) return;
        ++_fires;
        slog::emit<1>(head_rel[0], head_index[0], newbatch[0], std::array<u64,1>{v_c0}, std::array<u16,1>{0});
      });
      ...
      if (_fires) db->bumpFires("shape_or.slog:58", "all:p", _fires);
  ...
  // (crule (pre) (scan b X) (body) (head (emit o2 (0) X)) shape_or.slog:48 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("o2");
      std::vector<u16> ord8({0});
      slog::Relation* readrel9 = db->getRelation("o2");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_or.slog:48", "all:b", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre4qJe77 __errf3zUr78 __errf67mj79) (body) (head (emit error (0) __erre4qJe77)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre6diL60 __errf5FAz61 __errf08DO62 __errf8EPY63) (body) (head (emit error (0) __erre6diL60)) <internal>:1 #f)
  ...
  // (crule (pre) (scan c Y) (body (join a (0) 0 X)) (head (emit o3 (0 1) X Y)) shape_or.slog:50 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("o3");
      std::vector<u16> ord18({0, 1});
      slog::Relation* readrel19 = db->getRelation("o3");
      head_index[0] = readrel19->getIndex(ord18, false);
      outer_rel = db->getRelation("c");
      std::vector<u16> ord20({0});
      slog::Relation* readrel21 = db->getRelation("a");
      aindex16 = readrel21->getIndex(ord20, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c10 = _t[0];
        slog::join_all<1>(aindex16, [&](const std::array<u64,1>& m22) {
          u64 v_c0 = m22[0];
          ++_fires;
          slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c0, v_c10}, std::array<u16,2>{0, 1});
        });
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("shape_or.slog:50", "all:c", _fires);
  ...
  // (crule (pre) (scan a X) (body) (head (emit o1 (0) X)) shape_or.slog:46 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel25 = db->getRelation("o1");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_or.slog:46", "all:a", _fires);
  ...
  // (crule (pre) (scan c Y) (body (join b (0) 0 X)) (head (emit o3 (0 1) X Y)) shape_or.slog:50 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel29 = db->getRelation("o3");
      head_index[0] = readrel29->getIndex(ord28, false);
      outer_rel = db->getRelation("c");
      std::vector<u16> ord30({0});
      slog::Relation* readrel31 = db->getRelation("b");
      bindex26 = readrel31->getIndex(ord30, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c10 = _t[0];
        slog::join_all<1>(bindex26, [&](const std::array<u64,1>& m32) {
          u64 v_c0 = m32[0];
          ++_fires;
          slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c0, v_c10}, std::array<u16,2>{0, 1});
        });
  ...
  // (crule (pre) (scan g K) (body (join e (0 1) 1 K V)) (head (emit h (0) V)) shape_or.slog:56 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel36 = db->getRelation("h");
      head_index[0] = readrel36->getIndex(ord35, false);
      outer_rel = db->getRelation("g");
      std::vector<u16> ord37({0, 1});
      slog::Relation* readrel38 = db->getRelation("e");
      eindex33 = readrel38->getIndex(ord37, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c11 = _t[0];
        slog::join_probe<2,1>(eindex33, std::array<u64,2>{v_c11, 0}, [&](const std::array<u64,2>& m39) {
          u64 v_c12 = m39[1];
          ++_fires;
      ...
      if (_fires) db->bumpFires("shape_or.slog:56", "all:g", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre6G1M56 __errf6l4157 __errf0g1s58 __errf2iZD59) (body) (head (emit error (0) __erre6G1M56)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre8kmf53 __errf01HD54 __errf8myU55) (body) (head (emit error (0) __erre8kmf53)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre5gwL72 __errf3yE473 __errf4yPQ74 __errf236575 __errf5Wre76) (body) (head (emit error (0) __erre5gwL72)) <internal>:1 #f)
  ...
  // (crule (pre) (scan f K) (body (join e (0 1) 1 K V)) (head (emit h (0) V)) shape_or.slog:56 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel52 = db->getRelation("h");
      head_index[0] = readrel52->getIndex(ord51, false);
      outer_rel = db->getRelation("f");
      std::vector<u16> ord53({0, 1});
      slog::Relation* readrel54 = db->getRelation("e");
      eindex49 = readrel54->getIndex(ord53, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c11 = _t[0];
        slog::join_probe<2,1>(eindex49, std::array<u64,2>{v_c11, 0}, [&](const std::array<u64,2>& m55) {
          u64 v_c12 = m55[1];
          ++_fires;
          slog::emit<1>(head_rel[0], head_index[0], newbatch[0], std::array<u64,1>{v_c12}, std::array<u16,1>{0});
        });
      ...
      if (_fires) db->bumpFires("shape_or.slog:56", "all:f", _fires);
  ...
  // (crule (pre) (scan d Y) (body (join a (0) 0 X)) (head (emit o3 (0 1) X Y)) shape_or.slog:50 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel59 = db->getRelation("o3");
      head_index[0] = readrel59->getIndex(ord58, false);
      outer_rel = db->getRelation("d");
      std::vector<u16> ord60({0});
      slog::Relation* readrel61 = db->getRelation("a");
      aindex56 = readrel61->getIndex(ord60, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c10 = _t[0];
        slog::join_all<1>(aindex56, [&](const std::array<u64,1>& m62) {
          u64 v_c0 = m62[0];
          ++_fires;
          slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c0, v_c10}, std::array<u16,2>{0, 1});
        });
      ...
      if (_fires) db->bumpFires("shape_or.slog:50", "all:d", _fires);
  ...
  // (crule (pre) (scan d Y) (body (join b (0) 0 X)) (head (emit o3 (0 1) X Y)) shape_or.slog:50 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel66 = db->getRelation("o3");
      head_index[0] = readrel66->getIndex(ord65, false);
      outer_rel = db->getRelation("d");
      std::vector<u16> ord67({0});
      slog::Relation* readrel68 = db->getRelation("b");
      bindex63 = readrel68->getIndex(ord67, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c10 = _t[0];
        slog::join_all<1>(bindex63, [&](const std::array<u64,1>& m69) {
          u64 v_c0 = m69[0];
          ++_fires;
          slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c0, v_c10}, std::array<u16,2>{0, 1});
        });
  ...
  // (crule (pre) (scan c X) (body) (head (emit o2 (0) X)) shape_or.slog:48 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel72 = db->getRelation("o2");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_or.slog:48", "all:c", _fires);
  ...
  // (crule (pre (let __tconst0sHM2 const4b227777d4dd1fc61c6f884f)) (scan p X) (body (cmp gt X __tconst0sHM2)) (head (emit q (0) X)) shape_or.slog:58 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel75 = db->getRelation("q");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c26 = _prim_gt(db, v_c0, v_c25);
        if (v_c26 == slog_error) { slog::emit_pending_error(db, "shape_or.slog:58"); return; }
        if (!v_c26) return;
        ++_fires;
        slog::emit<1>(head_rel[0], head_index[0], newbatch[0], std::array<u64,1>{v_c0}, std::array<u16,1>{0});
      });
  ...
  // (crule (pre) (scan div_by_zero __erre6RZd50 __errf3OKP51 __errf8g7352) (body) (head (emit error (0) __erre6RZd50)) <internal>:1 #f)
  ...
  // (crule (pre) (scan a X) (body) (head (emit o2 (0) X)) shape_or.slog:48 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel82 = db->getRelation("o2");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_or.slog:48", "all:a", _fires);
    ...
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_read, new ReadTask80(db,b), true);
  // (crule (pre) (scan toint_range __erre5gkQ64 __errf6EwJ65 __errf8fBh66) (body) (head (emit error (0) __erre5gkQ64)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre8hV867 __errf7Pbu68 __errf3FME69 __errf0Jmd70 __errf3j8M71) (body) (head (emit error (0) __erre8hV867)) <internal>:1 #f)
