...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("d010ab86");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst6Fhj4 constf5ca38f748a1d6eaf726b8a4) (let __tconst6uk43 const4a44dc15364204a80fe80e90) (let __tconst0TAy2 constd4735e3a265e16eee03f5971) (let __tconst669z1 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit b (0) __tconst6Fhj4) (emit b (0) __tconst6uk43) (emit a (0) __tconst0TAy2) (emit a (0) __tconst669z1)) cartesian.slog:5 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel2 = db->getRelation("b");
      head_index[0] = readrel2->getIndex(ord1, false);
      head_rel[1] = db->getRelation("b");
      std::vector<u16> ord3({0});
      slog::Relation* readrel4 = db->getRelation("b");
    ...
    virtual bool work()
    {
      u64 v_c0 = v_constf5ca38f748a1d6eaf726b8a4;
      ...
      if (_fires) db->bumpFires("cartesian.slog:5", "once", _fires);
