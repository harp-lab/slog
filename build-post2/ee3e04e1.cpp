...
u64 v_const8566bd84ac5cefbdaacb0d97;
u64 v_const7808f18c8b98bf0341212d21;
u64 v_const05e7b93925da1614f442644c;
u64 v_constda7d351a6dbf31ff4acbdba4;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("ee3e04e1");
  if (s == nullptr) return;
  slog::Relation* r;
  v_const5feceb66ffc86f38d952786c = s32_encode(0);
  v_const8566bd84ac5cefbdaacb0d97 = db->encodeString("tycheck_basic.slog:26");
  v_const7808f18c8b98bf0341212d21 = db->encodeString("vals");
  v_const05e7b93925da1614f442644c = db->encodeString("tycheck_basic.slog:23");
  v_constda7d351a6dbf31ff4acbdba4 = db->encodeString("typed");
  ...
  // (crule (pre) (scan malformed_deduction __erre8Wof22 __errf9K9523 __errf4Xu624 __errf1p9h25 __errf9Q2D26) (body) (head (emit error (0) __erre8Wof22)) <internal>:1 #f)
  ...
  // (crule (pre (let __trid0dXl14 const05e7b93925da1614f442644c) (let __trel60Z115 constda7d351a6dbf31ff4acbdba4) (let __tcol4TH016 const5feceb66ffc86f38d952786c)) (scan raw X) (body) (head (tycheck X (accept int) __trid0dXl14 __trel60Z115 __tcol4TH016 (1 2 3 4 0)) (emit typed (0) X)) tycheck_basic.slog:23 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      head_rel[1] = db->getRelation("typed");
      std::vector<u16> ord4({0});
      slog::Relation* readrel5 = db->getRelation("typed");
    ...
    virtual bool work()
    {
      u64 v_c5 = v_const05e7b93925da1614f442644c;
      u64 v_c6 = v_constda7d351a6dbf31ff4acbdba4;
      ...
      if (_fires) db->bumpFires("tycheck_basic.slog:23", "all:raw", _fires);
  ...
  // (crule (pre (let __trid3Kou11 const8566bd84ac5cefbdaacb0d97) (let __trel8GrS12 const7808f18c8b98bf0341212d21) (let __tcol9o9R13 const5feceb66ffc86f38d952786c)) (scan flow E) (body) (head (tycheck E (accept (struct lam)) __trid3Kou11 __trel8GrS12 __tcol9o9R13 (1 2 3 4 0)) (emit vals (0) E)) tycheck_basic.slog:26 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel9 = db->getRelation("vals");
      head_index[1] = readrel9->getIndex(ord8, false);
      outer_rel = db->getRelation("flow");
      sid6 = db->getRelation("lam")->getStructId();
  
    }
    ReadTask7(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c9 = v_const8566bd84ac5cefbdaacb0d97;
      u64 v_c10 = v_const7808f18c8b98bf0341212d21;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c12 = _t[0];
        ++_fires;
        if (!((is_struct(v_c12) && (decode_struct_id(v_c12) == sid6))))
        {
          slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c9, v_c10, v_c11, v_c12}, std::array<u16,5>{1, 2, 3, 4, 0});
          return;
        }
        slog::emit<1>(head_rel[1], head_index[1], newbatch[1], std::array<u64,1>{v_c12}, std::array<u16,1>{0});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
        head_rel[1]->sendBatch(newbatch[1]);
  
      if (_fires) db->bumpFires("tycheck_basic.slog:26", "all:flow", _fires);
