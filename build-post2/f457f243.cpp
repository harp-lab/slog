...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("f457f243");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan toint_range __erre7Lj455 __errf9MHW56 __errf4sqJ57) (body) (head (emit error (0) __erre7Lj455)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst81qy7 const4a44dc15364204a80fe80e90)) (scan a X) (body (let __t9ylf8 (_0002b X __tconst81qy7))) (head (emit b (0) __t9ylf8)) strat_chain.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("b");
      std::vector<u16> ord4({0});
      slog::Relation* readrel5 = db->getRelation("b");
      head_index[0] = readrel5->getIndex(ord4, false);
      outer_rel = db->getRelation("a");
  
    }
    ReadTask3(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c3 = v_const4a44dc15364204a80fe80e90;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c4 = _t[0];
        u64 v_c5 = _prim__0002b(db, v_c4, v_c3);
        if (v_c5 == slog_error) { slog::emit_pending_error(db, "strat_chain.slog:15"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_chain.slog:15", "all:a", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre4Y5o63 __errf8fWT64 __errf5PfW65 __errf11CM66 __errf9JVt67) (body) (head (emit error (0) __erre4Y5o63)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre0fTd51 __errf6mDj52 __errf0GW853 __errf9McN54) (body) (head (emit error (0) __erre0fTd51)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre0deJ41 __errf7Wa442 __errf8txn43) (body) (head (emit error (0) __erre0deJ41)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre47nE44 __errf6Ukw45 __errf8SNc46) (body) (head (emit error (0) __erre47nE44)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre22nT68 __errf0C1g69 __errf3bG570) (body) (head (emit error (0) __erre22nT68)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre8eVT58 __errf1DEv59 __errf8oeb60 __errf1Rvb61 __errf4wvP62) (body) (head (emit error (0) __erre8eVT58)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre2DgS47 __errf4FrC48 __errf7HdC49 __errf5XRb50) (body) (head (emit error (0) __erre2DgS47)) <internal>:1 #f)
