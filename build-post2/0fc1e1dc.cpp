...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("0fc1e1dc");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp6YJj117");
  if (r == 0) db->addTempRelation("temp6YJj117", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp4aK9118");
  if (r == 0) db->addTempRelation("temp4aK9118", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp3UwB120");
  if (r == 0) db->addTempRelation("temp3UwB120", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp2x1a119");
  if (r == 0) db->addTempRelation("temp2x1a119", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  ...
  // (crule (pre (let __tconst8Dpf3 const4e07408562bedb8b60ce05c1)) (scan temp2x1a119 __t82PY8) (body (let __t7gps9 (lpush __t82PY8 __tconst8Dpf3))) (head (emit-temp temp3UwB120 __t7gps9)) lst_basic.slog:14 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("temp3UwB120");
      outer_rel = db->getRelation("temp2x1a119");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        u64 v_c2 = _prim_lpush(db, v_c1, v_c0);
        if (v_c2 == slog_error) { slog::emit_pending_error(db, "lst_basic.slog:14"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("lst_basic.slog:14", "delta:temp2x1a119", _fires);
  ...
  // (crule (pre (let __tconst8Dpf3 const4e07408562bedb8b60ce05c1) (let __tconst9efJ4 constd4735e3a265e16eee03f5971) (let __tconst6ll85 const6b86b273ff34fce19d6b804e)) (scan temp6YJj117 __t73RN10) (body (let __t6w0j7 (lpush __t73RN10 __tconst6ll85))) (head (emit-temp temp4aK9118 __t6w0j7) (emit input (0) __t73RN10)) lst_basic.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp4aK9118");
      head_rel[1] = db->getRelation("input");
      std::vector<u16> ord2({0});
      slog::Relation* readrel3 = db->getRelation("input");
      head_index[1] = readrel3->getIndex(ord2, false);
      outer_rel = db->getRelation("temp6YJj117");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        if (v_c6 == slog_error) { slog::emit_pending_error(db, "lst_basic.slog:14"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("lst_basic.slog:14", "delta:temp6YJj117", _fires);
  ...
  // (crule (pre) (scan nan_result __erre5xLy97 __errf49x198 __errf1c1F99 __errf8Scx100) (body) (head (emit error (0) __erre5xLy97)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre5yrH104 __errf4fJR105 __errf9BKE106 __errf5EeK107 __errf55c8108) (body) (head (emit error (0) __erre5yrH104)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre8d8W114 __errf0UZM115 __errf2mE4116) (body) (head (emit error (0) __erre8d8W114)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst8Dpf3 const4e07408562bedb8b60ce05c1) (let __tconst9efJ4 constd4735e3a265e16eee03f5971)) (scan temp4aK9118 __t6w0j7) (body (let __t82PY8 (lpush __t6w0j7 __tconst9efJ4))) (head (emit-temp temp2x1a119 __t82PY8)) lst_basic.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp2x1a119");
      outer_rel = db->getRelation("temp4aK9118");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c6 = _t[0];
        u64 v_c1 = _prim_lpush(db, v_c6, v_c3);
        if (v_c1 == slog_error) { slog::emit_pending_error(db, "lst_basic.slog:14"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("lst_basic.slog:14", "delta:temp4aK9118", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre11bu109 __errf6shG110 __errf9SAp111 __errf2gx2112 __errf4qQM113) (body) (head (emit error (0) __erre11bu109)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst7sBq2 const6b86b273ff34fce19d6b804e) (let __tconst0fcT1 constd4735e3a265e16eee03f5971)) (once) (body) (head (emit edge (0 1) __tconst7sBq2 __tconst0fcT1)) lst_basic.slog:15 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("lst_basic.slog:15", "once", _fires);
  ...
  // (crule (pre) (scan temp3UwB120 __t7gps9) (body) (head (emit input (0) __t7gps9)) lst_basic.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel22 = db->getRelation("input");
      head_index[0] = readrel22->getIndex(ord21, false);
      outer_rel = db->getRelation("temp3UwB120");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("lst_basic.slog:14", "delta:temp3UwB120", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre5eNI90 __errf6lnm91 __errf6C6M92) (body) (head (emit error (0) __erre5eNI90)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre60Zl93 __errf0v8k94 __errf39rl95 __errf7YOb96) (body) (head (emit error (0) __erre60Zl93)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre3Tr7101 __errf2vud102 __errf008Z103) (body) (head (emit error (0) __erre3Tr7101)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst8Dpf3 const4e07408562bedb8b60ce05c1) (let __tconst9efJ4 constd4735e3a265e16eee03f5971) (let __tconst6ll85 const6b86b273ff34fce19d6b804e) (let __t73RN10 (lempty))) (once) (body) (head (emit-temp temp6YJj117 __t73RN10)) lst_basic.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp6YJj117");
    ...
    virtual bool work()
    {
      ...
      if (v_c5 == slog_error) { slog::emit_pending_error(db, "lst_basic.slog:14"); return true; }
      ...
      if (_fires) db->bumpFires("lst_basic.slog:14", "once", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre2zKe87 __errf5PvN88 __errf6pAk89) (body) (head (emit error (0) __erre2zKe87)) <internal>:1 #f)
  ...
  s->addReadRel("temp2x1a119");
  s->addReadRel("temp3UwB120");
  s->addReadRel("temp4aK9118");
  s->addReadRel("temp6YJj117");
  ...
  s->addDynamicRel("temp2x1a119");
  s->addDynamicRel("temp3UwB120");
  s->addDynamicRel("temp4aK9118");
  s->addDynamicRel("temp6YJj117");
