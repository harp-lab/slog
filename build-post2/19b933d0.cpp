...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("19b933d0");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan int_overflow __erre7sJ277 __errf9SuT78 __errf9A6w79 __errf0jIX80) (body) (head (emit error (0) __erre7sJ277)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre201I71 __errf6GXj72 __errf4zoB73) (body) (head (emit error (0) __erre201I71)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre456993 __errf9LSs94 __errf32w595 __errf1Rut96 __errf7fRv97) (body) (head (emit error (0) __erre456993)) <internal>:1 #f)
  ...
  // (crule (pre (let __t2mw415 (cmap))) (scan edge a b w) (body (let __t4leV16 (cput __t2mw415 b w))) (head (emit-lat best a __t4leV16)) lat_set.slog:26 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c12 = _prim_cmap(db);
      if (v_c12 == slog_error) { slog::emit_pending_error(db, "lat_set.slog:26"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c14 = _t[1];
        u64 v_c15 = _t[2];
        u64 v_c16 = _prim_cput(db, v_c12, v_c14, v_c15);
        if (v_c16 == slog_error) { slog::emit_pending_error(db, "lat_set.slog:26"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c13, v_c16});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lat_set.slog:26", "all:edge", _fires);
  ...
  // (crule (pre) (scan nan_result __erre1Zqj81 __errf36jD82 __errf6jP683 __errf6S2e84) (body) (head (emit error (0) __erre1Zqj81)) <internal>:1 #f)
  ...
  // (crule (pre) (scan reach b s) (body (join edge (1 0 2) 1 b a w)) (head (emit-lat reach a s)) lat_set.slog:23 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      edgeindex13 = readrel16->getIndex(ord15, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c14 = _t[0];
        u64 v_c21 = _t[1];
        slog::join_probe<3,1>(edgeindex13, std::array<u64,3>{v_c14, 0, 0}, [&](const std::array<u64,3>& m17) {
          u64 v_c13 = m17[1]; u64 v_c15 = m17[2];
          ++_fires;
          slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c13, v_c21});
        });
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lat_set.slog:23", "delta:reach", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre8Ka074 __errf6W8Y75 __errf5Z8C76) (body) (head (emit error (0) __erre8Ka074)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre0bU885 __errf5VX986 __errf9bTv87) (body) (head (emit error (0) __erre0bU885)) <internal>:1 #f)
  ...
  // (crule (pre (let __t2UwJ30 (cmap))) (scan edge a b w) (body (let __t139m31 (cins __t2UwJ30 b))) (head (emit-lat reach a __t139m31)) lat_set.slog:21 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c28 = _prim_cmap(db);
      if (v_c28 == slog_error) { slog::emit_pending_error(db, "lat_set.slog:21"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c14 = _t[1];
        u64 v_c15 = _t[2];
        u64 v_c29 = _prim_cins(db, v_c28, v_c14);
        if (v_c29 == slog_error) { slog::emit_pending_error(db, "lat_set.slog:21"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c13, v_c29});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lat_set.slog:21", "all:edge", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre9MMb98 __errf4z9a99 __errf6QTm100) (body) (head (emit error (0) __erre9MMb98)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre47px88 __errf2p4g89 __errf6MDq90 __errf7wOz91 __errf7j8w92) (body) (head (emit error (0) __erre47px88)) <internal>:1 #f)
