...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("a9842cb0");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst3xkN3 const7902699be42c8a8e46fbbb45) (let __tconst39pX2 constef2d127de37b942baad06145)) (once) (body) (head (emit want (0) __tconst3xkN3) (emit want (0) __tconst39pX2)) dem_escape.slog:13 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("want");
      std::vector<u16> ord1({0});
      slog::Relation* readrel2 = db->getRelation("want");
      head_index[0] = readrel2->getIndex(ord1, false);
      head_rel[1] = db->getRelation("want");
      std::vector<u16> ord3({0});
      slog::Relation* readrel4 = db->getRelation("want");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_escape.slog:13", "once", _fires);
