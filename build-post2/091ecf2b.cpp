...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("091ecf2b");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst4WnG2 constd4735e3a265e16eee03f5971) (let __tconst9X5w1 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit p (0) __tconst4WnG2) (emit p (0) __tconst9X5w1)) strat_run2_base.slog:6 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("strat_run2_base.slog:6", "once", _fires);
