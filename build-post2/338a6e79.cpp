...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("338a6e79");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp39a3159");
  if (r == 0) db->addTempRelation("temp39a3159", 2);
  ...
  // (crule (pre (let __tconst7vbl4 const6b86b273ff34fce19d6b804e) (let __tconst6VPm7 constd4735e3a265e16eee03f5971)) (scan fib_ans __t3ojO6 __v0) (body (join fib (0 1) 1 __t3ojO6 __t94L95) (join fib (0 1) 0 __t7KU52 n) (cmp lt __tconst7vbl4 n) (join-old fib_ans (0 1) 0 (0 1) __t72U49 __v1) (let __t4RJw8 (_0002d n __tconst6VPm7)) (join fib (0 1) 2 __t72U49 __t4RJw8) (let chk3rld160 (_0002d n __tconst7vbl4)) (eq __t94L95 chk3rld160) (let __t4LtS1 (_0002b __v0 __v1))) (head (emit-temp temp39a3159 __t4LtS1 __t7KU52)) dem_value.slog:11 #f)
  class ReadTask5 : public slog::Task
  {
    ...
    slog::Index** fibindex0;  slog::Index** fibindex1;  slog::Index** fib_ansindex2;  slog::Index** fibindex3;  slog::Index** fib_ansdelta4;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp39a3159");
      outer_rel = db->getRelation("fib_ans");
      std::vector<u16> ord6({0, 1});
      slog::Relation* readrel7 = db->getRelation("fib");
      fibindex0 = readrel7->getIndex(ord6, false);
      std::vector<u16> ord8({0, 1});
      slog::Relation* readrel9 = db->getRelation("fib");
      fibindex1 = readrel9->getIndex(ord8, false);
      std::vector<u16> ord10({0, 1});
      slog::Relation* readrel11 = db->getRelation("fib_ans");
      fib_ansindex2 = readrel11->getIndex(ord10, false);
      std::vector<u16> ord12({0, 1});
      slog::Relation* readrel13 = db->getRelation("fib_ans");
      fib_ansdelta4 = readrel13->getIndex(ord12, true);
      std::vector<u16> ord14({0, 1});
      slog::Relation* readrel15 = db->getRelation("fib");
      fibindex3 = readrel15->getIndex(ord14, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c2 = _t[0];
        u64 v_c3 = _t[1];
        slog::join_probe<2,1>(fibindex0, std::array<u64,2>{v_c2, 0}, [&](const std::array<u64,2>& m16) {
          u64 v_c4 = m16[1];
          slog::join_all<2>(fibindex1, [&](const std::array<u64,2>& m17) {
            u64 v_c5 = m17[0]; u64 v_c6 = m17[1];
            u64 v_c7 = _prim_lt(db, v_c0, v_c6);
            if (v_c7 == slog_error) { slog::emit_pending_error(db, "dem_value.slog:11"); return; }
            if (!v_c7) return;
            slog::join_all_old<2>(fib_ansindex2, fib_ansdelta4, [&](const std::array<u64,2>& m19) {
              u64 v_c8 = m19[0]; u64 v_c9 = m19[1];
              u64 v_c10 = _prim__0002d(db, v_c6, v_c1);
              if (v_c10 == slog_error) { slog::emit_pending_error(db, "dem_value.slog:11"); return; }
              slog::join_probe<2,2>(fibindex3, std::array<u64,2>{v_c8, v_c10}, [&](const std::array<u64,2>& m20) {
                u64 v_c11 = _prim__0002d(db, v_c6, v_c0);
                if (v_c11 == slog_error) { slog::emit_pending_error(db, "dem_value.slog:11"); return; }
                if (v_c4 != v_c11) return;
                u64 v_c12 = _prim__0002b(db, v_c3, v_c9);
                if (v_c12 == slog_error) { slog::emit_pending_error(db, "dem_value.slog:11"); return; }
                ++_fires;
                slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c12, v_c5});
              });
            });
          });
        });
      ...
      if (_fires) db->bumpFires("dem_value.slog:11", "delta:fib_ans", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre7VxL151 __errf2Nq8152 __errf311F153 __errf1rWl154 __errf1WAY155) (body) (head (emit error (0) __erre7VxL151)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre3FB5143 __errf7VZu144 __errf5EOb145) (body) (head (emit error (0) __erre3FB5143)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre5Mwb156 __errf1jaC157 __errf0xoZ158) (body) (head (emit error (0) __erre5Mwb156)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst7vbl4 const6b86b273ff34fce19d6b804e) (let __tconst6VPm7 constd4735e3a265e16eee03f5971)) (scan fib_ans __t72U49 __v1) (body (join fib (0 1) 1 __t72U49 __t4RJw8) (join fib (0 1) 0 __t7KU52 n) (cmp lt __tconst7vbl4 n) (join fib_ans (0 1) 0 __t3ojO6 __v0) (let __t94L95 (_0002d n __tconst7vbl4)) (join fib (0 1) 2 __t3ojO6 __t94L95) (let chk6mAx161 (_0002d n __tconst6VPm7)) (eq __t4RJw8 chk6mAx161) (let __t4LtS1 (_0002b __v0 __v1))) (head (emit-temp temp39a3159 __t4LtS1 __t7KU52)) dem_value.slog:11 #f)
  class ReadTask34 : public slog::Task
  {
    ...
    slog::Index** fibindex30;  slog::Index** fibindex31;  slog::Index** fib_ansindex32;  slog::Index** fibindex33;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel36 = db->getRelation("fib");
      fibindex30 = readrel36->getIndex(ord35, false);
      std::vector<u16> ord37({0, 1});
      slog::Relation* readrel38 = db->getRelation("fib");
      fibindex31 = readrel38->getIndex(ord37, false);
      std::vector<u16> ord39({0, 1});
      slog::Relation* readrel40 = db->getRelation("fib_ans");
      fib_ansindex32 = readrel40->getIndex(ord39, false);
      std::vector<u16> ord41({0, 1});
      slog::Relation* readrel42 = db->getRelation("fib");
      fibindex33 = readrel42->getIndex(ord41, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c8 = _t[0];
        u64 v_c9 = _t[1];
        slog::join_probe<2,1>(fibindex30, std::array<u64,2>{v_c8, 0}, [&](const std::array<u64,2>& m43) {
          u64 v_c10 = m43[1];
          slog::join_all<2>(fibindex31, [&](const std::array<u64,2>& m44) {
            u64 v_c5 = m44[0]; u64 v_c6 = m44[1];
            u64 v_c24 = _prim_lt(db, v_c0, v_c6);
            if (v_c24 == slog_error) { slog::emit_pending_error(db, "dem_value.slog:11"); return; }
            if (!v_c24) return;
            slog::join_all<2>(fib_ansindex32, [&](const std::array<u64,2>& m46) {
              u64 v_c2 = m46[0]; u64 v_c3 = m46[1];
              u64 v_c4 = _prim__0002d(db, v_c6, v_c0);
              if (v_c4 == slog_error) { slog::emit_pending_error(db, "dem_value.slog:11"); return; }
              slog::join_probe<2,2>(fibindex33, std::array<u64,2>{v_c2, v_c4}, [&](const std::array<u64,2>& m47) {
                u64 v_c25 = _prim__0002d(db, v_c6, v_c1);
                if (v_c25 == slog_error) { slog::emit_pending_error(db, "dem_value.slog:11"); return; }
  ...
  // (crule (pre) (scan div_by_zero __erre4BJA129 __errf8dwt130 __errf98yC131) (body) (head (emit error (0) __erre4BJA129)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre7QaA146 __errf43Uu147 __errf58U0148 __errf2T4V149 __errf1SY8150) (body) (head (emit error (0) __erre7QaA146)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre8i7S132 __errf4lNI133 __errf1e25134) (body) (head (emit error (0) __erre8i7S132)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre9XFp139 __errf5xRP140 __errf6B13141 __errf4oIz142) (body) (head (emit error (0) __erre9XFp139)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre8kkX135 __errf5ri0136 __errf1xbd137 __errf8Z6Q138) (body) (head (emit error (0) __erre8kkX135)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst9N4y13 constd4735e3a265e16eee03f5971)) (scan fib __t9Vx112 n) (body (cmp lt n __tconst9N4y13)) (head (emit fib_ans (0 1) __t9Vx112 n)) dem_value.slog:10 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("fib_ans");
      std::vector<u16> ord64({0, 1});
      slog::Relation* readrel65 = db->getRelation("fib_ans");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c46 = _t[0];
        u64 v_c6 = _t[1];
        u64 v_c47 = _prim_lt(db, v_c6, v_c45);
        if (v_c47 == slog_error) { slog::emit_pending_error(db, "dem_value.slog:10"); return; }
        if (!v_c47) return;
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c46, v_c6}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("dem_value.slog:10", "all:fib", _fires);
  ...
  // (crule (pre) (scan temp39a3159 __t4LtS1 __t7KU52) (body) (head (emit fib_ans (0 1) __t7KU52 __t4LtS1)) dem_value.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel69 = db->getRelation("fib_ans");
      head_index[0] = readrel69->getIndex(ord68, false);
      outer_rel = db->getRelation("temp39a3159");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_value.slog:11", "delta:temp39a3159", _fires);
  ...
  s->addReadRel("temp39a3159");
  s->addReadRel("toint_range");
  s->addReadRel("type_mismatch");
  s->addDynamicRel("div_by_zero");
  s->addDynamicRel("error");
  s->addDynamicRel("fib_ans");
  s->addDynamicRel("int_overflow");
  s->addDynamicRel("modulo_by_zero");
  s->addDynamicRel("mpz_overflow");
  s->addDynamicRel("mpz_table_overflow");
  s->addDynamicRel("nan_result");
  s->addDynamicRel("temp39a3159");
