...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("42f102d9");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan mincost __t9OzN4 N) (body (join edge (0 1 2) 1 N M W)) (head (mkstruct mincost (1 0) __5W6E34 M)) lat_demand.slog:20 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("mincost");
      outer_rel = db->getRelation("mincost");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("lat_demand.slog:20", "delta:mincost", _fires);
  ...
  // (crule (pre (let __tconst2ixo32 const6b86b273ff34fce19d6b804e)) (once) (body) (head (mkstruct mincost (1 0) __0KVz33 __tconst2ixo32)) lat_demand.slog:26 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("lat_demand.slog:26", "once", _fires);
  ...
  // (crule (pre (let __tconst5zVI3 const6b86b273ff34fce19d6b804e)) (once) (body) (head (mkstruct mincost (1 0) __8ytW35 __tconst5zVI3)) lat_demand.slog:23 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("lat_demand.slog:23", "once", _fires);
