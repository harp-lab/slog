...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("f2666a0c");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan split __40Ni11 n) (body) (head (emit demanded (0) n)) dem_multi.slog:17 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("demanded");
      std::vector<u16> ord1({0});
      slog::Relation* readrel2 = db->getRelation("demanded");
      head_index[0] = readrel2->getIndex(ord1, false);
      outer_rel = db->getRelation("split");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_multi.slog:17", "all:split", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre5k9G69 __errf2CbB70 __errf3Mpj71) (body) (head (emit error (0) __erre5k9G69)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre2BcQ42 __errf5Sg643 __errf6NgI44) (body) (head (emit error (0) __erre2BcQ42)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre4hEj52 __errf9Wwa53 __errf70U454 __errf7rcV55) (body) (head (emit error (0) __erre4hEj52)) <internal>:1 #f)
  ...
  // (crule (pre) (scan num a) (body (join num (0) 0 b) (let __t0Nz62 (_0002b a b)) (join split (1 0) 1 __t0Nz62 __t7dsB1)) (head (emit split_ans (0 1 2) __t7dsB1 a b)) dem_multi.slog:10 #f)
  class ReadTask14 : public slog::Task
  {
    ...
    slog::Index** numindex12;  slog::Index** splitindex13;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("split_ans");
      std::vector<u16> ord15({0, 1, 2});
      slog::Relation* readrel16 = db->getRelation("split_ans");
      head_index[0] = readrel16->getIndex(ord15, false);
      outer_rel = db->getRelation("num");
      std::vector<u16> ord17({0});
      slog::Relation* readrel18 = db->getRelation("num");
      numindex12 = readrel18->getIndex(ord17, false);
      std::vector<u16> ord19({1, 0});
      slog::Relation* readrel20 = db->getRelation("split");
      splitindex13 = readrel20->getIndex(ord19, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c12 = _t[0];
        slog::join_all<1>(numindex12, [&](const std::array<u64,1>& m21) {
          u64 v_c13 = m21[0];
          u64 v_c14 = _prim__0002b(db, v_c12, v_c13);
          if (v_c14 == slog_error) { slog::emit_pending_error(db, "dem_multi.slog:10"); return; }
          slog::join_probe<2,1>(splitindex13, std::array<u64,2>{v_c14, 0}, [&](const std::array<u64,2>& m22) {
            u64 v_c15 = m22[1];
            ++_fires;
            slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c15, v_c12, v_c13}, std::array<u16,3>{0, 1, 2});
          });
        });
      });
      ...
      if (_fires) db->bumpFires("dem_multi.slog:10", "all:num", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre5YNu59 __errf7YwR60 __errf0LHw61 __errf4ILD62 __errf0DV863) (body) (head (emit error (0) __erre5YNu59)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre7KGL56 __errf3U0v57 __errf3zk858) (body) (head (emit error (0) __erre7KGL56)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre4d5845 __errf6OCf46 __errf2bAy47) (body) (head (emit error (0) __erre4d5845)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre97PS48 __errf5J2x49 __errf4Hft50 __errf3hSY51) (body) (head (emit error (0) __erre97PS48)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre1ipG64 __errf2C5M65 __errf01uG66 __errf7M0467 __errf4UDE68) (body) (head (emit error (0) __erre1ipG64)) <internal>:1 #f)
