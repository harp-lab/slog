...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("c1397a41");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp7V1v71");
  if (r == 0) db->addTempRelation("temp7V1v71", 2);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre9CD668 __errf6s2o69 __errf3wZT70) (body) (head (emit error (0) __erre9CD668)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp7V1v71 X __t9GUy10) (body) (head (emit q (0 1) X __t9GUy10)) prim2_headlet.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      outer_rel = db->getRelation("temp7V1v71");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("prim2_headlet.slog:14", "delta:temp7V1v71", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre6zNt41 __errf13qP42 __errf5PsZ43) (body) (head (emit error (0) __erre6zNt41)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst2CAx9 const6b86b273ff34fce19d6b804e)) (scan p X __t9GUy10) (body (let chk17hw72 (_0002b X __tconst2CAx9)) (eq __t9GUy10 chk17hw72)) (head (emit-temp temp7V1v71 X __t9GUy10)) prim2_headlet.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp7V1v71");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c3 = _t[0];
        u64 v_c4 = _t[1];
        u64 v_c9 = _prim__0002b(db, v_c3, v_c8);
        if (v_c9 == slog_error) { slog::emit_pending_error(db, "prim2_headlet.slog:14"); return; }
        if (v_c4 != v_c9) return;
        ++_fires;
      ...
      if (_fires) db->bumpFires("prim2_headlet.slog:14", "all:p", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre67Ye44 __errf8jhT45 __errf63RH46) (body) (head (emit error (0) __erre67Ye44)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre7pnq55 __errf97vl56 __errf8uUD57) (body) (head (emit error (0) __erre7pnq55)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre0GtS63 __errf0Vby64 __errf6Gmc65 __errf6V0C66 __errf6rGV67) (body) (head (emit error (0) __erre0GtS63)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre1xvD47 __errf0o7R48 __errf9vp749 __errf2hqn50) (body) (head (emit error (0) __erre1xvD47)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre28kf51 __errf6dHW52 __errf2KC753 __errf54TA54) (body) (head (emit error (0) __erre28kf51)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre86iX58 __errf93cT59 __errf93Gm60 __errf9hwu61 __errf9dAC62) (body) (head (emit error (0) __erre86iX58)) <internal>:1 #f)
