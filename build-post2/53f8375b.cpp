...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("53f8375b");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst477w10 constb40d060f542e4963e0fc1392)) (once) (body) (head (mkstruct _enum (1 0) __5tFR11 __tconst477w10)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst6xLR8 const4e07408562bedb8b60ce05c1) (let __tconst5bkw7 constd4735e3a265e16eee03f5971) (let __tconst2ibA6 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit src (0) __tconst6xLR8) (emit src (0) __tconst5bkw7) (emit src (0) __tconst2ibA6)) stage_derived.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel3 = db->getRelation("src");
      ...
      slog::Relation* readrel7 = db->getRelation("src");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("stage_derived.slog:15", "once", _fires);
