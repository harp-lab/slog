...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("9619e108");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan edge X Y) (body) (head (emit path (0 1) X Y)) reach.slog:9 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("reach.slog:9", "all:edge", _fires);
  ...
  // (crule (pre) (scan path X Y) (body (join edge (0 1) 1 Y Z)) (head (emit path (0 1) X Z)) reach.slog:14 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("reach.slog:14", "delta:path", _fires);
