...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("aeaef15f");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp7oYh1242");
  if (r == 0) db->addTempRelation("temp7oYh1242", 3);
  else if (r->getArity() != 3) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp19MW1243");
  if (r == 0) db->addTempRelation("temp19MW1243", 3);
  else if (r->getArity() != 3) slog::fatal("Temp rel arity mismatch.");
  ...
  if (r == 0) db->addRelation("$sup56712x93x0x0x0", 5);
    ...
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("$sup56712x93x0x0x0");
      std::vector<u16> ord180({0, 1, 2, 3, 4});
  ...
  // (crule (pre) (scan int_overflow __erre7m6n1215 __errf2Yhr1216 __errf4jiM1217 __errf4QYC1218) (body) (head (emit error (0) __erre7m6n1215)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp7oYh1242 __t1b4s431 l x) (body) (head (emit-lat flow_count x l __t1b4s431)) counting.slog:28 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      outer_rel = db->getRelation("temp7oYh1242");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c6 = _t[2];
        ++_fires;
        slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c6, v_c5, v_c4});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("counting.slog:28", "delta:temp7oYh1242", _fires);
  ...
  // (crule (pre) (scan temp19MW1243 __t0x5X17 l x) (body) (head (emit-lat flow_count x l __t0x5X17)) counting.slog:27 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("flow_count");
      outer_rel = db->getRelation("temp19MW1243");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c6 = _t[2];
        ++_fires;
        slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c6, v_c5, v_c7});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("counting.slog:27", "delta:temp19MW1243", _fires);
  ...
  // (crule (pre (let __t1b4s431 (inf))) (scan binding x l v2) (body (join binding (0 1 2) 2 x l v1) (neq v1 v2)) (head (emit-temp temp7oYh1242 __t1b4s431 l x)) counting.slog:28 #f)
  class ReadTask6 : public slog::Task
  {
    ...
    slog::Index** bindingindex5;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp7oYh1242");
      outer_rel = db->getRelation("binding");
      std::vector<u16> ord7({0, 1, 2});
      slog::Relation* readrel8 = db->getRelation("binding");
      bindingindex5 = readrel8->getIndex(ord7, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c5 = _t[1];
        u64 v_c8 = _t[2];
        slog::join_probe<3,2>(bindingindex5, std::array<u64,3>{v_c6, v_c5, 0}, [&](const std::array<u64,3>& m9) {
          u64 v_c9 = m9[2];
          if (v_c9 == v_c8) return;
          ++_fires;
          slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c4, v_c5, v_c6});
        });
      });
  ...
  // (crule (pre) (scan type_mismatch __erre6g491226 __errf1i4y1227 __errf7QtZ1228 __errf8YAs1229 __errf6prV1230) (body) (head (emit error (0) __erre6g491226)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre2XIS1231 __errf0fTI1232 __errf1E9S1233 __errf6QCg1234 __errf5I8n1235) (body) (head (emit error (0) __erre2XIS1231)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre2G7I1236 __errf48Y11237 __errf9IwV1238) (body) (head (emit error (0) __erre2G7I1236)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre9ciT1219 __errf1cNp1220 __errf3eXz1221 __errf1pIe1222) (body) (head (emit error (0) __erre9ciT1219)) <internal>:1 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel25 = db->getRelation("many_frames");
      head_index[0] = readrel25->getIndex(ord24, false);
      outer_rel = db->getRelation("call_event");
      std::vector<u16> ord26({0, 1});
      slog::Relation* readrel27 = db->getRelation("call_event");
      call_eventindex22 = readrel27->getIndex(ord26, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c5 = _t[0];
        u64 v_c27 = _t[1];
        slog::join_probe<2,1>(call_eventindex22, std::array<u64,2>{v_c5, 0}, [&](const std::array<u64,2>& m28) {
          u64 v_c28 = m28[1];
          if (v_c28 == v_c27) return;
          ++_fires;
  ...
  // (crule (pre) (scan eval __6iUY759 e c) (body) (head (emit reachable_expr (0) e)) interp.slog:131 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel31 = db->getRelation("reachable_expr");
  ...
  // (crule (pre) (scan div_by_zero __erre3b7I1209 __errf7Vu41210 __errf7MbL1211) (body) (head (emit error (0) __erre3b7I1209)) <internal>:1 #f)
  ...
  // (crule (pre (let _00024sqc1PvW566 const5feceb66ffc86f38d952786c)) (scan program e) (body (join eval (1 2 0) 1 e _00024seq0 __t3y7s319) (join eval_ans (0 1) 1 __t3y7s319 v) (letp _00024sql8CfP564 (aslst _00024seq0)) (let chk6xQc1239 (llen _00024sql8CfP564)) (eq _00024sqc1PvW566 chk6xQc1239)) (head (emit program_result (0) v)) interp.slog:130 #f)
  class ReadTask37 : public slog::Task
  {
    ...
    slog::Index** evalindex35;  slog::Index** eval_ansindex36;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel39 = db->getRelation("program_result");
      ...
      evalindex35 = readrel41->getIndex(ord40, false);
      std::vector<u16> ord42({0, 1});
      slog::Relation* readrel43 = db->getRelation("eval_ans");
      eval_ansindex36 = readrel43->getIndex(ord42, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c30 = _t[0];
        slog::join_probe<3,1>(evalindex35, std::array<u64,3>{v_c30, 0, 0}, [&](const std::array<u64,3>& m44) {
          u64 v_c36 = m44[1]; u64 v_c37 = m44[2];
          slog::join_probe<2,1>(eval_ansindex36, std::array<u64,2>{v_c37, 0}, [&](const std::array<u64,2>& m45) {
            u64 v_c38 = m45[1];
            bool ok46 = true;
            u64 v_c39 = _prim_aslst(db, v_c36, &ok46);
            if (!ok46) return;
            u64 v_c40 = _prim_llen(db, v_c39);
            if (v_c40 == slog_error) { slog::emit_pending_error(db, "interp.slog:130"); return; }
  ...
  // (crule (pre) (scan toint_range __erre7Djx1223 __errf9M7L1224 __errf2n7Y1225) (body) (head (emit error (0) __erre7Djx1223)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre0LPi1212 __errf65Z01213 __errf2ybu1214) (body) (head (emit error (0) __erre0LPi1212)) <internal>:1 #f)
  ...
  // (crule (pre (let __t0x5X17 (one))) (scan binding x l v) (body) (head (emit-temp temp19MW1243 __t0x5X17 l x)) counting.slog:27 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp19MW1243");
      outer_rel = db->getRelation("binding");
    ...
    virtual bool work()
    {
      u64 v_c7 = _prim_one(db);
      if (v_c7 == slog_error) { slog::emit_pending_error(db, "counting.slog:27"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c38 = _t[2];
        ++_fires;
        slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c7, v_c5, v_c6});
      });
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel57 = db->getRelation("many_frames");
      head_index[0] = readrel57->getIndex(ord56, false);
      outer_rel = db->getRelation("many_frames");
      std::vector<u16> ord58({1, 0});
      slog::Relation* readrel59 = db->getRelation("call_event");
      call_eventindex54 = readrel59->getIndex(ord58, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c31 = _t[0];
        slog::join_probe<2,1>(call_eventindex54, std::array<u64,2>{v_c31, 0}, [&](const std::array<u64,2>& m60) {
          u64 v_c5 = m60[1];
          ++_fires;
          slog::emit<1>(head_rel[0], head_index[0], newbatch[0], std::array<u64,1>{v_c5}, std::array<u16,1>{0});
        });
  ...
  s->addReadRel("temp19MW1243");
  s->addReadRel("temp7oYh1242");
  ...
  s->addDynamicRel("temp19MW1243");
  s->addDynamicRel("temp7oYh1242");
