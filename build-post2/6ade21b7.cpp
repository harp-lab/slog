...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("6ade21b7");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst3f4g5 const9ddefe4435b21d901439e546) (let __tconst7dkV4 const12ae32cb1ec02d01eda3581b) (let __tconst2IHp3 constb2213295d564916f89a6a424)) (once) (body) (head (emit w (0) __tconst3f4g5) (emit w (0) __tconst7dkV4) (emit w (0) __tconst2IHp3)) prim2_size.slog:8 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("prim2_size.slog:8", "once", _fires);
