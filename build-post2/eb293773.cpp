...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("eb293773");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst7vn883 consta221beeaebe583607e193be7)) (once) (body) (head (mkstruct _enum (1 0) __82mQ84 __tconst7vn883)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst1PN085 constab76c7d069d6f33dc950fb33)) (once) (body) (head (mkstruct _enum (1 0) __7igP86 __tconst1PN085)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst6Tya87 consteb8bf0d80db323992f6b634a)) (once) (body) (head (mkstruct _enum (1 0) __46hJ88 __tconst6Tya87)) <internal>:1 #f)
