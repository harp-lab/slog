...
u64 v_const8aed642bf5118b9d3c859bd4;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("9e1e5a5f");
  if (s == nullptr) return;
  slog::Relation* r;
  v_const8aed642bf5118b9d3c859bd4 = float_encode(0.0);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre9QpW71 __errf3BiA72 __errf2J9J73) (body) (head (emit error (0) __erre9QpW71)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre5fsW54 __errf8IMK55 __errf8n3456 __errf8hwr57) (body) (head (emit error (0) __erre5fsW54)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre8IXy47 __errf85gV48 __errf5CxE49) (body) (head (emit error (0) __erre8IXy47)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre5mmg50 __errf43bx51 __errf15mz52 __errf3Wt453) (body) (head (emit error (0) __erre5mmg50)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre0WTR44 __errf1k3145 __errf6k8C46) (body) (head (emit error (0) __erre0WTR44)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst2ETx1 const8aed642bf5118b9d3c859bd4)) (scan fl F) (body (let __t5ic32 (_0002d __tconst2ETx1 F)) (let __t78E23 (toint __t5ic32))) (head (emit tineg (0 1) __t5ic32 __t78E23)) prim2_roundtrip.slog:22 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("tineg");
      std::vector<u16> ord16({0, 1});
      slog::Relation* readrel17 = db->getRelation("tineg");
      head_index[0] = readrel17->getIndex(ord16, false);
      outer_rel = db->getRelation("fl");
  
    }
    ReadTask15(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c17 = v_const8aed642bf5118b9d3c859bd4;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c18 = _t[0];
        u64 v_c19 = _prim__0002d(db, v_c17, v_c18);
        if (v_c19 == slog_error) { slog::emit_pending_error(db, "prim2_roundtrip.slog:22"); return; }
        u64 v_c20 = _prim_toint(db, v_c19);
        if (v_c20 == slog_error) { slog::emit_pending_error(db, "prim2_roundtrip.slog:22"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("prim2_roundtrip.slog:22", "all:fl", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre4VbE66 __errf8DkY67 __errf9gJ968 __errf4Ij569 __errf41rj70) (body) (head (emit error (0) __erre4VbE66)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre1Mom61 __errf7uSG62 __errf7Sjw63 __errf7cMV64 __errf3dTB65) (body) (head (emit error (0) __erre1Mom61)) <internal>:1 #f)
  ...
  // (crule (pre) (scan fl F) (body (let __t06mi6 (toint F)) (let __t2fj37 (tofloat __t06mi6))) (head (emit rtf (0 1) F __t2fj37)) prim2_roundtrip.slog:21 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("rtf");
      std::vector<u16> ord25({0, 1});
      slog::Relation* readrel26 = db->getRelation("rtf");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c18 = _t[0];
        u64 v_c31 = _prim_toint(db, v_c18);
        if (v_c31 == slog_error) { slog::emit_pending_error(db, "prim2_roundtrip.slog:21"); return; }
        u64 v_c32 = _prim_tofloat(db, v_c31);
        if (v_c32 == slog_error) { slog::emit_pending_error(db, "prim2_roundtrip.slog:21"); return; }
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c18, v_c32}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim2_roundtrip.slog:21", "all:fl", _fires);
  ...
  // (crule (pre) (scan toint_range __erre7c0458 __errf2Cyq59 __errf0f5u60) (body) (head (emit error (0) __erre7c0458)) <internal>:1 #f)
  ...
  // (crule (pre) (scan i N) (body (let __t9rc44 (tofloat N)) (let __t2fcx5 (toint __t9rc44))) (head (emit rti (0 1) N __t2fcx5)) prim2_roundtrip.slog:20 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("rti");
      std::vector<u16> ord31({0, 1});
      slog::Relation* readrel32 = db->getRelation("rti");
      head_index[0] = readrel32->getIndex(ord31, false);
      outer_rel = db->getRelation("i");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c36 = _t[0];
        u64 v_c37 = _prim_tofloat(db, v_c36);
        if (v_c37 == slog_error) { slog::emit_pending_error(db, "prim2_roundtrip.slog:20"); return; }
        u64 v_c38 = _prim_toint(db, v_c37);
        if (v_c38 == slog_error) { slog::emit_pending_error(db, "prim2_roundtrip.slog:20"); return; }
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c36, v_c38}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim2_roundtrip.slog:20", "all:i", _fires);
