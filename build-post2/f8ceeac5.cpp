...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("f8ceeac5");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan toint_range __erre6gu452 __errf0P1m53 __errf87mo54) (body) (head (emit error (0) __erre6gu452)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre5AWP65 __errf8RKz66 __errf7Win67) (body) (head (emit error (0) __erre5AWP65)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst4jj53 const6b86b273ff34fce19d6b804e)) (scan inc __t5cwI2 n) (body (let __t7oOC4 (_0002b n __tconst4jj53))) (head (emit inc_ans (0 1) __t5cwI2 __t7oOC4)) dem_chain.slog:6 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("inc_ans");
      std::vector<u16> ord7({0, 1});
      slog::Relation* readrel8 = db->getRelation("inc_ans");
      head_index[0] = readrel8->getIndex(ord7, false);
      outer_rel = db->getRelation("inc");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c7 = _t[0];
        u64 v_c8 = _t[1];
        u64 v_c9 = _prim__0002b(db, v_c8, v_c6);
        if (v_c9 == slog_error) { slog::emit_pending_error(db, "dem_chain.slog:6"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("dem_chain.slog:6", "all:inc", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre7bgl41 __errf9Zeq42 __errf8Iwh43) (body) (head (emit error (0) __erre7bgl41)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre9Mk048 __errf8bBo49 __errf6f2p50 __errf0Alw51) (body) (head (emit error (0) __erre9Mk048)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre33h538 __errf7hwf39 __errf86j740) (body) (head (emit error (0) __erre33h538)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre4E8a55 __errf4Jov56 __errf0ytM57 __errf0dYB58 __errf3SyW59) (body) (head (emit error (0) __erre4E8a55)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre9FvB60 __errf5rAY61 __errf8sqi62 __errf1p1s63 __errf5CWF64) (body) (head (emit error (0) __erre9FvB60)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre709h44 __errf0AHQ45 __errf5WJQ46 __errf6KU347) (body) (head (emit error (0) __erre709h44)) <internal>:1 #f)
