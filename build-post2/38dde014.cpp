...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("38dde014");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan mpz_overflow __erre428T224 __errf3OxW225 __errf9VkP226 __errf4M2F227 __errf0tq6228) (body) (head (emit error (0) __erre428T224)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre3iQf216 __errf6C6V217 __errf1ncL218) (body) (head (emit error (0) __erre3iQf216)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre1dWt202 __errf7HSF203 __errf05HK204) (body) (head (emit error (0) __erre1dWt202)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre2Xox208 __errf3dsO209 __errf3hmy210 __errf2Bwt211) (body) (head (emit error (0) __erre2Xox208)) <internal>:1 #f)
  ...
  // (crule (pre) (scan dom h a) (body (join edge (0 1) 2 a h)) (head (emit backedge (0 1) a h)) domtree.slog:86 #f)
  class ReadTask13 : public slog::Task
  {
    ...
    slog::Index** edgeindex12;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("backedge");
      std::vector<u16> ord14({0, 1});
      slog::Relation* readrel15 = db->getRelation("backedge");
      head_index[0] = readrel15->getIndex(ord14, false);
      outer_rel = db->getRelation("dom");
      std::vector<u16> ord16({0, 1});
      slog::Relation* readrel17 = db->getRelation("edge");
      edgeindex12 = readrel17->getIndex(ord16, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c15 = _t[0];
        u64 v_c16 = _t[1];
        slog::join_probe<2,2>(edgeindex12, std::array<u64,2>{v_c16, v_c15}, [&](const std::array<u64,2>& m18) {
          ++_fires;
      ...
      if (_fires) db->bumpFires("domtree.slog:86", "all:dom", _fires);
  ...
  // (crule (pre (let __t6A9d17 (cmap))) (scan dom d n) (body (let __t5vsi18 (cins __t6A9d17 d))) (head (emit-lat domset n __t5vsi18)) domtree.slog:68 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("domset");
      outer_rel = db->getRelation("dom");
    ...
    virtual bool work()
    {
      u64 v_c17 = _prim_cmap(db);
      if (v_c17 == slog_error) { slog::emit_pending_error(db, "domtree.slog:68"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c18 = _t[0];
        u64 v_c19 = _t[1];
        u64 v_c20 = _prim_cins(db, v_c17, v_c18);
        if (v_c20 == slog_error) { slog::emit_pending_error(db, "domtree.slog:68"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c19, v_c20});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("domtree.slog:68", "all:dom", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre7ctU205 __errf4B2r206 __errf5Afi207) (body) (head (emit error (0) __erre7ctU205)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre75om219 __errf75AE220 __errf5p9B221 __errf5xj2222 __errf4PEv223) (body) (head (emit error (0) __erre75om219)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre8Tca212 __errf8aDc213 __errf5B7v214 __errf6yrc215) (body) (head (emit error (0) __erre8Tca212)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre9mSD229 __errf60Ny230 __errf1eLm231) (body) (head (emit error (0) __erre9mSD229)) <internal>:1 #f)
  ...
  s->addDynamicRel("backedge");
  s->addDynamicRel("div_by_zero");
  s->addDynamicRel("domset");
