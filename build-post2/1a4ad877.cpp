...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("1a4ad877");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst9a9z20 const4bc9274d8758b867e8c071a6)) (once) (body) (head (mkstruct _enum (1 0) __5FBD21 __tconst9a9z20)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst5hML22 const3aae004f448787fcf06c2d53)) (once) (body) (head (mkstruct _enum (1 0) __8Q0h23 __tconst5hML22)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c1 = v_const3aae004f448787fcf06c2d53;
  ...
  // (crule (pre (let __tconst6Mzm18 const7f3e916bf628c503cac5f6ba)) (once) (body) (head (mkstruct _enum (1 0) __333M19 __tconst6Mzm18)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c2 = v_const7f3e916bf628c503cac5f6ba;
