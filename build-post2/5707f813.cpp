...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("5707f813");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan smt_vcode C V) (body (join smt_qsat_ans (1 0) 1 C __t7N6i26) (join smt_qsat (0 1) 1 __t7N6i26 F) (join smt_check (1 0) 1 F __t5CNP25)) (head (emit smt_check_ans (0 1) __t5CNP25 V)) smt.slog:69 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre9Tnz158 __errf8O6n159 __errf5Ytl160 __errf7oMC161 __errf6nv7162) (body) (head (emit error (0) __erre9Tnz158)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst2CJM30 constfa94099f784d91500e1b95df) (let __trid377366 constd2c28e4f541b3051f713f2a3) (let __trel7EcO67 const356829ca6c3df0a0d1117410) (let __tcol6rKG68 constd4735e3a265e16eee03f5971)) (scan smt_vcode __t2l9O29 V) (body (join smt_qcore_ans (0 1) 0 __t0Ybe32 M0) (join smt_qcore (0 1) 1 __t0Ybe32 F) (join smt_core (1 0) 1 F __t7q6T27) (letp chk670Y167 (cget M0 __tconst2CJM30)) (eq __t2l9O29 chk670Y167) (let __t5HJ931 (cdel M0 __tconst2CJM30))) (head (tycheck __t5HJ931 (accept cnode) __trid377366 __trel7EcO67 __tcol6rKG68 (1 2 3 4 0)) (emit smt_core_ans (0 1 2) __t7q6T27 V __t5HJ931)) smt.slog:106 #f)
  class ReadTask21 : public slog::Task
  {
    ...
    slog::Index** smt_qcore_ansindex18;  slog::Index** smt_qcoreindex19;  slog::Index** smt_coreindex20;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel23 = db->getRelation("smt_core_ans");
      head_index[1] = readrel23->getIndex(ord22, false);
      outer_rel = db->getRelation("smt_vcode");
      std::vector<u16> ord24({0, 1});
      slog::Relation* readrel25 = db->getRelation("smt_qcore_ans");
      smt_qcore_ansindex18 = readrel25->getIndex(ord24, false);
      std::vector<u16> ord26({0, 1});
      slog::Relation* readrel27 = db->getRelation("smt_qcore");
      smt_qcoreindex19 = readrel27->getIndex(ord26, false);
      std::vector<u16> ord28({1, 0});
      slog::Relation* readrel29 = db->getRelation("smt_core");
      smt_coreindex20 = readrel29->getIndex(ord28, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c14 = _t[0];
        u64 v_c1 = _t[1];
        slog::join_all<2>(smt_qcore_ansindex18, [&](const std::array<u64,2>& m30) {
          u64 v_c15 = m30[0]; u64 v_c16 = m30[1];
          slog::join_probe<2,1>(smt_qcoreindex19, std::array<u64,2>{v_c15, 0}, [&](const std::array<u64,2>& m31) {
            u64 v_c3 = m31[1];
            slog::join_probe<2,1>(smt_coreindex20, std::array<u64,2>{v_c3, 0}, [&](const std::array<u64,2>& m32) {
              u64 v_c17 = m32[1];
              bool ok33 = true;
              u64 v_c18 = _prim_cget(db, v_c16, v_c10, &ok33);
              if (!ok33) return;
              if (v_c14 != v_c18) return;
              u64 v_c19 = _prim_cdel(db, v_c16, v_c10);
              if (v_c19 == slog_error) { slog::emit_pending_error(db, "smt.slog:106"); return; }
              ++_fires;
              if (!(is_cnode(v_c19)))
              {
                slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c11, v_c12, v_c13, v_c19}, std::array<u16,5>{1, 2, 3, 4, 0});
                return;
              }
              slog::emit<3>(head_rel[1], head_index[1], newbatch[1], std::array<u64,3>{v_c17, v_c1, v_c19}, std::array<u16,3>{0, 1, 2});
            });
          });
        });
      });
  ...
  // (crule (pre (let __tconst1DKz36 constfa94099f784d91500e1b95df) (let __trid1L2771 constbf14e8e2740173c2e99e36a3) (let __trel361T72 const7b4b6d235bc6fbc8c9ba5801) (let __tcol92r973 constd4735e3a265e16eee03f5971)) (scan smt_vcode __t13Ea35 V) (body (join smt_qmodel_ans (0 1) 0 __t4lP538 M0) (join smt_qmodel (0 1) 1 __t4lP538 F) (join smt_model (1 0) 1 F __t2ndB33) (letp chk2YHf166 (cget M0 __tconst1DKz36)) (eq __t13Ea35 chk2YHf166) (let __t3Oot37 (cdel M0 __tconst1DKz36))) (head (tycheck __t3Oot37 (accept cnode) __trid1L2771 __trel361T72 __tcol92r973 (1 2 3 4 0)) (emit smt_model_ans (0 1 2) __t2ndB33 V __t3Oot37)) smt.slog:93 #f)
  class ReadTask37 : public slog::Task
  {
    ...
    slog::Index** smt_qmodel_ansindex34;  slog::Index** smt_qmodelindex35;  slog::Index** smt_modelindex36;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel39 = db->getRelation("smt_model_ans");
      head_index[1] = readrel39->getIndex(ord38, false);
      outer_rel = db->getRelation("smt_vcode");
      std::vector<u16> ord40({0, 1});
      slog::Relation* readrel41 = db->getRelation("smt_qmodel_ans");
      smt_qmodel_ansindex34 = readrel41->getIndex(ord40, false);
      std::vector<u16> ord42({0, 1});
      slog::Relation* readrel43 = db->getRelation("smt_qmodel");
      smt_qmodelindex35 = readrel43->getIndex(ord42, false);
      std::vector<u16> ord44({1, 0});
      slog::Relation* readrel45 = db->getRelation("smt_model");
      smt_modelindex36 = readrel45->getIndex(ord44, false);
  
    }
    ReadTask37(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c20 = v_constfa94099f784d91500e1b95df;
      u64 v_c21 = v_constbf14e8e2740173c2e99e36a3;
      u64 v_c22 = v_const7b4b6d235bc6fbc8c9ba5801;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c24 = _t[0];
        u64 v_c1 = _t[1];
        slog::join_all<2>(smt_qmodel_ansindex34, [&](const std::array<u64,2>& m46) {
          u64 v_c25 = m46[0]; u64 v_c16 = m46[1];
          slog::join_probe<2,1>(smt_qmodelindex35, std::array<u64,2>{v_c25, 0}, [&](const std::array<u64,2>& m47) {
            u64 v_c3 = m47[1];
            slog::join_probe<2,1>(smt_modelindex36, std::array<u64,2>{v_c3, 0}, [&](const std::array<u64,2>& m48) {
              u64 v_c26 = m48[1];
              bool ok49 = true;
              u64 v_c27 = _prim_cget(db, v_c16, v_c20, &ok49);
              if (!ok49) return;
              if (v_c24 != v_c27) return;
              u64 v_c28 = _prim_cdel(db, v_c16, v_c20);
              if (v_c28 == slog_error) { slog::emit_pending_error(db, "smt.slog:93"); return; }
              ++_fires;
              if (!(is_cnode(v_c28)))
              {
                slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c21, v_c22, v_c23, v_c28}, std::array<u16,5>{1, 2, 3, 4, 0});
                return;
              }
              slog::emit<3>(head_rel[1], head_index[1], newbatch[1], std::array<u64,3>{v_c26, v_c1, v_c28}, std::array<u16,3>{0, 1, 2});
            });
          });
        });
      });
  ...
  // (crule (pre) (scan modulo_by_zero __erre3hPN139 __errf8GTu140 __errf0FXs141) (body) (head (emit error (0) __erre3hPN139)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre3WZl142 __errf2o9n143 __errf45Ek144 __errf0Ny5145) (body) (head (emit error (0) __erre3WZl142)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre2cR9153 __errf2Egc154 __errf1kql155 __errf2WNZ156 __errf3c3F157) (body) (head (emit error (0) __erre2cR9153)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre9O83150 __errf6Bkc151 __errf9RjN152) (body) (head (emit error (0) __erre9O83150)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre3752163 __errf6nbM164 __errf6ASq165) (body) (head (emit error (0) __erre3752163)) <internal>:1 #f)
  ...
  // (crule (pre) (scan malformed_deduction __erre98wh131 __errf1TMB132 __errf2K7Z133 __errf9ubW134 __errf4trq135) (body) (head (emit error (0) __erre98wh131)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre14bw146 __errf3bzz147 __errf2KSI148 __errf1uE6149) (body) (head (emit error (0) __erre14bw146)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre75Db136 __errf03KE137 __errf8QgA138) (body) (head (emit error (0) __erre75Db136)) <internal>:1 #f)
