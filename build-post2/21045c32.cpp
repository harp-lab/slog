...
u64 v_constb2213295d564916f89a6a424;
u64 v_const12ae32cb1ec02d01eda3581b;
u64 v_const9ddefe4435b21d901439e546;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("21045c32");
  if (s == nullptr) return;
  slog::Relation* r;
  v_constb2213295d564916f89a6a424 = db->encodeString("foo");
  v_const12ae32cb1ec02d01eda3581b = db->encodeString("");
  v_const9ddefe4435b21d901439e546 = db->encodeString("hello world");
  r = db->getRelation("w");
  ...
  // (crule (pre (let __tconst51yN6 const9ddefe4435b21d901439e546) (let __tconst5aWQ5 const12ae32cb1ec02d01eda3581b) (let __tconst2yRs4 constb2213295d564916f89a6a424)) (once) (body) (head (emit w (0) __tconst51yN6) (emit w (0) __tconst5aWQ5) (emit w (0) __tconst2yRs4)) prim2_sizeany.slog:10 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("w");
      std::vector<u16> ord1({0});
      slog::Relation* readrel2 = db->getRelation("w");
      head_index[0] = readrel2->getIndex(ord1, false);
      head_rel[1] = db->getRelation("w");
      std::vector<u16> ord3({0});
      slog::Relation* readrel4 = db->getRelation("w");
      head_index[1] = readrel4->getIndex(ord3, false);
      head_rel[2] = db->getRelation("w");
      std::vector<u16> ord5({0});
      slog::Relation* readrel6 = db->getRelation("w");
    ...
    virtual bool work()
    {
      u64 v_c0 = v_const9ddefe4435b21d901439e546;
      u64 v_c1 = v_const12ae32cb1ec02d01eda3581b;
      u64 v_c2 = v_constb2213295d564916f89a6a424;
      ...
      if (_fires) db->bumpFires("prim2_sizeany.slog:10", "once", _fires);
