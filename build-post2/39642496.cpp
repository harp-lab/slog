...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("39642496");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan smt_vcode C V) (body (join smt_qsat_ans (1 0) 1 C __t9D0q21) (join smt_qsat (0 1) 1 __t9D0q21 F) (join smt_check (1 0) 1 F __t20MD20)) (head (emit smt_check_ans (0 1) __t20MD20 V)) smt.slog:69 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre5vkl185 __errf5341186 __errf17zW187) (body) (head (emit error (0) __erre5vkl185)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre8neW199 __errf6wbB200 __errf805a201 __errf5WR6202 __errf8O4A203) (body) (head (emit error (0) __erre8neW199)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre9axC209 __errf4GDq210 __errf0MKO211) (body) (head (emit error (0) __erre9axC209)) <internal>:1 #f)
  ...
  // (crule (pre) (scan malformed_deduction __erre7sTw177 __errf5Tf8178 __errf92RN179 __errf50At180 __errf7dNZ181) (body) (head (emit error (0) __erre7sTw177)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre1AkC192 __errf96KD193 __errf1oWC194 __errf2azQ195) (body) (head (emit error (0) __erre1AkC192)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre7u5C196 __errf6dvN197 __errf5N5g198) (body) (head (emit error (0) __erre7u5C196)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre4FQx182 __errf9oIF183 __errf1lGF184) (body) (head (emit error (0) __erre4FQx182)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst3xKL25 constfa94099f784d91500e1b95df) (let __trid2jBL59 constd2c28e4f541b3051f713f2a3) (let __trel4TX760 const356829ca6c3df0a0d1117410) (let __tcol2hgV61 constd4735e3a265e16eee03f5971)) (scan smt_vcode __t9jlr24 V) (body (join smt_qcore_ans (0 1) 0 __t2t5u27 M0) (join smt_qcore (0 1) 1 __t2t5u27 F) (join smt_core (1 0) 1 F __t1h4322) (letp chk1nCA212 (cget M0 __tconst3xKL25)) (eq __t9jlr24 chk1nCA212) (let __t73gH26 (cdel M0 __tconst3xKL25))) (head (tycheck __t73gH26 (accept cnode) __trid2jBL59 __trel4TX760 __tcol2hgV61 (1 2 3 4 0)) (emit smt_core_ans (0 1 2) __t1h4322 V __t73gH26)) smt.slog:106 #f)
  class ReadTask39 : public slog::Task
  {
    ...
    slog::Index** smt_qcore_ansindex36;  slog::Index** smt_qcoreindex37;  slog::Index** smt_coreindex38;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel41 = db->getRelation("smt_core_ans");
      head_index[1] = readrel41->getIndex(ord40, false);
      outer_rel = db->getRelation("smt_vcode");
      std::vector<u16> ord42({0, 1});
      slog::Relation* readrel43 = db->getRelation("smt_qcore_ans");
      smt_qcore_ansindex36 = readrel43->getIndex(ord42, false);
      std::vector<u16> ord44({0, 1});
      slog::Relation* readrel45 = db->getRelation("smt_qcore");
      smt_qcoreindex37 = readrel45->getIndex(ord44, false);
      std::vector<u16> ord46({1, 0});
      slog::Relation* readrel47 = db->getRelation("smt_core");
      smt_coreindex38 = readrel47->getIndex(ord46, false);
  
    }
    ReadTask39(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c31 = v_constfa94099f784d91500e1b95df;
      u64 v_c32 = v_constd2c28e4f541b3051f713f2a3;
      u64 v_c33 = v_const356829ca6c3df0a0d1117410;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c35 = _t[0];
        u64 v_c1 = _t[1];
        slog::join_all<2>(smt_qcore_ansindex36, [&](const std::array<u64,2>& m48) {
          u64 v_c36 = m48[0]; u64 v_c37 = m48[1];
          slog::join_probe<2,1>(smt_qcoreindex37, std::array<u64,2>{v_c36, 0}, [&](const std::array<u64,2>& m49) {
            u64 v_c3 = m49[1];
            slog::join_probe<2,1>(smt_coreindex38, std::array<u64,2>{v_c3, 0}, [&](const std::array<u64,2>& m50) {
              u64 v_c38 = m50[1];
              bool ok51 = true;
              u64 v_c39 = _prim_cget(db, v_c37, v_c31, &ok51);
              if (!ok51) return;
              if (v_c35 != v_c39) return;
              u64 v_c40 = _prim_cdel(db, v_c37, v_c31);
              if (v_c40 == slog_error) { slog::emit_pending_error(db, "smt.slog:106"); return; }
              ++_fires;
              if (!(is_cnode(v_c40)))
              {
                slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c32, v_c33, v_c34, v_c40}, std::array<u16,5>{1, 2, 3, 4, 0});
                return;
              }
              slog::emit<3>(head_rel[1], head_index[1], newbatch[1], std::array<u64,3>{v_c38, v_c1, v_c40}, std::array<u16,3>{0, 1, 2});
            });
          });
        });
      });
    ...
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_read, new ReadTask39(db,b), true);
  // (crule (pre) (scan mpz_overflow __erre6LUJ204 __errf9Tvx205 __errf3Ii9206 __errf6fCO207 __errf8Nr3208) (body) (head (emit error (0) __erre6LUJ204)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre7i4N188 __errf8R94189 __errf75MM190 __errf2OO4191) (body) (head (emit error (0) __erre7i4N188)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst869w33 constfa94099f784d91500e1b95df) (let __trid7Ckm51 constbf14e8e2740173c2e99e36a3) (let __trel0pwB52 const7b4b6d235bc6fbc8c9ba5801) (let __tcol0dE753 constd4735e3a265e16eee03f5971)) (scan smt_vcode __t3GYc32 V) (body (join smt_qmodel_ans (0 1) 0 __t6xwO35 M0) (join smt_qmodel (0 1) 1 __t6xwO35 F) (join smt_model (1 0) 1 F __t3mWs30) (letp chk9jLC213 (cget M0 __tconst869w33)) (eq __t3GYc32 chk9jLC213) (let __t3JBK34 (cdel M0 __tconst869w33))) (head (tycheck __t3JBK34 (accept cnode) __trid7Ckm51 __trel0pwB52 __tcol0dE753 (1 2 3 4 0)) (emit smt_model_ans (0 1 2) __t3mWs30 V __t3JBK34)) smt.slog:93 #f)
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        slog::join_all<2>(smt_qmodel_ansindex58, [&](const std::array<u64,2>& m70) {
          u64 v_c55 = m70[0]; u64 v_c37 = m70[1];
          slog::join_probe<2,1>(smt_qmodelindex59, std::array<u64,2>{v_c55, 0}, [&](const std::array<u64,2>& m71) {
            u64 v_c3 = m71[1];
            slog::join_probe<2,1>(smt_modelindex60, std::array<u64,2>{v_c3, 0}, [&](const std::array<u64,2>& m72) {
              u64 v_c56 = m72[1];
              bool ok73 = true;
              u64 v_c57 = _prim_cget(db, v_c37, v_c50, &ok73);
              if (!ok73) return;
              if (v_c54 != v_c57) return;
              u64 v_c58 = _prim_cdel(db, v_c37, v_c50);
              ...
              slog::emit<3>(head_rel[1], head_index[1], newbatch[1], std::array<u64,3>{v_c56, v_c1, v_c58}, std::array<u16,3>{0, 1, 2});
            });
          });
        });
      });
