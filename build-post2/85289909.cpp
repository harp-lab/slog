...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("85289909");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp6kCo86");
  if (r == 0) db->addTempRelation("temp6kCo86", 3);
  ...
  // (crule (pre) (scan dist X Y D) (body (join edge (0 1 2) 1 Y Z W) (let __t7SG825 (_0002b D W))) (head (emit-temp temp6kCo86 X Z __t7SG825)) lat_sssp_extract.slog:22 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("temp6kCo86");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c1 = _t[1];
        u64 v_c2 = _t[2];
        slog::join_probe<3,1>(edgeindex0, std::array<u64,3>{v_c1, 0, 0}, [&](const std::array<u64,3>& m4) {
          u64 v_c3 = m4[1]; u64 v_c4 = m4[2];
          u64 v_c5 = _prim__0002b(db, v_c2, v_c4);
          if (v_c5 == slog_error) { slog::emit_pending_error(db, "lat_sssp_extract.slog:22"); return; }
          ++_fires;
          slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c0, v_c3, v_c5});
        });
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lat_sssp_extract.slog:22", "delta:dist", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre8NfJ62 __errf0sHu63 __errf4og164 __errf5LYY65) (body) (head (emit error (0) __erre8NfJ62)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre5xND73 __errf4Pnj74 __errf81YP75 __errf37MY76 __errf2WKQ77) (body) (head (emit error (0) __erre5xND73)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre2gnH70 __errf7vnQ71 __errf6xQ772) (body) (head (emit error (0) __erre2gnH70)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre44kW78 __errf6sq479 __errf2a2O80 __errf2BVS81 __errf6wBY82) (body) (head (emit error (0) __erre44kW78)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre4CKt56 __errf3IFq57 __errf1sj758) (body) (head (emit error (0) __erre4CKt56)) <internal>:1 #f)
  ...
  // (crule (pre) (scan edge X Y W) (body) (head (emit-lat dist X Y W)) lat_sssp_extract.slog:21 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("lat_sssp_extract.slog:21", "all:edge", _fires);
  ...
  // (crule (pre) (scan nan_result __erre37fE66 __errf5EhC67 __errf6dCP68 __errf8sCg69) (body) (head (emit error (0) __erre37fE66)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre2W1N59 __errf8ho560 __errf9mLy61) (body) (head (emit error (0) __erre2W1N59)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp6kCo86 X Z __t7SG825) (body) (head (emit-lat dist X Z __t7SG825)) lat_sssp_extract.slog:22 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("dist");
      outer_rel = db->getRelation("temp6kCo86");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("lat_sssp_extract.slog:22", "delta:temp6kCo86", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre8Xye83 __errf1rTY84 __errf66OW85) (body) (head (emit error (0) __erre8Xye83)) <internal>:1 #f)
