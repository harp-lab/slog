...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("b5ea4c5a");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst0NJx21 const18d10c7d2b4b04aaf04254d1)) (once) (body) (head (mkstruct _enum (1 0) __33Br22 __tconst0NJx21)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst26fC23 const076de6e730df0b4c3860877a)) (once) (body) (head (mkstruct _enum (1 0) __28PQ24 __tconst26fC23)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst7GPC19 const7f3e916bf628c503cac5f6ba)) (once) (body) (head (mkstruct _enum (1 0) __49YC20 __tconst7GPC19)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst2npU25 const4bc9274d8758b867e8c071a6)) (once) (body) (head (mkstruct _enum (1 0) __50q226 __tconst2npU25)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c3 = v_const4bc9274d8758b867e8c071a6;
