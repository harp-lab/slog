...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("fa57825a");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<2>(db, db->getRelation("out"), std::array<u16,2>{1, 0}, b));
  ...
  // (crule (pre (let __tconst7ieb8 constc48b5b1a9776c84602de2306)) (probe _enum (1 0) 1 __tconst7ieb8 __t3ggr1) (body (join box (1 0) 1 __t3ggr1 __t4g332) (join out (1 0) 1 __t4g332 n)) (head (emit oks (0) n)) enum_struct_field2.slog:16 #f)
  class ReadTask2 : public slog::Task
  {
    ...
    slog::Index** boxindex0;  slog::Index** outindex1;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel8 = db->getRelation("box");
      boxindex0 = readrel8->getIndex(ord7, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m11) {
        ...
        slog::join_probe<2,1>(boxindex0, std::array<u64,2>{v_c1, 0}, [&](const std::array<u64,2>& m12) {
          u64 v_c2 = m12[1];
          slog::join_probe<2,1>(outindex1, std::array<u64,2>{v_c2, 0}, [&](const std::array<u64,2>& m13) {
            u64 v_c3 = m13[1];
            ++_fires;
      ...
      if (_fires) db->bumpFires("enum_struct_field2.slog:16", "all:_enum", _fires);
