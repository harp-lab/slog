...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("6ff94979");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let _00024sqc5p7A26 constd4735e3a265e16eee03f5971) (let _00024sqc4VcQ39 const6b86b273ff34fce19d6b804e)) (scan doc _00024seq0) (body (letp _00024sql8rVE24 (aslst _00024seq0)) (let _00024sqn0xpN25 (llen _00024sql8rVE24)) (cmp ge _00024sqn0xpN25 _00024sqc5p7A26)) (head (emit $seq_posdem (0 1) _00024seq0 _00024sqc4VcQ39)) seq_split_mixed.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel2 = db->getRelation("$seq_posdem");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c2 = _t[0];
        bool ok3 = true;
        u64 v_c3 = _prim_aslst(db, v_c2, &ok3);
        if (!ok3) return;
        u64 v_c4 = _prim_llen(db, v_c3);
        if (v_c4 == slog_error) { slog::emit_pending_error(db, "seq_split_mixed.slog:14"); return; }
        u64 v_c5 = _prim_ge(db, v_c4, v_c0);
        if (v_c5 == slog_error) { slog::emit_pending_error(db, "seq_split_mixed.slog:14"); return; }
        if (!v_c5) return;
        ++_fires;
      ...
      if (_fires) db->bumpFires("seq_split_mixed.slog:14", "all:doc", _fires);
  ...
  // (crule (pre) (scan toint_range __erre4yYZ184 __errf5OGH185 __errf0mbP186) (body) (head (emit error (0) __erre4yYZ184)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre9ZfS170 __errf5306171 __errf1p40172) (body) (head (emit error (0) __erre9ZfS170)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre93VS180 __errf36T3181 __errf2Hm1182 __errf1eeZ183) (body) (head (emit error (0) __erre93VS180)) <internal>:1 #f)
  ...
  // (crule (pre (let _00024sqc2QJz42 const6b86b273ff34fce19d6b804e) (let _00024sqc3WvX68 const6b86b273ff34fce19d6b804e)) (scan doc _00024seq0) (body (letp _00024sql1lqR40 (aslst _00024seq0)) (let _00024sqn0pOQ41 (llen _00024sql1lqR40)) (cmp ge _00024sqn0pOQ41 _00024sqc2QJz42)) (head (emit $seq_posdem (0 1) _00024seq0 _00024sqc3WvX68)) seq_split_mixed.slog:13 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel16 = db->getRelation("$seq_posdem");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c2 = _t[0];
        bool ok17 = true;
        u64 v_c18 = _prim_aslst(db, v_c2, &ok17);
        if (!ok17) return;
        u64 v_c19 = _prim_llen(db, v_c18);
        if (v_c19 == slog_error) { slog::emit_pending_error(db, "seq_split_mixed.slog:13"); return; }
        u64 v_c20 = _prim_ge(db, v_c19, v_c16);
        if (v_c20 == slog_error) { slog::emit_pending_error(db, "seq_split_mixed.slog:13"); return; }
        if (!v_c20) return;
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c2, v_c17}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("seq_split_mixed.slog:13", "all:doc", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre9fJT187 __errf51CC188 __errf28dV189 __errf4yct190 __errf4AMY191) (body) (head (emit error (0) __erre9fJT187)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre2HnN197 __errf1Ju2198 __errf82es199) (body) (head (emit error (0) __erre2HnN197)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre8LmZ192 __errf8Iu6193 __errf1Ywt194 __errf82aS195 __errf27b9196) (body) (head (emit error (0) __erre8LmZ192)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre2O5Z173 __errf8Lb0174 __errf3RPy175) (body) (head (emit error (0) __erre2O5Z173)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre2OvG176 __errf9M9s177 __errf23s4178 __errf7EUq179) (body) (head (emit error (0) __erre2OvG176)) <internal>:1 #f)
