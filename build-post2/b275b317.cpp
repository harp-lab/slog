...
u64 v_consta9a6d512c3f845483b03fd37;
u64 v_const580dc10e980f4c3a7a1f2359;
u64 v_const14e32b34cd055e89c9cc695a;
u64 v_constbb1534a1c906f3ee1939a91e;
u64 v_consteb8bf0d80db323992f6b634a;
u64 v_const5feceb66ffc86f38d952786c;
u64 v_const40480dc150931aa1b1d04926;
u64 v_const6b86b273ff34fce19d6b804e;
u64 v_const1c39633808c54038b6212e46;
u64 v_const521847e7e2e4552b87a9916b;
u64 v_const09c9e756387a87c9bbdc4c0e;
u64 v_const4e07408562bedb8b60ce05c1;
u64 v_constef39e22752c73795a9d935a5;
u64 v_const45aa4f80f636b15f8d75cce8;
u64 v_constfc5bdca6f3fa7cfdc4f78dd7;
u64 v_const4a44dc15364204a80fe80e90;
u64 v_constb5c7d53c1c5cb8517644318d;
u64 v_const1277a2cd065b41d0baf310a1;
u64 v_constb3bd32486de3ee02878db405;
u64 v_consta221beeaebe583607e193be7;
u64 v_conste433800a79f2d3be41014577;
u64 v_consta68730bc42ed463b202c634e;
u64 v_consted0583037dc2e002b6af2ca9;
u64 v_constab76c7d069d6f33dc950fb33;
u64 v_const75f539c022ff58cca2ea854c;
...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("b275b317");
  if (s == nullptr) return;
  slog::Relation* r;
  v_constd4735e3a265e16eee03f5971 = s32_encode(2);
  v_consta9a6d512c3f845483b03fd37 = db->encodeString("p1_start");
  v_const580dc10e980f4c3a7a1f2359 = db->encodeString("p2_end");
  v_const14e32b34cd055e89c9cc695a = db->encodeString("p3_end");
  v_constbb1534a1c906f3ee1939a91e = db->encodeString("const-ok");
  v_consteb8bf0d80db323992f6b634a = db->encodeString("unknown");
  v_const5feceb66ffc86f38d952786c = s32_encode(0);
  v_const40480dc150931aa1b1d04926 = db->encodeString("p1_check");
  v_const6b86b273ff34fce19d6b804e = s32_encode(1);
  v_const1c39633808c54038b6212e46 = db->encodeString("p2_start");
  v_const521847e7e2e4552b87a9916b = db->encodeString("p1_pos");
  v_const09c9e756387a87c9bbdc4c0e = db->encodeString("p1_y");
  v_const4e07408562bedb8b60ce05c1 = s32_encode(3);
  v_constef39e22752c73795a9d935a5 = db->encodeString("p1_x");
  v_const45aa4f80f636b15f8d75cce8 = db->encodeString("p1_end");
  v_constfc5bdca6f3fa7cfdc4f78dd7 = db->encodeString("p2_d");
  v_const4a44dc15364204a80fe80e90 = s32_encode(10);
  v_constb5c7d53c1c5cb8517644318d = db->encodeString("p3_b");
  v_const1277a2cd065b41d0baf310a1 = db->encodeString("abs-nonneg");
  v_constb3bd32486de3ee02878db405 = db->encodeString("const-bad");
  v_consta221beeaebe583607e193be7 = db->encodeString("unsat");
  v_conste433800a79f2d3be41014577 = db->encodeString("halt");
  v_consta68730bc42ed463b202c634e = db->encodeString("div-nonzero");
  v_consted0583037dc2e002b6af2ca9 = db->encodeString("p3_start");
  v_constab76c7d069d6f33dc950fb33 = db->encodeString("sat");
  v_const75f539c022ff58cca2ea854c = db->encodeString("p1_neg");
  ...
  r = db->getRelation("temp3XuN172");
  if (r == 0) db->addTempRelation("temp3XuN172", 3);
  else if (r->getArity() != 3) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp2RZM171");
  if (r == 0) db->addTempRelation("temp2RZM171", 2);
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<2>(db, db->getRelation("stmt"), std::array<u16,2>{1, 0}, b));
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternStructTask<3>(db, db->getRelation("lge"), std::array<u16,3>{2, 1, 0}, b));
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternStructTask<4>(db, db->getRelation("check"), std::array<u16,4>{1, 3, 2, 0}, b));
  r = db->getRelation("bv");
  ...
  r = db->getRelation("branch");
    ...
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<4>(db, r, std::array<u16,4>{0, 1, 2, 3}, false, b), false);
      std::vector<u16> ord98({2, 3, 0, 1});
    
    r->addIndex<4>(ord98, true);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<4>(db, r, std::array<u16,4>{2, 3, 0, 1}, true, b), false);
  

  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternStructTask<4>(db, db->getRelation("branch"), std::array<u16,4>{2, 3, 1, 0}, b));
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternStructTask<4>(db, db->getRelation("asgn"), std::array<u16,4>{1, 3, 2, 0}, b));
  ...
  slog_rules_c0691dac12232a1eb(db, s);
  slog_rules_c93cecb0f05bb5361(db, s);
  s->addReadRel("_enum");
  s->addReadRel("asgn");
  s->addReadRel("branch");
  s->addReadRel("check");
  ...
  s->addReadRel("lsub");
  s->addReadRel("stmt");
  s->addReadRel("temp2RZM171");
  s->addReadRel("temp3XuN172");
  s->addDynamicRel("asgn");
  s->addDynamicRel("branch");
  ...
  s->addDynamicRel("stmt");
  s->addDynamicRel("temp2RZM171");
  s->addDynamicRel("temp3XuN172");
  d->push(s);
  d->continueRun();
}
