...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("dae8c679");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst0tUy62 consta221beeaebe583607e193be7)) (once) (body) (head (mkstruct _enum (1 0) __80Ze63 __tconst0tUy62)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst3n7564 constab76c7d069d6f33dc950fb33)) (once) (body) (head (mkstruct _enum (1 0) __5Y1V65 __tconst3n7564)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst7UcN66 consteb8bf0d80db323992f6b634a)) (once) (body) (head (mkstruct _enum (1 0) __4FnU67 __tconst7UcN66)) <internal>:1 #f)
