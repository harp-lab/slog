...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("54ecd41b");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan toint_range __erre5hxr468 __errf8L2A469 __errf8ocY470) (body) (head (emit error (0) __erre5hxr468)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst6keR77 constfa94099f784d91500e1b95df) (let __trid2hqm279 constbf14e8e2740173c2e99e36a3) (let __trel3qDV280 const7b4b6d235bc6fbc8c9ba5801) (let __tcol0MlN281 constd4735e3a265e16eee03f5971)) (scan smt_vcode __t85eI76 V) (body (join smt_qmodel_ans (0 1) 0 __t2OwP79 M0) (join smt_qmodel (0 1) 1 __t2OwP79 F) (join smt_model (1 0) 1 F __t6Z4A74) (letp chk3uIv485 (cget M0 __tconst6keR77)) (eq __t85eI76 chk3uIv485) (let __t65SF78 (cdel M0 __tconst6keR77))) (head (tycheck __t65SF78 (accept cnode) __trid2hqm279 __trel3qDV280 __tcol0MlN281 (1 2 3 4 0)) (emit smt_model_ans (0 1 2) __t6Z4A74 V __t65SF78)) smt.slog:93 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c3 = v_constfa94099f784d91500e1b95df;
      u64 v_c4 = v_constbf14e8e2740173c2e99e36a3;
      u64 v_c5 = v_const7b4b6d235bc6fbc8c9ba5801;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        slog::join_all<2>(smt_qmodel_ansindex3, [&](const std::array<u64,2>& m15) {
          u64 v_c9 = m15[0]; u64 v_c10 = m15[1];
          slog::join_probe<2,1>(smt_qmodelindex4, std::array<u64,2>{v_c9, 0}, [&](const std::array<u64,2>& m16) {
            u64 v_c11 = m16[1];
            slog::join_probe<2,1>(smt_modelindex5, std::array<u64,2>{v_c11, 0}, [&](const std::array<u64,2>& m17) {
              u64 v_c12 = m17[1];
              bool ok18 = true;
              u64 v_c13 = _prim_cget(db, v_c10, v_c3, &ok18);
              if (!ok18) return;
              if (v_c7 != v_c13) return;
              u64 v_c14 = _prim_cdel(db, v_c10, v_c3);
              if (v_c14 == slog_error) { slog::emit_pending_error(db, "smt.slog:93"); return; }
              ++_fires;
              if (!(is_cnode(v_c14)))
              {
                slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c4, v_c5, v_c6, v_c14}, std::array<u16,5>{1, 2, 3, 4, 0});
                return;
              }
              slog::emit<3>(head_rel[1], head_index[1], newbatch[1], std::array<u64,3>{v_c12, v_c8, v_c14}, std::array<u16,3>{0, 1, 2});
            });
          });
        });
      });
  ...
  // (crule (pre) (scan modulo_by_zero __erre0tua457 __errf6Q1r458 __errf13YF459) (body) (head (emit error (0) __erre0tua457)) <internal>:1 #f)
  ...
  // (crule (pre) (scan smt_vcode C V) (body (join smt_qsat_ans (1 0) 1 C __t4pPZ25) (join smt_qsat (0 1) 1 __t4pPZ25 F) (join smt_check (1 0) 1 F __t2nJd24)) (head (emit smt_check_ans (0 1) __t2nJd24 V)) smt.slog:69 #f)
  class ReadTask25 : public slog::Task
  {
    ...
    slog::Index** smt_qsat_ansindex22;  slog::Index** smt_qsatindex23;  slog::Index** smt_checkindex24;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel29 = db->getRelation("smt_qsat_ans");
      smt_qsat_ansindex22 = readrel29->getIndex(ord28, false);
      std::vector<u16> ord30({0, 1});
      slog::Relation* readrel31 = db->getRelation("smt_qsat");
      smt_qsatindex23 = readrel31->getIndex(ord30, false);
      std::vector<u16> ord32({1, 0});
      slog::Relation* readrel33 = db->getRelation("smt_check");
      smt_checkindex24 = readrel33->getIndex(ord32, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c18 = _t[0];
        u64 v_c8 = _t[1];
        slog::join_probe<2,1>(smt_qsat_ansindex22, std::array<u64,2>{v_c18, 0}, [&](const std::array<u64,2>& m34) {
          u64 v_c19 = m34[1];
          slog::join_probe<2,1>(smt_qsatindex23, std::array<u64,2>{v_c19, 0}, [&](const std::array<u64,2>& m35) {
            u64 v_c11 = m35[1];
            slog::join_probe<2,1>(smt_checkindex24, std::array<u64,2>{v_c11, 0}, [&](const std::array<u64,2>& m36) {
              u64 v_c20 = m36[1];
              ++_fires;
              slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c20, v_c8}, std::array<u16,2>{0, 1});
            });
          });
        });
      });
  ...
  // (crule (pre (let __tconst2gBV58 constfa94099f784d91500e1b95df) (let __trid8guy276 constd2c28e4f541b3051f713f2a3) (let __trel41Wb277 const356829ca6c3df0a0d1117410) (let __tcol4qKQ278 constd4735e3a265e16eee03f5971)) (scan smt_vcode __t7DDg57 V) (body (join smt_qcore_ans (0 1) 0 __t8tSO60 M0) (join smt_qcore (0 1) 1 __t8tSO60 F) (join smt_core (1 0) 1 F __t7AtG55) (letp chk6gEi484 (cget M0 __tconst2gBV58)) (eq __t7DDg57 chk6gEi484) (let __t2Jnu59 (cdel M0 __tconst2gBV58))) (head (tycheck __t2Jnu59 (accept cnode) __trid8guy276 __trel41Wb277 __tcol4qKQ278 (1 2 3 4 0)) (emit smt_core_ans (0 1 2) __t7AtG55 V __t2Jnu59)) smt.slog:106 #f)
  class ReadTask40 : public slog::Task
  {
    ...
    slog::Index** smt_qcore_ansindex37;  slog::Index** smt_qcoreindex38;  slog::Index** smt_coreindex39;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel42 = db->getRelation("smt_core_ans");
      head_index[1] = readrel42->getIndex(ord41, false);
      outer_rel = db->getRelation("smt_vcode");
      std::vector<u16> ord43({0, 1});
      slog::Relation* readrel44 = db->getRelation("smt_qcore_ans");
      smt_qcore_ansindex37 = readrel44->getIndex(ord43, false);
      std::vector<u16> ord45({0, 1});
      slog::Relation* readrel46 = db->getRelation("smt_qcore");
      smt_qcoreindex38 = readrel46->getIndex(ord45, false);
      std::vector<u16> ord47({1, 0});
      slog::Relation* readrel48 = db->getRelation("smt_core");
      smt_coreindex39 = readrel48->getIndex(ord47, false);
  
    }
    ReadTask40(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c21 = v_constfa94099f784d91500e1b95df;
      u64 v_c22 = v_constd2c28e4f541b3051f713f2a3;
      u64 v_c23 = v_const356829ca6c3df0a0d1117410;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c25 = _t[0];
        u64 v_c8 = _t[1];
        slog::join_all<2>(smt_qcore_ansindex37, [&](const std::array<u64,2>& m49) {
          u64 v_c26 = m49[0]; u64 v_c10 = m49[1];
          slog::join_probe<2,1>(smt_qcoreindex38, std::array<u64,2>{v_c26, 0}, [&](const std::array<u64,2>& m50) {
            u64 v_c11 = m50[1];
            slog::join_probe<2,1>(smt_coreindex39, std::array<u64,2>{v_c11, 0}, [&](const std::array<u64,2>& m51) {
              u64 v_c27 = m51[1];
              bool ok52 = true;
              u64 v_c28 = _prim_cget(db, v_c10, v_c21, &ok52);
              if (!ok52) return;
              if (v_c25 != v_c28) return;
              u64 v_c29 = _prim_cdel(db, v_c10, v_c21);
              if (v_c29 == slog_error) { slog::emit_pending_error(db, "smt.slog:106"); return; }
              ++_fires;
              if (!(is_cnode(v_c29)))
              {
                slog::emit_struct<5>(head_rel[0], newbatch[0], std::array<u64,4>{v_c22, v_c23, v_c24, v_c29}, std::array<u16,5>{1, 2, 3, 4, 0});
                return;
              }
              slog::emit<3>(head_rel[1], head_index[1], newbatch[1], std::array<u64,3>{v_c27, v_c8, v_c29}, std::array<u16,3>{0, 1, 2});
            });
          });
        });
      });
  ...
  // (crule (pre) (scan div_by_zero __erre7BuN454 __errf8aP4455 __errf6b6D456) (body) (head (emit error (0) __erre7BuN454)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre7n3i460 __errf8BrZ461 __errf1USz462 __errf692P463) (body) (head (emit error (0) __erre7n3i460)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre63PH471 __errf5ay2472 __errf1bn0473 __errf742C474 __errf4Xv1475) (body) (head (emit error (0) __erre63PH471)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre0sHx464 __errf0f3o465 __errf9u2r466 __errf1Bkh467) (body) (head (emit error (0) __erre0sHx464)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre1Tr7476 __errf2vqR477 __errf8JdI478 __errf8S1h479 __errf6Sf3480) (body) (head (emit error (0) __erre1Tr7476)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre3T6f481 __errf71rg482 __errf8Jif483) (body) (head (emit error (0) __erre3T6f481)) <internal>:1 #f)
  ...
  // (crule (pre) (scan malformed_deduction __erre1KKH449 __errf1zSU450 __errf0X1g451 __errf16QB452 __errf0MRs453) (body) (head (emit error (0) __erre1KKH449)) <internal>:1 #f)
