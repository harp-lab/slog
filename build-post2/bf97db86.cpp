...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("bf97db86");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp9Z7E255");
  if (r == 0) db->addTempRelation("temp9Z7E255", 3);
  else if (r->getArity() != 3) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp6IBS256");
  if (r == 0) db->addTempRelation("temp6IBS256", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp5o83254");
  if (r == 0) db->addTempRelation("temp5o83254", 4);
  else if (r->getArity() != 4) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp1dRy257");
  if (r == 0) db->addTempRelation("temp1dRy257", 1);
  ...
  // (crule (pre (let __t4SNe22 (lempty))) (scan thirds as bs cs) (body) (head (emit-temp temp5o83254 __t4SNe22 as bs cs)) seq_split_kway.slog:16 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("temp5o83254");
      outer_rel = db->getRelation("thirds");
    ...
    virtual bool work()
    {
      ...
      if (v_c0 == slog_error) { slog::emit_pending_error(db, "seq_split_kway.slog:16"); return true; }
      ...
      if (_fires) db->bumpFires("seq_split_kway.slog:16", "all:thirds", _fires);
  ...
  // (crule (pre) (scan temp5o83254 __t4SNe22 as bs cs) (body (let __t0jYQ23 (lcat __t4SNe22 as))) (head (emit-temp temp9Z7E255 __t0jYQ23 bs cs)) seq_split_kway.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp9Z7E255");
      outer_rel = db->getRelation("temp5o83254");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c2 = _t[2];
        u64 v_c3 = _t[3];
        u64 v_c4 = _prim_lcat(db, v_c0, v_c1);
        if (v_c4 == slog_error) { slog::emit_pending_error(db, "seq_split_kway.slog:16"); return; }
        ++_fires;
        slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c4, v_c2, v_c3});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("seq_split_kway.slog:16", "delta:temp5o83254", _fires);
  ...
  // (crule (pre) (scan toint_range __erre6lo7238 __errf2ZSi239 __errf4l6w240) (body) (head (emit error (0) __erre6lo7238)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre1usk246 __errf9wOS247 __errf2H98248 __errf5Fuj249 __errf5egw250) (body) (head (emit error (0) __erre1usk246)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre7pLC227 __errf88OJ228 __errf4Iyc229) (body) (head (emit error (0) __erre7pLC227)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre06dz224 __errf6qLm225 __errf6vep226) (body) (head (emit error (0) __erre06dz224)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp9Z7E255 __t0jYQ23 bs cs) (body (let __t6YHa24 (lcat __t0jYQ23 bs))) (head (emit-temp temp6IBS256 __t6YHa24 cs)) seq_split_kway.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp6IBS256");
      outer_rel = db->getRelation("temp9Z7E255");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c2 = _t[1];
        u64 v_c3 = _t[2];
        u64 v_c19 = _prim_lcat(db, v_c4, v_c2);
        if (v_c19 == slog_error) { slog::emit_pending_error(db, "seq_split_kway.slog:16"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c19, v_c3});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("seq_split_kway.slog:16", "delta:temp9Z7E255", _fires);
  ...
  // (crule (pre) (scan nan_result __erre2v3s234 __errf2y57235 __errf0jrF236 __errf8AY8237) (body) (head (emit error (0) __erre2v3s234)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp6IBS256 __t6YHa24 cs) (body (let __t225C25 (lcat __t6YHa24 cs))) (head (emit-temp temp1dRy257 __t225C25)) seq_split_kway.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp1dRy257");
      outer_rel = db->getRelation("temp6IBS256");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c19 = _t[0];
        u64 v_c3 = _t[1];
        u64 v_c24 = _prim_lcat(db, v_c19, v_c3);
        if (v_c24 == slog_error) { slog::emit_pending_error(db, "seq_split_kway.slog:16"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("seq_split_kway.slog:16", "delta:temp6IBS256", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre2os3230 __errf92h6231 __errf1QF8232 __errf6sX4233) (body) (head (emit error (0) __erre2os3230)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp1dRy257 __t225C25) (body) (head (emit rebuilt (0) __t225C25)) seq_split_kway.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel24 = db->getRelation("rebuilt");
      head_index[0] = readrel24->getIndex(ord23, false);
      outer_rel = db->getRelation("temp1dRy257");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("seq_split_kway.slog:16", "delta:temp1dRy257", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre45iK251 __errf10dw252 __errf2Hmq253) (body) (head (emit error (0) __erre45iK251)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre2DZn241 __errf9JAL242 __errf7uro243 __errf6bdP244 __errf5kX6245) (body) (head (emit error (0) __erre2DZn241)) <internal>:1 #f)
  ...
  s->addReadRel("temp1dRy257");
  s->addReadRel("temp5o83254");
  s->addReadRel("temp6IBS256");
  s->addReadRel("temp9Z7E255");
  s->addReadRel("thirds");
  ...
  s->addDynamicRel("temp1dRy257");
  s->addDynamicRel("temp5o83254");
  s->addDynamicRel("temp6IBS256");
  s->addDynamicRel("temp9Z7E255");
