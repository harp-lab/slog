...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("ee9acb6a");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp9vkE332");
  if (r == 0) db->addTempRelation("temp9vkE332", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp90iQ327");
  if (r == 0) db->addTempRelation("temp90iQ327", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp7hCs333");
  if (r == 0) db->addTempRelation("temp7hCs333", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp6YZG330");
  if (r == 0) db->addTempRelation("temp6YZG330", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp38ND331");
  if (r == 0) db->addTempRelation("temp38ND331", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp2hdv329");
  if (r == 0) db->addTempRelation("temp2hdv329", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp0F5y328");
  if (r == 0) db->addTempRelation("temp0F5y328", 3);
  ...
  // (crule (pre) (scan nan_result __erre1zkK307 __errf9LYJ308 __errf9AYS309 __errf3HPB310) (body) (head (emit error (0) __erre1zkK307)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp90iQ327 __t0l0s7 __t4yJO6) (body) (head (emit lst_len_ans (0 1) __t0l0s7 __t4yJO6)) list.slog:24 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel5 = db->getRelation("lst_len_ans");
      head_index[0] = readrel5->getIndex(ord4, false);
      outer_rel = db->getRelation("temp90iQ327");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("list.slog:24", "delta:temp90iQ327", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre6ZYp324 __errf5Jon325 __errf3hbT326) (body) (head (emit error (0) __erre6ZYp324)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre0VUz314 __errf5k7m315 __errf1vyW316 __errf5RMZ317 __errf6aN3318) (body) (head (emit error (0) __erre0VUz314)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp0F5y328 __t09Ss8 __t3FDk10 acc) (body (let __t0kNa9 (lcat __t09Ss8 acc))) (head (emit-temp temp2hdv329 __t0kNa9 __t3FDk10)) list.slog:42 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp2hdv329");
      outer_rel = db->getRelation("temp0F5y328");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c15 = _t[1];
        u64 v_c16 = _t[2];
        u64 v_c17 = _prim_lcat(db, v_c14, v_c16);
        if (v_c17 == slog_error) { slog::emit_pending_error(db, "list.slog:42"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c17, v_c15});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("list.slog:42", "delta:temp0F5y328", _fires);
  ...
  // (crule (pre) (scan temp38ND331 __t13jl25 __t4ou824) (body) (head (emit lst_ref_ans (0 1) __t13jl25 __t4ou824)) list.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel15 = db->getRelation("lst_ref_ans");
      head_index[0] = readrel15->getIndex(ord14, false);
      outer_rel = db->getRelation("temp38ND331");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("list.slog:16", "delta:temp38ND331", _fires);
  ...
  // (crule (pre) (scan temp6YZG330 __t0Qfa30 __t2yHV31) (body) (head (emit lst_rev_ans (0 1) __t2yHV31 __t0Qfa30)) list.slog:37 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel18 = db->getRelation("lst_rev_ans");
      head_index[0] = readrel18->getIndex(ord17, false);
      outer_rel = db->getRelation("temp6YZG330");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("list.slog:37", "delta:temp6YZG330", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre7Qi3300 __errf0pOq301 __errf7hyH302) (body) (head (emit error (0) __erre7Qi3300)) <internal>:1 #f)
  ...
  // (crule (pre) (scan lst_rev_acc __t3FDk10 l acc) (body (let __t09Ss8 (lrev l))) (head (emit-temp temp0F5y328 __t09Ss8 __t3FDk10 acc)) list.slog:42 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp0F5y328");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c25 = _t[1];
        u64 v_c16 = _t[2];
        u64 v_c14 = _prim_lrev(db, v_c25);
        if (v_c14 == slog_error) { slog::emit_pending_error(db, "list.slog:42"); return; }
        ++_fires;
        slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c14, v_c15, v_c16});
      });
  ...
  // (crule (pre) (scan lst_append __t5m8Z23 a b) (body (let __t1JG922 (lcat a b))) (head (emit-temp temp9vkE332 __t1JG922 __t5m8Z23)) list.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp9vkE332");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c27 = _t[1];
        u64 v_c28 = _t[2];
        u64 v_c29 = _prim_lcat(db, v_c27, v_c28);
        if (v_c29 == slog_error) { slog::emit_pending_error(db, "list.slog:11"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c29, v_c26});
      });
  ...
  // (crule (pre) (scan div_by_zero __erre6pLl297 __errf81j2298 __errf9PQs299) (body) (head (emit error (0) __erre6pLl297)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre0ZSy319 __errf4bWc320 __errf0ysc321 __errf63e3322 __errf1u0i323) (body) (head (emit error (0) __erre0ZSy319)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp9vkE332 __t1JG922 __t5m8Z23) (body) (head (emit lst_append_ans (0 1) __t5m8Z23 __t1JG922)) list.slog:11 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel32 = db->getRelation("lst_append_ans");
      head_index[0] = readrel32->getIndex(ord31, false);
      outer_rel = db->getRelation("temp9vkE332");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("list.slog:11", "delta:temp9vkE332", _fires);
  ...
  // (crule (pre (let __tconst04q817 const6b86b273ff34fce19d6b804e)) (scan lst_absent __t2lbk15 l y) (body (let __t9L8716 (lmem l y)) (cmp lt __t9L8716 __tconst04q817)) (head (emit lst_absent_ans (0 1) __t2lbk15 __tconst04q817)) list.slog:33 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel35 = db->getRelation("lst_absent_ans");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c25 = _t[1];
        u64 v_c40 = _t[2];
        u64 v_c41 = _prim_lmem(db, v_c25, v_c40);
  ...
  // (crule (pre) (scan int_overflow __erre56a1303 __errf3YJR304 __errf1siu305 __errf63K9306) (body) (head (emit error (0) __erre56a1303)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst0d0h21 const5feceb66ffc86f38d952786c) (let __tconst6im918 const6b86b273ff34fce19d6b804e)) (scan lst_member __t0zNS19 l y) (body (let __t16XW20 (lmem l y)) (cmp lt __tconst0d0h21 __t16XW20)) (head (emit lst_member_ans (0 1) __t0zNS19 __tconst6im918)) list.slog:20 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel42 = db->getRelation("lst_member_ans");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c25 = _t[1];
        u64 v_c40 = _t[2];
        u64 v_c50 = _prim_lmem(db, v_c25, v_c40);
        if (v_c50 == slog_error) { slog::emit_pending_error(db, "list.slog:20"); return; }
        u64 v_c51 = _prim_lt(db, v_c47, v_c50);
        if (v_c51 == slog_error) { slog::emit_pending_error(db, "list.slog:20"); return; }
        if (!v_c51) return;
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c49, v_c48}, std::array<u16,2>{0, 1});
      });
  ...
  // (crule (pre) (scan lst_rev __t2yHV31 l) (body (let __t0Qfa30 (lrev l))) (head (emit-temp temp6YZG330 __t0Qfa30 __t2yHV31)) list.slog:37 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp6YZG330");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c21 = _t[0];
        u64 v_c25 = _t[1];
        u64 v_c20 = _prim_lrev(db, v_c25);
        if (v_c20 == slog_error) { slog::emit_pending_error(db, "list.slog:37"); return; }
        ++_fires;
  ...
  // (crule (pre) (scan temp2hdv329 __t0kNa9 __t3FDk10) (body) (head (emit lst_rev_acc_ans (0 1) __t3FDk10 __t0kNa9)) list.slog:42 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel47 = db->getRelation("lst_rev_acc_ans");
      head_index[0] = readrel47->getIndex(ord46, false);
      outer_rel = db->getRelation("temp2hdv329");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c15 = _t[1];
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c15, v_c17}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("list.slog:42", "delta:temp2hdv329", _fires);
  ...
  // (crule (pre) (scan toint_range __erre8EbR311 __errf89TC312 __errf3nrQ313) (body) (head (emit error (0) __erre8EbR311)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp7hCs333 __t1Vy04 __t1vcm3) (body) (head (emit lst_take_ans (0 1) __t1Vy04 __t1vcm3)) list.slog:29 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel53 = db->getRelation("lst_take_ans");
      head_index[0] = readrel53->getIndex(ord52, false);
      outer_rel = db->getRelation("temp7hCs333");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c56 = _t[1];
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c55, v_c56}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("list.slog:29", "delta:temp7hCs333", _fires);
  ...
  // (crule (pre) (scan lst_ref __t13jl25 l n) (body (letp __t4ou824 (lref l n))) (head (emit-temp temp38ND331 __t13jl25 __t4ou824)) list.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp38ND331");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c57 = _t[2];
        bool ok55 = true;
        u64 v_c19 = _prim_lref(db, v_c25, v_c57, &ok55);
        if (!ok55) return;
        ++_fires;
  ...
  // (crule (pre (let __tconst1hgb2 const5feceb66ffc86f38d952786c)) (scan lst_take __t1Vy04 l n) (body (let __t1vcm3 (lslice l __tconst1hgb2 n))) (head (emit-temp temp7hCs333 __t1Vy04 __t1vcm3)) list.slog:29 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp7hCs333");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c25 = _t[1];
        u64 v_c57 = _t[2];
        u64 v_c56 = _prim_lslice(db, v_c25, v_c58, v_c57);
        if (v_c56 == slog_error) { slog::emit_pending_error(db, "list.slog:29"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c55, v_c56});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("list.slog:29", "all:lst_take", _fires);
  ...
  // (crule (pre) (scan lst_len __t0l0s7 l) (body (let __t4yJO6 (llen l))) (head (emit-temp temp90iQ327 __t0l0s7 __t4yJO6)) list.slog:24 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp90iQ327");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c4 = _t[0];
        u64 v_c25 = _t[1];
        u64 v_c5 = _prim_llen(db, v_c25);
        if (v_c5 == slog_error) { slog::emit_pending_error(db, "list.slog:24"); return; }
        ++_fires;
  ...
  s->addReadRel("temp0F5y328");
  s->addReadRel("temp2hdv329");
  s->addReadRel("temp38ND331");
  s->addReadRel("temp6YZG330");
  s->addReadRel("temp7hCs333");
  s->addReadRel("temp90iQ327");
  s->addReadRel("temp9vkE332");
  ...
  s->addDynamicRel("temp0F5y328");
  s->addDynamicRel("temp2hdv329");
  s->addDynamicRel("temp38ND331");
  s->addDynamicRel("temp6YZG330");
  s->addDynamicRel("temp7hCs333");
  s->addDynamicRel("temp90iQ327");
  s->addDynamicRel("temp9vkE332");
