...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("fb1a53e5");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp9HKn168");
  if (r == 0) db->addTempRelation("temp9HKn168", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp6X4f166");
  if (r == 0) db->addTempRelation("temp6X4f166", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp0fXL169");
  if (r == 0) db->addTempRelation("temp0fXL169", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp0Rpr167");
  if (r == 0) db->addTempRelation("temp0Rpr167", 1);
  else if (r->getArity() != 1) slog::fatal("Temp rel arity mismatch.");
  ...
  // (crule (pre) (scan div_by_zero __erre53rv136 __errf2alG137 __errf3qwu138) (body) (head (emit error (0) __erre53rv136)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst1mys3 const6b86b273ff34fce19d6b804e) (let __tconst1awl2 constd4735e3a265e16eee03f5971) (let __tconst2kP81 const4e07408562bedb8b60ce05c1)) (scan temp6X4f166 __t4BWw4) (body (let __t8RZZ5 (lpush __t4BWw4 __tconst1mys3))) (head (emit-temp temp0Rpr167 __t8RZZ5)) dem_lambda.slog:13 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp0Rpr167");
      outer_rel = db->getRelation("temp6X4f166");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c6 = _t[0];
        u64 v_c7 = _prim_lpush(db, v_c6, v_c3);
        if (v_c7 == slog_error) { slog::emit_pending_error(db, "dem_lambda.slog:13"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("dem_lambda.slog:13", "delta:temp6X4f166", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre93p3153 __errf7Xss154 __errf1YvI155 __errf0Y80156 __errf0Kou157) (body) (head (emit error (0) __erre93p3153)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst8Bcu102 conste593eb62d5b2b78aac29610d)) (once) (body) (head (mkstruct _enum (1 0) __51z1103 __tconst8Bcu102)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c13 = v_conste593eb62d5b2b78aac29610d;
  ...
  // (crule (pre (let __tconst9c9p104 const99071cf3586be89134ffc1b3)) (once) (body) (head (mkstruct _enum (1 0) __3hEI105 __tconst9c9p104)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c14 = v_const99071cf3586be89134ffc1b3;
  ...
  // (crule (pre) (scan nan_result __erre7Mv5146 __errf3aAP147 __errf3K97148 __errf7TpR149) (body) (head (emit error (0) __erre7Mv5146)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp0fXL169 __t1AqR7) (body) (head (emit input (0) __t1AqR7)) dem_lambda.slog:13 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel14 = db->getRelation("input");
      head_index[0] = readrel14->getIndex(ord13, false);
      outer_rel = db->getRelation("temp0fXL169");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("dem_lambda.slog:13", "delta:temp0fXL169", _fires);
  ...
  // (crule (pre (let __tconst2kP81 const4e07408562bedb8b60ce05c1)) (scan temp9HKn168 __t9xSE6) (body (let __t1AqR7 (lpush __t9xSE6 __tconst2kP81))) (head (emit-temp temp0fXL169 __t1AqR7)) dem_lambda.slog:13 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp0fXL169");
      outer_rel = db->getRelation("temp9HKn168");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c20 = _t[0];
        u64 v_c19 = _prim_lpush(db, v_c20, v_c5);
        if (v_c19 == slog_error) { slog::emit_pending_error(db, "dem_lambda.slog:13"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("dem_lambda.slog:13", "delta:temp9HKn168", _fires);
  ...
  // (crule (pre (let __tconst1awl2 constd4735e3a265e16eee03f5971) (let __tconst2kP81 const4e07408562bedb8b60ce05c1)) (scan temp0Rpr167 __t8RZZ5) (body (let __t9xSE6 (lpush __t8RZZ5 __tconst1awl2))) (head (emit-temp temp9HKn168 __t9xSE6)) dem_lambda.slog:13 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp9HKn168");
      outer_rel = db->getRelation("temp0Rpr167");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c7 = _t[0];
        u64 v_c20 = _prim_lpush(db, v_c7, v_c4);
        if (v_c20 == slog_error) { slog::emit_pending_error(db, "dem_lambda.slog:13"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("dem_lambda.slog:13", "delta:temp0Rpr167", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre7pJN142 __errf9RQ4143 __errf4Rw1144 __errf9Orh145) (body) (head (emit error (0) __erre7pJN142)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst1mys3 const6b86b273ff34fce19d6b804e) (let __tconst1awl2 constd4735e3a265e16eee03f5971) (let __tconst2kP81 const4e07408562bedb8b60ce05c1) (let __t4BWw4 (lempty))) (once) (body) (head (emit-temp temp6X4f166 __t4BWw4)) dem_lambda.slog:13 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp6X4f166");
    ...
    virtual bool work()
    {
      ...
      if (v_c6 == slog_error) { slog::emit_pending_error(db, "dem_lambda.slog:13"); return true; }
      ...
      if (_fires) db->bumpFires("dem_lambda.slog:13", "once", _fires);
  ...
  // (crule (pre) (scan toint_range __erre2RLm150 __errf1LKY151 __errf0oi3152) (body) (head (emit error (0) __erre2RLm150)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre0PB0139 __errf8Twi140 __errf4WjT141) (body) (head (emit error (0) __erre0PB0139)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre6Gfe163 __errf7ykp164 __errf9TJm165) (body) (head (emit error (0) __erre6Gfe163)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst5P0q33 const4a44dc15364204a80fe80e90)) (once) (body) (head (emit kv (0) __tconst5P0q33)) dem_lambda.slog:17 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("kv");
      std::vector<u16> ord31({0});
      slog::Relation* readrel32 = db->getRelation("kv");
    ...
    virtual bool work()
    {
      u64 v_c34 = v_const4a44dc15364204a80fe80e90;
      ...
      if (_fires) db->bumpFires("dem_lambda.slog:17", "once", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre4kst158 __errf7OS6159 __errf0nlZ160 __errf4qQ3161 __errf96pz162) (body) (head (emit error (0) __erre4kst158)) <internal>:1 #f)
  ...
  s->addReadRel("temp0Rpr167");
  s->addReadRel("temp0fXL169");
  s->addReadRel("temp6X4f166");
  s->addReadRel("temp9HKn168");
  ...
  s->addDynamicRel("temp0Rpr167");
  s->addDynamicRel("temp0fXL169");
  s->addDynamicRel("temp6X4f166");
  s->addDynamicRel("temp9HKn168");
