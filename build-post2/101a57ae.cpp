...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("101a57ae");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan nan_result __erre1ih5259 __errf0P79260 __errf9iwU261 __errf115z262) (body) (head (emit error (0) __erre1ih5259)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre2Rvp263 __errf0cYb264 __errf8VYD265) (body) (head (emit error (0) __erre2Rvp263)) <internal>:1 #f)
  ...
  // (crule (pre) (scan addk __t9N1p20 k) (body (join apply (1 2 0) 1 __t9N1p20 n __t2SZ721) (let __t6Qj222 (_0002b n k))) (head (emit apply_ans (0 1) __t2SZ721 __t6Qj222)) dem_brackets.slog:8 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel9 = db->getRelation("apply_ans");
      head_index[0] = readrel9->getIndex(ord8, false);
      outer_rel = db->getRelation("addk");
      std::vector<u16> ord10({1, 2, 0});
      slog::Relation* readrel11 = db->getRelation("apply");
      applyindex6 = readrel11->getIndex(ord10, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c7 = _t[0];
        u64 v_c8 = _t[1];
        slog::join_probe<3,1>(applyindex6, std::array<u64,3>{v_c7, 0, 0}, [&](const std::array<u64,3>& m12) {
          u64 v_c9 = m12[1]; u64 v_c10 = m12[2];
          u64 v_c11 = _prim__0002b(db, v_c9, v_c8);
          if (v_c11 == slog_error) { slog::emit_pending_error(db, "dem_brackets.slog:8"); return; }
          ++_fires;
      ...
      if (_fires) db->bumpFires("dem_brackets.slog:8", "all:addk", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre5tNx249 __errf1Gxj250 __errf7aB6251) (body) (head (emit error (0) __erre5tNx249)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre2L5o255 __errf8uNG256 __errf3r7G257 __errf90cn258) (body) (head (emit error (0) __erre2L5o255)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre4crv271 __errf8zO7272 __errf4DHX273 __errf467t274 __errf3ksw275) (body) (head (emit error (0) __erre4crv271)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre0OUn252 __errf6CTy253 __errf84WJ254) (body) (head (emit error (0) __erre0OUn252)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre1Tjs276 __errf7fIC277 __errf3ML8278) (body) (head (emit error (0) __erre1Tjs276)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst6apv57 const933b575c961e931c43e84b05)) (probe _enum (1 0) 1 __tconst6apv57 __t0BMk14) (body (join apply (1 2 0) 1 __t0BMk14 n __t6NkD15) (let __t862R16 (_0002b n n))) (head (emit apply_ans (0 1) __t6NkD15 __t862R16)) dem_brackets.slog:9 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel31 = db->getRelation("apply_ans");
      head_index[0] = readrel31->getIndex(ord30, false);
      std::vector<u16> ord32({1, 0});
      slog::Relation* readrel33 = db->getRelation("_enum");
      driver_index = readrel33->getIndex(ord32, true);
      std::vector<u16> ord34({1, 2, 0});
      slog::Relation* readrel35 = db->getRelation("apply");
      applyindex28 = readrel35->getIndex(ord34, false);
  
    }
    ReadTask29(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c30 = v_const933b575c961e931c43e84b05;
      ...
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c30, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m36) {
        u64 v_c31 = m36[1];
        if (buckethash(v_c31) != bucket) return;
        slog::join_probe<3,1>(applyindex28, std::array<u64,3>{v_c31, 0, 0}, [&](const std::array<u64,3>& m37) {
          u64 v_c9 = m37[1]; u64 v_c32 = m37[2];
          u64 v_c33 = _prim__0002b(db, v_c9, v_c9);
          if (v_c33 == slog_error) { slog::emit_pending_error(db, "dem_brackets.slog:9"); return; }
          ++_fires;
          slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c32, v_c33}, std::array<u16,2>{0, 1});
        });
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("dem_brackets.slog:9", "all:_enum", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre7yAF266 __errf9Kk0267 __errf4kmp268 __errf4HGs269 __errf14pC270) (body) (head (emit error (0) __erre7yAF266)) <internal>:1 #f)
