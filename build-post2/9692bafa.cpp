...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("9692bafa");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst4zmV9 constef2d127de37b942baad06145)) (scan a X Y) (body (let __t3mSH10 (_0002b Y __tconst4zmV9))) (head (emit c (0 1) X __t3mSH10)) strat_diamond.slog:15 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        u64 v_c2 = _t[1];
        u64 v_c3 = _prim__0002b(db, v_c2, v_c0);
        if (v_c3 == slog_error) { slog::emit_pending_error(db, "strat_diamond.slog:15"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_diamond.slog:15", "all:a", _fires);
  ...
  // (crule (pre) (scan toint_range __erre64gr55 __errf2oAh56 __errf5yaW57) (body) (head (emit error (0) __erre64gr55)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre4twr58 __errf2b3T59 __errf6l1n60 __errf27tw61 __errf3gTm62) (body) (head (emit error (0) __erre4twr58)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre24me63 __errf6wJo64 __errf7eR765 __errf6l9V66 __errf4mgU67) (body) (head (emit error (0) __erre24me63)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre3uA451 __errf0Hx652 __errf9M8r53 __errf4cLL54) (body) (head (emit error (0) __erre3uA451)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre0XfY68 __errf0piR69 __errf19zq70) (body) (head (emit error (0) __erre0XfY68)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre5Sr247 __errf3zrU48 __errf8x0f49 __errf8hLX50) (body) (head (emit error (0) __erre5Sr247)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre8b9L41 __errf7D4v42 __errf3Gpz43) (body) (head (emit error (0) __erre8b9L41)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst0wYI1 constd4735e3a265e16eee03f5971)) (scan a X Y) (body (let __t36aG2 (_0002a Y __tconst0wYI1))) (head (emit b (0 1) X __t36aG2)) strat_diamond.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel26 = db->getRelation("b");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        u64 v_c2 = _t[1];
        u64 v_c32 = _prim__0002a(db, v_c2, v_c31);
        if (v_c32 == slog_error) { slog::emit_pending_error(db, "strat_diamond.slog:14"); return; }
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c1, v_c32}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("strat_diamond.slog:14", "all:a", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre9ob544 __errf07Kn45 __errf2Ri146) (body) (head (emit error (0) __erre9ob544)) <internal>:1 #f)
