...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("83a38dee");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan modulo_by_zero __erre974W120 __errf3aG7121 __errf1jCG122) (body) (head (emit error (0) __erre974W120)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre3MeL131 __errf008h132 __errf4VAH133) (body) (head (emit error (0) __erre3MeL131)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst9ZSg24 conste7f6c011776e8db7cd330b54)) (scan dist X Y D) (body (cmp lt D __tconst9ZSg24)) (head (emit cheap (0 1) X Y)) lat_sssp_extract.slog:27 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("cheap");
      std::vector<u16> ord7({0, 1});
      slog::Relation* readrel8 = db->getRelation("cheap");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c8 = _t[1];
        u64 v_c9 = _t[2];
        u64 v_c10 = _prim_lt(db, v_c9, v_c6);
        if (v_c10 == slog_error) { slog::emit_pending_error(db, "lat_sssp_extract.slog:27"); return; }
        if (!v_c10) return;
        ++_fires;
      ...
      if (_fires) db->bumpFires("lat_sssp_extract.slog:27", "all:dist", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre5vfl139 __errf7CsN140 __errf4mKZ141 __errf3NPm142 __errf9XaU143) (body) (head (emit error (0) __erre5vfl139)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst02bz23 const4b227777d4dd1fc61c6f884f)) (probe dist (1 0 2) 1 __tconst02bz23 X D) (body) (head (emit to4 (0 1) X D)) lat_sssp_extract.slog:26 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("to4");
      std::vector<u16> ord14({0, 1});
      slog::Relation* readrel15 = db->getRelation("to4");
      head_index[0] = readrel15->getIndex(ord14, false);
      std::vector<u16> ord16({1, 0, 2});
      slog::Relation* readrel17 = db->getRelation("dist");
    ...
    virtual bool work()
    {
      u64 v_c16 = v_const4b227777d4dd1fc61c6f884f;
      ...
      bool _done = slog::join_probe_sliced<3,1>(driver_index, std::array<u64,3>{v_c16, 0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,3>& m18) {
        u64 v_c7 = m18[1];
        u64 v_c9 = m18[2];
      ...
      if (_fires) db->bumpFires("lat_sssp_extract.slog:26", "all:dist", _fires);
  ...
  // (crule (pre) (scan hub H) (body (join-lat dist (0 1 2) 1 H Y D)) (head (emit hubdist (0 1) Y D)) lat_sssp_extract.slog:25 #f)
  class ReadTask20 : public slog::Task
  {
    ...
    slog::Index** distindex19;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("hubdist");
      std::vector<u16> ord21({0, 1});
      slog::Relation* readrel22 = db->getRelation("hubdist");
      head_index[0] = readrel22->getIndex(ord21, false);
      outer_rel = db->getRelation("hub");
      std::vector<u16> ord23({0, 1, 2});
      slog::Relation* readrel24 = db->getRelation("dist");
      distindex19 = readrel24->getIndex(ord23, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c17 = _t[0];
        slog::join_probe_lat<2,1>(distindex19, std::array<u64,2>{v_c17, 0}, [&](const std::array<u64,2>& m25, u64 val26) {
          u64 v_c8 = m25[1]; u64 v_c9 = val26;
          ++_fires;
      ...
      if (_fires) db->bumpFires("lat_sssp_extract.slog:25", "all:hub", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre7HsB144 __errf8YcC145 __errf3Dnj146) (body) (head (emit error (0) __erre7HsB144)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre45z7117 __errf1GjA118 __errf2x1y119) (body) (head (emit error (0) __erre45z7117)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre14VK123 __errf5Z5Z124 __errf2BBs125 __errf3VF6126) (body) (head (emit error (0) __erre14VK123)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre9PkJ134 __errf9d8B135 __errf1egZ136 __errf3IDs137 __errf19Yg138) (body) (head (emit error (0) __erre9PkJ134)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre2zXP127 __errf1DxC128 __errf9pzV129 __errf4y8I130) (body) (head (emit error (0) __erre2zXP127)) <internal>:1 #f)
  ...
  s->addDynamicRel("cheap");
  s->addDynamicRel("div_by_zero");
  s->addDynamicRel("error");
  s->addDynamicRel("hubdist");
