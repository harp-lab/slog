...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("6c22eb55");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan div_by_zero __erre9PoF98 __errf5WS399 __errf8ZNY100) (body) (head (emit error (0) __erre9PoF98)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre3fof120 __errf42Ui121 __errf9Qm4122 __errf1JIk123 __errf18UO124) (body) (head (emit error (0) __erre3fof120)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre9w3i125 __errf8D7P126 __errf3Cyp127) (body) (head (emit error (0) __erre9w3i125)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre0ZpA101 __errf2zx4102 __errf4gBW103) (body) (head (emit error (0) __erre0ZpA101)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre7DL1104 __errf35Kx105 __errf9uD4106 __errf5Ml1107) (body) (head (emit error (0) __erre7DL1104)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre5XVT108 __errf23Kv109 __errf5NYd110 __errf8HVd111) (body) (head (emit error (0) __erre5XVT108)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre6WE6115 __errf5k4g116 __errf8n5J117 __errf30wm118 __errf3Zac119) (body) (head (emit error (0) __erre6WE6115)) <internal>:1 #f)
  ...
  // (crule (pre) (scan dbl X Z) (body (let __t1Hkv1 (_0002b X Z))) (head (emit final (0) __t1Hkv1)) strat_inc_main.slog:13 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("final");
      std::vector<u16> ord22({0});
      slog::Relation* readrel23 = db->getRelation("final");
      head_index[0] = readrel23->getIndex(ord22, false);
      outer_rel = db->getRelation("dbl");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c27 = _t[0];
        u64 v_c28 = _t[1];
        u64 v_c29 = _prim__0002b(db, v_c27, v_c28);
        if (v_c29 == slog_error) { slog::emit_pending_error(db, "strat_inc_main.slog:13"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_inc_main.slog:13", "all:dbl", _fires);
  ...
  // (crule (pre) (scan toint_range __erre1Jv3112 __errf3Kj6113 __errf3jt6114) (body) (head (emit error (0) __erre1Jv3112)) <internal>:1 #f)
