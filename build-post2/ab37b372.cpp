...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("ab37b372");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("base");
  if (r == 0) db->addRelation("base", 2);
  else if (r->getArity() != 2)
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("base");
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<2>(db, db->getRelation("base"), std::array<u16,2>{0, 1}, b));
  ...
  // (crule (pre (let __tconst2MIb2 constd4735e3a265e16eee03f5971)) (scan base X Y) (body (let __t50Yu3 (_0002a Y __tconst2MIb2))) (head (emit dbl (0 1) X __t50Yu3)) strat_inc_lib.slog:7 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("dbl");
      std::vector<u16> ord1({0, 1});
      slog::Relation* readrel2 = db->getRelation("dbl");
      head_index[0] = readrel2->getIndex(ord1, false);
      outer_rel = db->getRelation("base");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c1 = _t[0];
        u64 v_c2 = _t[1];
        u64 v_c3 = _prim__0002a(db, v_c2, v_c0);
        if (v_c3 == slog_error) { slog::emit_pending_error(db, "strat_inc_lib.slog:7"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_inc_lib.slog:7", "all:base", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre58Je38 __errf64j239 __errf51Gz40) (body) (head (emit error (0) __erre58Je38)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre2stE65 __errf51cx66 __errf2RkU67) (body) (head (emit error (0) __erre2stE65)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre4a8Q52 __errf4gmC53 __errf2luZ54) (body) (head (emit error (0) __erre4a8Q52)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre9qZw55 __errf8OuQ56 __errf8AVf57 __errf5STF58 __errf07yd59) (body) (head (emit error (0) __erre9qZw55)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre9NKa60 __errf3URo61 __errf9WYo62 __errf21ix63 __errf7AuW64) (body) (head (emit error (0) __erre9NKa60)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre19Wq48 __errf5VZX49 __errf37DT50 __errf1r1v51) (body) (head (emit error (0) __erre19Wq48)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre65nN41 __errf3tS342 __errf7VlA43) (body) (head (emit error (0) __erre65nN41)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre7Pes44 __errf07K745 __errf3bfH46 __errf4D9e47) (body) (head (emit error (0) __erre7Pes44)) <internal>:1 #f)
