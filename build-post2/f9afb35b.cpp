...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("f9afb35b");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst661q66 consta221beeaebe583607e193be7)) (once) (body) (head (mkstruct _enum (1 0) __8vHQ67 __tconst661q66)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst3fBj64 const683276d23a1fc1d255583994)) (once) (body) (head (mkstruct _enum (1 0) __4O3P65 __tconst3fBj64)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c1 = v_const683276d23a1fc1d255583994;
  ...
  // (crule (pre (let __tconst8SAV68 constab76c7d069d6f33dc950fb33)) (once) (body) (head (mkstruct _enum (1 0) __0Z6g69 __tconst8SAV68)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c2 = v_constab76c7d069d6f33dc950fb33;
  ...
  // (crule (pre (let __tconst03Rm70 consteb8bf0d80db323992f6b634a)) (once) (body) (head (mkstruct _enum (1 0) __2z2N71 __tconst03Rm70)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c3 = v_consteb8bf0d80db323992f6b634a;
