...
u64 v_const37171d544cfb48318189f58f;
u64 v_constc44926e20290c13324a8ecdf;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("92db109a");
  if (s == nullptr) return;
  slog::Relation* r;
  v_const37171d544cfb48318189f58f = db->encodeString("north");
  v_constc44926e20290c13324a8ecdf = db->encodeString("south");
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternStructTask<3>(db, db->getRelation("step"), std::array<u16,3>{1, 2, 0}, b));
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<2>(db, db->getRelation("go"), std::array<u16,2>{0, 1}, b));
  ...
  // (crule (pre (let __tconst17d731 constc44926e20290c13324a8ecdf)) (once) (body) (head (mkstruct _enum (1 0) __5leR32 __tconst17d731)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c0 = v_constc44926e20290c13324a8ecdf;
  ...
  // (crule (pre (let __tconst18Ln29 const37171d544cfb48318189f58f)) (once) (body) (head (mkstruct _enum (1 0) __73pd30 __tconst18Ln29)) <internal>:1 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c1 = v_const37171d544cfb48318189f58f;
