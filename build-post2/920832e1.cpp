...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("920832e1");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst3xMP15 const3aae004f448787fcf06c2d53)) (probe _enum (1 0) 1 __tconst3xMP15 __t5llU1) (body (join isred (0) 0 n)) (head (emit verdict (0 1) n __t5llU1)) enum_basic.slog:20 #f)
  class ReadTask1 : public slog::Task
  {
    ...
    slog::Index** isredindex0;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("verdict");
      std::vector<u16> ord2({0, 1});
      slog::Relation* readrel3 = db->getRelation("verdict");
      ...
      slog::Relation* readrel7 = db->getRelation("isred");
      isredindex0 = readrel7->getIndex(ord6, false);
  
    }
    ReadTask1(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c0 = v_const3aae004f448787fcf06c2d53;
      ...
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m8) {
        ...
        slog::join_all<1>(isredindex0, [&](const std::array<u64,1>& m9) {
          u64 v_c2 = m9[0];
          ++_fires;
      ...
      if (_fires) db->bumpFires("enum_basic.slog:20", "all:_enum", _fires);
