...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("5742d80e");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan rm __t13E52) (body (join Lf (0 1) 1 __t13E52 b) (join lm (0) 0 __t26An1) (join Lf (0 1) 1 __t26An1 a)) (head (emit corners (0 1) a b)) frozen_fact.slog:19 #f)
  class ReadTask3 : public slog::Task
  {
    ...
    slog::Index** Lfindex0;  slog::Index** lmindex1;  slog::Index** Lfindex2;
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel5 = db->getRelation("corners");
      head_index[0] = readrel5->getIndex(ord4, false);
      outer_rel = db->getRelation("rm");
      std::vector<u16> ord6({0, 1});
      slog::Relation* readrel7 = db->getRelation("Lf");
      Lfindex0 = readrel7->getIndex(ord6, false);
      std::vector<u16> ord8({0});
      slog::Relation* readrel9 = db->getRelation("lm");
      lmindex1 = readrel9->getIndex(ord8, false);
      std::vector<u16> ord10({0, 1});
      slog::Relation* readrel11 = db->getRelation("Lf");
      Lfindex2 = readrel11->getIndex(ord10, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        slog::join_probe<2,1>(Lfindex0, std::array<u64,2>{v_c0, 0}, [&](const std::array<u64,2>& m12) {
          u64 v_c1 = m12[1];
          slog::join_all<1>(lmindex1, [&](const std::array<u64,1>& m13) {
            u64 v_c2 = m13[0];
            slog::join_probe<2,1>(Lfindex2, std::array<u64,2>{v_c2, 0}, [&](const std::array<u64,2>& m14) {
              u64 v_c3 = m14[1];
              ++_fires;
      ...
      if (_fires) db->bumpFires("frozen_fact.slog:19", "all:rm", _fires);
