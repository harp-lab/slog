...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("1474d181");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst62Qe43 conste433800a79f2d3be41014577)) (probe _enum (1 0) 1 __tconst62Qe43 __t0G0O27) (body (join ret (1 0) 1 __t0G0O27 v)) (head (emit result (0) v)) 0cfa.slog:64 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel3 = db->getRelation("result");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m8) {
        ...
        slog::join_probe<2,1>(retindex0, std::array<u64,2>{v_c1, 0}, [&](const std::array<u64,2>& m9) {
          u64 v_c2 = m9[1];
          ++_fires;
      ...
      if (_fires) db->bumpFires("0cfa.slog:64", "all:_enum", _fires);
