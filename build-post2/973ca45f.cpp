...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("973ca45f");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst4DrK2 constd4735e3a265e16eee03f5971) (let __tconst2FQP1 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit seed (0) __tconst4DrK2) (emit seed (0) __tconst2FQP1)) strat_run_base.slog:8 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("strat_run_base.slog:8", "once", _fires);
