...
u64 v_const39e5b4830d4d9c14db7368a9;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("c516a272");
  if (s == nullptr) return;
  slog::Relation* r;
  v_const39e5b4830d4d9c14db7368a9 = s32_encode(10000);
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<1>(db, db->getRelation("e"), std::array<u16,1>{0}, b));
  ...
  // (crule (pre) (scan div_by_zero __erre8Y3T221 __errf6K1q222 __errf2jBS223) (body) (head (emit error (0) __erre8Y3T221)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre6ji2248 __errf1bbc249 __errf99RD250) (body) (head (emit error (0) __erre6ji2248)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre2IfZ235 __errf8uI4236 __errf3atk237) (body) (head (emit error (0) __erre2IfZ235)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre4feW238 __errf5cKs239 __errf3nwQ240 __errf7dvO241 __errf0Vxs242) (body) (head (emit error (0) __erre4feW238)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre24bY227 __errf3UbK228 __errf64zJ229 __errf0Fra230) (body) (head (emit error (0) __erre24bY227)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre9qHG243 __errf1OnF244 __errf1DVL245 __errf9Mzh246 __errf5G2O247) (body) (head (emit error (0) __erre9qHG243)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre9NzF231 __errf6jo7232 __errf9NZX233 __errf2yhx234) (body) (head (emit error (0) __erre9NzF231)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst8DLH3 const39e5b4830d4d9c14db7368a9)) (scan d X) (body (let __t8R5c4 (_0002b X __tconst8DLH3))) (head (emit e (0) __t8R5c4)) strat_chain.slog:18 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel23 = db->getRelation("e");
      head_index[0] = readrel23->getIndex(ord22, false);
      outer_rel = db->getRelation("d");
  
    }
    ReadTask21(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c27 = v_const39e5b4830d4d9c14db7368a9;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c28 = _t[0];
        u64 v_c29 = _prim__0002b(db, v_c28, v_c27);
        if (v_c29 == slog_error) { slog::emit_pending_error(db, "strat_chain.slog:18"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_chain.slog:18", "all:d", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre3Yf2224 __errf2U1x225 __errf1bLL226) (body) (head (emit error (0) __erre3Yf2224)) <internal>:1 #f)
