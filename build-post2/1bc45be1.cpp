...
u64 v_constf4bef7d1c2e17f892c9697c4;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("1bc45be1");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  v_constf4bef7d1c2e17f892c9697c4 = db->encodeString("tom");
  ...
  r = db->getRelation("redfans");
  if (r == 0) db->addRelation("redfans", 1);
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<1>(db, db->getRelation("redfans"), std::array<u16,1>{0}, b));
  ...
  r = db->getRelation("fav");
  if (r == 0) db->addRelation("fav", 2);
  ...
  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<2>(db, db->getRelation("fav"), std::array<u16,2>{0, 1}, b));
  ...
  // (crule (pre (let __tconst4ODH6 const7f3e916bf628c503cac5f6ba) (let __tconst9XU67 const4bc9274d8758b867e8c071a6) (let __tconst9T4w4 const57e459adabad9fb762bf6769) (let __tconst9RYw2 constf4bef7d1c2e17f892c9697c4)) (probe _enum (1 0) 1 __tconst4ODH6 __t93DI3) (body (join _enum (1 0) 1 __tconst9XU67 __t2QlT1)) (head (emit fav (0 1) __tconst9T4w4 __t93DI3) (emit fav (0 1) __tconst9RYw2 __t2QlT1)) enum_typed_col.slog:10 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("fav");
      std::vector<u16> ord2({0, 1});
      slog::Relation* readrel3 = db->getRelation("fav");
      head_index[0] = readrel3->getIndex(ord2, false);
      head_rel[1] = db->getRelation("fav");
      std::vector<u16> ord4({0, 1});
      slog::Relation* readrel5 = db->getRelation("fav");
    ...
    virtual bool work()
    {
      ...
      u64 v_c2 = v_const57e459adabad9fb762bf6769;
      u64 v_c3 = v_constf4bef7d1c2e17f892c9697c4;
      ...
      if (_fires) db->bumpFires("enum_typed_col.slog:10", "all:_enum", _fires);
