...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("29aae260");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst7RYx2 const6b86b273ff34fce19d6b804e) (let __tconst398e4 constd4735e3a265e16eee03f5971) (let __tconst2fYA6 const4e07408562bedb8b60ce05c1) (let __tconst2kIm7 constef2d127de37b942baad06145) (let __tconst7J5a8 const4b227777d4dd1fc61c6f884f)) (once) (body) (head (emit edge (0 1) __tconst7RYx2 __tconst398e4) (emit edge (0 1) __tconst398e4 __tconst2fYA6) (emit edge (0 1) __tconst2fYA6 __tconst7J5a8) (emit edge (0 1) __tconst7J5a8 __tconst2kIm7)) stat_selfjoin.slog:23 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("stat_selfjoin.slog:23", "once", _fires);
