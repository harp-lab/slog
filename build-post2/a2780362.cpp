...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("a2780362");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst7tLI24 const2c624232cdd221771294dfbb) (let __t9WfC25 (cmap))) (scan bound a c v) (body (cmp lt v __tconst7tLI24) (join edge (0 1 2) 1 c e w2) (let __t3KnY26 (cput __t9WfC25 e w2))) (head (emit-lat best a __t3KnY26)) lat_rat.slog:29 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      outer_rel = db->getRelation("bound");
      std::vector<u16> ord2({0, 1, 2});
      slog::Relation* readrel3 = db->getRelation("edge");
      edgeindex0 = readrel3->getIndex(ord2, false);
  
    }
    ReadTask1(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c0 = v_const2c624232cdd221771294dfbb;
      u64 v_c1 = _prim_cmap(db);
      if (v_c1 == slog_error) { slog::emit_pending_error(db, "lat_rat.slog:29"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c3 = _t[1];
        u64 v_c4 = _t[2];
        u64 v_c5 = _prim_lt(db, v_c4, v_c0);
        if (v_c5 == slog_error) { slog::emit_pending_error(db, "lat_rat.slog:29"); return; }
        if (!v_c5) return;
        slog::join_probe<3,1>(edgeindex0, std::array<u64,3>{v_c3, 0, 0}, [&](const std::array<u64,3>& m5) {
          u64 v_c6 = m5[1]; u64 v_c7 = m5[2];
          u64 v_c8 = _prim_cput(db, v_c1, v_c6, v_c7);
          if (v_c8 == slog_error) { slog::emit_pending_error(db, "lat_rat.slog:29"); return; }
          ++_fires;
      ...
      if (_fires) db->bumpFires("lat_rat.slog:29", "delta:bound", _fires);
  ...
  // (crule (pre (let __tconst3GIO3 const6b86b273ff34fce19d6b804e) (let __t6MVy7 (cmap))) (scan edge a b w) (body (let __t1lmF5 (cput __t6MVy7 w __tconst3GIO3)) (let __t2LMO6 (cput __t1lmF5 b __tconst3GIO3)) (let __t3NoZ8 (cput __t6MVy7 b __t2LMO6))) (head (emit-lat tags a __t3NoZ8)) lat_rat.slog:44 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("tags");
    ...
    virtual bool work()
    {
      ...
      u64 v_c10 = _prim_cmap(db);
      if (v_c10 == slog_error) { slog::emit_pending_error(db, "lat_rat.slog:44"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c11 = _t[1];
        u64 v_c12 = _t[2];
        u64 v_c13 = _prim_cput(db, v_c10, v_c12, v_c9);
        if (v_c13 == slog_error) { slog::emit_pending_error(db, "lat_rat.slog:44"); return; }
        u64 v_c14 = _prim_cput(db, v_c13, v_c11, v_c9);
        if (v_c14 == slog_error) { slog::emit_pending_error(db, "lat_rat.slog:44"); return; }
        u64 v_c15 = _prim_cput(db, v_c10, v_c11, v_c14);
        if (v_c15 == slog_error) { slog::emit_pending_error(db, "lat_rat.slog:44"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("lat_rat.slog:44", "all:edge", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre346t74 __errf0HpF75 __errf045K76 __errf3zVq77 __errf78mW78) (body) (head (emit error (0) __erre346t74)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre36eB63 __errf9Hr464 __errf1nHW65 __errf7HcM66) (body) (head (emit error (0) __erre36eB63)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre6MZU84 __errf6hYs85 __errf1q4g86) (body) (head (emit error (0) __erre6MZU84)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre6AJi67 __errf9cJd68 __errf4BM969 __errf2SD070) (body) (head (emit error (0) __erre6AJi67)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre4TQR79 __errf5sEF80 __errf6pqs81 __errf4ZVr82 __errf57vz83) (body) (head (emit error (0) __erre4TQR79)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre7Hwa71 __errf2cAp72 __errf5WjN73) (body) (head (emit error (0) __erre7Hwa71)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre3dzy57 __errf7wlJ58 __errf6eoK59) (body) (head (emit error (0) __erre3dzy57)) <internal>:1 #f)
  ...
  // (crule (pre (let __t2eCY22 (cmap))) (scan edge a b w) (body (let __t36Kt23 (cput __t2eCY22 b w))) (head (emit-lat best a __t36Kt23)) lat_rat.slog:20 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      u64 v_c43 = _prim_cmap(db);
      if (v_c43 == slog_error) { slog::emit_pending_error(db, "lat_rat.slog:20"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c11 = _t[1];
        u64 v_c12 = _t[2];
        u64 v_c44 = _prim_cput(db, v_c43, v_c11, v_c12);
        if (v_c44 == slog_error) { slog::emit_pending_error(db, "lat_rat.slog:20"); return; }
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c2, v_c44});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lat_rat.slog:20", "all:edge", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre4ArP60 __errf1DRE61 __errf2AdH62) (body) (head (emit error (0) __erre4ArP60)) <internal>:1 #f)
  ...
  // (crule (pre) (scan best_at b c d) (body (join edge (1 0 2) 1 b a w) (let __t1lsu21 (_0002b w d))) (head (emit-lat bound a c __t1lsu21)) lat_rat.slog:24 #f)
  class ReadTask33 : public slog::Task
  {
    ...
    slog::Index** edgeindex32;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("bound");
      outer_rel = db->getRelation("best_at");
      std::vector<u16> ord34({1, 0, 2});
      slog::Relation* readrel35 = db->getRelation("edge");
      edgeindex32 = readrel35->getIndex(ord34, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c3 = _t[1];
        u64 v_c48 = _t[2];
        slog::join_probe<3,1>(edgeindex32, std::array<u64,3>{v_c11, 0, 0}, [&](const std::array<u64,3>& m36) {
          u64 v_c2 = m36[1]; u64 v_c12 = m36[2];
          u64 v_c49 = _prim__0002b(db, v_c12, v_c48);
          if (v_c49 == slog_error) { slog::emit_pending_error(db, "lat_rat.slog:24"); return; }
          ++_fires;
          slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c2, v_c3, v_c49});
        });
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("lat_rat.slog:24", "delta:best_at", _fires);
