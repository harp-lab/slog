...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("ec56d8b5");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst9Dk75 const4e07408562bedb8b60ce05c1) (let __tconst9n0I4 const4b227777d4dd1fc61c6f884f) (let __tconst8DMM3 const6b86b273ff34fce19d6b804e) (let __tconst9AGe2 constd4735e3a265e16eee03f5971)) (once) (body) (head (emit src (0 1) __tconst9Dk75 __tconst9n0I4) (emit src (0 1) __tconst8DMM3 __tconst9AGe2)) shape_multihead.slog:19 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("shape_multihead.slog:19", "once", _fires);
