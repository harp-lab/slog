...
u64 v_const40510175845988f13f6162ed;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("fa46a294");
  if (s == nullptr) return;
  slog::Relation* r;
  v_const40510175845988f13f6162ed = s32_encode(1000);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre8Dyg188 __errf6bTT189 __errf9euz190) (body) (head (emit error (0) __erre8Dyg188)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre9HuG183 __errf7Ptr184 __errf1JtV185 __errf8bhS186 __errf5pas187) (body) (head (emit error (0) __erre9HuG183)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre4GFu178 __errf9YiG179 __errf0KGc180 __errf6seE181 __errf1wfJ182) (body) (head (emit error (0) __erre4GFu178)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre4m15167 __errf7zAl168 __errf5OKh169 __errf7twM170) (body) (head (emit error (0) __erre4m15167)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst09vu9 const40510175845988f13f6162ed)) (scan c X) (body (let __t3k9c10 (_0002b X __tconst09vu9))) (head (emit d (0) __t3k9c10)) strat_chain.slog:17 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel14 = db->getRelation("d");
    ...
    virtual bool work()
    {
      u64 v_c17 = v_const40510175845988f13f6162ed;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c18 = _t[0];
        u64 v_c19 = _prim__0002b(db, v_c18, v_c17);
        if (v_c19 == slog_error) { slog::emit_pending_error(db, "strat_chain.slog:17"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_chain.slog:17", "all:c", _fires);
  ...
  // (crule (pre) (scan nan_result __erre4w9T171 __errf5ORo172 __errf5GJX173 __errf6zzB174) (body) (head (emit error (0) __erre4w9T171)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre30ua164 __errf41W0165 __errf5U0H166) (body) (head (emit error (0) __erre30ua164)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre9FL7175 __errf36PA176 __errf2eGD177) (body) (head (emit error (0) __erre9FL7175)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre9bv9161 __errf6GZh162 __errf0oVQ163) (body) (head (emit error (0) __erre9bv9161)) <internal>:1 #f)
