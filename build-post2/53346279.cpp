...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("53346279");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan nan_result __erre2nRZ310 __errf4jzp311 __errf9ZLF312 __errf6CTO313) (body) (head (emit error (0) __erre2nRZ310)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre0ftg314 __errf4bxm315 __errf8Y3A316) (body) (head (emit error (0) __erre0ftg314)) <internal>:1 #f)
  ...
  // (crule (pre (let one const6b86b273ff34fce19d6b804e)) (scan $seq_pos l j p) (body (let n (llen l)) (let lim (_0002d n j)) (cmp lt p lim) (let p1 (_0002b p one))) (head (emit $seq_pos (0 1 2) l j p1)) seq_run.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel8 = db->getRelation("$seq_pos");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c9 = _t[1];
        u64 v_c10 = _t[2];
        u64 v_c11 = _prim_llen(db, v_c8);
        if (v_c11 == slog_error) { slog::emit_pending_error(db, "seq_run.slog:15"); return; }
        u64 v_c12 = _prim__0002d(db, v_c11, v_c9);
        if (v_c12 == slog_error) { slog::emit_pending_error(db, "seq_run.slog:15"); return; }
        u64 v_c13 = _prim_lt(db, v_c10, v_c12);
        if (v_c13 == slog_error) { slog::emit_pending_error(db, "seq_run.slog:15"); return; }
        if (!v_c13) return;
        u64 v_c14 = _prim__0002b(db, v_c10, v_c7);
        if (v_c14 == slog_error) { slog::emit_pending_error(db, "seq_run.slog:15"); return; }
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c8, v_c9, v_c14}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("seq_run.slog:15", "delta:$seq_pos", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre7BcH303 __errf3CPh304 __errf2uYm305) (body) (head (emit error (0) __erre7BcH303)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre8ZgQ317 __errf5DJ1318 __errf0bBc319 __errf7Nd7320 __errf2kAf321) (body) (head (emit error (0) __erre8ZgQ317)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre1nmi322 __errf153V323 __errf4epl324 __errf0m2X325 __errf9Gcg326) (body) (head (emit error (0) __erre1nmi322)) <internal>:1 #f)
  ...
  // (crule (pre (let z const5feceb66ffc86f38d952786c)) (scan $seq_posdem l j) (body (let n (llen l)) (cmp ge n j)) (head (emit $seq_pos (0 1 2) l j z)) seq_run.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel21 = db->getRelation("$seq_pos");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c11 = _prim_llen(db, v_c8);
        if (v_c11 == slog_error) { slog::emit_pending_error(db, "seq_run.slog:15"); return; }
        u64 v_c29 = _prim_ge(db, v_c11, v_c9);
        if (v_c29 == slog_error) { slog::emit_pending_error(db, "seq_run.slog:15"); return; }
        if (!v_c29) return;
        ++_fires;
        slog::emit<3>(head_rel[0], head_index[0], newbatch[0], std::array<u64,3>{v_c8, v_c9, v_c28}, std::array<u16,3>{0, 1, 2});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("seq_run.slog:15", "all:$seq_posdem", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre4pqP306 __errf6ZKV307 __errf3wyf308 __errf1q7e309) (body) (head (emit error (0) __erre4pqP306)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre8C9F300 __errf3z6b301 __errf0JZ7302) (body) (head (emit error (0) __erre8C9F300)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre8SKa327 __errf7OEE328 __errf6PAG329) (body) (head (emit error (0) __erre8SKa327)) <internal>:1 #f)
