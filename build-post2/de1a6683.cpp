...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("de1a6683");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst6Z786 constd4735e3a265e16eee03f5971) (let __tconst5XAw7 const6b86b273ff34fce19d6b804e) (let __tconst754R8 const4b227777d4dd1fc61c6f884f) (let __tconst5lDE9 const4e07408562bedb8b60ce05c1)) (once) (body) (head (emit edge (0 1 2) __tconst5XAw7 __tconst6Z786 __tconst5XAw7) (emit edge (0 1 2) __tconst6Z786 __tconst5lDE9 __tconst5XAw7) (emit edge (0 1 2) __tconst5lDE9 __tconst754R8 __tconst5XAw7)) lat_twohop.slog:10 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      slog::emit<3>(head_rel[1], head_index[1], newbatch[1], std::array<u64,3>{v_c0, v_c3, v_c1}, std::array<u16,3>{0, 1, 2});
      slog::emit<3>(head_rel[2], head_index[2], newbatch[2], std::array<u64,3>{v_c3, v_c2, v_c1}, std::array<u16,3>{0, 1, 2});
  
        head_rel[0]->sendBatch(newbatch[0]);
        head_rel[1]->sendBatch(newbatch[1]);
        head_rel[2]->sendBatch(newbatch[2]);
  
      if (_fires) db->bumpFires("lat_twohop.slog:10", "once", _fires);
