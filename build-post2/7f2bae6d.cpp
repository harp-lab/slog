...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("7f2bae6d");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan int_overflow __erre9r7s43 __errf4WB044 __errf3X5I45 __errf8NDu46) (body) (head (emit error (0) __erre9r7s43)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre5vkJ40 __errf6xOQ41 __errf3F1P42) (body) (head (emit error (0) __erre5vkJ40)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre5qgZ37 __errf7w2N38 __errf7GS339) (body) (head (emit error (0) __erre5qgZ37)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst0xGI3 constad57366865126e55649ecb23)) (scan p X) (body (let __t0bWM4 (_0002b X __tconst0xGI3))) (head (emit q (0) __t0bWM4)) strat_run2_step_base.slog:8 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("q");
      std::vector<u16> ord10({0});
      slog::Relation* readrel11 = db->getRelation("q");
      head_index[0] = readrel11->getIndex(ord10, false);
      outer_rel = db->getRelation("p");
  
    }
    ReadTask9(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c10 = v_constad57366865126e55649ecb23;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c11 = _t[0];
        u64 v_c12 = _prim__0002b(db, v_c11, v_c10);
        if (v_c12 == slog_error) { slog::emit_pending_error(db, "strat_run2_step_base.slog:8"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("strat_run2_step_base.slog:8", "all:p", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre7uR364 __errf4Oak65 __errf4nLC66) (body) (head (emit error (0) __erre7uR364)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre0fDh51 __errf9MpA52 __errf0qwT53) (body) (head (emit error (0) __erre0fDh51)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre9RBA47 __errf9EnS48 __errf2cxp49 __errf3ejM50) (body) (head (emit error (0) __erre9RBA47)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre3v5059 __errf5rz560 __errf34tD61 __errf5C1x62 __errf63WW63) (body) (head (emit error (0) __erre3v5059)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre3j8554 __errf6Myz55 __errf70Nb56 __errf8CX757 __errf18TR58) (body) (head (emit error (0) __erre3j8554)) <internal>:1 #f)
