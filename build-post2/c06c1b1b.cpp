...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("c06c1b1b");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan edge X Y) (body) (head (emit path (0 1) X Y)) line.slog:17 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("line.slog:17", "all:edge", _fires);
  ...
  // (crule (pre) (scan path X Y) (body (join edge (0 1) 1 Y Z)) (head (emit path (0 1) X Z)) line.slog:22 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("line.slog:22", "delta:path", _fires);
