...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("315db3df");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp0Zpn100");
  if (r == 0) db->addTempRelation("temp0Zpn100", 2);
  ...
  // (crule (pre) (scan mpz_overflow __erre4vyF92 __errf9IAF93 __errf3unb94 __errf2OzS95 __errf8QHg96) (body) (head (emit error (0) __erre4vyF92)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst6dRl15 const5feceb66ffc86f38d952786c)) (scan seed s) (body) (head (emit grow (0 1) __tconst6dRl15 s)) str_utf8.slog:16 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel5 = db->getRelation("grow");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("str_utf8.slog:16", "all:seed", _fires);
  ...
  // (crule (pre) (scan temp0Zpn100 __t4PXB24 __t6j9U26) (body) (head (emit grow (0 1) __t6j9U26 __t4PXB24)) str_utf8.slog:17 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel8 = db->getRelation("grow");
      head_index[0] = readrel8->getIndex(ord7, false);
      outer_rel = db->getRelation("temp0Zpn100");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c8 = _t[1];
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c8, v_c7}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("str_utf8.slog:17", "delta:temp0Zpn100", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre0X1776 __errf2AOE77 __errf5FY978 __errf7Ld179) (body) (head (emit error (0) __erre0X1776)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre3gDa87 __errf8utS88 __errf4OOM89 __errf7NMD90 __errf5mMC91) (body) (head (emit error (0) __erre3gDa87)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre31t097 __errf5m1P98 __errf1wTr99) (body) (head (emit error (0) __erre31t097)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre1VhZ80 __errf0c5281 __errf83tA82 __errf0XW583) (body) (head (emit error (0) __erre1VhZ80)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre2zy984 __errf3sMM85 __errf8DnH86) (body) (head (emit error (0) __erre2zy984)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre4Beh73 __errf6Rn074 __errf4vSd75) (body) (head (emit error (0) __erre4Beh73)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst9kNt27 constef2d127de37b942baad06145) (let __tconst4NMp25 const6b86b273ff34fce19d6b804e)) (scan grow n s) (body (cmp lt n __tconst9kNt27) (let __t6j9U26 (_0002b n __tconst4NMp25)) (let __t4PXB24 (_0002b s s))) (head (emit-temp temp0Zpn100 __t4PXB24 __t6j9U26)) str_utf8.slog:17 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp0Zpn100");
    ...
    virtual bool work()
    {
      u64 v_c31 = v_constef2d127de37b942baad06145;
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c33 = _t[0];
        u64 v_c6 = _t[1];
        u64 v_c34 = _prim_lt(db, v_c33, v_c31);
        if (v_c34 == slog_error) { slog::emit_pending_error(db, "str_utf8.slog:17"); return; }
        if (!v_c34) return;
        u64 v_c8 = _prim__0002b(db, v_c33, v_c32);
        if (v_c8 == slog_error) { slog::emit_pending_error(db, "str_utf8.slog:17"); return; }
        u64 v_c7 = _prim__0002b(db, v_c6, v_c6);
        if (v_c7 == slog_error) { slog::emit_pending_error(db, "str_utf8.slog:17"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("str_utf8.slog:17", "delta:grow", _fires);
  ...
  // (crule (pre) (scan div_by_zero __erre9ci370 __errf5QFw71 __errf1d1S72) (body) (head (emit error (0) __erre9ci370)) <internal>:1 #f)
