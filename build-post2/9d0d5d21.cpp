...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("9d0d5d21");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan probe n) (body) (head (mkstruct classify (1 0) __0KDs11 n)) dem_or.slog:16 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("classify");
