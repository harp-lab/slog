...
{
  // (crule (pre) (scan a42 X) (body) (head (emit a41 (0) X)) split_vprefix.slog:102 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("a41");
      std::vector<u16> ord1({0});
      slog::Relation* readrel2 = db->getRelation("a41");
      head_index[0] = readrel2->getIndex(ord1, false);
      outer_rel = db->getRelation("a42");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:102", "delta:a42", _fires);
  ...
  // (crule (pre) (scan a36 X) (body) (head (emit a35 (0) X)) split_vprefix.slog:96 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a35");
      std::vector<u16> ord4({0});
      slog::Relation* readrel5 = db->getRelation("a35");
      head_index[0] = readrel5->getIndex(ord4, false);
      outer_rel = db->getRelation("a36");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:96", "delta:a36", _fires);
  ...
  // (crule (pre) (scan a8 X) (body) (head (emit a7 (0) X)) split_vprefix.slog:68 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a7");
      std::vector<u16> ord7({0});
      slog::Relation* readrel8 = db->getRelation("a7");
      head_index[0] = readrel8->getIndex(ord7, false);
      outer_rel = db->getRelation("a8");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:68", "delta:a8", _fires);
  ...
  // (crule (pre) (scan a9 X) (body) (head (emit a8 (0) X)) split_vprefix.slog:69 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a8");
      std::vector<u16> ord10({0});
      slog::Relation* readrel11 = db->getRelation("a8");
      head_index[0] = readrel11->getIndex(ord10, false);
      outer_rel = db->getRelation("a9");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:69", "delta:a9", _fires);
  ...
  // (crule (pre) (scan a47 X) (body) (head (emit a46 (0) X)) split_vprefix.slog:107 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a46");
      std::vector<u16> ord13({0});
      slog::Relation* readrel14 = db->getRelation("a46");
      head_index[0] = readrel14->getIndex(ord13, false);
      outer_rel = db->getRelation("a47");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:107", "delta:a47", _fires);
  ...
  // (crule (pre) (scan a35 X) (body) (head (emit a34 (0) X)) split_vprefix.slog:95 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a34");
      std::vector<u16> ord16({0});
      slog::Relation* readrel17 = db->getRelation("a34");
      head_index[0] = readrel17->getIndex(ord16, false);
      outer_rel = db->getRelation("a35");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:95", "delta:a35", _fires);
  ...
  // (crule (pre) (scan a1 X) (body) (head (emit a0 (0) X)) split_vprefix.slog:61 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a0");
      std::vector<u16> ord19({0});
      slog::Relation* readrel20 = db->getRelation("a0");
      head_index[0] = readrel20->getIndex(ord19, false);
      outer_rel = db->getRelation("a1");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:61", "delta:a1", _fires);
  ...
  // (crule (pre) (scan a27 X) (body) (head (emit a26 (0) X)) split_vprefix.slog:87 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a26");
      std::vector<u16> ord22({0});
      slog::Relation* readrel23 = db->getRelation("a26");
      head_index[0] = readrel23->getIndex(ord22, false);
      outer_rel = db->getRelation("a27");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:87", "delta:a27", _fires);
  ...
  // (crule (pre) (scan a12 X) (body) (head (emit a11 (0) X)) split_vprefix.slog:72 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a11");
      std::vector<u16> ord25({0});
      slog::Relation* readrel26 = db->getRelation("a11");
      head_index[0] = readrel26->getIndex(ord25, false);
      outer_rel = db->getRelation("a12");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:72", "delta:a12", _fires);
  ...
  // (crule (pre) (scan a0 X) (body) (head (emit v_x (0) X)) split_vprefix.slog:112 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("v_x");
      std::vector<u16> ord28({0});
      slog::Relation* readrel29 = db->getRelation("v_x");
      head_index[0] = readrel29->getIndex(ord28, false);
      outer_rel = db->getRelation("a0");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:112", "delta:a0", _fires);
  ...
  // (crule (pre) (scan a5 X) (body) (head (emit a4 (0) X)) split_vprefix.slog:65 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a4");
      std::vector<u16> ord31({0});
      slog::Relation* readrel32 = db->getRelation("a4");
      head_index[0] = readrel32->getIndex(ord31, false);
      outer_rel = db->getRelation("a5");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:65", "delta:a5", _fires);
  ...
  // (crule (pre) (scan a17 X) (body) (head (emit a16 (0) X)) split_vprefix.slog:77 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a16");
      std::vector<u16> ord34({0});
      slog::Relation* readrel35 = db->getRelation("a16");
      head_index[0] = readrel35->getIndex(ord34, false);
      outer_rel = db->getRelation("a17");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:77", "delta:a17", _fires);
  ...
  // (crule (pre) (scan a49 X) (body) (head (emit a48 (0) X)) split_vprefix.slog:109 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a48");
      std::vector<u16> ord37({0});
      slog::Relation* readrel38 = db->getRelation("a48");
      head_index[0] = readrel38->getIndex(ord37, false);
      outer_rel = db->getRelation("a49");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:109", "delta:a49", _fires);
  ...
  // (crule (pre) (scan a40 X) (body) (head (emit a39 (0) X)) split_vprefix.slog:100 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a39");
      std::vector<u16> ord40({0});
      slog::Relation* readrel41 = db->getRelation("a39");
      head_index[0] = readrel41->getIndex(ord40, false);
      outer_rel = db->getRelation("a40");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:100", "delta:a40", _fires);
  ...
  // (crule (pre) (scan a24 X) (body) (head (emit a23 (0) X)) split_vprefix.slog:84 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a23");
      std::vector<u16> ord43({0});
      slog::Relation* readrel44 = db->getRelation("a23");
      head_index[0] = readrel44->getIndex(ord43, false);
      outer_rel = db->getRelation("a24");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:84", "delta:a24", _fires);
  ...
  // (crule (pre) (scan a6 X) (body) (head (emit a5 (0) X)) split_vprefix.slog:66 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a5");
      std::vector<u16> ord46({0});
      slog::Relation* readrel47 = db->getRelation("a5");
      head_index[0] = readrel47->getIndex(ord46, false);
      outer_rel = db->getRelation("a6");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:66", "delta:a6", _fires);
  ...
  // (crule (pre) (scan a39 X) (body) (head (emit a38 (0) X)) split_vprefix.slog:99 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a38");
      std::vector<u16> ord49({0});
      slog::Relation* readrel50 = db->getRelation("a38");
      head_index[0] = readrel50->getIndex(ord49, false);
      outer_rel = db->getRelation("a39");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:99", "delta:a39", _fires);
  ...
  // (crule (pre) (scan a50 X) (body) (head (emit a49 (0) X)) split_vprefix.slog:110 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a49");
      std::vector<u16> ord52({0});
      slog::Relation* readrel53 = db->getRelation("a49");
      head_index[0] = readrel53->getIndex(ord52, false);
      outer_rel = db->getRelation("a50");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:110", "delta:a50", _fires);
  ...
  // (crule (pre) (scan a45 X) (body) (head (emit a44 (0) X)) split_vprefix.slog:105 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a44");
      std::vector<u16> ord55({0});
      slog::Relation* readrel56 = db->getRelation("a44");
      head_index[0] = readrel56->getIndex(ord55, false);
      outer_rel = db->getRelation("a45");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:105", "delta:a45", _fires);
  ...
  // (crule (pre) (scan a23 X) (body) (head (emit a22 (0) X)) split_vprefix.slog:83 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a22");
      std::vector<u16> ord58({0});
      slog::Relation* readrel59 = db->getRelation("a22");
      head_index[0] = readrel59->getIndex(ord58, false);
      outer_rel = db->getRelation("a23");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:83", "delta:a23", _fires);
  ...
  // (crule (pre) (scan a37 X) (body) (head (emit a36 (0) X)) split_vprefix.slog:97 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a36");
      std::vector<u16> ord61({0});
      slog::Relation* readrel62 = db->getRelation("a36");
      head_index[0] = readrel62->getIndex(ord61, false);
      outer_rel = db->getRelation("a37");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:97", "delta:a37", _fires);
  ...
  // (crule (pre) (scan a4 X) (body) (head (emit a3 (0) X)) split_vprefix.slog:64 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a3");
      std::vector<u16> ord64({0});
      slog::Relation* readrel65 = db->getRelation("a3");
      head_index[0] = readrel65->getIndex(ord64, false);
      outer_rel = db->getRelation("a4");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:64", "delta:a4", _fires);
  ...
  // (crule (pre) (scan v_x X) (body) (head (emit a50 (0) X)) split_vprefix.slog:111 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a50");
      std::vector<u16> ord67({0});
      slog::Relation* readrel68 = db->getRelation("a50");
      head_index[0] = readrel68->getIndex(ord67, false);
      outer_rel = db->getRelation("v_x");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:111", "delta:v_x", _fires);
  ...
  // (crule (pre (let __tconst0cj61 const7902699be42c8a8e46fbbb45)) (once) (body) (head (emit a0 (0) __tconst0cj61)) split_vprefix.slog:60 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel71 = db->getRelation("a0");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:60", "once", _fires);
  ...
  // (crule (pre) (scan a22 X) (body) (head (emit a21 (0) X)) split_vprefix.slog:82 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a21");
      std::vector<u16> ord73({0});
      slog::Relation* readrel74 = db->getRelation("a21");
      head_index[0] = readrel74->getIndex(ord73, false);
      outer_rel = db->getRelation("a22");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:82", "delta:a22", _fires);
  ...
  // (crule (pre) (scan a18 X) (body) (head (emit a17 (0) X)) split_vprefix.slog:78 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a17");
      std::vector<u16> ord76({0});
      slog::Relation* readrel77 = db->getRelation("a17");
      head_index[0] = readrel77->getIndex(ord76, false);
      outer_rel = db->getRelation("a18");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:78", "delta:a18", _fires);
  ...
  // (crule (pre) (scan a7 X) (body) (head (emit a6 (0) X)) split_vprefix.slog:67 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a6");
      std::vector<u16> ord79({0});
      slog::Relation* readrel80 = db->getRelation("a6");
      head_index[0] = readrel80->getIndex(ord79, false);
      outer_rel = db->getRelation("a7");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:67", "delta:a7", _fires);
  ...
  // (crule (pre) (scan a10 X) (body) (head (emit a9 (0) X)) split_vprefix.slog:70 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("a9");
      std::vector<u16> ord82({0});
      slog::Relation* readrel83 = db->getRelation("a9");
      head_index[0] = readrel83->getIndex(ord82, false);
      outer_rel = db->getRelation("a10");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("split_vprefix.slog:70", "delta:a10", _fires);
