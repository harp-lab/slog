...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("916c5fd9");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst5vQH5 const6b86b273ff34fce19d6b804e)) (probe mincost (1 0) 1 __tconst5vQH5 __t16mm6) (body (join-lat mincost_ans (0 1) 1 __t16mm6 C)) (head (emit answer (0) C)) lat_demand.slog:26 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel5 = db->getRelation("mincost");
      driver_index = readrel5->getIndex(ord4, true);
      std::vector<u16> ord6({0, 1});
      slog::Relation* readrel7 = db->getRelation("mincost_ans");
      mincost_ansindex0 = readrel7->getIndex(ord6, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::join_probe_sliced<2,1>(driver_index, std::array<u64,2>{v_c0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,2>& m8) {
        ...
        slog::join_probe_lat<1,1>(mincost_ansindex0, std::array<u64,1>{v_c1}, [&](const std::array<u64,1>& m9, u64 val10) {
          u64 v_c2 = val10;
          ++_fires;
      ...
      if (_fires) db->bumpFires("lat_demand.slog:26", "all:mincost", _fires);
