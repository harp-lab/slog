...
u64 v_const265f10e1bf87701b7aa597c1;
u64 v_const3bb78535cc9555ff19fe3556;


extern "C" void slog_plugin(slog::Daemon* d)
{
  slog::Database* db = d->db();
  slog::Stratum* s = d->beginStratum("04e3541f");
  if (s == nullptr) return;
  slog::Relation* r;
  v_const6b86b273ff34fce19d6b804e = s32_encode(1);
  v_constd4735e3a265e16eee03f5971 = s32_encode(2);
  v_constad57366865126e55649ecb23 = s32_encode(100);
  v_const265f10e1bf87701b7aa597c1 = s32_encode(70000);
  v_const3bb78535cc9555ff19fe3556 = s32_encode(100000);
  ...
  // (crule (pre) (scan nan_result __erre12rF51 __errf6tDI52 __errf7R1s53 __errf06SA54) (body) (head (emit error (0) __erre12rF51)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst5gqp2 constad57366865126e55649ecb23) (let __tconst71U93 constd4735e3a265e16eee03f5971) (let __t6FKu4 (pow __tconst71U93 __tconst5gqp2))) (scan go X) (body) (head (emit ok (0) __t6FKu4)) int_caps.slog:19 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel5 = db->getRelation("ok");
      head_index[0] = readrel5->getIndex(ord4, false);
      outer_rel = db->getRelation("go");
  
    }
    ReadTask3(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c4 = v_constad57366865126e55649ecb23;
      u64 v_c5 = v_constd4735e3a265e16eee03f5971;
      u64 v_c6 = _prim_pow(db, v_c5, v_c4);
      if (v_c6 == slog_error) { slog::emit_pending_error(db, "int_caps.slog:19"); return true; }
      ...
      if (_fires) db->bumpFires("int_caps.slog:19", "all:go", _fires);
  ...
  // (crule (pre) (scan modulo_by_zero __erre717D44 __errf9zxZ45 __errf88fC46) (body) (head (emit error (0) __erre717D44)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre3A8G68 __errf1QTt69 __errf9LdA70) (body) (head (emit error (0) __erre3A8G68)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre2Qve41 __errf3RTM42 __errf3YZ343) (body) (head (emit error (0) __erre2Qve41)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre89UQ63 __errf6q1j64 __errf5NF365 __errf64qO66 __errf0KXq67) (body) (head (emit error (0) __erre89UQ63)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst68GI5 const3bb78535cc9555ff19fe3556) (let __tconst2INI6 constd4735e3a265e16eee03f5971) (let __t07Yv7 (pow __tconst2INI6 __tconst68GI5))) (scan go X) (body) (head (emit nope (0) __t07Yv7)) int_caps.slog:15 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("nope");
      std::vector<u16> ord19({0});
      slog::Relation* readrel20 = db->getRelation("nope");
    ...
    virtual bool work()
    {
      u64 v_c22 = v_const3bb78535cc9555ff19fe3556;
      u64 v_c23 = v_constd4735e3a265e16eee03f5971;
      u64 v_c24 = _prim_pow(db, v_c23, v_c22);
      if (v_c24 == slog_error) { slog::emit_pending_error(db, "int_caps.slog:15"); return true; }
      ...
      if (_fires) db->bumpFires("int_caps.slog:15", "all:go", _fires);
  ...
  // (crule (pre) (scan toint_range __erre4EqJ55 __errf8pRB56 __errf21jI57) (body) (head (emit error (0) __erre4EqJ55)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre8Myv58 __errf8bXg59 __errf8zb460 __errf6Enc61 __errf4KOE62) (body) (head (emit error (0) __erre8Myv58)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst3lyY8 const265f10e1bf87701b7aa597c1) (let __tconst1TPu9 const6b86b273ff34fce19d6b804e) (let __t7ma510 (shl __tconst1TPu9 __tconst3lyY8))) (scan go X) (body) (head (emit nope2 (0) __t7ma510)) int_caps.slog:17 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("nope2");
      std::vector<u16> ord28({0});
      slog::Relation* readrel29 = db->getRelation("nope2");
    ...
    virtual bool work()
    {
      u64 v_c33 = v_const265f10e1bf87701b7aa597c1;
      u64 v_c34 = v_const6b86b273ff34fce19d6b804e;
      u64 v_c35 = _prim_shl(db, v_c34, v_c33);
      if (v_c35 == slog_error) { slog::emit_pending_error(db, "int_caps.slog:17"); return true; }
      ...
      if (_fires) db->bumpFires("int_caps.slog:17", "all:go", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre9AG047 __errf08NL48 __errf7COV49 __errf1LKQ50) (body) (head (emit error (0) __erre9AG047)) <internal>:1 #f)
  ...
  s->addDynamicRel("nope");
  s->addDynamicRel("nope2");
  s->addDynamicRel("ok");
