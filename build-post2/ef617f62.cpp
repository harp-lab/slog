...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("ef617f62");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan mpz_table_overflow __erre3jJ3169 __errf4eqK170 __errf1qDt171) (body) (head (emit error (0) __erre3jJ3169)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre5N0m145 __errf0Pf0146 __errf52LD147) (body) (head (emit error (0) __erre5N0m145)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre8mXy164 __errf6Hyr165 __errf9OhE166 __errf8Jwf167 __errf6RvT168) (body) (head (emit error (0) __erre8mXy164)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre4z0N159 __errf3srL160 __errf1olK161 __errf6n0l162 __errf3yhW163) (body) (head (emit error (0) __erre4z0N159)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre4p6L152 __errf07k6153 __errf1fwS154 __errf6lKa155) (body) (head (emit error (0) __erre4p6L152)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre1pTT142 __errf6EG3143 __errf5L6f144) (body) (head (emit error (0) __erre1pTT142)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre5MGe156 __errf8Bex157 __errf8o5I158) (body) (head (emit error (0) __erre5MGe156)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre8oJW148 __errf7ljE149 __errf6Dly150 __errf2r0A151) (body) (head (emit error (0) __erre8oJW148)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst51lk14 const6b86b273ff34fce19d6b804e)) (scan node d) (body (join-lat ndset (0 1) 0 n s) (let __t8VWn13 (cmem s d)) (cmp lt __t8VWn13 __tconst51lk14)) (head (emit dom (0 1) d n)) domtree.slog:64 #f)
  class ReadTask25 : public slog::Task
  {
    ...
    slog::Index** ndsetindex24;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("dom");
      std::vector<u16> ord26({0, 1});
      slog::Relation* readrel27 = db->getRelation("dom");
      head_index[0] = readrel27->getIndex(ord26, false);
      outer_rel = db->getRelation("node");
      std::vector<u16> ord28({0, 1});
      slog::Relation* readrel29 = db->getRelation("ndset");
      ndsetindex24 = readrel29->getIndex(ord28, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c31 = _t[0];
        slog::join_all_lat<1>(ndsetindex24, [&](const std::array<u64,1>& m30, u64 val31) {
          u64 v_c32 = m30[0]; u64 v_c33 = val31;
          u64 v_c34 = _prim_cmem(db, v_c33, v_c31);
          if (v_c34 == slog_error) { slog::emit_pending_error(db, "domtree.slog:64"); return; }
          u64 v_c35 = _prim_lt(db, v_c34, v_c30);
          if (v_c35 == slog_error) { slog::emit_pending_error(db, "domtree.slog:64"); return; }
          if (!v_c35) return;
          ++_fires;
          slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c31, v_c32}, std::array<u16,2>{0, 1});
        });
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("domtree.slog:64", "all:node", _fires);
