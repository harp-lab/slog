...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("fc79aecb");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan assign L V) (body) (head (emit-lat val L V)) lst_flat.slog:21 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      outer_rel = db->getRelation("assign");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("lst_flat.slog:21", "all:assign", _fires);
  ...
  // (crule (pre) (scan val L V) (body (join flow (0 1) 1 L L2)) (head (emit-lat val L2 V)) lst_flat.slog:22 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel4 = db->getRelation("flow");
      flowindex1 = readrel4->getIndex(ord3, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c0 = _t[0];
        u64 v_c1 = _t[1];
        slog::join_probe<2,1>(flowindex1, std::array<u64,2>{v_c0, 0}, [&](const std::array<u64,2>& m5) {
          u64 v_c2 = m5[1];
          ++_fires;
      ...
      if (_fires) db->bumpFires("lst_flat.slog:22", "delta:val", _fires);
