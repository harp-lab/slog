...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("a350a3a9");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst7gHN109 consta221beeaebe583607e193be7) (let __tconst0npi110 constab76c7d069d6f33dc950fb33) (let __tconst561s111 consteb8bf0d80db323992f6b634a) (let __tconst763K92 constd4735e3a265e16eee03f5971) (let __tconst2SZ190 const6b86b273ff34fce19d6b804e) (let __tconst5iLS88 const5feceb66ffc86f38d952786c)) (probe _enum (1 0) 1 __tconst7gHN109 __t4W8s91) (body (exists _enum (1 0) 1 __tconst561s111) (join _enum (1 0) 1 __tconst0npi110 __t3JHq89) (join _enum (1 0) 1 __tconst561s111 __t5EQH87)) (head (emit smt_vcode (0 1) __tconst763K92 __t4W8s91) (emit smt_vcode (0 1) __tconst2SZ190 __t3JHq89) (emit smt_vcode (0 1) __tconst5iLS88 __t5EQH87)) smt.slog:68 #f)
