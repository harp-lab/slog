...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("892e7920");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan mpz_table_overflow __erre047h66 __errf6XJV67 __errf4OIH68) (body) (head (emit error (0) __erre047h66)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre7xYG45 __errf6cpq46 __errf4kmo47 __errf3Nqw48) (body) (head (emit error (0) __erre7xYG45)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst05jt1 const4b227777d4dd1fc61c6f884f) (let __tconst3AME2 constd4735e3a265e16eee03f5971)) (scan t S) (body (let __t41la3 (substr S __tconst3AME2 __tconst05jt1))) (head (emit mid24 (0 1) S __t41la3)) prim2_substr.slog:13 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("mid24");
      std::vector<u16> ord7({0, 1});
      slog::Relation* readrel8 = db->getRelation("mid24");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c9 = _t[0];
        u64 v_c10 = _prim_substr(db, v_c9, v_c8, v_c7);
        if (v_c10 == slog_error) { slog::emit_pending_error(db, "prim2_substr.slog:13"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("prim2_substr.slog:13", "all:t", _fires);
  ...
  // (crule (pre) (scan type_mismatch __erre5lWu56 __errf4Tnf57 __errf6BX458 __errf1Ozy59 __errf9GU160) (body) (head (emit error (0) __erre5lWu56)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre4DV339 __errf2jq140 __errf45Va41) (body) (head (emit error (0) __erre4DV339)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre3ary49 __errf2BKr50 __errf5I6o51 __errf1yOW52) (body) (head (emit error (0) __erre3ary49)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre5u7Y42 __errf0Bi643 __errf6nMh44) (body) (head (emit error (0) __erre5u7Y42)) <internal>:1 #f)
  ...
  // (crule (pre (let __tconst9kMU6 const4e07408562bedb8b60ce05c1) (let __tconst5zCH7 const6b86b273ff34fce19d6b804e)) (scan t S) (body (let __t2jw58 (substr S __tconst5zCH7 __tconst9kMU6))) (head (emit mid13 (0 1) S __t2jw58)) prim2_substr.slog:14 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("mid13");
      std::vector<u16> ord22({0, 1});
      slog::Relation* readrel23 = db->getRelation("mid13");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c9 = _t[0];
        u64 v_c28 = _prim_substr(db, v_c9, v_c27, v_c26);
        if (v_c28 == slog_error) { slog::emit_pending_error(db, "prim2_substr.slog:14"); return; }
        ++_fires;
        slog::emit<2>(head_rel[0], head_index[0], newbatch[0], std::array<u64,2>{v_c9, v_c28}, std::array<u16,2>{0, 1});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("prim2_substr.slog:14", "all:t", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre2XTb61 __errf27je62 __errf74MZ63 __errf6aO464 __errf76QC65) (body) (head (emit error (0) __erre2XTb61)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre4OqW53 __errf6zde54 __errf2dqE55) (body) (head (emit error (0) __erre4OqW53)) <internal>:1 #f)
  ...
  s->addDynamicRel("mid13");
  s->addDynamicRel("mid24");
