...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("384d6ab9");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst3M5p2 constd4735e3a265e16eee03f5971) (let __tconst5NTZ1 const6b86b273ff34fce19d6b804e)) (once) (body) (head (emit a (0) __tconst3M5p2) (emit a (0) __tconst5NTZ1)) strat_chain.slog:11 #f)
  ...
  public:
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("strat_chain.slog:11", "once", _fires);
