...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("a7c73b9d");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp9o8H73");
  if (r == 0) db->addTempRelation("temp9o8H73", 2);
  ...
  // (crule (pre) (scan nan_result __erre2B5L53 __errf5lcO54 __errf47jY55 __errf1yvV56) (body) (head (emit error (0) __erre2B5L53)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp9o8H73 __t0nJG4 __t5aV93) (body) (head (emit dub_ans (0 1) __t0nJG4 __t5aV93)) rule_noarrow.slog:17 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("dub_ans");
      std::vector<u16> ord4({0, 1});
      slog::Relation* readrel5 = db->getRelation("dub_ans");
      head_index[0] = readrel5->getIndex(ord4, false);
      outer_rel = db->getRelation("temp9o8H73");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("rule_noarrow.slog:17", "delta:temp9o8H73", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre84sB49 __errf3t9B50 __errf9yrs51 __errf5IJI52) (body) (head (emit error (0) __erre84sB49)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_table_overflow __erre49Q170 __errf1S5y71 __errf9cmt72) (body) (head (emit error (0) __erre49Q170)) <internal>:1 #f)
  ...
  // (crule (pre) (scan dub __t0nJG4 n) (body (let __t5aV93 (_0002b n n))) (head (emit-temp temp9o8H73 __t0nJG4 __t5aV93) (emit asked (0) n)) rule_noarrow.slog:17 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp9o8H73");
      head_rel[1] = db->getRelation("asked");
      std::vector<u16> ord13({0});
      slog::Relation* readrel14 = db->getRelation("asked");
      head_index[1] = readrel14->getIndex(ord13, false);
      outer_rel = db->getRelation("dub");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c4 = _t[0];
        u64 v_c13 = _t[1];
        u64 v_c5 = _prim__0002b(db, v_c13, v_c13);
        if (v_c5 == slog_error) { slog::emit_pending_error(db, "rule_noarrow.slog:17"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("rule_noarrow.slog:17", "all:dub", _fires);
  ...
  // (crule (pre) (scan toint_range __erre9kgI57 __errf64FW58 __errf1sa459) (body) (head (emit error (0) __erre9kgI57)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre3Stl60 __errf0n9o61 __errf9aR162 __errf9uiN63 __errf08Be64) (body) (head (emit error (0) __erre3Stl60)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre3JOI43 __errf6gM544 __errf8WO445) (body) (head (emit error (0) __erre3JOI43)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre6ij865 __errf3bru66 __errf5DYk67 __errf3R0668 __errf3u4O69) (body) (head (emit error (0) __erre6ij865)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre3d1y46 __errf1MVN47 __errf8KA948) (body) (head (emit error (0) __erre3d1y46)) <internal>:1 #f)
  ...
  s->addReadRel("temp9o8H73");
  s->addReadRel("toint_range");
  s->addReadRel("type_mismatch");
  s->addDynamicRel("asked");
  s->addDynamicRel("div_by_zero");
  s->addDynamicRel("dub_ans");
