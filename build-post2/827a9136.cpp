...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("827a9136");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre) (scan type_mismatch __erre9vO2251 __errf9nQU252 __errf5pV6253 __errf1Uvv254 __errf9InK255) (body) (head (emit error (0) __erre9vO2251)) <internal>:1 #f)
  ...
  // (crule (pre) (scan int_overflow __erre1j8b240 __errf0i5h241 __errf9vwZ242 __errf4jhP243) (body) (head (emit error (0) __erre1j8b240)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre7xrz248 __errf1QqP249 __errf98US250) (body) (head (emit error (0) __erre7xrz248)) <internal>:1 #f)
  ...
  // (crule (pre) (scan nan_result __erre1LyY244 __errf4qCR245 __errf5ckX246 __errf8Csf247) (body) (head (emit error (0) __erre1LyY244)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre1hCX234 __errf2gSy235 __errf4My1236) (body) (head (emit error (0) __erre1hCX234)) <internal>:1 #f)
  ...
  // (crule (pre) (scan big b) (body (let __t3Bc310 (llen b))) (head (emit bsz (0) __t3Bc310)) seq_io.slog:18 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel17 = db->getRelation("bsz");
      head_index[0] = readrel17->getIndex(ord16, false);
      outer_rel = db->getRelation("big");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        if (v_c20 == slog_error) { slog::emit_pending_error(db, "seq_io.slog:18"); return; }
        ++_fires;
      ...
      if (_fires) db->bumpFires("seq_io.slog:18", "all:big", _fires);
  ...
  // (crule (pre) (scan mpz_table_overflow __erre1Isa261 __errf0JBm262 __errf2wQp263) (body) (head (emit error (0) __erre1Isa261)) <internal>:1 #f)
  ...
  // (crule (pre) (scan modulo_by_zero __erre7zwI237 __errf9LwW238 __errf3Fx2239) (body) (head (emit error (0) __erre7zwI237)) <internal>:1 #f)
  ...
  // (crule (pre) (scan mpz_overflow __erre3m4X256 __errf1epv257 __errf5zLw258 __errf5qfm259 __errf9gFx260) (body) (head (emit error (0) __erre3m4X256)) <internal>:1 #f)
