...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("f1e0b689");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  r = db->getRelation("temp6KrG1171");
  if (r == 0) db->addTempRelation("temp6KrG1171", 3);
  else if (r->getArity() != 3) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp3Qu01169");
  if (r == 0) db->addTempRelation("temp3Qu01169", 3);
  else if (r->getArity() != 3) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp3IpF1170");
  if (r == 0) db->addTempRelation("temp3IpF1170", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp2l6t1167");
  if (r == 0) db->addTempRelation("temp2l6t1167", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp1JHB1172");
  if (r == 0) db->addTempRelation("temp1JHB1172", 3);
  else if (r->getArity() != 3) slog::fatal("Temp rel arity mismatch.");
  r = db->getRelation("temp0MD71168");
  if (r == 0) db->addTempRelation("temp0MD71168", 2);
  else if (r->getArity() != 2) slog::fatal("Temp rel arity mismatch.");
  ...
  if (r == 0) db->addRelation("call_target", 4);
    ...
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("call_target");
      std::vector<u16> ord172({2, 0, 1, 3});
    
    r->addIndex<4>(ord172, false);
    for (u16 b = 0; b < 32; ++b)
      s->addTask(phase_write, new slog::WriteTask<4>(db, r, std::array<u16,4>{2, 0, 1, 3}, false, b), true);
  

  for (u16 b = 0; b < 32; ++b)
    s->addTask(phase_intern, new slog::InternTask<4>(db, db->getRelation("call_target"), std::array<u16,4>{2, 0, 1, 3}, b));
  ...
  if (r == 0) db->addRelation("$sup56712x91x0x0x0", 5);
    ...
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("$sup56712x91x0x0x0");
      std::vector<u16> ord191({0, 1, 2, 3, 4});
  ...
  if (r == 0) db->addRelation("$sup56712x37x0x0x0", 5);
    ...
    slog::fatal("Relation already exists at incorrect arity.");
  r = db->getRelation("$sup56712x37x0x0x0");
      std::vector<u16> ord195({0, 1, 2, 3, 4});
  ...
  // (crule (pre (let __t8pxC198 (one))) (scan binding_event x l c) (body) (head (emit-temp temp1JHB1172 __t8pxC198 l x)) counting.slog:21 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("temp1JHB1172");
    ...
    virtual bool work()
    {
      ...
      if (v_c0 == slog_error) { slog::emit_pending_error(db, "counting.slog:21"); return true; }
  ...
  // (crule (pre) (scan modulo_by_zero __erre1qEK1140 __errf3NCR1141 __errf0vUh1142) (body) (head (emit error (0) __erre1qEK1140)) <internal>:1 #f)
  ...
  // (crule (pre (let __t5x8O2 (lempty)) (let __t4ZfR1 (one))) (scan program e) (body) (head (emit-temp temp0MD71168 __t4ZfR1 __t5x8O2)) counting.slog:17 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp0MD71168");
    ...
    virtual bool work()
    {
      ...
      if (v_c7 == slog_error) { slog::emit_pending_error(db, "counting.slog:17"); return true; }
      u64 v_c8 = _prim_one(db);
      if (v_c8 == slog_error) { slog::emit_pending_error(db, "counting.slog:17"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c9 = _t[0];
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c8, v_c7});
      });
  ...
  // (crule (pre (let __t5umN115 (inf))) (probe flow_count (2 0 1) 1 __t5umN115 x l) (body) (head (emit polyvariant_flow (0 1) x l)) counting.slog:40 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel7 = db->getRelation("polyvariant_flow");
      head_index[0] = readrel7->getIndex(ord6, false);
      std::vector<u16> ord8({2, 0, 1});
      slog::Relation* readrel9 = db->getRelation("flow_count");
    ...
    virtual bool work()
    {
      u64 v_c10 = _prim_inf(db);
      if (v_c10 == slog_error) { slog::emit_pending_error(db, "counting.slog:40"); return true; }
      ...
      bool _done = slog::join_probe_sliced<3,1>(driver_index, std::array<u64,3>{v_c10, 0, 0}, _sc, _rkey, _hr, [&](const std::array<u64,3>& m10) {
        u64 v_c1 = m10[1];
        u64 v_c2 = m10[2];
  ...
  // (crule (pre) (scan temp0MD71168 __t4ZfR1 __t5x8O2) (body) (head (emit-lat frame_count __t5x8O2 __t4ZfR1)) counting.slog:17 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      outer_rel = db->getRelation("temp0MD71168");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("counting.slog:17", "delta:temp0MD71168", _fires);
  ...
  // (crule (pre) (scan int_overflow __erre4vGp1143 __errf6l5V1144 __errf4cjJ1145 __errf2S2m1146) (body) (head (emit error (0) __erre4vGp1143)) <internal>:1 #f)
  ...
  // (crule (pre) (scan toint_range __erre8vZH1151 __errf5QoM1152 __errf3qzV1153) (body) (head (emit error (0) __erre8vZH1151)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp1JHB1172 __t8pxC198 l x) (body) (head (emit-lat binding_count x l __t8pxC198)) counting.slog:21 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      outer_rel = db->getRelation("temp1JHB1172");
    ...
    virtual bool work()
    {
      ...
      if (_fires) db->bumpFires("counting.slog:21", "delta:temp1JHB1172", _fires);
  ...
  // (crule (pre (let __t2Hpv335 (one))) (probe flow_count (2 0 1) 1 __t2Hpv335 x l) (body) (head (emit singleton_flow (0 1) x l)) counting.slog:39 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      ...
      slog::Relation* readrel21 = db->getRelation("singleton_flow");
      head_index[0] = readrel21->getIndex(ord20, false);
      std::vector<u16> ord22({2, 0, 1});
      slog::Relation* readrel23 = db->getRelation("flow_count");
    ...
    virtual bool work()
    {
      ...
      if (v_c18 == slog_error) { slog::emit_pending_error(db, "counting.slog:39"); return true; }
  ...
  // (crule (pre (let __t3Aac188 (inf))) (scan many_frames l) (body) (head (emit-temp temp2l6t1167 __t3Aac188 l)) counting.slog:19 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp2l6t1167");
    ...
    virtual bool work()
    {
      u64 v_c19 = _prim_inf(db);
      if (v_c19 == slog_error) { slog::emit_pending_error(db, "counting.slog:19"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c2 = _t[0];
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c19, v_c2});
      });
  ...
  // (crule (pre) (scan temp3Qu01169 __t4TsM57 l x) (body) (head (emit-lat binding_count x l __t4TsM57)) counting.slog:23 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("binding_count");
      outer_rel = db->getRelation("temp3Qu01169");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c1 = _t[2];
        ++_fires;
        slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c1, v_c2, v_c20});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("counting.slog:23", "delta:temp3Qu01169", _fires);
  ...
  // (crule (pre (let __t8yDd126 (one))) (scan call_event l c) (body) (head (emit-temp temp3IpF1170 __t8yDd126 l)) counting.slog:18 #f)
  ...
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp3IpF1170");
    ...
    virtual bool work()
    {
      u64 v_c21 = _prim_one(db);
      if (v_c21 == slog_error) { slog::emit_pending_error(db, "counting.slog:18"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c3 = _t[1];
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c21, v_c2});
      });
  ...
  // (crule (pre) (scan temp3IpF1170 __t8yDd126 l) (body) (head (emit-lat frame_count l __t8yDd126)) counting.slog:18 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("frame_count");
      outer_rel = db->getRelation("temp3IpF1170");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c2 = _t[1];
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c2, v_c21});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("counting.slog:18", "delta:temp3IpF1170", _fires);
  ...
  // (crule (pre (let __t4TsM57 (inf))) (scan binding_event x l c2) (body (join binding_event (0 1 2) 2 x l c1) (neq c1 c2)) (head (emit-temp temp3Qu01169 __t4TsM57 l x)) counting.slog:23 #f)
  class ReadTask30 : public slog::Task
  {
    ...
    slog::Index** binding_eventindex29;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp3Qu01169");
      outer_rel = db->getRelation("binding_event");
      std::vector<u16> ord31({0, 1, 2});
      slog::Relation* readrel32 = db->getRelation("binding_event");
      binding_eventindex29 = readrel32->getIndex(ord31, false);
    ...
    virtual bool work()
    {
      ...
      if (v_c20 == slog_error) { slog::emit_pending_error(db, "counting.slog:23"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c2 = _t[1];
        u64 v_c22 = _t[2];
        slog::join_probe<3,2>(binding_eventindex29, std::array<u64,3>{v_c1, v_c2, 0}, [&](const std::array<u64,3>& m33) {
          u64 v_c23 = m33[2];
          if (v_c23 == v_c22) return;
          ++_fires;
          slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c20, v_c2, v_c1});
        });
      });
  ...
  // (crule (pre) (scan mpz_table_overflow __erre37sD1164 __errf3e3x1165 __errf5Qo91166) (body) (head (emit error (0) __erre37sD1164)) <internal>:1 #f)
  ...
  // (crule (pre) (scan div_by_zero __erre8euU1137 __errf5Wm01138 __errf295y1139) (body) (head (emit error (0) __erre8euU1137)) <internal>:1 #f)
  ...
  // (crule (pre) (scan closure __t9v82299 lam cb) (body (join call_target (2 0 1 3) 1 __t9v82299 site c l)) (head (emit site_targets (0 1) site lam)) analysis.slog:18 #f)
  class ReadTask41 : public slog::Task
  {
    ...
    slog::Index** call_targetindex40;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("site_targets");
      std::vector<u16> ord42({0, 1});
      slog::Relation* readrel43 = db->getRelation("site_targets");
      head_index[0] = readrel43->getIndex(ord42, false);
      outer_rel = db->getRelation("closure");
      std::vector<u16> ord44({2, 0, 1, 3});
      slog::Relation* readrel45 = db->getRelation("call_target");
      call_targetindex40 = readrel45->getIndex(ord44, false);
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c31 = _t[1];
        u64 v_c32 = _t[2];
        slog::join_probe<4,1>(call_targetindex40, std::array<u64,4>{v_c30, 0, 0, 0}, [&](const std::array<u64,4>& m46) {
          u64 v_c33 = m46[1]; u64 v_c3 = m46[2]; u64 v_c2 = m46[3];
          ++_fires;
      ...
      if (_fires) db->bumpFires("analysis.slog:18", "all:closure", _fires);
  ...
  // (crule (pre) (scan nan_result __erre6iw91147 __errf5gwl1148 __errf6dFR1149 __errf20ne1150) (body) (head (emit error (0) __erre6iw91147)) <internal>:1 #f)
  ...
  // (crule (pre) (scan type_mismatch __erre4vjn1154 __errf1cW11155 __errf1W1Q1156 __errf5lR81157 __errf1qt91158) (body) (head (emit error (0) __erre4vjn1154)) <internal>:1 #f)
  ...
  // (crule (pre) (scan temp6KrG1171 __t9Ucq5 l x) (body) (head (emit-lat binding_count x l __t9Ucq5)) counting.slog:22 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("binding_count");
      outer_rel = db->getRelation("temp6KrG1171");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c1 = _t[2];
        ++_fires;
        slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c1, v_c2, v_c43});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("counting.slog:22", "delta:temp6KrG1171", _fires);
  ...
  // (crule (pre (let __t9Ucq5 (inf))) (scan many_frames c) (body (join binding_event (2 0 1) 1 c x l)) (head (emit-temp temp6KrG1171 __t9Ucq5 l x)) counting.slog:22 #f)
  class ReadTask55 : public slog::Task
  {
    ...
    slog::Index** binding_eventindex54;
  
  public:
    void bind(slog::Database* db)
    {
      head_rel[0] = db->getRelation("temp6KrG1171");
      outer_rel = db->getRelation("many_frames");
      std::vector<u16> ord56({2, 0, 1});
      slog::Relation* readrel57 = db->getRelation("binding_event");
      binding_eventindex54 = readrel57->getIndex(ord56, false);
  
    }
    ReadTask55(slog::Database* _db, u16 _b) : db(_db), bucket(_b) { bind(_db); }
    virtual bool work()
    {
      u64 v_c43 = _prim_inf(db);
      if (v_c43 == slog_error) { slog::emit_pending_error(db, "counting.slog:22"); return true; }
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        u64 v_c3 = _t[0];
        slog::join_probe<3,1>(binding_eventindex54, std::array<u64,3>{v_c3, 0, 0}, [&](const std::array<u64,3>& m58) {
          u64 v_c1 = m58[1]; u64 v_c2 = m58[2];
          ++_fires;
          slog::emit_temp<3>(head_rel[0], newbatch[0], std::array<u64,3>{v_c43, v_c2, v_c1});
        });
      });
  ...
  // (crule (pre) (scan temp2l6t1167 __t3Aac188 l) (body) (head (emit-lat frame_count l __t3Aac188)) counting.slog:19 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("frame_count");
      outer_rel = db->getRelation("temp2l6t1167");
    ...
    virtual bool work()
    {
      ...
      bool _done = slog::read_delta_sliced(outer_rel, bucket, db->getThreadCount(), _sc, _rt, _ri, [&](const u64* _t) {
        ...
        u64 v_c2 = _t[1];
        ++_fires;
        slog::emit_temp<2>(head_rel[0], newbatch[0], std::array<u64,2>{v_c2, v_c19});
      });
  
        head_rel[0]->sendBatch(newbatch[0]);
  
      if (_fires) db->bumpFires("counting.slog:19", "delta:temp2l6t1167", _fires);
  ...
  // (crule (pre) (scan mpz_overflow __erre2ASl1159 __errf5AYH1160 __errf87vx1161 __errf5r0B1162 __errf4PRb1163) (body) (head (emit error (0) __erre2ASl1159)) <internal>:1 #f)
  ...
  s->addReadRel("temp0MD71168");
  s->addReadRel("temp1JHB1172");
  s->addReadRel("temp2l6t1167");
  s->addReadRel("temp3IpF1170");
  s->addReadRel("temp3Qu01169");
  s->addReadRel("temp6KrG1171");
  ...
  s->addDynamicRel("site_targets");
  s->addDynamicRel("temp0MD71168");
  s->addDynamicRel("temp1JHB1172");
  s->addDynamicRel("temp2l6t1167");
  s->addDynamicRel("temp3IpF1170");
  s->addDynamicRel("temp3Qu01169");
  s->addDynamicRel("temp6KrG1171");
