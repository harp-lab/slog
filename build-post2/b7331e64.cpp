...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("b7331e64");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst1lTH11 conste433800a79f2d3be41014577)) (once) (body) (head (mkstruct _enum (1 0) __5MEY12 __tconst1lTH11)) <internal>:1 #f)
