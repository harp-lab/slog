...
extern "C" void slog_plugin(slog::Daemon* d)
{
  ...
  slog::Stratum* s = d->beginStratum("7de9bae2");
  if (s == nullptr) return;
  slog::Relation* r;
  ...
  // (crule (pre (let __tconst8AD82 const5feceb66ffc86f38d952786c) (let __tconst1ZBH4 const6b86b273ff34fce19d6b804e) (let __tconst57xs5 constac8d8342bbb2362d13f0a559) (let __tconst3FuX6 constd4735e3a265e16eee03f5971)) (once) (body) (head (emit tok2 (0 1) __tconst8AD82 __tconst57xs5) (emit tok2 (0 1) __tconst1ZBH4 __tconst57xs5) (emit tok2 (0 1) __tconst3FuX6 __tconst57xs5)) dem_sppf.slog:12 #f)
  ...
  public:
    ...
    {
      head_rel[0] = db->getRelation("tok2");
      std::vector<u16> ord1({0, 1});
      slog::Relation* readrel2 = db->getRelation("tok2");
      head_index[0] = readrel2->getIndex(ord1, false);
      head_rel[1] = db->getRelation("tok2");
      std::vector<u16> ord3({0, 1});
      slog::Relation* readrel4 = db->getRelation("tok2");
      head_index[1] = readrel4->getIndex(ord3, false);
      head_rel[2] = db->getRelation("tok2");
      std::vector<u16> ord5({0, 1});
      slog::Relation* readrel6 = db->getRelation("tok2");
    ...
    virtual bool work()
    {
      ...
      u64 v_c2 = v_constac8d8342bbb2362d13f0a559;
      ...
      if (_fires) db->bumpFires("dem_sppf.slog:12", "once", _fires);
